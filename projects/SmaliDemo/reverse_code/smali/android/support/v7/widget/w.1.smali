...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 48
    iput-object p1, p0, Landroid/support/v7/widget/w;->b:Landroid/widget/ProgressBar;
...
.method private a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v5, v6}, Landroid/support/v7/widget/w;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    check-cast v1, Landroid/support/v4/graphics/drawable/c;

    invoke-interface {v1, v0}, Landroid/support/v4/graphics/drawable/c;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-direct {p0, v6, v7}, Landroid/support/v7/widget/w;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/w;->c:Landroid/graphics/Bitmap;

    if-nez v3, :cond_7

    .line 101
    iput-object v2, p0, Landroid/support/v7/widget/w;->c:Landroid/graphics/Bitmap;

    .line 104
    :cond_7
    new-instance v3, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {p0}, Landroid/support/v7/widget/w;->b()Landroid/graphics/drawable/shapes/Shape;
...
.method a()Landroid/graphics/Bitmap;
    ...
    .line 145
    iget-object v0, p0, Landroid/support/v7/widget/w;->c:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 52
    iget-object v0, p0, Landroid/support/v7/widget/w;->b:Landroid/widget/ProgressBar;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/ta;->c(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 57
    iget-object v3, p0, Landroid/support/v7/widget/w;->b:Landroid/widget/ProgressBar;
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ta;->c(I)Landroid/graphics/drawable/Drawable;
