...
.method public a(Landroid/support/v7/view/menu/l;Z)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/b;->b()Landroid/support/v7/view/menu/v$a;

    move-result-object v0

    .line 787
    .local v0, "cb":Landroid/support/v7/view/menu/v$a;
    if-eqz v0, :cond_1
...
.method public a(Landroid/support/v7/view/menu/l;)Z
    ...
    iput v2, v1, Landroid/support/v7/widget/g;->E:I

    .line 777
    iget-object v1, p0, Landroid/support/v7/widget/g$f;->a:Landroid/support/v7/widget/g;

    invoke-virtual {v1}, Landroid/support/v7/view/menu/b;->b()Landroid/support/v7/view/menu/v$a;

    move-result-object v1

    .line 778
    .local v1, "cb":Landroid/support/v7/view/menu/v$a;
    if-eqz v1, :cond_1
