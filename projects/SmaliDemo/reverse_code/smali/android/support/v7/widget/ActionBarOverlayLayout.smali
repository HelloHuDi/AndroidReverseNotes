...
.field private final B:La/b/c/g/p;
...
.method static constructor <clinit>()V
    ...
    sget v1, La/b/d/a/a;->actionBarSize:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 144
    new-instance v0, La/b/c/g/p;

    invoke-direct {v0, p0}, La/b/c/g/p;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:La/b/c/g/p;
...
.method private a(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Landroid/widget/OverScroller;
...
.method public a(I)V
    ...
    .line 639
    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->f:Landroid/support/v7/widget/L;

    invoke-interface {v0}, Landroid/support/v7/widget/L;->n()V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/L;->m()V
...
.method public a(Landroid/view/Menu;Landroid/support/v7/view/menu/v$a;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/L;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/v$a;)V
...
.method public a()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/L;->a()Z
...
.method public b()V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/L;->b()V
...
.method public c()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/L;->c()Z
...
.method public d()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/L;->d()Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 458
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->g:Landroid/graphics/drawable/Drawable;
...
.method public e()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/L;->e()Z
...
.method public f()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/L;->f()Z
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    .line 289
    invoke-static {p0}, La/b/c/g/u;->g(Landroid/view/View;)I
    ...
    iget-object v4, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->e:Landroid/support/v7/widget/ActionBarContainer;
    ...
    invoke-direct/range {v3 .. v9}, Landroid/support/v7/widget/ActionBarOverlayLayout;->a(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
    ...
    iget-object v5, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->o:Landroid/graphics/Rect;

    invoke-static {p0, v4, v5}, Landroid/support/v7/widget/Ha;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    .line 298
    iget-object v4, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->s:Landroid/graphics/Rect;

    iget-object v5, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->r:Landroid/graphics/Rect;
...
.method public g()V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/L;->g()V
...
.method public getNestedScrollAxes()I
    ...
    .line 532
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:La/b/c/g/p;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/L;->getTitle()Ljava/lang/CharSequence;
...
.method j()V
    ...
    .line 537
    sget v0, La/b/d/a/f;->action_bar_activity_content:I
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->a(Landroid/view/View;)Landroid/support/v7/widget/L;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->f:Landroid/support/v7/widget/L;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 225
    invoke-static {p0}, La/b/c/g/u;->m(Landroid/view/View;)V
...
.method protected onLayout(ZIIII)V
    ...
    check-cast v8, Landroid/support/v7/widget/ActionBarOverlayLayout$b;

    .line 438
    .local v8, "lp":Landroid/support/v7/widget/ActionBarOverlayLayout$b;
    ...
    .end local v8    # "lp":Landroid/support/v7/widget/ActionBarOverlayLayout$b;
...
.method protected onMeasure(II)V
    ...
    iget-object v1, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->e:Landroid/support/v7/widget/ActionBarContainer;
    ...
    .line 350
    iget-object v0, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->e:Landroid/support/v7/widget/ActionBarContainer;
    ...
    check-cast v12, Landroid/support/v7/widget/ActionBarOverlayLayout$b;

    .line 351
    .local v12, "lp":Landroid/support/v7/widget/ActionBarOverlayLayout$b;
    iget-object v0, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->e:Landroid/support/v7/widget/ActionBarContainer;
    ...
    .line 357
    invoke-static/range {p0 .. p0}, La/b/c/g/u;->g(Landroid/view/View;)I
    ...
    .line 363
    iget v10, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->b:I

    .line 364
    iget-boolean v0, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->j:Z
    ...
    .line 368
    iget v1, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->b:I
    ...
    :cond_3
    :goto_1
    iget-object v0, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->q:Landroid/graphics/Rect;

    iget-object v1, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->o:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    .line 382
    iget-object v0, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->t:Landroid/graphics/Rect;

    iget-object v1, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->r:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    .line 383
    iget-boolean v0, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->i:Z
    ...
    .line 390
    :goto_2
    iget-object v1, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->d:Landroid/support/v7/widget/ContentFrameLayout;

    iget-object v2, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->q:Landroid/graphics/Rect;
    ...
    .line 392
    iget-object v0, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->u:Landroid/graphics/Rect;

    iget-object v1, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->t:Landroid/graphics/Rect;
    ...
    .line 398
    iget-object v0, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->d:Landroid/support/v7/widget/ContentFrameLayout;
    ...
    .line 403
    .end local v12    # "lp":Landroid/support/v7/widget/ActionBarOverlayLayout$b;
    .local v0, "lp":Landroid/support/v7/widget/ActionBarOverlayLayout$b;
    iget-object v1, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->d:Landroid/support/v7/widget/ContentFrameLayout;
    ...
    .local v1, "maxWidth":I
    iget-object v2, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->d:Landroid/support/v7/widget/ContentFrameLayout;
    ...
    iget-object v3, v7, Landroid/support/v7/widget/ActionBarOverlayLayout;->d:Landroid/support/v7/widget/ContentFrameLayout;
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, La/b/c/g/p;->a(Landroid/view/View;Landroid/view/View;I)V
...
.method public onWindowSystemUiVisibilityChanged(I)V
    ...
    .local v4, "stable":Z
    :goto_1
    iget-object v5, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->v:Landroid/support/v7/widget/ActionBarOverlayLayout$a;
    ...
    :goto_2
    invoke-interface {v5, v2}, Landroid/support/v7/widget/ActionBarOverlayLayout$a;->a(Z)V
    ...
    .line 244
    :cond_4
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->v:Landroid/support/v7/widget/ActionBarOverlayLayout$a;

    invoke-interface {v2}, Landroid/support/v7/widget/ActionBarOverlayLayout$a;->c()V
    ...
    invoke-interface {v2}, Landroid/support/v7/widget/ActionBarOverlayLayout$a;->a()V
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/L;->setIcon(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/L;->setIcon(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/L;->b(I)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/L;->setWindowCallback(Landroid/view/Window$Callback;)V
