...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v2, p0, Landroid/support/v7/widget/ActionMenuView;->z:I

    .line 85
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->q:Landroid/content/Context;

    .line 86
    iput v0, p0, Landroid/support/v7/widget/ActionMenuView;->r:I
...
.method static a(Landroid/view/View;IIII)I
    ...
    .line 406
    .local v2, "lp":Landroid/support/v7/widget/ActionMenuView$c;
    ...
    invoke-virtual {v6}, Landroid/support/v7/view/menu/ActionMenuItemView;->d()Z
    ...
    :cond_4
    iget-boolean v11, v2, Landroid/support/v7/widget/ActionMenuView$c;->c:Z
    ...
    :cond_5
    iput-boolean v7, v2, Landroid/support/v7/widget/ActionMenuView$c;->f:Z

    .line 430
    iput v10, v2, Landroid/support/v7/widget/ActionMenuView$c;->d:I
...
.method private e(II)V
    ...
    .line 227
    .local v9, "lp":Landroid/support/v7/widget/ActionMenuView$c;
    iput-boolean v10, v9, Landroid/support/v7/widget/ActionMenuView$c;->h:Z

    .line 228
    iput v10, v9, Landroid/support/v7/widget/ActionMenuView$c;->e:I

    .line 229
    iput v10, v9, Landroid/support/v7/widget/ActionMenuView$c;->d:I

    .line 230
    iput-boolean v10, v9, Landroid/support/v7/widget/ActionMenuView$c;->f:Z
    ...
    invoke-virtual {v10}, Landroid/support/v7/view/menu/ActionMenuItemView;->d()Z
    ...
    :goto_2
    iput-boolean v10, v9, Landroid/support/v7/widget/ActionMenuView$c;->g:Z

    .line 236
    iget-boolean v10, v9, Landroid/support/v7/widget/ActionMenuView$c;->c:Z
    ...
    invoke-static {v4, v8, v10, v6, v5}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/view/View;IIII)I
    ...
    iget-boolean v5, v9, Landroid/support/v7/widget/ActionMenuView$c;->f:Z
    ...
    .line 243
    :cond_5
    iget-boolean v5, v9, Landroid/support/v7/widget/ActionMenuView$c;->c:Z
    ...
    .end local v9    # "lp":Landroid/support/v7/widget/ActionMenuView$c;
    ...
    .line 267
    .local v7, "lp":Landroid/support/v7/widget/ActionMenuView$c;
    ...
    .line 270
    :cond_a
    iget v10, v7, Landroid/support/v7/widget/ActionMenuView$c;->d:I

    if-ge v10, v9, :cond_b

    .line 271
    iget v9, v7, Landroid/support/v7/widget/ActionMenuView$c;->d:I
    ...
    .line 262
    .end local v7    # "lp":Landroid/support/v7/widget/ActionMenuView$c;
    ...
    .line 291
    .local v12, "lp":Landroid/support/v7/widget/ActionMenuView$c;
    move/from16 v34, v4
    ...
    .line 293
    iget v2, v12, Landroid/support/v7/widget/ActionMenuView$c;->d:I
    ...
    iget-boolean v2, v12, Landroid/support/v7/widget/ActionMenuView$c;->g:Z
    ...
    iput v2, v12, Landroid/support/v7/widget/ActionMenuView$c;->d:I

    .line 302
    iput-boolean v3, v12, Landroid/support/v7/widget/ActionMenuView$c;->h:Z
    ...
    .line 288
    .end local v10    # "child":Landroid/view/View;
    .end local v12    # "lp":Landroid/support/v7/widget/ActionMenuView$c;
    :cond_11
    :goto_a
    ...
    .line 321
    .local v7, "lp":Landroid/support/v7/widget/ActionMenuView$c;
    iget-boolean v9, v7, Landroid/support/v7/widget/ActionMenuView$c;->g:Z
    ...
    .line 325
    .local v4, "lp":Landroid/support/v7/widget/ActionMenuView$c;
    iget-boolean v5, v4, Landroid/support/v7/widget/ActionMenuView$c;->g:Z
    ...
    .line 317
    .end local v4    # "lp":Landroid/support/v7/widget/ActionMenuView$c;
    ...
    iput-boolean v12, v3, Landroid/support/v7/widget/ActionMenuView$c;->h:Z

    .line 341
    if-nez v5, :cond_1d

    iget-boolean v12, v3, Landroid/support/v7/widget/ActionMenuView$c;->g:Z
    ...
    .line 347
    :cond_1e
    iget-boolean v12, v3, Landroid/support/v7/widget/ActionMenuView$c;->c:Z
    ...
    .line 374
    .local v5, "lp":Landroid/support/v7/widget/ActionMenuView$c;
    iget-boolean v7, v5, Landroid/support/v7/widget/ActionMenuView$c;->h:Z
    ...
    .line 376
    :cond_24
    iget v7, v5, Landroid/support/v7/widget/ActionMenuView$c;->d:I

    mul-int v7, v7, v8

    iget v12, v5, Landroid/support/v7/widget/ActionMenuView$c;->e:I
    ...
    .line 370
    .end local v4    # "child":Landroid/view/View;
    .end local v5    # "lp":Landroid/support/v7/widget/ActionMenuView$c;
...
.method public a()V
    ...
    .line 723
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->t:Landroid/support/v7/widget/g;
...
.method public a(Landroid/support/v7/view/menu/v$a;Landroid/support/v7/view/menu/l$a;)V
    .locals 0
    .param p1, "pcb"    # Landroid/support/v7/view/menu/v$a;
    .param p2, "mcb"    # Landroid/support/v7/view/menu/l$a;
...
.method protected d(I)Z
    ...
    check-cast v3, Landroid/support/v7/widget/ActionMenuView$a;

    invoke-interface {v3}, Landroid/support/v7/widget/ActionMenuView$a;->a()Z
    ...
    invoke-interface {v3}, Landroid/support/v7/widget/ActionMenuView$a;->b()Z
...
.method public g()Landroid/support/v7/view/menu/l;
    .locals 1
...
.method protected generateDefaultLayoutParams()Landroid/support/v7/widget/ActionMenuView$c;
    ...
    iput v1, v0, Landroid/support/v7/widget/Q$a;->b:I

    .line 586
    return-object v0
.end method

.method protected bridge synthetic generateDefaultLayoutParams()Landroid/support/v7/widget/Q$a;
    .locals 1
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/ActionMenuView$c;
    ...
    invoke-direct {v0, v1}, Landroid/support/v7/widget/ActionMenuView$c;-><init>(Landroid/support/v7/widget/ActionMenuView$c;)V
    ...
    .local v0, "result":Landroid/support/v7/widget/ActionMenuView$c;
    :goto_0
    iget v1, v0, Landroid/support/v7/widget/Q$a;->b:I
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/support/v7/widget/Q$a;
    .locals 0
...
.method protected bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/Q$a;
    .locals 0
...
.method public getMenu()Landroid/view/Menu;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->t:Landroid/support/v7/widget/g;

    .line 656
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->t:Landroid/support/v7/widget/g;

    const/4 v2, 0x1

    invoke-virtual {v1, v2}, Landroid/support/v7/widget/g;->c(Z)V

    .line 657
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->t:Landroid/support/v7/widget/g;

    iget-object v2, p0, Landroid/support/v7/widget/ActionMenuView;->u:Landroid/support/v7/view/menu/v$a;
    ...
    invoke-direct {v2}, Landroid/support/v7/widget/ActionMenuView$b;-><init>()V

    :goto_0
    invoke-virtual {v1, v2}, Landroid/support/v7/view/menu/b;->a(Landroid/support/v7/view/menu/v$a;)V

    .line 659
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->p:Landroid/support/v7/view/menu/l;

    iget-object v2, p0, Landroid/support/v7/widget/ActionMenuView;->t:Landroid/support/v7/widget/g;

    iget-object v3, p0, Landroid/support/v7/widget/ActionMenuView;->q:Landroid/content/Context;

    invoke-virtual {v1, v2, v3}, Landroid/support/v7/view/menu/l;->a(Landroid/support/v7/view/menu/v;Landroid/content/Context;)V

    .line 660
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->t:Landroid/support/v7/widget/g;

    invoke-virtual {v1, p0}, Landroid/support/v7/widget/g;->a(Landroid/support/v7/widget/ActionMenuView;)V
...
.method public getOverflowIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/g;->d()Landroid/graphics/drawable/Drawable;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/g;->a(Z)V
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/Q;->getDividerWidth()I
    ...
    .line 460
    .local v11, "p":Landroid/support/v7/widget/ActionMenuView$c;
    iget-boolean v13, v11, Landroid/support/v7/widget/ActionMenuView$c;->c:Z
    ...
    .line 462
    invoke-virtual {v0, v10}, Landroid/support/v7/widget/ActionMenuView;->d(I)Z
    ...
    .line 453
    .end local v2    # "size":I
    .end local v11    # "p":Landroid/support/v7/widget/ActionMenuView$c;
    ...
    .line 512
    .local v14, "lp":Landroid/support/v7/widget/ActionMenuView$c;
    ...
    iget-boolean v15, v14, Landroid/support/v7/widget/ActionMenuView$c;->c:Z
    ...
    .end local v14    # "lp":Landroid/support/v7/widget/ActionMenuView$c;
    ...
    .line 528
    .local v11, "lp":Landroid/support/v7/widget/ActionMenuView$c;
    ...
    iget-boolean v12, v11, Landroid/support/v7/widget/ActionMenuView$c;->c:Z
    ...
    .end local v11    # "lp":Landroid/support/v7/widget/ActionMenuView$c;
...
.method protected onMeasure(II)V
    ...
    iget-boolean v4, p0, Landroid/support/v7/widget/ActionMenuView;->w:Z

    if-eqz v4, :cond_2

    iget-object v4, p0, Landroid/support/v7/widget/ActionMenuView;->p:Landroid/support/v7/view/menu/l;

    if-eqz v4, :cond_2

    iget v5, p0, Landroid/support/v7/widget/ActionMenuView;->x:I
    ...
    .line 159
    invoke-virtual {v4, v2}, Landroid/support/v7/view/menu/l;->b(Z)V
    ...
    .line 170
    .local v6, "lp":Landroid/support/v7/widget/ActionMenuView$c;
    ...
    .end local v6    # "lp":Landroid/support/v7/widget/ActionMenuView$c;
    add-int/lit8 v4, v4, 0x1
...
.method public setExpandedActionViewsExclusive(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/g;->b(Z)V
...
.method public setPresenter(Landroid/support/v7/widget/g;)V
    .locals 1
    .param p1, "presenter"    # Landroid/support/v7/widget/g;

    .line 122
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->t:Landroid/support/v7/widget/g;
