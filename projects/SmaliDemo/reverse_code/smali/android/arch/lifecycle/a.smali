...
.method private a(Ljava/lang/Class;[Ljava/lang/reflect/Method;)Landroid/arch/lifecycle/a$a;
    ...
    .line 107
    invoke-virtual {v0, v2}, Landroid/arch/lifecycle/a;->a(Ljava/lang/Class;)Landroid/arch/lifecycle/a$a;

    move-result-object v4

    .line 108
    .local v4, "superInfo":Landroid/arch/lifecycle/a$a;
    if-eqz v4, :cond_0

    .line 109
    iget-object v5, v4, Landroid/arch/lifecycle/a$a;->b:Ljava/util/Map;

    invoke-interface {v3, v5}, Ljava/util/Map;->putAll(Ljava/util/Map;)V

    .line 113
    .end local v4    # "superInfo":Landroid/arch/lifecycle/a$a;
    :cond_0
    ...
    invoke-virtual {v0, v8}, Landroid/arch/lifecycle/a;->a(Ljava/lang/Class;)Landroid/arch/lifecycle/a$a;

    move-result-object v9

    iget-object v9, v9, Landroid/arch/lifecycle/a$a;->b:Ljava/util/Map;
    ...
    check-cast v11, Landroid/arch/lifecycle/a$b;

    invoke-interface {v10}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;

    move-result-object v12

    check-cast v12, Landroid/arch/lifecycle/d$a;

    invoke-direct {v0, v3, v11, v12, v1}, Landroid/arch/lifecycle/a;->a(Ljava/util/Map;Landroid/arch/lifecycle/a$b;Landroid/arch/lifecycle/d$a;Ljava/lang/Class;)V
    ...
    :cond_3
    invoke-direct/range {p0 .. p1}, Landroid/arch/lifecycle/a;->c(Ljava/lang/Class;)[Ljava/lang/reflect/Method;
    ...
    const-class v11, Landroid/arch/lifecycle/o;

    invoke-virtual {v10, v11}, Ljava/lang/reflect/Method;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v11

    check-cast v11, Landroid/arch/lifecycle/o;

    .line 125
    .local v11, "annotation":Landroid/arch/lifecycle/o;
    if-nez v11, :cond_4
    ...
    const-class v15, Landroid/arch/lifecycle/f;
    ...
    :cond_6
    :goto_4
    invoke-interface {v11}, Landroid/arch/lifecycle/o;->value()Landroid/arch/lifecycle/d$a;

    move-result-object v14

    .line 140
    .local v14, "event":Landroid/arch/lifecycle/d$a;
    ...
    const-class v15, Landroid/arch/lifecycle/d$a;
    ...
    .line 146
    sget-object v6, Landroid/arch/lifecycle/d$a;->ON_ANY:Landroid/arch/lifecycle/d$a;
    ...
    .line 154
    new-instance v6, Landroid/arch/lifecycle/a$b;

    invoke-direct {v6, v13, v10}, Landroid/arch/lifecycle/a$b;-><init>(ILjava/lang/reflect/Method;)V

    .line 155
    .local v6, "methodReference":Landroid/arch/lifecycle/a$b;
    invoke-direct {v0, v3, v6, v14, v1}, Landroid/arch/lifecycle/a;->a(Ljava/util/Map;Landroid/arch/lifecycle/a$b;Landroid/arch/lifecycle/d$a;Ljava/lang/Class;)V

    .line 123
    .end local v6    # "methodReference":Landroid/arch/lifecycle/a$b;
    .end local v10    # "method":Ljava/lang/reflect/Method;
    .end local v11    # "annotation":Landroid/arch/lifecycle/o;
    .end local v12    # "params":[Ljava/lang/Class;, "[Ljava/lang/Class<*>;"
    .end local v13    # "callType":I
    .end local v14    # "event":Landroid/arch/lifecycle/d$a;
    :goto_6
    add-int/lit8 v7, v7, 0x1
    ...
    .restart local v11    # "annotation":Landroid/arch/lifecycle/o;
    .restart local v12    # "params":[Ljava/lang/Class;, "[Ljava/lang/Class<*>;"
    .restart local v13    # "callType":I
    .restart local v14    # "event":Landroid/arch/lifecycle/d$a;
    :cond_a
    new-instance v6, Ljava/lang/IllegalArgumentException;
    ...
    .end local v14    # "event":Landroid/arch/lifecycle/d$a;
    :cond_b
    new-instance v6, Landroid/arch/lifecycle/a$a;

    invoke-direct {v6, v3}, Landroid/arch/lifecycle/a$a;-><init>(Ljava/util/Map;)V

    .line 158
    .local v6, "info":Landroid/arch/lifecycle/a$a;
    iget-object v7, v0, Landroid/arch/lifecycle/a;->b:Ljava/util/Map;

    invoke-interface {v7, v1, v6}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 159
    iget-object v7, v0, Landroid/arch/lifecycle/a;->c:Ljava/util/Map;
...
.method private a(Ljava/util/Map;Landroid/arch/lifecycle/a$b;Landroid/arch/lifecycle/d$a;Ljava/lang/Class;)V
    .locals 5
    .param p2, "newHandler"    # Landroid/arch/lifecycle/a$b;
    .param p3, "newEvent"    # Landroid/arch/lifecycle/d$a;
    ...
    .line 91
    .local v0, "event":Landroid/arch/lifecycle/d$a;
    if-eqz v0, :cond_1
...
.method a(Ljava/lang/Class;)Landroid/arch/lifecycle/a$a;
    ...
    .line 81
    .local v0, "existing":Landroid/arch/lifecycle/a$a;
    if-eqz v0, :cond_0
    ...
    invoke-direct {p0, p1, v1}, Landroid/arch/lifecycle/a;->a(Ljava/lang/Class;[Ljava/lang/reflect/Method;)Landroid/arch/lifecycle/a$a;
...
.method b(Ljava/lang/Class;)Z
    ...
    check-cast v5, Landroid/arch/lifecycle/o;

    .line 52
    .local v5, "annotation":Landroid/arch/lifecycle/o;
    if-eqz v5, :cond_1
    ...
    .end local v5    # "annotation":Landroid/arch/lifecycle/o;
    :cond_1
    ...
    .line 63
    :cond_2
    iget-object v1, p0, Landroid/arch/lifecycle/a;->c:Ljava/util/Map;
