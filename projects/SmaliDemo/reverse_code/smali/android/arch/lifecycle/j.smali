...
.method static a(Ljava/lang/Object;)Landroid/arch/lifecycle/GenericLifecycleObserver;
    ...
    .line 64
    .local v3, "generatedAdapter":Landroid/arch/lifecycle/c;
    new-instance v4, Landroid/arch/lifecycle/SingleGeneratedAdapterObserver;

    invoke-direct {v4, v3}, Landroid/arch/lifecycle/SingleGeneratedAdapterObserver;-><init>(Landroid/arch/lifecycle/c;)V

    return-object v4

    .line 66
    .end local v3    # "generatedAdapter":Landroid/arch/lifecycle/c;
    :cond_2
    invoke-interface {v2}, Ljava/util/List;->size()I

    move-result v3

    new-array v3, v3, [Landroid/arch/lifecycle/c;

    .line 67
    .local v3, "adapters":[Landroid/arch/lifecycle/c;
    const/4 v4, 0x0
    ...
    invoke-static {v5, p0}, Landroid/arch/lifecycle/j;->a(Ljava/lang/reflect/Constructor;Ljava/lang/Object;)Landroid/arch/lifecycle/c;
    ...
    invoke-direct {v4, v3}, Landroid/arch/lifecycle/CompositeGeneratedAdaptersObserver;-><init>([Landroid/arch/lifecycle/c;)V
    ...
    .end local v3    # "adapters":[Landroid/arch/lifecycle/c;
    :cond_4
...
.method private static a(Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    ...
    .line 95
    :goto_1
    invoke-static {v3}, Landroid/arch/lifecycle/j;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method private static d(Ljava/lang/Class;)I
    ...
    .line 137
    :cond_1
    sget-object v3, Landroid/arch/lifecycle/a;->a:Landroid/arch/lifecycle/a;

    invoke-virtual {v3, p0}, Landroid/arch/lifecycle/a;->b(Ljava/lang/Class;)Z
    ...
    invoke-static {v4}, Landroid/arch/lifecycle/j;->c(Ljava/lang/Class;)Z
    ...
    invoke-static {v9}, Landroid/arch/lifecycle/j;->c(Ljava/lang/Class;)Z
    ...
    .line 155
    :cond_5
    invoke-static {v9}, Landroid/arch/lifecycle/j;->b(Ljava/lang/Class;)I
    ...
    .line 161
    :cond_7
    sget-object v10, Landroid/arch/lifecycle/j;->b:Ljava/util/Map;
