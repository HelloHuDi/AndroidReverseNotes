...
.method public constructor <init>(Ljava/lang/String;II)V
    ...
    iput-object v0, p0, La/b/c/d/k;->a:Ljava/lang/Object;

    .line 58
    new-instance v0, La/b/c/d/g;

    invoke-direct {v0, p0}, La/b/c/d/g;-><init>(La/b/c/d/k;)V

    iput-object v0, p0, La/b/c/d/k;->e:Landroid/os/Handler$Callback;

    .line 80
    iput-object p1, p0, La/b/c/d/k;->h:Ljava/lang/String;

    .line 81
    iput p2, p0, La/b/c/d/k;->g:I

    .line 82
    iput p3, p0, La/b/c/d/k;->f:I

    .line 83
    const/4 v0, 0x0

    iput v0, p0, La/b/c/d/k;->d:I
...
.method private b(Ljava/lang/Runnable;)V
    ...
    .line 107
    iget-object v0, p0, La/b/c/d/k;->a:Ljava/lang/Object;

    monitor-enter v0

    .line 108
    :try_start_0
    iget-object v1, p0, La/b/c/d/k;->b:Landroid/os/HandlerThread;
    ...
    iget-object v3, p0, La/b/c/d/k;->h:Ljava/lang/String;

    iget v4, p0, La/b/c/d/k;->g:I

    invoke-direct {v1, v3, v4}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;I)V

    iput-object v1, p0, La/b/c/d/k;->b:Landroid/os/HandlerThread;
    ...
    iget-object v3, p0, La/b/c/d/k;->b:Landroid/os/HandlerThread;

    invoke-virtual {v3}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v3

    iget-object v4, p0, La/b/c/d/k;->e:Landroid/os/Handler$Callback;

    invoke-direct {v1, v3, v4}, Landroid/os/Handler;-><init>(Landroid/os/Looper;Landroid/os/Handler$Callback;)V

    iput-object v1, p0, La/b/c/d/k;->c:Landroid/os/Handler;

    .line 112
    iget v1, p0, La/b/c/d/k;->d:I

    add-int/2addr v1, v2

    iput v1, p0, La/b/c/d/k;->d:I

    .line 114
    :cond_0
    iget-object v1, p0, La/b/c/d/k;->c:Landroid/os/Handler;
    ...
    iget-object v3, p0, La/b/c/d/k;->c:Landroid/os/Handler;
...
.method public a(Ljava/util/concurrent/Callable;I)Ljava/lang/Object;
    ...
    invoke-direct/range {v0 .. v6}, La/b/c/d/j;-><init>(La/b/c/d/k;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/Callable;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Ljava/util/concurrent/locks/Condition;)V

    invoke-direct {p0, v8}, La/b/c/d/k;->b(Ljava/lang/Runnable;)V
...
.method public a(Ljava/util/concurrent/Callable;La/b/c/d/k$a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 136
    .local p1, "callable":Ljava/util/concurrent/Callable;, "Ljava/util/concurrent/Callable<TT;>;"
    .local p2, "reply":La/b/c/d/k$a;, "Landroid/support/v4/provider/SelfDestructiveThread$ReplyCallback<TT;>;"
    ...
    new-instance v1, La/b/c/d/i;

    invoke-direct {v1, p0, p1, v0, p2}, La/b/c/d/i;-><init>(La/b/c/d/k;Ljava/util/concurrent/Callable;Landroid/os/Handler;La/b/c/d/k$a;)V

    invoke-direct {p0, v1}, La/b/c/d/k;->b(Ljava/lang/Runnable;)V
