...
public class XWalkEnvironment {
    ...
    private static boolean initXWalkPlugins() {
        ...
        boolean dVP = com.tencent.xweb.xwalk.a.e.dVP();
    ...
    private static boolean getFeatureSupport(int i) {
        ...
        boolean booleanValue = ((Boolean) k.f(d.WV_KIND_CW).excute("STR_CMD_FEATURE_SUPPORT", new Object[]{Integer.valueOf(i)})).booleanValue();
    ...
    public static boolean setAvailableVersion(int i, String str) {
        ...
        Log.i(TAG, "setAvailableVersion:".concat(String.valueOf(i)));
    ...
    public static String getPluginConfigUrl() {
        ...
        if (sharedPreferencesForTestXWeb == null) {
            Log.e(TAG, "getPluginConfigUrl sp is null, use default");
        ...
        if (str.trim().isEmpty()) {
            ...
            Log.i(TAG, "plugin use release config url: http://dldir1.qq.com/weixin/android/wxweb/plugin/pluginUpdateConfig.xml");
            str = DOWNLOAD_PLUGIN_UPDATE_CONFIG_URL;
            AppMethodBeat.o(4258);
            return str;
        }
        addXWalkInitializeLog("plugin use test config url");
        Log.i(TAG, "plugin use test config url: ".concat(String.valueOf(str)));
        AppMethodBeat.o(4258);
        return str;
    }
    ...
    public static void setIpType(int i) {
        ...
        if (i != ipType) {
            ...
            if (ipType > 0 || i > 0) {
                ...
                k.f(d.WV_KIND_CW).excute("STR_CMD_SET_RECHECK_COMMAND", null);
            }
        }
    ...
    public static void setGrayValueByUserId(int i) {
        ...
        try {
            ...
            int i2 = ((digest[0] & com.tencent.view.d.MIC_SketchMark) << 24) | (((digest[3] & 255) | ((digest[2] & 255) << 8)) | ((digest[1] & 255) << 16));
            if (i2 == 0) {
                AppMethodBeat.o(4273);
                return;
            }
    ...
    public static String getDeviceAbi() {
        ...
        if (sDeviceAbi == null) {
            try {
                ...
                Log.e(TAG, "Build.SUPPORTED_ABIS excpet " + e2.getMessage());
            } catch (NoSuchFieldError e3) {
                Log.e(TAG, "Build.SUPPORTED_ABIS NoSuchFieldError " + e3.getMessage());
            }
            if (sDeviceAbi == null) {
                ...
                try {
                    ...
                    try {
                        ...
                        bufferedReader = null;
                        try {
                            Log.e(TAG, "Device ABI: " + e2.getMessage());
    ...
    public static boolean delApiVersion(int i) {
        ...
        boolean avl = b.avl(getVesionDir(i));
    ...
    public static int readAvailableVersionFromSP(Context context) {
        ...
        if (sharedPreferences == null) {
            Log.e(TAG, "readAvailableVersionFromSP sp is null");
            AppMethodBeat.o(4295);
            return -1;
        }
