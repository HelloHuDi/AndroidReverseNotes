...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = -1;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a.LinearLayoutCompat_Layout);
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        this.alp = 0;
        this.Hu = 8388659;
        bc a = bc.a(context, attributeSet, a.LinearLayoutCompat, i, 0);
        int i2 = a.getInt(1, -1);
        if (i2 >= 0) {
            setOrientation(i2);
        }
        ...
        if (this.ahS != null) {
            ...
            if (this.mOrientation == 1) {
                ...
                while (i < virtualChildCount) {
                    ...
                    if (!(childAt2 == null || childAt2.getVisibility() == 8 || !bV(i))) {
                        b(canvas, (childAt2.getTop() - ((LayoutParams) childAt2.getLayoutParams()).topMargin) - this.alw);
                    }
                    i++;
                }
                if (bV(virtualChildCount)) {
            ...
            while (i < virtualChildCount) {
                ...
                if (!(childAt3 == null || childAt3.getVisibility() == 8 || !bV(i))) {
    ...
    public void onMeasure(int i, int i2) {
        if (this.mOrientation == 1) {
                ...
                if (childAt == null) {
                    ...
                    if (childAt.getVisibility() != 8) {
                        ...
                        if (mode2 == 1073741824 && layoutParams2.height == 0 && layoutParams2.weight > 0.0f) {
                            ...
                            i5 = i4;
                            h(childAt, i, 0, i2, f2 == 0.0f ? this.alq : 0);
            ...
            if (this.alq > 0 && bV(virtualChildCount)) {
                this.alq += this.alw;
            }
            ...
            if (childAt == null) {
                ...
                if (childAt.getVisibility() != 8) {
                    ...
                    if (mode == 1073741824 && layoutParams.width == 0 && layoutParams.weight > 0.0f) {
                        ...
                        int i14 = i3;
                        h(childAt, i, f2 == 0.0f ? this.alq : 0, i2, 0);
                    ...
                    if (z) {
                        ...
                        if (baseline != -1) {
                            i6 = ((((layoutParams.gravity < 0 ? this.Hu : layoutParams.gravity) & 112) >> 4) & -2) >> 1;
            ...
            while (i7 < virtualChildCount) {
                ...
                if (childAt3 == null || childAt3.getVisibility() == 8) {
                    ...
                    if (z) {
                        ...
                        if (i6 != -1) {
                            i3 = ((((layoutParams2.gravity < 0 ? this.Hu : layoutParams2.gravity) & 112) >> 4) & -2) >> 1;
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mOrientation == 1) {
            ...
            while (i7 < virtualChildCount) {
                ...
                if (childAt == null) {
                    ...
                    i(childAt, i9, i8 + 0, measuredWidth, measuredHeight);
        ...
        i5 = this.Hu & 8388615;
        virtualChildCount = this.Hu & 112;
        boolean z2 = this.aln;
        int[] iArr = this.alt;
        int[] iArr2 = this.alu;
        switch (d.getAbsoluteGravity(i5, s.T(this))) {
            case 1:
        ...
        while (paddingRight2 < measuredHeight) {
            ...
            if (childAt2 == null) {
                ...
                i(childAt2, i7 + 0, i8, measuredWidth2, measuredHeight2);
    ...
    public void setHorizontalGravity(int i) {
        int i2 = i & 8388615;
        if ((this.Hu & 8388615) != i2) {
            this.Hu = i2 | (this.Hu & -8388616);
            requestLayout();
        }
    }
