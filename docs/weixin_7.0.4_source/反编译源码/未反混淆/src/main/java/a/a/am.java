...
public class am extends al {
    public static final <T> Set<T> b(Set<? extends T> set, T t) {
        ...
        j.p(set, "receiver$0");
        LinkedHashSet linkedHashSet = new LinkedHashSet(ag.SI(set.size() + 1));
    ...
    public static final <T> Set<T> a(Set<? extends T> set, Iterable<? extends T> iterable) {
        ...
        j.p(set, "receiver$0");
        j.p(iterable, MessengerShareContentUtility.ELEMENTS);
        ...
        LinkedHashSet linkedHashSet = new LinkedHashSet(ag.SI(valueOf != null ? valueOf.intValue() + set.size() : set.size() * 2));
        linkedHashSet.addAll(set);
