            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        cks.BaseRequest = hlVar;
                    }
                    AppMethodBeat.o(136946);
                    return 0;
                case 2:
                    cks.ptv = aVar3.BTU.readString();
                    AppMethodBeat.o(136946);
                    return 0;
                case 3:
                    cks.ptw = aVar3.BTU.vd();
                    AppMethodBeat.o(136946);
                    return 0;
                case 4:
                    cks.ptx = aVar3.BTU.vd();
                    AppMethodBeat.o(136946);
                    return 0;
                case 5:
                    cks.pty = aVar3.BTU.vd();
                    AppMethodBeat.o(136946);
                    return 0;
                case 6:
                    Vh = aVar3.Vh(intValue);
