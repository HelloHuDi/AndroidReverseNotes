...
public abstract class MMWizardActivity extends MMActivity {
    ...
    public static void J(Context context, Intent intent) {
        ...
        if (bo.isNullOrNil(str)) {
            try {
                ...
                ab.printErrStackTrace("MicroMsg.MMWizardActivity", e, "", new Object[0]);
            }
        }
        Assert.assertFalse("startWizardActivity: ERROR in Get Root Class :[" + intent + "][ " + intent.getComponent() + " ]", bo.isNullOrNil(str));
    ...
    public static void b(Context context, Intent intent, Intent intent2) {
        try {
            String str = "trans." + bo.yz() + "." + intent2.hashCode();
            ynD.put(str, intent2);
            ...
            ab.e("MicroMsg.MMWizardActivity", "%s", bo.l(e));
        }
    }
    ...
    public final void exit(int i) {
        ...
        if (intent != null) {
            ab.d("MicroMsg.MMWizardActivity", "doing post exit for transaction=" + stringExtra + ", intent=" + intent);
    ...
    public final void cancel() {
        ...
        ynD.remove(stringExtra);
        if (intent != null) {
            ab.d("MicroMsg.MMWizardActivity", "canceled exit for transaction=" + stringExtra + ", intent=" + intent);
        }
    }
