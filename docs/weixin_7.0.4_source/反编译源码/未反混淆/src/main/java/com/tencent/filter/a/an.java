...
public final class an extends BaseFilter {
    ...
    public final void ApplyGLSLFilter(boolean z, float f, float f2) {
        ...
        baseFilter2.addParam(new g("color2", new float[]{0.9647059f, 0.9647059f, 0.88235295f, 1.0f}));
        baseFilter2.addParam(new f("transparency", 1.0f));
        baseFilter.setNextFilter(baseFilter2, null);
        baseFilter = new BaseFilter(GLSLRender.bKF);
        baseFilter.addParam(new g("color2", new float[]{0.101960786f, 0.07058824f, 0.0627451f, 1.0f}));
        baseFilter.addParam(new f("transparency", 1.0f));
        baseFilter2.setNextFilter(baseFilter, null);
        baseFilter2 = new BaseFilter(GLSLRender.bKD);
        baseFilter2.addParam(new o("inputImageTexture2", "sh/huaijiu.png", 33986));
        baseFilter.setNextFilter(baseFilter2, null);
