...
public class FabbyFilters {
    ...
    public h updateAndRender(h hVar, Map<Integer, h> map, Map<Integer, FaceActionCounter> map2, Set<Integer> set, long j) {
        ...
        h updateAndRender = fabbyMvFilter.updateAndRender(hVar, map, j);
