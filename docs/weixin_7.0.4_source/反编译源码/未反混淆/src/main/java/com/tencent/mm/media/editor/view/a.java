...
public final class a extends Drawable {
    ...
    public a(Resources resources) {
        ...
        this.aFY.setStrokeWidth(this.aEH.getDimension(R.dimen.zw));
        this.aFY.setStyle(Style.FILL);
        this.eVf = this.aEH.getDimension(R.dimen.zw);
        this.eVg = this.aEH.getDimension(R.dimen.zu);
        this.eVe = this.aEH.getDimension(R.dimen.zv);
