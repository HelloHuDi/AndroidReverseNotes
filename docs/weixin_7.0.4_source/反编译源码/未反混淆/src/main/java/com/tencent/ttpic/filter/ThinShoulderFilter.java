...
public class ThinShoulderFilter extends VideoFilterBase {
    ...
    public void setCenter(PointF pointF) {
        ...
        pointF2.y = f2;
        addParam(new b("center", this.center.x, this.center.y));
    ...
    public void setWidth(float f) {
        ...
        this.width = f;
        addParam(new f("width", this.width));
    ...
    public void setHeight(float f) {
        ...
        this.height = f;
        addParam(new f("height", this.height));
    ...
    public void initParams() {
        ...
        addParam(new b("center", 0.0f, 0.0f));
        addParam(new f("width", 0.0f));
        addParam(new f("height", 0.0f));
        addParam(new f("prop", 0.5625f));
