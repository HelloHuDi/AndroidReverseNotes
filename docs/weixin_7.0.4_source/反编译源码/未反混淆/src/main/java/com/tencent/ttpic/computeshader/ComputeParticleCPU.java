...
public class ComputeParticleCPU {
    ...
    public void compute() {
        ...
        while (true) {
            ...
            if (((double) vector22.x) < -1.0d || ((double) vector22.x) > 1.0d || ((double) vector22.y) < -1.0d || ((double) vector22.y) > 1.0d) {
            ...
            vector4.r = (float) (((double) vector4.r) + (0.02d * ((double) this.ubo.deltaT)));
            if (((double) this.particles[i2].gradientPos.r) > 1.0d) {
                vector4 = this.particles[i2].gradientPos;
                vector4.r = (float) (((double) vector4.r) - 1.0d);
            }
            i = i2 + 1;
        }
