...
public class BaseFilter {
    ...
    public BaseFilter addParam(m mVar) {
    ...
    public m getParam(String str) {
        AppMethodBeat.i(86320);
        m mVar = (m) this.mParamList.get(str);
    ...
    public void RenderProcess(int i, int i2, int i3, int i4, int i5, int i6, double d, h hVar) {
        ...
        while (baseFilter != null) {
            ...
            if (baseFilter == this) {
                ...
                baseFilter.beforeRender(hVar2.texture[0], hVar2.width, hVar2.height);
            }
            hVar3.needReleaseFrmae = baseFilter.needReleaseFrmae;
            if (baseFilter.mNextFilter == null) {
                hVar3.a(i6, (int) ((((float) i4) * baseFilter.scaleFact) * this.outPutScaleFact), (int) ((((float) i5) * baseFilter.scaleFact) * this.outPutScaleFact), d);
            } else {
                hVar3.a(-1, (int) (((float) i4) * baseFilter.scaleFact), (int) (((float) i5) * baseFilter.scaleFact), d);
            }
            ...
            if (baseFilter.mTextureIndexMap != null && baseFilter.mTextureIndexMap.length > 0) {
                for (i7 = 0; i7 < baseFilter.mTextureIndexMap.length; i7++) {
                    if (baseFilter.mTextureIndexMap[i7] < 0) {
                        ...
                        findFrame = findFrame(hVar, baseFilter.mTextureIndexMap[i7]);
                        if (findFrame != null) {
            ...
            if (baseFilter == this) {
                ...
                i7 = hVar2.texture[0];
                baseFilter.renderTexture(hVar2.texture[0], hVar2.width, hVar2.height);
                if (hVar2.needReleaseFrmae) {
                    hVar2.wF();
                }
                findFrame = hVar3;
            }
            if (i6 != 0) {
                checkInputOutputValid(baseFilter, hVar3, i7);
            }
    ...
    public h findFrame(h hVar, int i) {
        h hVar2 = hVar;
        while (hVar2 != null) {
            if (i == 0) {
                return hVar2;
    ...
    public void RenderProcess(int i, int i2, int i3, int i4, double d, h hVar) {
        ...
        RenderProcess(i, i2, i3, i2, i3, i4, d, hVar);
        AppMethodBeat.o(86333);
    }

    public void RenderProcessBitmap(Bitmap bitmap, h hVar) {
        AppMethodBeat.i(86334);
        f as = f.as(bitmap);
        if (b.AIH < 0) {
            RenderProcess(as.texture, as.width, as.height, as.texture, 0.0d, hVar);
            g.a(as.texture, as.width, as.height, bitmap);
        } else {
            RenderProcess(as.texture, as.width, as.height, -2, 0.0d, hVar);
            GLSLRender.nativePushBitmapFromTexture(bitmap, b.AIH);
        }
    ...
    public void RendProcessImage(QImage qImage, h hVar) {
        ...
        int[] iArr2 = new int[1];
        com.tencent.util.f.dSJ().c(iArr2, true);
        ...
        for (int i = 0; i < iArr[0]; i++) {
            for (int i2 = 0; i2 < iArr[1]; i2++) {
                ...
                if (b.AIH >= 0) {
                    RenderProcess(iArr2[0], iArr3[0], iArr3[1], -2, 0.0d, hVar);
                    GLSLRender.nativePushJepgFromTexture(qImage, i, i2, iArr[0], iArr[1], b.AIH);
                } else {
                    RenderProcess(iArr2[0], iArr3[0], iArr3[1], -1, 0.0d, hVar);
                    GLSLRender.nativePushJepgFromTexture(qImage, i, i2, iArr[0], iArr[1], b.AIH);
                }
            }
        }
        ...
        i.k("BaseFilter", "RendProcessImage:" + (System.currentTimeMillis() - currentTimeMillis));
    ...
    private void checkInputOutputValid(BaseFilter baseFilter, h hVar, int i) {
        ...
        for (m mVar : baseFilter.mParamList.values()) {
            if ((mVar instanceof n) && ((n) mVar).texture[0] == hVar.texture[0]) {
                i.m("BaseFilter", "input and output texture is same!");
                if (g.isEnableLog()) {
                    runtimeException = new RuntimeException("input and output texture is same!");
                    AppMethodBeat.o(86332);
