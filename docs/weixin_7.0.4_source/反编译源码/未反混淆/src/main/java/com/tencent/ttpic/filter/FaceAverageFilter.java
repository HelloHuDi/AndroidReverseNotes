...
public class FaceAverageFilter extends VideoFilterBase {
    ...
    public void initParams() {
        ...
        addParam(new n("inputImageTexture2", this.userTex, 33986));
        addParam(new k("inputImageTexture3", this.maskBitmap, 33987, true));
        addParam(new k("inputImageTexture4", this.materialBitmap, 33988, true));
        addParam(new f("alphaBlend", (float) this.mFaceLayer.blendAlpha));
        addParam(new i("drawTypeFragment", 1));
        addParam(new i("drawTypeVertex", 1));
