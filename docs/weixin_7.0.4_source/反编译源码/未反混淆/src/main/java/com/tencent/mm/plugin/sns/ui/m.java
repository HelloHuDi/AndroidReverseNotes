...
public final class m implements y {
    ...
    public final boolean a(int i, int i2, org.b.d.i iVar, String str, List<String> list, ayt ayt, int i3, boolean z, List<String> list2, PInt pInt, String str2, int i4, int i5) {
        ...
        } else if (!(bo.isNullOrNil(this.rid) || o.ahk() == null)) {
            o.ahk();
        ...
        af.cnB().cmp();
        this.crP.finish();
        ((com.tencent.mm.plugin.emoji.b.d) com.tencent.mm.kernel.g.M(com.tencent.mm.plugin.emoji.b.d.class)).getEmojiMgr().Jm(this.rik);
        ((com.tencent.mm.plugin.emoji.b.d) com.tencent.mm.kernel.g.M(com.tencent.mm.plugin.emoji.b.d.class)).getEmojiMgr().Jn(this.rik);
