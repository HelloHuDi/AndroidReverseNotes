...
public class FaceBeautysRealAutoFilter extends BaseFilter {
    ...
    public void setParameterDic(Map<String, Object> map) {
        ...
        if (map.containsKey("smoothMag")) {
            ...
            this.smootherFilter.addParam(new f("smoothOpacity", this.smoothOpacity));
        }
    ...
    public void ApplyGLSLFilter(boolean z, float f, float f2) {
        ...
        this.smootherFilter.addParam(new f("smoothOpacity", this.smoothOpacity));
        this.smootherFilter.addParam(new i("width", (int) f));
        this.smootherFilter.addParam(new i("height", (int) f2));
    ...
    public void beforeRender(int i, int i2, int i3) {
        ...
        this.smootherFilter.addParam(new i("width", i2));
        this.smootherFilter.addParam(new i("height", i3));
