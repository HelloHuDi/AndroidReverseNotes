...
public class BitmapUtils {
    ...
    public static Options getBitmapOptionsFromUri(Context context, Uri uri) {
        ...
        if (scheme != null && scheme.toLowerCase().startsWith("file")) {
            ...
            LogUtils.v(TAG, "[getBitmapOptionsFromUri] file = ".concat(String.valueOf(substring)));
            ...
            LogUtils.v(TAG, "[getBitmapOptionsFromUri] in else , file = ".concat(String.valueOf(substring)));
            bitmapOptionsFromFile = getBitmapOptionsFromFile(substring);
            AppMethodBeat.o(49616);
            return bitmapOptionsFromFile;
        }
    ...
    public static Bitmap flipBitmap(Bitmap bitmap, boolean z) {
        ...
        if (bitmap != null) {
            ...
            try {
                ...
                LogUtils.e(TAG, "OutOfMemoryError. ".concat(String.valueOf(e)));
            }
        }
    ...
    public static int getDegreeByExif(String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            try {
                i = getDegreeByOrientation(new ExifInterface(str).getAttributeInt(a.TAG_ORIENTATION, 0));
                AppMethodBeat.o(49628);
            } catch (Exception e) {
                AppMethodBeat.o(49628);
            }
    ...
    public static Bitmap decodeSampledBitmapFromUri(Uri uri, int i, int i2) {
        ...
        if (scheme != null && scheme.toLowerCase().startsWith("file")) {
            ...
            LogUtils.v(TAG, "decodeSampledBitmapFromUri(), file = ".concat(String.valueOf(scheme)));
            bitmap = decodeSampledBitmapFromFileCheckExif(scheme, i, i2);
        } else if (uri != null) {
            scheme = Uri.decode(uri.toString());
            LogUtils.v(TAG, "decodeSampledBitmapFromUri() in else , file = ".concat(String.valueOf(scheme)));
            bitmap = decodeSampledBitmapFromFileCheckExif(scheme, i, i2);
        } else {
            bitmap = null;
        }
    ...
    public static Bitmap decodeBitmapFromFileForShare(String str, int i, int i2, int[] iArr) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                LogUtils.v(TAG, "decodeBitmapFromFileForShare(), inSampleSize = ".concat(String.valueOf(i3)));
    ...
    public static int calculateInSampleSize(Options options, int i, int i2, boolean z) {
        ...
        LogUtils.d(TAG, "[calculateInSampleSize] source size = " + i4 + " * " + i3 + ", request size = " + i + " * " + i2 + ", inSampleSize = " + i5 + ", preferLarge = " + z);
