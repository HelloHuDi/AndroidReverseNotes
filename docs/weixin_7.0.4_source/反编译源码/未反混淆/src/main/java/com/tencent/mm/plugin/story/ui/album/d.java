...
public final class d extends android.support.v7.widget.RecyclerView.a<b> {
    private static final String TAG = TAG;
    public static final a sgp = new a();
    a.f.a.b<? super h, y> sgd;
    final ArrayList<h> sgo = new ArrayList();
    ...
    public final class b extends v {
        ...
        public b(d dVar, View view) {
            ...
            j.o(findViewById, "view.findViewById(R.id.album_story_item_media_img)");
            this.sgq = (ImageView) findViewById;
            findViewById = view.findViewById(R.id.epn);
            j.o(findViewById, "view.findViewById(R.id.a…_story_item_multiple_tip)");
            this.sgr = (ImageView) findViewById;
            findViewById = view.findViewById(R.id.epo);
            j.o(findViewById, "view.findViewById(R.id.album_story_item_count_tv)");
    ...
    static final class c implements OnClickListener {
        ...
        public final void onClick(View view) {
            ...
            if (view.getTag() != null && (view.getTag() instanceof h)) {
                a.f.a.b bVar = this.sgs.sgd;
                if (bVar != null) {
                    Object tag = view.getTag();
                    if (tag == null) {
                        a.v vVar = new a.v("null cannot be cast to non-null type com.tencent.mm.plugin.story.storage.StoryHistoryInfo");
