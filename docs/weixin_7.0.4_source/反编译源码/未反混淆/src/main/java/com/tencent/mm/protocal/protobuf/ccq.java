...
public final class ccq extends bsr {
    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            int bs = (ix + e.a.a.b.b.a.bs(5, this.xbY)) + e.a.a.b.b.a.bs(6, this.xbZ);
            AppMethodBeat.o(56977);
            return bs;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        ccq.BaseRequest = hlVar;
                    }
                    AppMethodBeat.o(56977);
                    return 0;
                case 2:
                    ccq.scene = aVar3.BTU.vd();
                    AppMethodBeat.o(56977);
                    return 0;
                case 3:
                    ccq.rOh = aVar3.BTU.readString();
                    AppMethodBeat.o(56977);
                    return 0;
                case 4:
                    ccq.jSY = aVar3.BTU.readString();
                    AppMethodBeat.o(56977);
                    return 0;
                case 5:
                    ccq.xbY = aVar3.BTU.vd();
                    AppMethodBeat.o(56977);
                    return 0;
                case 6:
                    ccq.xbZ = aVar3.BTU.vd();
                    AppMethodBeat.o(56977);
                    return 0;
                default:
                    AppMethodBeat.o(56977);
