...
public abstract class SearchActionVerificationClientService extends IntentService {
    ...
    private a buq;
    private com.google.android.search.verification.a.a bur = null;
    ...
    class a implements ServiceConnection {
        ...
        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            SearchActionVerificationClientService.this.bur = com.google.android.search.verification.a.a.a.g(iBinder);
        ...
        if (intent != null) {
            ...
            if (!isConnected()) {
                ...
                try {
                    ...
                    if (!(z2 && this.bur.a(intent2, bundle))) {
                        z = false;
                    }
                    a(intent2, z);
