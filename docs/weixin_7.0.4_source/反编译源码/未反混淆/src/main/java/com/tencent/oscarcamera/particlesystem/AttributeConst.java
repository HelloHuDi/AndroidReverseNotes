...
public class AttributeConst {
    ...
    static {
        ...
        ATTR_INDEX_MAP.put(X, Integer.valueOf(7));
        ATTR_INDEX_MAP.put(Y, Integer.valueOf(8));
        ATTR_INDEX_MAP.put(Z, Integer.valueOf(9));
        ATTR_INDEX_MAP.put(R, Integer.valueOf(3));
        ATTR_INDEX_MAP.put(G, Integer.valueOf(4));
        ATTR_INDEX_MAP.put(B, Integer.valueOf(5));
        ATTR_INDEX_MAP.put(A, Integer.valueOf(6));
