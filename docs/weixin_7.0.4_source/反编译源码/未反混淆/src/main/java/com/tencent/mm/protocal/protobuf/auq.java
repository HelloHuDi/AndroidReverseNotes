...
public final class auq extends btd {
    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.wbP != null) {
                ix += e.a.a.b.b.a.f(7, this.wbP);
            }
            if (this.wbQ != null) {
                ix += e.a.a.b.b.a.f(8, this.wbQ);
            }
            AppMethodBeat.o(11776);
            return ix;
        } else if (i == 2) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    return 0;
                case 3:
                    auq.vNb = aVar3.BTU.readString();
                    AppMethodBeat.o(11776);
                    return 0;
                case 4:
                    auq.wbR = aVar3.BTU.vd();
                    AppMethodBeat.o(11776);
                    return 0;
                case 5:
                    Vh = aVar3.Vh(intValue);
                ...
                case 6:
                    ...
                    return 0;
                case 7:
                    auq.wbP = aVar3.BTU.readString();
                    AppMethodBeat.o(11776);
                    return 0;
                case 8:
                    auq.wbQ = aVar3.BTU.readString();
                    AppMethodBeat.o(11776);
                    return 0;
                default:
                    AppMethodBeat.o(11776);
