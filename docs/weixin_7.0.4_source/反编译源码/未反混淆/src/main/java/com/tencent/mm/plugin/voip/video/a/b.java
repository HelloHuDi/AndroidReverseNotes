...
public final class b {
    ...
    public final synchronized void c(byte[] bArr, int i, int i2, int i3, int i4) {
        ...
        if (i4 != 0 && (this.lpV == null || obj != null)) {
            ab.i("MicroMsg.FilterRenderer", "%s frameSizeChange %s %s %s %s", Integer.valueOf(hashCode()), Integer.valueOf(this.tbT), Integer.valueOf(this.tbU), Integer.valueOf(this.iZn), Integer.valueOf(this.iZo));
        ...
        if (i4 != 0) {
            ...
            if (!(obj2 == null || aVar2.mPTFilter == null)) {
                BenchUtil.benchStart("PTFilter");
                BenchUtil.benchEnd("PTFilter");
                ab.d(a.TAG, "%s mFilterOutTex: %s", Integer.valueOf(aVar2.hashCode()), Integer.valueOf(aVar2.tbK));
            }
            if (!(aVar2.tbH == null || aVar2.tbJ == 0 || aVar2.tbO == 0)) {
                g.a(aVar2.tbJ, aVar2.eYW, aVar2.eYX, aVar2.lho, aVar2.tbO);
            }
    ...
    public final synchronized void reset() {
        ...
        ab.d("MicroMsg.FilterRenderer", "%s reset", Integer.valueOf(hashCode()));
        GLES20.glBindFramebuffer(36160, 0);
        GLES20.glBindTexture(3553, 0);
        if (this.tbV != null) {
            this.tbV.clear();
    ...
    public final synchronized void destroy() {
        ...
        if (this.eNa) {
            ab.i("MicroMsg.FilterRenderer", "%s do destroy", Integer.valueOf(hashCode()));
            if (this.tbV != null) {
                this.tbV.clear();
                this.tbV = null;
            }
