...
public class PhantomFilter extends VideoFilterBase {
    ...
    public void initParams() {
        ...
        while (true) {
            ...
            if (indexOf < 0) {
                ...
                if (BitmapUtils.isLegal(decodeSampledBitmapFromAssets)) {
                    ...
                    addParam(new k("inputImageTexture_".concat(String.valueOf(i2)), decodeSampledBitmapFromAssets, 33985 + i2, true));
                    new StringBuilder("PhantomFitler inputImageTexuture_").append(i2).append(" mask bitmap loaded. ").append(phantomItem.getMaskImage());
                }
            } else {
                addParam(new k("inputImageTexture_".concat(String.valueOf(i2)), (Bitmap) this.bitmaps.get(indexOf), 33985 + i2, true));
        ...
        addParam(new i("itemCount", this.items.size()));
        addParam(new g(WMElement.ANIMATE_TYPE_SCALE, fArr2));
        addParam(new g("opacity", fArr3));
        addParam(new g("blendMode", fArr));
        addParam(new g("offsetX", fArr4));
        addParam(new g("offsetY", fArr5));
    ...
    public void updatePreview(long j) {
        ...
        while (true) {
            ...
            if (it.hasNext()) {
                ...
                addParam(new g("offsetX", fArr));
                addParam(new g("offsetY", fArr2));
