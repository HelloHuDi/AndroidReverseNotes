    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.vEi == null) {
                ...
                bVar = new b("Not all required fields were included: ChatRoomTopic");
                AppMethodBeat.o(5599);
                throw bVar;
            } else {
                if (this.vEi != null) {
                ...
                if (this.wGe != null) {
                    aVar.iy(2, this.wGe.computeSize());
                    this.wGe.writeFields(aVar);
                }
                AppMethodBeat.o(5599);
                return 0;
            }
            ...
            if (this.wGe != null) {
                ix += e.a.a.a.ix(2, this.wGe.computeSize());
            }
            AppMethodBeat.o(5599);
            return ix;
        } else if (i == 2) {
