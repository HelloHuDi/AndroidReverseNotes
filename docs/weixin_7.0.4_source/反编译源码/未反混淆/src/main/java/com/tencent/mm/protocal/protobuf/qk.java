            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        qkVar.BaseRequest = hlVar;
                    }
                    AppMethodBeat.o(135752);
                    return 0;
                case 2:
                    qkVar.ndG = aVar3.BTU.readString();
                    AppMethodBeat.o(135752);
                    return 0;
                case 3:
                    qkVar.ndF = aVar3.BTU.readString();
                    AppMethodBeat.o(135752);
                    return 0;
                case 4:
                    qkVar.vXv = aVar3.BTU.ve();
                    AppMethodBeat.o(135752);
                    return 0;
                case 5:
                    qkVar.vRw = aVar3.BTU.readString();
                    AppMethodBeat.o(135752);
                    return 0;
                case 6:
                    qkVar.vXw = aVar3.BTU.readString();
                    AppMethodBeat.o(135752);
                    return 0;
                case 7:
                    qkVar.vHo = aVar3.BTU.vd();
                    AppMethodBeat.o(135752);
                    return 0;
                case 8:
                    qkVar.vXx = aVar3.BTU.readString();
                    AppMethodBeat.o(135752);
                    return 0;
                case 9:
                    qkVar.fMd = aVar3.BTU.readString();
                    AppMethodBeat.o(135752);
                    return 0;
                default:
                    AppMethodBeat.o(135752);
