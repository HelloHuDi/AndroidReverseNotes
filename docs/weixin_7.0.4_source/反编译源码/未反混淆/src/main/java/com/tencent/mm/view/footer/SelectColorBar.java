...
public class SelectColorBar extends View {
    ...
    public void onMeasure(int i, int i2) {
        ...
        super.onMeasure(MeasureSpec.makeMeasureSpec(size, ErrorDialogData.SUPPRESSED), MeasureSpec.makeMeasureSpec((int) getResources().getDimension(R.dimen.xe), ErrorDialogData.SUPPRESSED));
        if (this.Acz == null) {
            this.Acz = new Rect[AcD.length];
        }
    ...
    public int getDetailHeight() {
        ...
        int dimension = (int) getResources().getDimension(R.dimen.xe);
