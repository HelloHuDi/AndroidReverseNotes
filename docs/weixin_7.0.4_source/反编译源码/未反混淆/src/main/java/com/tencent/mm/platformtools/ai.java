...
public final class ai {
    ...
    public static class b {
        ...
        public static String A(File file) {
            ...
            try {
                ...
                try {
                        ...
                        try {
                            ...
                            if (!(jarEntry.isDirectory() || jarEntry.getName().startsWith("META-INF/"))) {
                                ...
                                if (!("resources.arsc".equals(name) || "AndroidManifest.xml".equals(name) || jarEntry.getSize() > 5120)) {
                                    ...
                                    ab.d("voken", "name = ".concat(String.valueOf(name)));
                                    inputStream2 = jarFile.getInputStream(jarEntry);
                                    ab.d("voken", "get is cost " + (System.currentTimeMillis() - currentTimeMillis));
                            ...
                            inputStream = inputStream2;
                            try {
                                ab.printErrStackTrace("MicroMsg.YYBMarketVerify", e, "", new Object[0]);
                                AppMethodBeat.o(16710);
                                throw e;
                            } catch (Throwable th) {
                                e = th;
                    ...
                    x509Certificate = x509Certificate2;
                    if (x509Certificate != null) {
                        w = ag.w(new String(ae(x509Certificate.getEncoded())).getBytes());
                        if (inputStream2 != null) {
                            try {
                                inputStream2.close();
                            } catch (IOException e3) {
                                ab.printErrStackTrace("MicroMsg.YYBMarketVerify", e3, "", new Object[0]);
                            }
                        }
                        try {
                            jarFile.close();
                        } catch (IOException e32) {
                            ab.printErrStackTrace("MicroMsg.YYBMarketVerify", e32, "", new Object[0]);
                        }
                        AppMethodBeat.o(16710);
                    } else {
                        w = "";
                        if (inputStream2 != null) {
                            try {
                                ...
                                ab.printErrStackTrace("MicroMsg.YYBMarketVerify", e322, "", new Object[0]);
                            }
                        }
                        try {
                            jarFile.close();
                        } catch (IOException e3222) {
                            ab.printErrStackTrace("MicroMsg.YYBMarketVerify", e3222, "", new Object[0]);
                        }
                        AppMethodBeat.o(16710);
                    }
                    return w;
                ...
                if (inputStream2 != null) {
                    try {
                        ...
                        ab.printErrStackTrace("MicroMsg.YYBMarketVerify", e32222, "", new Object[0]);
                    }
                }
                if (jarFile != null) {
                    try {
                        ...
                        ab.printErrStackTrace("MicroMsg.YYBMarketVerify", e322222, "", new Object[0]);
                    }
                }
                AppMethodBeat.o(16710);
                throw e;
        ...
        private static char[] ae(byte[] bArr) {
    ...
    public static class a {
        /*  JADX ERROR: NullPointerException in pass: ProcessVariables
            java.lang.NullPointerException
            	...
            	at jadx.core.dex.visitors.regions.DepthRegionTraversal$$Lambda$83/170907563.accept(Unknown Source)
     ...
     */
        /* JADX WARNING: Missing block: B:39:?, code skipped:
            com.tencent.mm.sdk.platformtools.ab.printErrStackTrace("MicroMsg.YYBMarketVerify", r3, "", new java.lang.Object[0]);
     */
     ...
     */
        ...
        L_0x0012:
            ...
            com.tencent.mm.sdk.platformtools.ab.printErrStackTrace(r3, r1, r4, r5);
            r1 = r2;
            goto L_0x000c;
        L_0x0020:
            r3 = r1.getAssets();
            ...
            r4.<init>(r3, r5, r2);
            r2 = a(r1, r3);	 Catch:{ IOException -> 0x00ab }
        ...
        L_0x004f:
            ...
            com.tencent.mm.sdk.platformtools.ab.printErrStackTrace(r3, r1, r5, r6);	 Catch:{ IOException -> 0x00ab }
        ...
        L_0x0071:
            ...
            r1 = a(r1, r4);	 Catch:{ IOException -> 0x00ab }
        ...
        L_0x008e:
            r3 = 0;
            r0 = com.tencent.mm.platformtools.ah.getInt(r1, r3);	 Catch:{ IOException -> 0x00ab }
        ...
        L_0x009d:
            ...
            com.tencent.mm.sdk.platformtools.ab.printErrStackTrace(r5, r3, r6, r7);	 Catch:{ IOException -> 0x00ab }
            goto L_0x0044;
        L_0x00ab:
            r1 = move-exception;
            ...
            com.tencent.mm.sdk.platformtools.ab.printErrStackTrace(r3, r1, r4, r5);	 Catch:{ all -> 0x00d1 }
        ...
        L_0x00dd:
            ...
            goto L_0x00bd;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.platformtools.ai$a.N(android.content.Context, java.lang.String):int");
        }
                    ...
                    for (String replace2 : arrayList2) {
                        ...
                        if (file.exists()) {
                            try {
                                ...
                                long currentTimeMillis = System.currentTimeMillis();
                                if (z) {
                                    PackageInfo packageInfo = context.getPackageManager().getPackageInfo(cVar.ceO, 64);
                                    if (packageInfo.signatures.length > 0) {
                                        replace2 = ag.ck(packageInfo.signatures[packageInfo.signatures.length - 1].toCharsString());
                                    }
                                    charSequence3 = replace2;
                                } else {
                                    Object charSequence32 = b.A(file.getAbsoluteFile());
                                }
                                ...
                                boolean z2 = !TextUtils.isEmpty(charSequence32) && charSequence32.equalsIgnoreCase(cVar.gjJ);
                                objArr[4] = Boolean.valueOf(z2);
                                objArr[5] = Long.valueOf(System.currentTimeMillis() - currentTimeMillis);
                                ab.i(str3, str4, objArr);
                                if (!TextUtils.isEmpty(charSequence32) && charSequence32.equalsIgnoreCase(cVar.gjJ)) {
                                    int i2;
                                    currentTimeMillis = System.currentTimeMillis();
                                    if (z) {
                                        i2 = context.getPackageManager().getPackageInfo(cVar.ceO, 0).versionCode;
                                    } else {
                                        i2 = a.N(context, cVar.ceO);
                                    }
                                    ...
                                    objArr[0] = Boolean.valueOf(z);
                                    objArr[1] = cVar.ceO;
                                    objArr[2] = Integer.valueOf(cVar.gjI);
                                    objArr[3] = Integer.valueOf(i2);
                                    objArr[4] = Boolean.valueOf(i2 <= cVar.gjI);
                                    objArr[5] = Long.valueOf(System.currentTimeMillis() - currentTimeMillis);
                                    ab.i(str3, str4, objArr);
                                    if (i2 <= cVar.gjI) {
                                        AppMethodBeat.o(16711);
