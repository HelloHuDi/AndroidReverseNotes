...
public class RadarDataLayer extends DataLayerView {
    ...
    public RadarDataLayer(Context context, float f, a aVar) {
        ...
        this.qYs = aVar.size();
        this.qYy = aVar;
        Interpolator interpolator = aVar.qXG;
        ...
        if (j > 0) {
            ...
            this.qYB.addUpdateListener(new AnimatorUpdateListener() {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.qYy != null) {
            ...
            for (Entry entry : entrySet) {
                ...
                if (i == 0) {
                    this.vr.moveTo(floatValue, floatValue2);
                } else {
                    this.vr.lineTo(floatValue, floatValue2);
                }
                if (this.qYC) {
            ...
            this.vr.close();
            canvas.drawPath(this.vr, getPaintLayerFilling());
            canvas.drawPath(this.vr, getPaintLayerBorder());
            this.vr.reset();
        }
        AppMethodBeat.o(36970);
    }
