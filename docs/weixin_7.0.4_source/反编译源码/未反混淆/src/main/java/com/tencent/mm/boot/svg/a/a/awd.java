...
public final class awd extends c {
    ...
    public final int a(int i, Object... objArr) {
        switch (i) {
            ...
            case 2:
                ...
                canvas.save();
                float[] a = c.a(g, 1.0f, 0.0f, 24.0f, 0.0f, 1.0f, 0.0f);
                h.reset();
                h.setValues(a);
                canvas.concat(h);
                canvas.save();
                ...
                canvas.restore();
                canvas.save();
                g = c.a(a, 1.0f, 0.0f, 24.0f, 0.0f, 1.0f, 48.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.restore();
                ...
                k = c.a(k, looper);
                k.setColor(-15819547);
                g = c.a(g, 1.0f, 0.0f, 96.0f, 0.0f, 1.0f, 0.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
