...
public final class bx extends btd {
    public bet vEe;
    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.vEe != null) {
                aVar.iy(2, this.vEe.computeSize());
                this.vEe.writeFields(aVar);
            }
            AppMethodBeat.o(10152);
            return 0;
        } else if (i == 1) {
            ...
            if (this.vEe != null) {
                ix += e.a.a.a.ix(2, this.vEe.computeSize());
            }
            AppMethodBeat.o(10152);
            return ix;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        bxVar.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(10152);
                    return 0;
                case 2:
