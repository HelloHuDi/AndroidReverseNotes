...
public final class v {
    ...
    private byte[] b(byte[] bArr, int i, byte[] bArr2) {
        int i2 = 0;
    ...
    public final byte[] decrypt(byte[] bArr, byte[] bArr2) {
        ...
        byte[] b = b(bArr, bArr.length, bArr2);
    ...
    private byte[] a(byte[] bArr, int i, byte[] bArr2) {
        ...
        this.plain[0] = (byte) ((this.random.nextInt() & d.MIC_PTU_ZIPAI_THURSDAY) | this.pos);
    ...
    public final byte[] encrypt(byte[] bArr, byte[] bArr2) {
        ...
        byte[] a = a(bArr, bArr.length, bArr2);
