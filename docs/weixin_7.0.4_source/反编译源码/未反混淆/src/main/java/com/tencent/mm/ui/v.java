...
public final class v {
    ...
    static final class a implements Factory {
        ...
        public final View onCreateView(String str, Context context, AttributeSet attributeSet) {
            ...
            try {
                ...
                if (view == null) {
                    ab.w("MicroMsg.MMLayoutInflater", "Inflate view, ClassNotFound ".concat(String.valueOf(str)));
                    ...
                    if (str.equals("TextView") || str.equals("com.tencent.mm.ui.widget.MMTextView") || str.equals("com.tencent.mm.wallet_core.ui.WalletTextView")) {
                        ...
                        textView.setTextSize(1, (f * textView.getTextSize()) / com.tencent.mm.bz.a.getDensity(textView.getContext()));
                        context.getAssets();
                        f.dmU();
                        if (f.dmV()) {
                            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, v.ynp);
                            for (i = 0; i < v.ynp.length; i++) {
                                resourceId = obtainStyledAttributes.getResourceId(i, 0);
                                if (resourceId != 0) {
                                    if (v.ynp[i] == 16843379) {
                                        textView.setContentDescription(context.getString(resourceId));
                                    } else if (v.ynp[i] == 16843088) {
                        ...
                        button.setTextSize(1, (f * button.getTextSize()) / com.tencent.mm.bz.a.getDensity(button.getContext()));
                        context.getAssets();
                        f.dmU();
                        if (f.dmV()) {
                            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, v.ynp);
                        ...
                        editText.setTextSize(1, (f * editText.getTextSize()) / com.tencent.mm.bz.a.getDensity(editText.getContext()));
                        context.getAssets();
                        f.dmU();
                        if (f.dmV()) {
                            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, v.ynp);
                        ...
                        checkBox.setTextSize(1, (f * checkBox.getTextSize()) / com.tencent.mm.bz.a.getDensity(checkBox.getContext()));
                        context.getAssets();
                        f.dmU();
                        if (f.dmV()) {
                            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, v.ynp);
                        ...
                        f.dmU();
                        if (f.dmV()) {
                            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, v.ynq);
                            i = 0;
                            while (i < v.ynq.length) {
                                resourceId = obtainStyledAttributes.getResourceId(i, 0);
                                if (resourceId != 0 && v.ynq[i] == 16843379) {
                        ...
                        mMNeat7extView.setTextSize(1, (f * mMNeat7extView.getTextSize()) / com.tencent.mm.bz.a.getDensity(mMNeat7extView.getContext()));
                    } else {
                        textView = (TextView) view;
                        textView.setTextSize(1, (f * textView.getTextSize()) / com.tencent.mm.bz.a.getDensity(textView.getContext()));
                    }
                ...
                ab.w("MicroMsg.MMLayoutInflater", "[cpan] class not found. name:%s. Use default Inflate.", str);
            } catch (InflateException e2) {
                ab.w("MicroMsg.MMLayoutInflater", "[cpan] Inflate failed. name:%s. Use default Inflate.", str);
            }
    ...
    public static LayoutInflater a(LayoutInflater layoutInflater) {
        ...
        com.tencent.mm.bz.a.dm(layoutInflater.getContext());
    ...
    public static LayoutInflater hu(Context context) {
        AppMethodBeat.i(106108);
        com.tencent.mm.bz.a.dm(context);
