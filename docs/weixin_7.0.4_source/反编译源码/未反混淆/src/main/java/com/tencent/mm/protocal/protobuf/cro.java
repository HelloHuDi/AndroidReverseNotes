...
public final class cro extends a {
    public cqm xoW;
    public crf xpg;
    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.xpg != null) {
                aVar.iy(2, this.xpg.computeSize());
                this.xpg.writeFields(aVar);
            }
            AppMethodBeat.o(102426);
            return 0;
        } else if (i == 1) {
            ...
            if (this.xpg != null) {
                ix += e.a.a.a.ix(2, this.xpg.computeSize());
            }
            AppMethodBeat.o(102426);
            return ix;
        } else if (i == 2) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        crf crf = new crf();
                        aVar4 = new e.a.a.a.a(bArr, unknownTagHandler);
                        for (z = true; z; z = crf.populateBuilderWithField(aVar4, crf, a.getNextFieldNumber(aVar4))) {
                        }
                        cro.xpg = crf;
                    }
                    AppMethodBeat.o(102426);
