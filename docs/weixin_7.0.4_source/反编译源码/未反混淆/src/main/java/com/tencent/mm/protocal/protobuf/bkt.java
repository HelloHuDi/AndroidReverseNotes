...
public final class bkt extends a {
    public float vRp;
    public float vRq;
    public int wfG;
    public String wfH;
    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            switch (((Integer) objArr[2]).intValue()) {
                case 1:
                    bkt.vRp = Float.intBitsToFloat(aVar3.BTU.eia());
                    AppMethodBeat.o(80155);
                    return 0;
                case 2:
                    bkt.vRq = Float.intBitsToFloat(aVar3.BTU.eia());
                    AppMethodBeat.o(80155);
                    return 0;
                case 3:
                    bkt.wfG = aVar3.BTU.vd();
                    AppMethodBeat.o(80155);
                    return 0;
                case 4:
                    bkt.wfH = aVar3.BTU.readString();
                    AppMethodBeat.o(80155);
                    return 0;
                case 5:
                    bkt.wfI = aVar3.BTU.readString();
                    AppMethodBeat.o(80155);
                    return 0;
                case 6:
                    bkt.wfJ = aVar3.BTU.vd();
                    AppMethodBeat.o(80155);
                    return 0;
                default:
                    AppMethodBeat.o(80155);
