...
public class b {
    ...
    private void o() {
        ...
        try {
            ...
            if (responseCode == 304) {
                a(false);
                TXCLog.d("CloudConfig", new StringBuilder("fetch config Not-Modified-Since ").append(this.d).toString() == null ? "" : this.d);
            }
            AppMethodBeat.o(66157);
        } catch (Exception e) {
            TXCLog.e("CloudConfig", "fetch config catch exception ".concat(String.valueOf(e)));
            a(false);
            AppMethodBeat.o(66157);
        } catch (Throwable th) {
            while (true) {
    ...
    private void b(String str) {
        ...
        try {
            ...
            TXCLog.w("CloudConfig", "parseRespon catch ecxeption".concat(String.valueOf(e)));
            AppMethodBeat.o(66159);
        }
    }
    ...
    private void a(JSONObject jSONObject, a aVar) {
                    ...
                    if (jSONObject3 != null && jSONObject3.getString("Manufacture").equalsIgnoreCase(Build.MANUFACTURER)) {
                        ...
                        if (optJSONArray != null) {
                            for (i3 = 0; i3 < optJSONArray.length(); i3++) {
                                ...
                                if (optJSONObject != null) {
                                    String optString = optJSONObject.optString(android.support.d.a.TAG_MODEL);
                        ...
                        if (optJSONArray2 != null) {
                            for (int i4 = 0; i4 < optJSONArray2.length(); i4++) {
                                ...
                                if (optJSONObject2 != null) {
                                    String optString2 = optJSONObject2.optString(android.support.d.a.TAG_MODEL);
                                ...
                                try {
                                    if (!optString3.isEmpty()) {
                                        ...
                                        for (int i5 = 0; i5 < split.length; i5++) {
                                            aVar.f[i5] = Integer.valueOf(split[i5].trim()).intValue();
                                        }
                                    }
                                    aVar.g = jSONObject3.optInt("HWAACCodec", 0);
                                    aVar.h = jSONObject3.optString(android.support.d.a.TAG_SCENE_TYPE, "");
                                    str2 = optString3;
                                } catch (Exception e2) {
                                    e = e2;
        ...
        TXCLog.i("CloudConfig", "system aec config1:" + aVar.d + "," + aVar.e + "," + str + "," + aVar.g + "," + aVar.h + ", model = " + Build.MODEL + ", manufacturer = " + Build.MANUFACTURER + "， board = " + Build.BOARD);
            ...
            if (jSONObject2.has("InfoList")) {
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    ...
                    if (jSONObject3 != null) {
                        ...
                        String string2 = jSONObject3.getString(android.support.d.a.TAG_MODEL);
    ...
    private void e(JSONObject jSONObject, a aVar) {
        ...
        if (jSONObject.has("ExposureWhiteConfig")) {
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                ...
                if (jSONObject2.getString("Manufacture").equalsIgnoreCase(Build.MANUFACTURER) && jSONObject2.getString(android.support.d.a.TAG_MODEL).equalsIgnoreCase(Build.MODEL)) {
    ...
    private void f(JSONObject jSONObject, a aVar) {
        ...
        if (jSONObject.has("HWBlackConfig")) {
            ...
            while (i < jSONArray.length()) {
                JSONObject jSONObject3 = jSONArray.getJSONObject(i);
                if (!jSONObject3.getString("Manufacture").equalsIgnoreCase(Build.MANUFACTURER) || !jSONObject3.getString(android.support.d.a.TAG_MODEL).equalsIgnoreCase(Build.MODEL)) {
                    i++;
    ...
    private void a(String str, a aVar) {
        ...
        try {
            ...
            TXCLog.w("CloudConfig", "parseTraeLocalConfig catch ecxeption".concat(String.valueOf(e)));
            AppMethodBeat.o(66166);
        }
    }
    ...
    private boolean p() {
        ...
        try {
            ...
            this.c.clear();
            this.c.commit();
            TXCLog.d("CloudConfig", "loadLocalFileConfig catch exception ".concat(String.valueOf(e)));
            AppMethodBeat.o(66169);
            return false;
        }
    }
    ...
    private void q() {
        ...
        try {
            ...
            TXCLog.w("CloudConfig", "loadDefaultConfig catch exception ".concat(String.valueOf(e)));
            this.j = new a();
            AppMethodBeat.o(66170);
        }
    }
