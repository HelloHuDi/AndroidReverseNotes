        ...
        if (i == 0) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    bhVar.nbs = aVar3.BTU.readString();
                    AppMethodBeat.o(111607);
                    return 0;
                case 3:
                    bhVar.nbX.add(aVar3.BTU.readString());
                    AppMethodBeat.o(111607);
                    return 0;
                case 4:
                    bhVar.guW = aVar3.BTU.readString();
                    AppMethodBeat.o(111607);
                    return 0;
                case 5:
                    Vh = aVar3.Vh(intValue);
                    ...
                    return 0;
                case 6:
                    bhVar.nbZ = aVar3.BTU.vd();
                    AppMethodBeat.o(111607);
                    return 0;
                case 7:
                    bhVar.nca = aVar3.BTU.ehX();
                    AppMethodBeat.o(111607);
                    return 0;
                case 8:
                    bhVar.nbt = aVar3.BTU.vd();
                    AppMethodBeat.o(111607);
                    return 0;
                default:
                    AppMethodBeat.o(111607);
