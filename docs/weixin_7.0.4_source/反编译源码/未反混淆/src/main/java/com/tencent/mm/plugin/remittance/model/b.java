...
public final class b {
    public static LinkedList<abv> v(JSONArray jSONArray) {
        ...
        if (jSONArray == null) {
            ...
            while (i < jSONArray.length()) {
                try {
                    ...
                    abv.vPg = w(jSONObject.optJSONArray("favor_info_list"));
                    linkedList.add(abv);
                    i++;
                } catch (Exception e) {
                    ab.printErrStackTrace("MicroMsg.BusiFavorInfoParser", e, "", new Object[0]);
                }
            }
            AppMethodBeat.o(44719);
        }
    ...
    public static LinkedList<abw> w(JSONArray jSONArray) {
