...
public final class ca extends bsr {
    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            ix += e.a.a.b.b.a.bs(5, this.vEj);
            if (this.vEk != null) {
                ix += e.a.a.b.b.a.f(6, this.vEk);
            }
            AppMethodBeat.o(5562);
            return ix;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        caVar.BaseRequest = hlVar;
                    }
                    AppMethodBeat.o(5562);
                    return 0;
                case 2:
                    caVar.ehB = aVar3.BTU.vd();
                    AppMethodBeat.o(5562);
                    return 0;
                case 3:
                    Vh = aVar3.Vh(intValue);
                ...
                case 4:
                    ...
                    return 0;
                case 5:
                    caVar.vEj = aVar3.BTU.vd();
                    AppMethodBeat.o(5562);
                    return 0;
                case 6:
                    caVar.vEk = aVar3.BTU.readString();
                    AppMethodBeat.o(5562);
                    return 0;
                default:
                    AppMethodBeat.o(5562);
