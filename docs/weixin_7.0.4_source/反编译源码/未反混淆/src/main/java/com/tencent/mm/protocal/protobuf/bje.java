...
public final class bje extends btd {
    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.mZj != null) {
                ix += e.a.a.b.b.a.f(4, this.mZj);
            }
            int bs = ix + e.a.a.b.b.a.bs(5, this.wMt);
            AppMethodBeat.o(56891);
            return bs;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    bje.luT = aVar3.BTU.vd();
                    AppMethodBeat.o(56891);
                    return 0;
                case 3:
                    bje.luU = aVar3.BTU.readString();
                    AppMethodBeat.o(56891);
                    return 0;
                case 4:
                    bje.mZj = aVar3.BTU.readString();
                    AppMethodBeat.o(56891);
                    return 0;
                case 5:
                    bje.wMt = aVar3.BTU.vd();
                    AppMethodBeat.o(56891);
                    return 0;
                default:
                    AppMethodBeat.o(56891);
