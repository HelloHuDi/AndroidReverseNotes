...
public class SnakeFaceFilter extends VideoFilterBase {
    ...
    public void initParams() {
        ...
        addParam(new i(SHADER_FIELD.NPOINT.name, 0));
        addParam(new c(SHADER_FIELD.FSRC.name, new float[0]));
        addParam(new c(SHADER_FIELD.FDST.name, new float[0]));
    ...
    private void updateGLParams(int i) {
        ...
        addParam(new i(SHADER_FIELD.NPOINT.name, i));
        addParam(new c(SHADER_FIELD.FSRC.name, VideoMaterialUtil.toFlatArray(this.srcPoints)));
        addParam(new c(SHADER_FIELD.FDST.name, VideoMaterialUtil.toFlatArray(this.dstPoints)));
