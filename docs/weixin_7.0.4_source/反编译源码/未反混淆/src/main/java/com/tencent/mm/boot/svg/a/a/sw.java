    ...
    public final int a(int i, Object... objArr) {
        switch (i) {
            ...
            case 2:
                ...
                float[] a2 = c.a(g, 0.94551855f, 0.32556817f, -10.369054f, -0.32556817f, 0.94551855f, 13.085754f);
                h.reset();
                h.setValues(a2);
                canvas.concat(h);
                Path l = c.l(looper);
                ...
                k = c.a(k, looper);
                k.setColor(WebView.NIGHT_MODE_COLOR);
                g = c.a(a2, 0.70710677f, -0.70710677f, 24.052986f, 0.70710677f, 0.70710677f, -35.269047f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                l = c.l(looper);
