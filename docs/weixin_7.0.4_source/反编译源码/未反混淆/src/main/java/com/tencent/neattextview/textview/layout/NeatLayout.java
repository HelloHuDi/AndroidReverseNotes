...
public class NeatLayout extends c {
    ...
    public final void a(TextPaint textPaint, float f, int i, boolean z) {
        ...
        int nComputeBreak = nComputeBreak(this.AjZ, this.Akb, 0.0f, f + textSize, iArr, fArr, textSize2, zArr, a.AjU, this.Ake, a.AjT, this.Akd, this.Aky);
        ...
        while (i4 < nComputeBreak && i4 < i) {
            ...
            a(cArr, i3, i5, f7, fArr2, size, f5, z2, textSize2, f4);
            i4++;
            i3 = i5;
        }
