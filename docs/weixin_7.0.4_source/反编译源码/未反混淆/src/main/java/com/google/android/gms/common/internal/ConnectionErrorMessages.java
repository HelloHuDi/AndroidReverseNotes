...
public final class ConnectionErrorMessages {
    @GuardedBy("sCache")
    private static final m<String, String> zzse = new m();
    ...
    public static String getErrorMessage(Context context, int i) {
        ...
        switch (i) {
            case 1:
                string = resources.getString(R.string.common_google_play_services_install_text, new Object[]{appName});
                AppMethodBeat.o(61326);
                return string;
            case 2:
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    string = resources.getString(R.string.common_google_play_services_wear_update_text);
                    AppMethodBeat.o(61326);
                    return string;
                }
                string = resources.getString(R.string.common_google_play_services_update_text, new Object[]{appName});
                AppMethodBeat.o(61326);
                return string;
            case 3:
                string = resources.getString(R.string.common_google_play_services_enable_text, new Object[]{appName});
                AppMethodBeat.o(61326);
                return string;
            case 5:
            ...
            case 7:
                ...
                return string;
            case 9:
                string = resources.getString(R.string.common_google_play_services_unsupported_text, new Object[]{appName});
                AppMethodBeat.o(61326);
                return string;
            case 16:
            ...
            case 17:
                ...
                return string;
            case 18:
                string = resources.getString(R.string.common_google_play_services_updating_text, new Object[]{appName});
                AppMethodBeat.o(61326);
                return string;
            case 20:
                ...
                return string;
            default:
                string = resources.getString(R.string.common_google_play_services_unknown_issue, new Object[]{appName});
                AppMethodBeat.o(61326);
                return string;
        }
    }
    ...
    /* JADX WARNING: Missing block: B:18:0x0042, code skipped:
            com.tencent.matrix.trace.core.AppMethodBeat.o(61331);
     */
