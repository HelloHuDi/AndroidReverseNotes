...
public class V8Executor extends Thread {
    ...
    public void run() {
        ...
        monitor-enter(r9);
        r1 = com.eclipsesource.v8.V8.createV8Runtime();	 Catch:{ all -> 0x00a4 }
        ...
        r1 = r2 instanceof com.eclipsesource.v8.Releasable;	 Catch:{ all -> 0x0135, all -> 0x00dc, Exception -> 0x00e5 }
        if (r1 == 0) goto L_0x0055;	 Catch:{ all -> 0x0135, all -> 0x00dc, Exception -> 0x00e5 }
        r0 = r2;	 Catch:{ all -> 0x0135, all -> 0x00dc, Exception -> 0x00e5 }
        r0 = (com.eclipsesource.v8.Releasable) r0;	 Catch:{ all -> 0x0135, all -> 0x00dc, Exception -> 0x00e5 }
        r1 = r0;	 Catch:{ all -> 0x0135, all -> 0x00dc, Exception -> 0x00e5 }
        r1.release();	 Catch:{ all -> 0x0135, all -> 0x00dc, Exception -> 0x00e5 }
        r1 = r2 instanceof com.eclipsesource.v8.Releasable;	 Catch:{ all -> 0x0135, all -> 0x00dc, Exception -> 0x00e5 }
        if (r1 == 0) goto L_0x005e;	 Catch:{ all -> 0x0135, all -> 0x00dc, Exception -> 0x00e5 }
        r2 = (com.eclipsesource.v8.Releasable) r2;	 Catch:{ all -> 0x0135, all -> 0x00dc, Exception -> 0x00e5 }
        ...
        com.tencent.matrix.trace.core.AppMethodBeat.o(r2);	 Catch:{ all -> 0x0135, all -> 0x00dc, Exception -> 0x00e5 }
