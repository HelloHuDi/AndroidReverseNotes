...
public final class tc extends a {
    public int jBv;
    public LinkedList<tb> jBw = new LinkedList();
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        for (boolean z = true; z; z = tbVar.populateBuilderWithField(aVar4, tbVar, a.getNextFieldNumber(aVar4))) {
                        }
                        tcVar.jBw.add(tbVar);
                    }
                    AppMethodBeat.o(58904);
