...
public final class hp extends btd {
    public int jBv;
    public LinkedList<vp> jBw = new LinkedList();
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        hpVar.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(51368);
                    return 0;
                case 2:
                    hpVar.jBv = aVar3.BTU.vd();
                    AppMethodBeat.o(51368);
                    return 0;
                case 3:
                    Vh = aVar3.Vh(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        vp vpVar = new vp();
                        aVar4 = new e.a.a.a.a(bArr, unknownTagHandler);
                        for (z = true; z; z = vpVar.populateBuilderWithField(aVar4, vpVar, com.tencent.mm.bt.a.getNextFieldNumber(aVar4))) {
                        }
                        hpVar.jBw.add(vpVar);
                    }
                    AppMethodBeat.o(51368);
