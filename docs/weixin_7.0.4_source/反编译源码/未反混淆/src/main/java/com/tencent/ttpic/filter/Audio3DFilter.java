...
public class Audio3DFilter extends VideoFilterBase {
    ...
    public void render(h hVar, PTFaceAttr pTFaceAttr) {
        ...
        if (obj != null) {
            ...
            RenderProcess(hVar.texture[0], this.gameFilter.getGameRefTextureWidth(), this.gameFilter.getGameRefTextureHeight(), -1, 0.0d, this.gameFrame);
            this.gameFilter.updateAndRender(hVar, pTFaceAttr);
        }
