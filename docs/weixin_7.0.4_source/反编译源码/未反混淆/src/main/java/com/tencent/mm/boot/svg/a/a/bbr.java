    ...
    public final int a(int i, Object... objArr) {
        switch (i) {
            ...
            case 2:
                ...
                canvas.save();
                g = c.a(g, 1.0f, 0.0f, -394.0f, 0.0f, 1.0f, -603.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
                ...
                canvas.concat(h);
                canvas.save();
                g = c.a(g, 1.0f, 0.0f, 327.0f, 0.0f, 1.0f, 0.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
                a = c.a(a, looper);
                a.setColor(-5066062);
                g = c.a(g, 1.0f, 0.0f, 1.5f, 0.0f, 1.0f, 2.25f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
                ...
                canvas.drawPath(l2, c.a(a3, looper));
                canvas.restore();
                canvas.restore();
                canvas.restore();
                canvas.restore();
