...
public final class alw extends bsr {
    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            int bs = (((ix + e.a.a.b.b.a.bs(2, this.jBv)) + e.a.a.a.c(3, 8, this.jBw)) + e.a.a.b.b.a.bs(4, this.jCt)) + e.a.a.b.b.a.bs(5, this.vEq);
            AppMethodBeat.o(80092);
            return bs;
        } else if (i == 2) {
            bArr = (byte[]) objArr[0];
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        alw.BaseRequest = hlVar;
                    }
                    AppMethodBeat.o(80092);
                    return 0;
                case 2:
                    alw.jBv = aVar3.BTU.vd();
                    AppMethodBeat.o(80092);
                    return 0;
                case 3:
                    Vh = aVar3.Vh(intValue);
                    ...
                    return 0;
                case 4:
                    alw.jCt = aVar3.BTU.vd();
                    AppMethodBeat.o(80092);
                    return 0;
                case 5:
                    alw.vEq = aVar3.BTU.vd();
                    AppMethodBeat.o(80092);
                    return 0;
                default:
                    AppMethodBeat.o(80092);
