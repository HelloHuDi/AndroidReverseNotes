...
public class EyeLightenAndPounchFilter_573 extends VideoFilterBase {
    ...
    public void initParams() {
        ...
        addParam(new f("smoothOpacity", this.smoothOpacity));
        addParam(new f("contrastOpacity", this.contrastOpacity));
        addParam(new f("toothWhiten", this.toothWhitenAlpha));
        ...
        addParam(new f("contrast", 1.0f));
        addParam(new f("saturation", 1.0f));
        addParam(new f("brightness", 1.0f));
    ...
    public void updatePointParams(List<PointF> list) {
        ...
        addParam(new g("center1", new float[]{(float) (((double) (((PointF) list.get(44)).x + distance2)) / this.mFaceDetScale), (float) (((double) ((PointF) list.get(44)).y) / this.mFaceDetScale)}));
        addParam(new g("center2", fArr));
        addParam(new g("size", fArr2));
        addParam(new f("radius1", distance3));
        addParam(new f("radius2", max));
        addParam(new f("toothWhiten", (float) (Math.max(Math.min(((((double) AlgoUtils.getDistance((PointF) list.get(81), (PointF) list.get(73))) / this.mFaceDetScale) - 10.0d) / 20.0d, 1.0d), 0.0d) * ((double) this.toothWhitenAlpha))));
        AppMethodBeat.o(82239);
    }
