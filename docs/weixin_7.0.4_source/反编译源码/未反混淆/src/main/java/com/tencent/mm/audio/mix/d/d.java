...
import com.tencent.mm.audio.mix.f.a;
...
public class d extends c {
    ...
    public d(com.tencent.mm.audio.mix.f.d dVar, b bVar) {
        super(dVar, bVar);
    ...
    public final void DG() {
        ...
        try {
            ...
            try {
                ...
                com.tencent.mm.audio.mix.h.b.i("MicroMsg.Mix.AudioDecoderMediaCodec", "tractCount is %d", Integer.valueOf(this.clX.getTrackCount()));
                ...
                com.tencent.mm.audio.mix.h.b.i("MicroMsg.Mix.AudioDecoderMediaCodec", "format:%s", trackFormat);
                ...
                try {
                    ...
                    com.tencent.mm.audio.mix.h.b.i("MicroMsg.Mix.AudioDecoderMediaCodec", "Track info: extractorFormat: %s mime: %s", trackFormat, this.clY);
                    com.tencent.mm.audio.mix.h.b.i("MicroMsg.Mix.AudioDecoderMediaCodec", "sampleRate:%d, channels:%d, bitDepth:%d, duration:%d, audioId:%s,", Integer.valueOf(this.sampleRate), Integer.valueOf(this.channels), Integer.valueOf(this.cku), Long.valueOf(this.duration), this.clK.Ev().ckD);
                    this.clX.selectTrack(0);
                    BufferInfo bufferInfo = new BufferInfo();
                    int i2 = 0;
                    c DC = DC();
                    DC.reset();
                    if (!a.E(this.sampleRate, this.channels, this.cku)) {
                        com.tencent.mm.audio.mix.h.b.e("MicroMsg.Mix.AudioDecoderMediaCodec", "track param is not support config");
                        this.clM = new com.tencent.mm.audio.mix.c.d(DC, this.sampleRate, this.channels, this.cku, this.clO);
                    }
                    ...
                    while (obj == null && i2 < 50) {
                        try {
                                ...
                                if (obj2 == null) {
                                    ...
                                    if (dequeueInputBuffer >= 0) {
                                        ...
                                        if (dequeueOutputBuffer < 0) {
                                            ...
                                            com.tencent.mm.audio.mix.h.b.i("MicroMsg.Mix.AudioDecoderMediaCodec", "sampleRate:%d, channels:%d, bitDepth:%d, audioId:%s, sourcePath:%s", Integer.valueOf(this.sampleRate), Integer.valueOf(this.channels), Integer.valueOf(this.cku), this.clK.Ev().ckD, this.clO);
                                            switch (this.cku) {
                                                case 1:
                                                case 2:
                                                case 3:
                                            ...
                                            if (obj5 == null) {
                                                com.tencent.mm.audio.mix.h.b.e("MicroMsg.Mix.AudioDecoderMediaCodec", "bitDepth:%d is not support!", Integer.valueOf(this.cku));
                                                this.clN = 709;
                                                onError(this.clN);
                                                DO();
                                                DP();
                                                AppMethodBeat.o(137052);
                                                return;
                                            } else if (!a.E(this.sampleRate, this.channels, this.cku) || this.clM == null) {
                                                if (this.clM != null) {
                                                    com.tencent.mm.audio.mix.h.b.i("MicroMsg.Mix.AudioDecoderMediaCodec", "update config param");
                                                    this.clM.C(this.sampleRate, this.channels, this.cku);
                                                }
                                                obj2 = obj3;
                                            } else {
                            ...
                            com.tencent.mm.audio.mix.h.b.printErrStackTrace("MicroMsg.Mix.AudioDecoderMediaCodec", e, "onDecode", new Object[0]);
                            this.clN = 706;
                            onError(this.clN);
                            DO();
                            DP();
                    ...
                    if (i2 >= 50) {
                        com.tencent.mm.audio.mix.h.b.e("MicroMsg.Mix.AudioDecoderMediaCodec", "onError, noOutputCounter:%d", Integer.valueOf(i2));
                        this.clN = 706;
                        onError(this.clN);
                    } else {
                        com.tencent.mm.audio.mix.h.b.i("MicroMsg.Mix.AudioDecoderMediaCodec", "onStop, isComplete:%b", Boolean.valueOf(z));
                        if (z) {
                            b(DC);
                        } else {
                            DC.reset();
                    ...
                    DO();
                    DP();
                    DC.ckA = this.clK.Ev().ckA;
                    com.tencent.mm.audio.mix.h.b.i("MicroMsg.Mix.AudioDecoderMediaCodec", "stopping...");
                    AppMethodBeat.o(137052);
                } catch (Exception e2) {
                    com.tencent.mm.audio.mix.h.b.printErrStackTrace("MicroMsg.Mix.AudioDecoderMediaCodec", e2, "createDecoderByType", new Object[0]);
                    this.clN = 704;
                    onError(this.clN);
                    DO();
                    DP();
                ...
                com.tencent.mm.audio.mix.h.b.printErrStackTrace("MicroMsg.Mix.AudioDecoderMediaCodec", e22, "get media format from media extractor", new Object[0]);
                this.clN = 705;
                onError(this.clN);
                DO();
                AppMethodBeat.o(137052);
            ...
            com.tencent.mm.audio.mix.h.b.printErrStackTrace("MicroMsg.Mix.AudioDecoderMediaCodec", e222, "set extractor data source, sourcePath:%s", this.clO);
            this.clN = 702;
            Dz();
            AppMethodBeat.o(137052);
        }
    ...
    public void a(c cVar, ByteBuffer byteBuffer, int i) {
        ...
        if (this.clM != null) {
            ...
            if (this.clK.Ev().fqW) {
                com.tencent.mm.audio.mix.c.a.a(this.cma, DM().fqN);
            }
            this.clM.F(this.cma);
    ...
    /* Access modifiers changed, original: protected|final */
    public final void b(c cVar, ByteBuffer byteBuffer, int i) {
        byte[] bArr;
        ...
        if (this.clK.Ev().fqW) {
            com.tencent.mm.audio.mix.c.a.a(bArr, DM().fqN);
        }
        a(cVar, bArr);
    ...
    private void DO() {
        ...
        try {
            ...
            com.tencent.mm.audio.mix.h.b.printErrStackTrace("MicroMsg.Mix.AudioDecoderMediaCodec", e, "releaseMediaExtractor", new Object[0]);
            AppMethodBeat.o(137060);
        }
    }
    ...
    private void DP() {
        ...
        try {
            ...
            com.tencent.mm.audio.mix.h.b.printErrStackTrace("MicroMsg.Mix.AudioDecoderMediaCodec", e, "releaseMediaCodec", new Object[0]);
            AppMethodBeat.o(137061);
        }
    }
}
