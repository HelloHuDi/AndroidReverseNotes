            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        akd.BaseRequest = hlVar;
                    }
                    AppMethodBeat.o(56814);
                    return 0;
                case 2:
                    akd.wjV = aVar3.BTU.readString();
                    AppMethodBeat.o(56814);
                    return 0;
                case 3:
                    akd.wpE = aVar3.BTU.readString();
                    AppMethodBeat.o(56814);
                    return 0;
                case 4:
                    akd.wjW = aVar3.BTU.readString();
                    AppMethodBeat.o(56814);
                    return 0;
                case 5:
                    akd.wjX = aVar3.BTU.readString();
                    AppMethodBeat.o(56814);
                    return 0;
                case 6:
                    akd.wdB = aVar3.BTU.readString();
                    AppMethodBeat.o(56814);
                    return 0;
                default:
                    AppMethodBeat.o(56814);
