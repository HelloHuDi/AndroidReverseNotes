...
public class DeviceUtils {
    ...
    public static boolean isVeryLowEndDevice() {
        ...
        LogUtils.i(TAG, "[isVeryLowEndDevice] socClass = ".concat(String.valueOf(deviceSocClass)));
        if (deviceSocClass != SOC_CLASS.NULL && deviceSocClass == SOC_CLASS.V_LOW) {
            z = true;
        }
        LogUtils.i(TAG, "[isVeryLowEndDevice] + END, isVeryLowDevice = ".concat(String.valueOf(z)));
    ...
    public static boolean isLowEndDevice(Context context) {
        ...
        SOC_CLASS deviceSocClass = DeviceInstance.getInstance().getDeviceSocClass(DeviceAttrs.getInstance().str_deviceSocInfo);
        LogUtils.i(TAG, "[isLowEndDevice] socClass = ".concat(String.valueOf(deviceSocClass)));
        if (deviceSocClass == SOC_CLASS.NULL) {
            ...
            LogUtils.d(TAG, "[isLowEndDevice] isLowEndDisplay = " + z4 + ", widthPixels = " + screenWidth + ", heightPixels = " + screenHeight);
            ...
            LogUtils.d(TAG, "[isLowEndDevice] isLowMemory = " + z2 + ", deviceHeapSize(Mb) = " + heapMaxSizeInMb);
            ...
            LogUtils.d(TAG, "[isLowEndDevice] isLowCpuCount = " + z3 + ", cpuCount = " + numCores);
            if (!(z4 || z2 || z3)) {
                z = false;
            }
        ...
        LogUtils.i(TAG, "[isLowEndDevice] + END, isLowEndDevice = ".concat(String.valueOf(z)));
    ...
    public static boolean isHighEndDevice(Context context) {
        ...
        SOC_CLASS deviceSocClass = DeviceInstance.getInstance().getDeviceSocClass(DeviceAttrs.getInstance().str_deviceSocInfo);
        LogUtils.i(TAG, "[isHighEndDevice] socClass = ".concat(String.valueOf(deviceSocClass)));
        if (deviceSocClass == SOC_CLASS.NULL) {
            boolean z2;
            boolean z3;
            int screenWidth = getScreenWidth(context);
            ...
            LogUtils.d(TAG, "[isHighEndDevice] isHighDisplay = " + z4 + ", widthPixels = " + screenWidth + ", heightPixels = " + screenHeight);
            long heapMaxSizeInMb = getHeapMaxSizeInMb(context);
            ...
            LogUtils.d(TAG, "[isHighEndDevice] isHighMemory = " + z2 + ", deviceHeapSize(Mb) = " + heapMaxSizeInMb);
            int numCores = getNumCores();
            if (((long) numCores) >= 4) {
                z3 = true;
            } else {
            ...
            LogUtils.d(TAG, "[isHighEndDevice] isHighCpuCount = " + z3 + ", cpuCount = " + numCores);
            if (!(z4 && z2 && z3)) {
                z = false;
            }
        ...
        LogUtils.i(TAG, "[isHighEndDevice] + END, isHighEndDevice = ".concat(String.valueOf(z)));
    ...
    public static boolean isMiddleEndDevice(Context context) {
        ...
        SOC_CLASS deviceSocClass = DeviceInstance.getInstance().getDeviceSocClass(DeviceAttrs.getInstance().str_deviceSocInfo);
        LogUtils.i(TAG, "[isMiddleEndDevice] socClass = ".concat(String.valueOf(deviceSocClass)));
        if (deviceSocClass != SOC_CLASS.NULL) {
        ...
        LogUtils.i(TAG, "[isMiddleEndDevice] + END, isMiddleEndDevice = ".concat(String.valueOf(z)));
    ...
    public static float getHeapAllocatedPercent(Context context) {
        ...
        LogUtils.v(TAG, "getHeapAllocatedPercent(), percent = %f", Float.valueOf((((float) getHeapAllocatedSizeInKb()) * 1.0f) / ((float) getHeapMaxSizeInKb(context))));
    ...
    public static String getImei(Context context) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(deviceId)) {
                LogUtils.i(TAG, "[getImei] IMEI: ".concat(String.valueOf(deviceId)));
