...
public class SmileyPanelScrollView extends View {
    ...
    public class a implements Runnable {
        ...
        public final void dMJ() {
            ...
            h.pYm.e(13361, Integer.valueOf(0));
    ...
    private void init(Context context) {
        ...
        this.Aam = com.tencent.mm.svg.a.a.f(getResources(), R.raw.smiley_recent_dot);
        this.Aao = this.mContext.getResources().getDrawable(R.drawable.smiley_panel_scroll_thumb_selected);
        this.Aan = this.mContext.getResources().getDrawable(R.drawable.smiley_panel_scroll_thumb_pressed);
        this.Aap = this.mContext.getResources().getDrawable(R.drawable.smiley_panel_scroll_track_pressed);
        ...
        ab.d("MicroMsg.SmileyPanelScrollView", "init mDotPadding:%d mDotHeight:%d mDotWidth:%d", Integer.valueOf(this.Aau), Integer.valueOf(this.Aav), Integer.valueOf(this.Aaw));
        this.Aat = new Paint();
        ...
        ab.d("MicroMsg.SmileyPanelScrollView", "init mWidth:%d mHeight:%d mTrackWidth:%d mMaxDot:%d", Integer.valueOf(this.mWidth), Integer.valueOf(this.mHeight), Integer.valueOf(this.Aay), Integer.valueOf(this.Aas));
    ...
    public void draw(Canvas canvas) {
        ...
        if (SmileyPanelScrollView.this.getState() != SmileyPanelScrollView.this.AaJ) {
            ...
            if (uptimeMillis > aVar.mStartTime + aVar.AaL) {
                i2 = 255;
            } else {
                i2 = ((int) (((uptimeMillis - aVar.mStartTime) * 153) / aVar.AaL)) + 102;
                if (i2 < 102) {
                    i2 = 102;
                }
            }
        ...
        if (this.Aaq > this.Aas) {
            ...
            this.xJ = i4 - (this.AaA / 2);
            this.xM = (this.xJ + this.Aay) + this.AaA;
            if (DEBUG) {
                canvas.drawLine((float) this.xJ, 0.0f, (float) this.xJ, (float) this.mHeight, this.Aat);
                canvas.drawLine((float) this.xM, 0.0f, (float) this.xM, (float) this.mHeight, this.Aat);
            }
            ...
            this.xJ = i4 - ((this.AaA - this.Aaw) / 2);
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (i != this.mWidth) {
            this.mWidth = getMeasuredWidth();
            this.mHeight = getMeasuredHeight();
            this.Aay = (this.mWidth - (this.Aal.getColumnWidth() - this.Aal.Aed)) - (com.tencent.mm.bz.a.al(this.mContext, R.dimen.nh) * 2);
            this.Aas = this.Aay / (this.Aaw + this.Aau);
            ab.d("MicroMsg.SmileyPanelScrollView", "onSizeChanged mWidth:%d mHeight:%d mTrackWidth:%d mMaxDot:%d", Integer.valueOf(this.mWidth), Integer.valueOf(this.mHeight), Integer.valueOf(this.Aay), Integer.valueOf(this.Aas));
            if (this.mHeight == 0) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (x < this.xJ - this.Aau || x > this.xM + this.Aau) {
            ab.d("MicroMsg.SmileyPanelScrollView", "over x :%d mLeft:%d mRight:%d ", Integer.valueOf(x), Integer.valueOf(this.xJ), Integer.valueOf(this.xM));
            if (action == 0) {
        ...
        if (i == 0) {
            ...
            if (this.AaB) {
                x = (x - this.xJ) / (this.Aay / (this.Aaq - 1));
            } else {
                x = ((x - this.xJ) + this.Aau) / (this.Aaw + this.Aau);
            }
            if (x > this.Aaq - 1) {
                x = this.Aaq - 1;
            }
