...
public final class b extends o {
    ...
    public final boolean[] bj(String str) {
        ...
        if (str.length() < 2) {
            ...
            boolean a = a.a(bAk, toUpperCase);
            boolean a2 = a.a(bAk, toUpperCase2);
            boolean a3 = a.a(bAl, toUpperCase);
            boolean a4 = a.a(bAl, toUpperCase2);
        ...
        while (i2 < str.length()) {
            ...
            int i6 = 0;
            while (i6 < a.bAh.length) {
                if (toUpperCase3 == a.bAh[i6]) {
                    i3 = a.bAi[i6];
                    i4 = 0;
                    z = true;
                    i6 = i;
