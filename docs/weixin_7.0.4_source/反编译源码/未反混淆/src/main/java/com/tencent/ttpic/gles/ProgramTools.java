    ...
    public static int createProgram(String str, String str2) {
        ...
        if (iArr[0] == 0) {
            ...
            if (GLConfig.DEBUG) {
                ...
                LogUtils.e(TAG, "vertex shader compile,failed:" + str.substring(length));
                LogUtils.e(TAG, glGetShaderInfoLog);
            }
        ...
        if (iArr[0] == 0) {
            ...
            if (GLConfig.DEBUG) {
                ...
                LogUtils.e(TAG, "fragment shader compile,failed:" + str2.substring(length));
                LogUtils.e(TAG, glGetShaderInfoLog2);
            }
            AppMethodBeat.o(50022);
            return 0;
        }
        ...
        if (iArr[0] == 0) {
            ...
            if (GLConfig.DEBUG) {
                LogUtils.e(TAG, "link program,failed:" + GLES20.glGetProgramInfoLog(length));
            }
            AppMethodBeat.o(50022);
            return 0;
        }
