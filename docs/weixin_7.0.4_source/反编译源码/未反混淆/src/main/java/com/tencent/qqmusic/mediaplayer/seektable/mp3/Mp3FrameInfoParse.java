...
class Mp3FrameInfoParse {
    ...
    static {
        r0 = new int[2][][];
        r0[0] = new int[][]{new int[]{0, 32, 64, 96, 128, 160, az.CTRL_INDEX, 224, 256, d.MIC_PTU_YOUJIALI, 320, com.tencent.mm.plugin.appbrand.jsapi.nfc.d.CTRL_INDEX, 384, 416, FileUtils.S_IRWXU}, new int[]{0, 32, 48, 56, 64, 80, 96, 112, 128, 160, az.CTRL_INDEX, 224, 256, 320, 384}, new int[]{0, 32, 40, 48, 56, 64, 80, 96, 112, 128, 160, az.CTRL_INDEX, 224, 256, 320}};
        r0[1] = new int[][]{new int[]{0, 32, 48, 56, 64, 80, 96, 112, 128, 144, 160, ErrorCode.NEEDDOWNLOAD_FALSE_6, az.CTRL_INDEX, 224, 256}, new int[]{0, 8, 16, 24, 32, 40, 48, 56, 64, 80, 96, 112, 128, 144, 160}, new int[]{0, 8, 16, 24, 32, 40, 48, 56, 64, 80, 96, 112, 128, 144, 160}};
        BitrateTable = r0;
    }
    ...
    private static void skipId3v2(TrackPositionDataSource trackPositionDataSource, byte[] bArr, Mp3Info mp3Info) {
        ...
        if (bArr[0] == (byte) 73 && bArr[1] == (byte) 68 && bArr[2] == (byte) 51) {
            int i;
            int i2 = ((((bArr[6] & d.MIC_SketchMark) << 21) + ((bArr[7] & d.MIC_SketchMark) << 14)) + ((bArr[8] & d.MIC_SketchMark) << 7)) + (bArr[9] & d.MIC_SketchMark);
            if ((bArr[5] & 16) != 0) {
                i = i2 + 20;
                i2 = 1;
            } else {
