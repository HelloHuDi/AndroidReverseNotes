...
public final class fl extends btd {
    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.vHt != null) {
                aVar.iy(4, this.vHt.computeSize());
                this.vHt.writeFields(aVar);
            }
            if (this.vHu != null) {
                aVar.e(5, this.vHu);
            }
            ...
            if (this.vHt != null) {
                ix += e.a.a.a.ix(4, this.vHt.computeSize());
            }
            if (this.vHu != null) {
                ix += e.a.a.b.b.a.f(5, this.vHu);
            }
            AppMethodBeat.o(48774);
            return ix;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        flVar.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(48774);
                    return 0;
                case 2:
                    flVar.kCl = aVar3.BTU.vd();
                    AppMethodBeat.o(48774);
                    return 0;
                case 3:
                    flVar.kCm = aVar3.BTU.readString();
                    AppMethodBeat.o(48774);
                    return 0;
                case 4:
                    Vh = aVar3.Vh(intValue);
                    ...
                    return 0;
                case 5:
                    flVar.vHu = aVar3.BTU.readString();
                    AppMethodBeat.o(48774);
                    return 0;
                default:
                    AppMethodBeat.o(48774);
