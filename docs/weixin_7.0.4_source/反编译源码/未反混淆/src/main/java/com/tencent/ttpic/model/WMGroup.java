...
public class WMGroup {
    ...
    public void init() {
        ...
        this.mCopyFilter.addParam(new b("ditheringOffset", 0.0f, 0.0f));
        this.mCopyFilter.addParam(new i("texNeedTransform", 1));
        this.mCopyFilter.addParam(new b("canvasSize", 0.0f, 0.0f));
        this.mCopyFilter.addParam(new b("texAnchor", 0.0f, 0.0f));
        this.mCopyFilter.addParam(new f("texScale", 1.0f));
        this.mCopyFilter.addParam(new d("texRotate", 0.0f, 0.0f, 0.0f));
        this.mCopyFilter.addParam(new f("positionRotate", 0.0f));
