...
public class PullDownListView extends ListView implements OnItemClickListener, OnItemLongClickListener, OnItemSelectedListener {
    ...
    public PullDownListView(Context context, AttributeSet attributeSet) {
        ...
        ak.hy(context);
        this.iev = ak.hy(context).y;
        this.iVt = (Vibrator) getContext().getSystemService("vibrator");
        post(new Runnable() {
            public final void run() {
                AppMethodBeat.i(112725);
                ai.d("MicroMsg.PullDownListView", "mThis.getLeft()=%s, mThis.getTop()=%s, mThis.getRight()=%s, mThis.getBottom()=%s", Integer.valueOf(PullDownListView.this.zRo.getLeft()), Integer.valueOf(PullDownListView.this.zRo.getTop()), Integer.valueOf(PullDownListView.this.zRo.getRight()), Integer.valueOf(PullDownListView.this.zRo.getBottom()));
    ...
    public void setNavigationBarHeight(int i) {
        ...
        ai.i("MicroMsg.PullDownListView", "setNavigationBarHeight=%s", Integer.valueOf(i));
        this.zRq = i;
    ...
    public void onFinishInflate() {
        ...
        ai.d("MicroMsg.PullDownListView", "onFinishInflate %s %s %s %s", Integer.valueOf(this.zRo.getLeft()), Integer.valueOf(this.zRo.getTop()), Integer.valueOf(this.zRo.getRight()), Integer.valueOf(this.zRo.getBottom()));
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        ai.d("MicroMsg.PullDownListView", "dancy test onTouchEvent, supportOverscroll:%s, scrollY:%s", Boolean.valueOf(this.zRi), Integer.valueOf(getScrollY()));
        ...
        boolean z2;
        int Qm;
        ai.d("MicroMsg.PullDownListView", "onTouchEvent %s", Integer.valueOf(motionEvent.getActionMasked()));
        float y;
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case 1:
                ...
                if (findPointerIndex != -1) {
                    ...
                    ai.d("MicroMsg.PullDownListView", "dancy test action up, mDeltaY:%s, closeLimitPx:%s, bottom:%s, mPullDownDuration%s", Integer.valueOf(this.yI), Integer.valueOf(dLa()), Integer.valueOf(this.zRo.getBottom()), Long.valueOf(this.zRM));
                    if (dLc() && this.zRr != null && !this.zRz && this.zRn && !this.zRK) {
                        ai.d("MicroMsg.PullDownListView", "dancy test action up, deltaOverScrollY:%s, translateBaseY:%s", Integer.valueOf(this.zRI), Float.valueOf(this.zRD));
                        ...
                        if (z2) {
                            ...
                            z(this.yI, findPointerIndex, T(motionEvent));
                        } else {
                            if (((float) this.zRI) - this.zRD < 0.0f) {
                                z2 = true;
                            } else {
                            ...
                            if (z2) {
                                ...
                                z(this.yI, findPointerIndex, false);
                            }
                        }
                    } else if (!dLc()) {
                        this.hOy = false;
            ...
            case 2:
                ...
                if (findPointerIndex2 != -1) {
                    ...
                    if (findPointerIndex > 0 && this.isVisible) {
                        ...
                        if (!this.zRK) {
                            ai.d("MicroMsg.PullDownListView", "rawY:%s, rawX:%s, indexY:%s, indexX:%s", Float.valueOf(motionEvent.getRawY()), Float.valueOf(motionEvent.getRawX()), Float.valueOf(motionEvent.getY(findPointerIndex2)), Float.valueOf(motionEvent.getX(findPointerIndex2)));
                            ai.d("MicroMsg.PullDownListView", "move deltaY:%s, isAnima:%s, mDeltaY:%s, mIsIgnoreCallBack:%s translateBaseY:%s", Integer.valueOf((int) (this.mLastMotionY - this.zRx)), Boolean.valueOf(this.zRz), Integer.valueOf(this.yI), Boolean.valueOf(this.zRs), Float.valueOf(this.zRD));
                            if (!(this.zRs || this.zRz)) {
                                if (this.mRect.isEmpty()) {
                                    this.zRC = getTranslationY();
                                    this.mRect.set(this.zRo.getLeft(), this.zRo.getTop(), this.zRo.getRight(), this.zRo.getBottom());
                                    ai.d("MicroMsg.PullDownListView", "mRect.isEmpty() %s %s %s %s", Integer.valueOf(this.zRo.getLeft()), Integer.valueOf(this.zRo.getTop()), Integer.valueOf(this.zRo.getRight()), Integer.valueOf(this.zRo.getBottom()));
                                }
                                ai.d("MicroMsg.PullDownListView", "eventIndex:%s, ev.getY():%s, y_down:%s, ev.getY()-y_down:%s", Integer.valueOf(findPointerIndex2), Float.valueOf(motionEvent.getY(findPointerIndex2)), Float.valueOf(this.aKN), Float.valueOf(motionEvent.getY(findPointerIndex2) - this.aKN));
                                this.zRI += (int) (((float) ((int) (this.zRx - this.mLastMotionY))) / 2.0f);
                                this.yI = Math.max(0, this.zRI);
                                ai.d("MicroMsg.PullDownListView", "top %s, bottom:%s, mDeltaY %s, deltaOverScrollY:%s", Integer.valueOf(this.zRo.getTop()), Integer.valueOf(this.zRo.getBottom()), Integer.valueOf(this.yI), Integer.valueOf(this.zRI));
                                if (Math.abs(this.zRI) > 50) {
                                    ...
                                    ai.d("MicroMsg.PullDownListView", "OverScroll top %s, mIsIgnoreCallBack:%s, isVisible:%s", Integer.valueOf(this.mRect.top + this.yI), Boolean.valueOf(this.zRs), Boolean.valueOf(this.isVisible));
                                    z = true;
                                } else {
                                    z = false;
                                }
                                this.zRo.setTranslationY((float) this.yI);
                                MarginLayoutParams marginLayoutParams;
                                if (this.isVisible) {
                                    Qm = Qm(Math.max(this.yI - ((int) this.zRD), 0));
                                    if (this.zRw != null) {
                                        ...
                                        ai.d("MicroMsg.PullDownListView", "openingCoordinationView params.bottomMargin:%s", Integer.valueOf(marginLayoutParams.bottomMargin));
                                    ...
                                    Qm = Qm(Math.max(((int) this.zRD) - this.yI, 0));
                                    if (this.zRw != null) {
                                        marginLayoutParams = (MarginLayoutParams) this.zRw.getLayoutParams();
                                        marginLayoutParams.topMargin = Math.min(0, Math.max(this.zRE, -Qm));
                                        ai.d("MicroMsg.PullDownListView", "closingCoordinationView params.bottomMargin:%s", Integer.valueOf(marginLayoutParams.bottomMargin));
                                        this.zRw.setLayoutParams(marginLayoutParams);
                                    }
                                    if (this.zRr != null) {
                                ...
                                ai.d("MicroMsg.PullDownListView", "mThis.layout %s %s %s %s", Integer.valueOf(this.zRo.getLeft()), Integer.valueOf(this.zRo.getTop()), Integer.valueOf(this.zRo.getRight()), Integer.valueOf(this.zRo.getBottom()));
        ...
        z = false;
        ai.d("MicroMsg.PullDownListView", "consumed: %b", Boolean.valueOf(z));
        if (z) {
        ...
        try {
            ai.d("MicroMsg.PullDownListView", "super.onTouchEvent(): %b", Boolean.valueOf(super.onTouchEvent(motionEvent)));
            if (this.zRr != null && getChildCount() > 0) {
                ai.d("MicroMsg.PullDownListView", "scrolled %s", Integer.valueOf(getChildAt(0).getTop()));
                this.zRr.AW(Qm);
            }
            AppMethodBeat.o(112736);
            return z2;
        } catch (Exception e) {
            ai.printErrStackTrace("MicroMsg.PullDownListView", e, "%b, %d", Boolean.valueOf(z), Integer.valueOf(r4));
            AppMethodBeat.o(112736);
            return true;
        }
    }
    ...
    private void z(final int i, final int i2, final boolean z) {
        ...
        ai.i("MicroMsg.PullDownListView", "story_cat animation: %s %s %s %s %s %s %s %s start:%s, end:%s, openLimitPx():%s, closeLimitPx():%s, isMute:%s", Integer.valueOf(this.mRect.left), Integer.valueOf(this.mRect.top), Integer.valueOf(this.mRect.right), Integer.valueOf(this.mRect.bottom), Integer.valueOf(getLeft()), Integer.valueOf(getTop()), Integer.valueOf(getRight()), Integer.valueOf(getBottom()), Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(aOX()), Integer.valueOf(dLa()), Boolean.valueOf(z));
        AnimatorSet animatorSet = new AnimatorSet();
        ...
        if (this.zRw != null) {
            if (i2 >= getBottom()) {
                arrayList.add(hB(((MarginLayoutParams) this.zRw.getLayoutParams()).topMargin, 0));
            } else {
                arrayList.add(hB(((MarginLayoutParams) this.zRw.getLayoutParams()).topMargin, this.zRE));
            }
        }
        animatorSet.addListener(new AnimatorListenerAdapter() {
            public final void onAnimationStart(Animator animator) {
                AppMethodBeat.i(112728);
                ai.i("MicroMsg.PullDownListView", "onAnimationStart start:%s, openLimitPx():%s, closeLimitPx():%s", Integer.valueOf(i), Integer.valueOf(PullDownListView.e(PullDownListView.this)), Integer.valueOf(PullDownListView.f(PullDownListView.this)));
                ...
                if (PullDownListView.this.zRr != null && i > PullDownListView.e(PullDownListView.this) && i < PullDownListView.f(PullDownListView.this)) {
            ...
            public final void onAnimationEnd(Animator animator) {
                ...
                ai.i("MicroMsg.PullDownListView", "onAnimationEnd start:%s, openLimitPx():%s, closeLimitPx():%s", Integer.valueOf(i), Integer.valueOf(PullDownListView.e(PullDownListView.this)), Integer.valueOf(PullDownListView.f(PullDownListView.this)));
                ...
                if (PullDownListView.this.zRr != null && i > PullDownListView.e(PullDownListView.this) && i < PullDownListView.f(PullDownListView.this)) {
                    ...
                    PullDownListView.this.zRr.jM(z);
                }
                AppMethodBeat.o(112729);
            }
        });
    ...
    private void bBu() {
        ...
        this.yI = 0;
        ai.d("MicroMsg.PullDownListView", "startAnimation %s %s %s %s", Integer.valueOf(this.zRo.getLeft()), Integer.valueOf(this.zRo.getTop()), Integer.valueOf(this.zRo.getRight()), Integer.valueOf(this.zRo.getBottom()));
    ...
    private int Qm(int i) {
        ...
        ai.d("MicroMsg.PullDownListView", "offset:%s,  ((float) offset / screenHeight):%s,  Math.abs(mCoordinationAnimThreshold):%s,  result:%s", Integer.valueOf(i), Float.valueOf(((float) i) / ((float) this.iev)), Integer.valueOf(Math.abs(this.zRE)), Integer.valueOf((int) Math.abs((((float) i) / ((float) this.iev)) * ((float) this.zRE))));
    ...
    private ValueAnimator hB(int i, int i2) {
        AppMethodBeat.i(112746);
        ai.d("MicroMsg.PullDownListView", "startStoryGalleryOpenAnim start:%s, end:%s", Integer.valueOf(i), Integer.valueOf(i2));
