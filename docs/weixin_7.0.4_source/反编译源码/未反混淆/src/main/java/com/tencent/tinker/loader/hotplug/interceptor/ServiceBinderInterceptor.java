...
public class ServiceBinderInterceptor extends Interceptor<IBinder> {
    ...
    static class FakeClientBinderHandler implements InvocationHandler {
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) {
            ...
            IInterface iInterface = (IInterface) ShareReflectUtil.c(Class.forName(interfaceDescriptor), "asInterface", IBinder.class).invoke(null, new Object[]{this.ADG});
            return ServiceBinderInterceptor.a(ServiceBinderInterceptor.aK(iInterface.getClass()), new FakeInterfaceHandler(iInterface, (IBinder) obj, this.ADA));
        }
    }
    ...
    public final /* synthetic */ Object df(Object obj) {
        ...
        if (iBinder == null) {
            ...
            return (IBinder) a(aK(iBinder.getClass()), new FakeClientBinderHandler(iBinder, this.ADA));
        }
    }
        ...
        synchronized (ServiceBinderInterceptor.class) {
            if (ADB == null) {
                try {
                    ...
                    ADB = cls;
                    ADC = ShareReflectUtil.d(cls, "sCache");
                    ADE = ShareReflectUtil.c(ADB, "getService", String.class);
                } catch (Throwable th) {
                }
            }
        }
    ...
    private static Class<?>[] aK(Class<?> cls) {
        if (cls == null) {
            return null;
        }
