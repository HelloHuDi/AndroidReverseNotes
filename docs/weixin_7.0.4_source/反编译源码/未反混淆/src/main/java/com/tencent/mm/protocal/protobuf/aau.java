    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            switch (((Integer) objArr[2]).intValue()) {
                case 1:
                    aau.fiG = aVar3.BTU.readString();
                    AppMethodBeat.o(51393);
                    return 0;
                case 2:
                    aau.wid = aVar3.BTU.vd();
                    AppMethodBeat.o(51393);
                    return 0;
                case 3:
                    aau.fiJ = aVar3.BTU.readString();
                    AppMethodBeat.o(51393);
                    return 0;
                case 4:
                    aau.fiK = aVar3.BTU.readString();
                    AppMethodBeat.o(51393);
                    return 0;
                case 5:
                    aau.fiI = aVar3.BTU.readString();
                    AppMethodBeat.o(51393);
                    return 0;
                case 6:
                    aau.fiL = aVar3.BTU.readString();
                    AppMethodBeat.o(51393);
                    return 0;
                case 7:
                    aau.fiM = aVar3.BTU.readString();
                    AppMethodBeat.o(51393);
                    return 0;
                case 8:
                    aau.fiN = aVar3.BTU.readString();
                    AppMethodBeat.o(51393);
                    return 0;
                default:
                    AppMethodBeat.o(51393);
