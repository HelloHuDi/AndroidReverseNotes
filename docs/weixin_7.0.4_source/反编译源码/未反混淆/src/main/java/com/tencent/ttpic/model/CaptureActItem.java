...
public class CaptureActItem extends FrameSourceItem {
    ...
    public CaptureActItem(List<ExpressionItem> list, String str, String str2, BaseFilter baseFilter) {
        ...
        this.copyFrames = new h[list.size()];
    ...
    public void update(h hVar, long j, List<List<PointF>> list, List<float[]> list2, int i) {
        ...
        if (captureIndex >= 0) {
            ...
            this.copyFilter.RenderProcess(hVar.texture[0], hVar.width, hVar.height, -1, 0.0d, this.copyFrames[captureIndex]);
