...
public class ParticleCloud {
    ...
    public Pair<Particle, ParticleExpressionBundle> getAdvanceExpression(double d) {
        ...
        while (particle != null) {
            if (particle.a[2] <= 0.0d || particle.a[2] + particle.birth > d) {
    ...
    private void initParticle(Particle particle, double d) {
        ...
        particle.a[2] = (double) ((long) this.mAttrValue[2]);
        particle.a[0] = this.mAttrValue[0];
        particle.a[1] = this.mAttrValue[1];
        particle.a[7] = this.mAttrValue[7];
        particle.a[8] = this.mAttrValue[8];
        particle.a[9] = this.mAttrValue[9];
        particle.a[3] = this.mAttrValue[3];
        particle.a[4] = this.mAttrValue[4];
        particle.a[5] = this.mAttrValue[5];
        particle.a[6] = this.mAttrValue[6];
        advanceParticle(particle, d);
    ...
    private void optimized() {
        ...
        this.mAttrExpressions[3] = ((Attribute) this.mAttrs.get(AttributeConst.R)).expression();
        this.mAttrExpressions[4] = ((Attribute) this.mAttrs.get(AttributeConst.G)).expression();
        this.mAttrExpressions[5] = ((Attribute) this.mAttrs.get(AttributeConst.B)).expression();
        this.mAttrExpressions[6] = ((Attribute) this.mAttrs.get(AttributeConst.A)).expression();
        this.mAttrExpressions[7] = ((Attribute) this.mAttrs.get(AttributeConst.X)).expression();
        this.mAttrExpressions[8] = ((Attribute) this.mAttrs.get(AttributeConst.Y)).expression();
        this.mAttrExpressions[9] = ((Attribute) this.mAttrs.get(AttributeConst.Z)).expression();
        ...
        this.mAttrValue[3] = ((Attribute) this.mAttrs.get(AttributeConst.R)).value();
        this.mAttrValue[4] = ((Attribute) this.mAttrs.get(AttributeConst.G)).value();
        this.mAttrValue[5] = ((Attribute) this.mAttrs.get(AttributeConst.B)).value();
        this.mAttrValue[6] = ((Attribute) this.mAttrs.get(AttributeConst.A)).value();
        this.mAttrValue[7] = ((Attribute) this.mAttrs.get(AttributeConst.X)).value();
        this.mAttrValue[8] = ((Attribute) this.mAttrs.get(AttributeConst.Y)).value();
        this.mAttrValue[9] = ((Attribute) this.mAttrs.get(AttributeConst.Z)).value();
