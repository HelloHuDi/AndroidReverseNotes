...
public final class bmy extends bsr {
    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            int bs = ((ix + e.a.a.b.b.a.bs(3, this.wII)) + e.a.a.a.c(4, 1, this.wIJ)) + e.a.a.b.b.a.bs(5, this.wcA);
            AppMethodBeat.o(10229);
            return bs;
        } else if (i == 2) {
            bArr = (byte[]) objArr[0];
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        bmy.BaseRequest = hlVar;
                    }
                    AppMethodBeat.o(10229);
                    return 0;
                case 2:
                    bmy.wIH = aVar3.BTU.readString();
                    AppMethodBeat.o(10229);
                    return 0;
                case 3:
                    bmy.wII = aVar3.BTU.vd();
                    AppMethodBeat.o(10229);
                    return 0;
                case 4:
                    bmy.wIJ.add(aVar3.BTU.readString());
                    AppMethodBeat.o(10229);
                    return 0;
                case 5:
                    bmy.wcA = aVar3.BTU.vd();
                    AppMethodBeat.o(10229);
                    return 0;
                default:
                    AppMethodBeat.o(10229);
