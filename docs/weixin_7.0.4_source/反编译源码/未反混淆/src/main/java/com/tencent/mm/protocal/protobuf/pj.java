...
public final class pj extends btd {
    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            int bs = ix + e.a.a.b.b.a.bs(5, this.vWi);
            AppMethodBeat.o(56757);
            return bs;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        pjVar.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.o(56757);
                    return 0;
                case 2:
                    pjVar.kCl = aVar3.BTU.vd();
                    AppMethodBeat.o(56757);
                    return 0;
                case 3:
                    pjVar.kCm = aVar3.BTU.readString();
                    AppMethodBeat.o(56757);
                    return 0;
                case 4:
                    pjVar.vWj = aVar3.BTU.emu();
                    AppMethodBeat.o(56757);
                    return 0;
                case 5:
                    pjVar.vWi = aVar3.BTU.vd();
                    AppMethodBeat.o(56757);
                    return 0;
                default:
                    AppMethodBeat.o(56757);
