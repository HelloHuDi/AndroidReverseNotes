...
public class GetEmotionDetailRequest extends bsr {
    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            int bs = (ix + e.a.a.b.b.a.bs(3, this.Scene)) + e.a.a.b.b.a.bs(4, this.Version);
            AppMethodBeat.o(62558);
            return bs;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        getEmotionDetailRequest.BaseRequest = hlVar;
                    }
                    AppMethodBeat.o(62558);
                    return 0;
                case 2:
                    getEmotionDetailRequest.ProductID = aVar3.BTU.readString();
                    AppMethodBeat.o(62558);
                    return 0;
                case 3:
                    getEmotionDetailRequest.Scene = aVar3.BTU.vd();
                    AppMethodBeat.o(62558);
                    return 0;
                case 4:
                    getEmotionDetailRequest.Version = aVar3.BTU.vd();
                    AppMethodBeat.o(62558);
                    return 0;
                default:
                    AppMethodBeat.o(62558);
