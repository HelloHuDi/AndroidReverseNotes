...
public final class bo extends btd {
    public boolean nct;
    public int ncu;
    public LinkedList<e> ncx = new LinkedList();
    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            int c = ((ix + e.a.a.a.c(2, 8, this.ncx)) + (e.a.a.b.b.a.fv(3) + 1)) + e.a.a.b.b.a.bs(4, this.ncu);
            AppMethodBeat.o(111618);
            return c;
        } else if (i == 2) {
            bArr = (byte[]) objArr[0];
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    return 0;
                case 3:
                    boVar.nct = aVar3.BTU.ehX();
                    AppMethodBeat.o(111618);
                    return 0;
                case 4:
                    boVar.ncu = aVar3.BTU.vd();
                    AppMethodBeat.o(111618);
                    return 0;
                default:
                    AppMethodBeat.o(111618);
