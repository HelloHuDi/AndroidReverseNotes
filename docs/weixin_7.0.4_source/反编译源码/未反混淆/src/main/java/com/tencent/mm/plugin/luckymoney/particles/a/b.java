...
public abstract class b {
    ...
    public abstract void a(Canvas canvas, Matrix matrix, Paint paint, float f, float f2, float f3, float f4);
    ...
    public final void i(Rect rect) {
        ...
        if (this.oaJ == 0.0f) {
            ...
            this.oaJ = Math.min((float) a(this.oaA, this.oaC, this.nZU, this.oaE, this.nZY, rect.left - getWidth(), rect.right), this.oaJ);
            this.oaJ = Math.min((float) a(this.oaB, this.oaD, this.nZW, this.oaF, this.oaa, rect.top - getHeight(), rect.bottom), this.oaJ);
        }
    ...
    public final void a(Canvas canvas, float f, float f2, float f3, float f4) {
        ...
        this.aKk.reset();
        this.oay.setAlpha(this.alpha);
        a(canvas, this.aKk, this.oay, f, f2, f3, f4);
        canvas.restore();
    }
}
