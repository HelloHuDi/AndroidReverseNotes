    ...
    public boolean playRing(int i, int i2, Uri uri, String str, boolean z, int i3, boolean z2, boolean z3, int i4) {
        ...
        if (z || i3 > 0) {
            ...
            switch (i) {
                case 0:
                    if (QLog.isColorLevel()) {
                        QLog.e("TRAE", 2, "TraeMediaPlay | rsid:".concat(String.valueOf(i2)));
                    }
                    ...
                    if (QLog.isColorLevel()) {
                        QLog.e("TRAE", 2, "TraeMediaPlay | afd == null rsid:".concat(String.valueOf(i2)));
                    }
                    this.mMediaPlay.release();
                    this.mMediaPlay = null;
                    AppMethodBeat.o(65619);
                ...
                default:
                    if (QLog.isColorLevel()) {
                        QLog.e("TRAE", 2, "TraeMediaPlay | err datasource:".concat(String.valueOf(i)));
                    }
                    this.mMediaPlay.release();
                    this.mMediaPlay = null;
                    break;
