...
public class MMSingelLinePanel extends MMTagPanel {
    ...
    public final void dzU() {
        ...
        this.ywY.setText("...");
        this.ywY.setTextColor(getResources().getColor(R.color.a61));
    ...
    public void onMeasure(int i, int i2) {
        ...
        if ($assertionsDisabled || MeasureSpec.getMode(i) != 0) {
            ...
            if (this.mSingleLine && this.ywY != null) {
                this.ywY.measure(MeasureSpec.makeMeasureSpec(size, j.INVALID_ID), makeMeasureSpec);
                this.ywZ = this.ywY.getMeasuredWidth();
                this.yxa = this.ywY.getMeasuredHeight();
                ab.d("MicroMsg.MMTagContactPanel", "mEllipsisWidth %d", Integer.valueOf(this.ywZ));
            }
            if (this.mSingleLine) {
                size -= this.ywZ;
            }
            ...
            if (this.mSingleLine) {
                ...
                getPaddingTop();
                getPaddingBottom();
            } else if (MeasureSpec.getMode(i2) == j.INVALID_ID && i4 + i5 < size2) {
                getPaddingTop();
                getPaddingBottom();
            }
