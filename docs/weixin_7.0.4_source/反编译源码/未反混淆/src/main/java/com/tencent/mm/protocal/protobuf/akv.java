            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        akv.BaseRequest = hlVar;
                    }
                    AppMethodBeat.o(89099);
                    return 0;
                case 2:
                    akv.offset = aVar3.BTU.vd();
                    AppMethodBeat.o(89099);
                    return 0;
                case 3:
                    akv.vKW = aVar3.BTU.vd();
                    AppMethodBeat.o(89099);
                    return 0;
                case 4:
                    akv.latitude = Double.longBitsToDouble(aVar3.BTU.eib());
                    AppMethodBeat.o(89099);
                    return 0;
                case 5:
                    akv.longitude = Double.longBitsToDouble(aVar3.BTU.eib());
                    AppMethodBeat.o(89099);
                    return 0;
                default:
                    AppMethodBeat.o(89099);
