...
public class TransformFilter extends VideoFilterBase {
    ...
    public void initParams() {
        ...
        addParam(new f("screenRatioX", 0.0f));
        addParam(new f("screenRatioY", 0.0f));
        addParam(new a("item", this.flatMesh));
        addParam(new f("faceRatio", 1.0f));
        addParam(new f("sin_roll", 0.0f));
        addParam(new f("cos_roll", 0.0f));
        addParam(new f("tan_yaw", 0.0f));
        addParam(new f("cos_yaw", 0.0f));
        addParam(new f("tan_pitch", 0.0f));
        addParam(new f("cos_pitch", 0.0f));
        for (int i = 0; i < 30; i++) {
        ...
        if (!(copyList == null || copyList.size() < 90 || BaseUtils.isEmpty(this.items))) {
            if (VideoFilterUtil.actionTriggered(list, this.stickerItems, set)) {
                ...
                while (true) {
                    ...
                    f = ((float) distortionItem.x) * cos;
                    float f5 = ((float) distortionItem.y) * cos2;
                ...
                addParam(new f("faceRatio", f3));
                addParam(new f("sin_roll", (float) Math.sin((double) atan2)));
                addParam(new f("cos_roll", (float) Math.cos((double) atan2)));
                addParam(new f("tan_yaw", (float) Math.tan((double) min)));
                addParam(new f("cos_yaw", (float) Math.cos((double) min)));
                addParam(new f("tan_pitch", (float) Math.tan((double) min2)));
                addParam(new f("cos_pitch", (float) Math.cos((double) min2)));
                addParam(new a("item", this.flatMesh));
    ...
    public void updateVideoSize(int i, int i2, double d) {
        ...
        this.screenRatioY = f;
        addParam(new f("screenRatioX", this.screenRatioX));
        addParam(new f("screenRatioY", this.screenRatioY));
