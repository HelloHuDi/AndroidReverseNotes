...
public class ParticleTemplate {
    public static final String ATTR_COLOR_A = String.format("%s", new Object[]{AttributeConst.A});
    public static final String ATTR_COLOR_B = String.format("%s", new Object[]{AttributeConst.B});
    public static final String ATTR_COLOR_G = String.format("%s", new Object[]{AttributeConst.G});
    public static final String ATTR_COLOR_R = String.format("%s", new Object[]{AttributeConst.R});
    ...
    public static final String ATTR_POS_X = String.format("%s", new Object[]{AttributeConst.X});
    public static final String ATTR_POS_Y = String.format("%s", new Object[]{AttributeConst.Y});
    public static final String ATTR_POS_Z = String.format("%s", new Object[]{AttributeConst.Z});
