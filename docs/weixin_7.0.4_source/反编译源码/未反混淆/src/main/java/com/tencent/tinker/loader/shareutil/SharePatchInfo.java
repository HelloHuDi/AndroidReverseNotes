...
public class SharePatchInfo {
    ...
    public static SharePatchInfo l(File file, File file2) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static SharePatchInfo av(File file) {
        Object e;
        Throwable th;
        String str = null;
        boolean z = false;
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        SharePatchFileUtil.ah(fileInputStream);
                        str4 = property;
                    } catch (IOException e2) {
                        IOException e3 = e2;
                        try {
        ...
        while (i < 2 && !z) {
            ...
            try {
                ...
                try {
                    ...
                    SharePatchFileUtil.ah(fileOutputStream);
                } catch (Exception e2) {
                    e = e2;
                    try {
