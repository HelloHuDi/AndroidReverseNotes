...
public final class g extends btd {
    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.vzT != null) {
                aVar.iy(6, this.vzT.computeSize());
            ...
            if (this.vzN != null) {
                ix += e.a.a.b.b.a.f(5, this.vzN);
            }
            if (this.vzT != null) {
                ix += e.a.a.a.ix(6, this.vzT.computeSize());
            }
            AppMethodBeat.o(56674);
            return ix;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    gVar.kCl = aVar3.BTU.vd();
                    AppMethodBeat.o(56674);
                    return 0;
                case 3:
                    gVar.kCm = aVar3.BTU.readString();
                    AppMethodBeat.o(56674);
                    return 0;
                case 4:
                    gVar.vzL = aVar3.BTU.readString();
                    AppMethodBeat.o(56674);
                    return 0;
                case 5:
                    gVar.vzN = aVar3.BTU.readString();
                    AppMethodBeat.o(56674);
                    return 0;
                case 6:
                    Vh = aVar3.Vh(intValue);
