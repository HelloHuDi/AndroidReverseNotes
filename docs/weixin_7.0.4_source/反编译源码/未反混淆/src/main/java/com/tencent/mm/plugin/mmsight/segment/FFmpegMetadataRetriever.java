...
public class FFmpegMetadataRetriever {
    ...
    public int getVideoWidth() {
        ...
        try {
            ...
            ab.e(TAG, "can not get video width %s", e.getMessage());
        }
    ...
    public int getVideoRotation() {
        ...
        try {
            ...
            ab.e(TAG, "can not get video rotation. %s", e.getMessage());
        }
    ...
    public int getVideoHeight() {
        ...
        try {
            ...
            ab.d(TAG, "video height %s rotate %s", extractMetadata, extractMetadata2);
            i = Integer.valueOf(extractMetadata).intValue();
        } catch (Exception e) {
            ab.e(TAG, "can not get video height %s", e.getMessage());
        }
