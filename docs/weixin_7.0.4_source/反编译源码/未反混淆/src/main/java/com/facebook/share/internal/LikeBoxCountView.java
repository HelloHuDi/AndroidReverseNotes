...
public class LikeBoxCountView extends FrameLayout {
    ...
    private void initialize(Context context) {
        ...
        this.caretHeight = getResources().getDimension(R.dimen.xl);
        this.caretWidth = getResources().getDimension(R.dimen.xm);
        this.borderRadius = getResources().getDimension(R.dimen.xj);
        this.borderPaint = new Paint();
        this.borderPaint.setColor(getResources().getColor(R.color.ky));
        this.borderPaint.setStrokeWidth(getResources().getDimension(R.dimen.xk));
    ...
    private void initializeLikeCountLabel(Context context) {
        ...
        this.likeCountLabel.setTextSize(0, getResources().getDimension(R.dimen.xo));
        this.likeCountLabel.setTextColor(getResources().getColor(R.color.kz));
        this.textPadding = getResources().getDimensionPixelSize(R.dimen.xn);
        this.additionalTextPadding = getResources().getDimensionPixelSize(R.dimen.xl);
