...
public final class h extends a {
    ...
    public final void d(RandomAccessFile randomAccessFile) {
        ...
        while (true) {
            ...
            if (readInt2 == a.aWT) {
                ...
                if (c.a(randomAccessFile, 4)) {
                    ...
                    if (randomAccessFile.read(bArr3, 0, 4) < 4) {
                        ...
                        read = c.readInt(bArr3, 0);
                        long j3 = 8 * ((long) read);
                        if (j3 > ((long) (readInt - 16)) || j3 <= 0) {
                            ab.w("MicroMsg.StblAtom", "stts error entryCount : ".concat(String.valueOf(read)));
                            j = -1;
                        } else {
                            int i4 = 0;
                            int i5 = 0;
                            ...
                            while (read2 >= 8) {
                                j4 += (long) read2;
                                int readInt3 = c.readInt(bArr3, 0);
                                int readInt4 = c.readInt(bArr3, 4);
                                read2 = 0;
                                i2 = i5;
                                while (read2 < readInt3) {
                                    g gVar = new g();
                                    gVar.gkq = (long) readInt4;
                                    this.gkn.add(gVar);
                                    i5 = i4 + readInt4;
                                    i2++;
                ...
                if (c.a(randomAccessFile, 4)) {
                    ...
                    if (randomAccessFile.read(bArr4, 0, 4) < 4) {
                        ...
                        read = c.readInt(bArr4, 0);
                        j2 = 12 * ((long) read);
                        if (j2 > ((long) (readInt - 16)) || j2 <= 0) {
                            ab.w("MicroMsg.StblAtom", "stsc error entryCount : ".concat(String.valueOf(read)));
                            j = -1;
                        } else {
                            ab.d("MicroMsg.StblAtom", "handle stsc entryCount : ".concat(String.valueOf(read)));
                            ...
                            while (readInt2 >= 12) {
                                j += (long) readInt2;
                                this.gkx[i3] = c.readInt(bArr4, 0);
                                this.gky[i3] = c.readInt(bArr4, 4);
                                i3++;
                                if (j >= j2) {
                ...
                if (c.a(randomAccessFile, 4)) {
                    ...
                    if (randomAccessFile.read(bArr2, 0, 4) < 4) {
                        ...
                        read = c.readInt(bArr2, 0);
                        j2 = 4 * ((long) read);
                        if (j2 <= 0 || j2 > ((long) (readInt - 16))) {
                            ab.w("MicroMsg.StblAtom", "stco error entryCount : ".concat(String.valueOf(read)));
                            j = -1;
                        } else {
                ...
                if (c.a(randomAccessFile, 4)) {
                    ...
                    if (randomAccessFile.read(bArr5, 0, 4) < 4) {
                        ...
                        read = c.readInt(bArr5, 0);
                        if (read > 0) {
                            this.aZD = new int[1];
                            this.aZD[0] = read;
                            ab.i("MicroMsg.StblAtom", "all sample size is the same. size : ".concat(String.valueOf(read)));
                            j = 8;
                ...
                if (c.a(randomAccessFile, 4)) {
                    ...
                    if (randomAccessFile.read(bArr6, 0, 4) < 4) {
                        ...
                        read = c.readInt(bArr6, 0);
                        j2 = 4 * ((long) read);
                        if (j2 <= 0 || j2 > ((long) (readInt - 16))) {
                            ab.w("MicroMsg.StblAtom", "stss error entryCount : ".concat(String.valueOf(read)));
                            j = -1;
                        } else {
            ...
            if (c.a(randomAccessFile, (((long) readInt) - j) - ((long) i))) {
    ...
    private boolean aoa() {
        ...
        long j2 = 0;
        j = 0;
        for (g gVar2 : this.gkn) {
            gVar2.size = this.aZD[i5];
            length = mM(i5);
            if (length != i6) {
                gVar2.start = mN(length);
            } else {
                gVar2.start = j;
            }
            j = gVar2.start + ((long) gVar2.size);
            j2 += gVar2.gkq;
            gVar2.gkq = (long) ((((((float) j2) * 1.0f) / ((float) this.gki)) * 1000.0f) * 1000.0f);
            gVar2.id = i5;
            i5++;
            i6 = length;
        }
        ...
        while (true) {
            ...
            if (length < this.gkB.length) {
                gVar2 = (g) this.gkn.get(this.gkB[length] - 1);
                gVar2.gkr = 1;
                ab.d("MicroMsg.StblAtom", "stss key frame [%s %s]", r2.first, new Pair(Integer.valueOf(this.gkB[length] - 1), Long.valueOf(gVar2.gkq)).second);
                this.gko.add(r2);
                i = length + 1;
            } else {
