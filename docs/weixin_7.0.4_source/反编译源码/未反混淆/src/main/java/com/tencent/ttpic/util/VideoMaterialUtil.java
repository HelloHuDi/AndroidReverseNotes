...
public class VideoMaterialUtil {
    ...
    public static FilenameFilter mMp4Filter = new FilenameFilter() {
    ...
    public static FilenameFilter mPngFilter = new FilenameFilter() {
        public final boolean accept(File file, String str) {
    ...
    public static String getActionTipString(int i) {
        ...
        if (i == PTExpression.MOUTH_OPEN.value) {
            string = VideoGlobalContext.getContext().getString(R.string.g4d);
            AppMethodBeat.o(84144);
            return string;
        } else if (i == PTExpression.EYEBROWS_RAISE.value) {
            string = VideoGlobalContext.getContext().getString(R.string.g4e);
            AppMethodBeat.o(84144);
            return string;
        } else if (i == PTExpression.BLINK.value) {
            string = VideoGlobalContext.getContext().getString(R.string.g49);
            AppMethodBeat.o(84144);
            return string;
        } else if (i == PTExpression.HEAD_SHAKE.value) {
            string = VideoGlobalContext.getContext().getString(R.string.g4f);
            AppMethodBeat.o(84144);
            return string;
        } else if (i == PTExpression.KISS.value) {
            string = VideoGlobalContext.getContext().getString(R.string.g4b);
            AppMethodBeat.o(84144);
            return string;
        } else if (i == PTExpression.BLINK_LEFT_EYE.value) {
            string = VideoGlobalContext.getContext().getString(R.string.g4_);
            AppMethodBeat.o(84144);
            return string;
        } else if (i == PTExpression.BLINK_RIGHT_EYE.value) {
            string = VideoGlobalContext.getContext().getString(R.string.g4a);
            AppMethodBeat.o(84144);
            return string;
        } else if (i == PTExpression.HEAD_NOD.value) {
            string = VideoGlobalContext.getContext().getString(R.string.g4c);
            AppMethodBeat.o(84144);
            return string;
            ...
            string = VideoGlobalContext.getContext().getString(R.string.g4g);
            AppMethodBeat.o(84144);
            return string;
        } else {
            string = "";
        ...
        for (StickerItem stickerItem : videoMaterial.getItemList()) {
            ...
            if (stickerItem.wmGroupCopies != null) {
                for (WMGroup wMGroup : stickerItem.wmGroupCopies) {
                    wMGroup.setItemId(stickerItem.id);
    ...
    public static boolean isAudioTextTriggerType(int i) {
        return 300 <= i && i <= d.MIC_PTU_HONGKONG;
    }
    ...
    public static boolean isEmptyItem(StickerItem stickerItem) {
        ...
        if (stickerItem == null || TextUtils.isEmpty(stickerItem.id) || stickerItem.id.equals(NativeProtocol.WEB_DIALOG_ACTION) || stickerItem.id.equals(SlookAirButtonRecentMediaAdapter.AUDIO_TYPE)) {
    ...
    public static boolean isEmptyItem(FaceItem faceItem) {
        ...
        if (faceItem == null || ((TextUtils.isEmpty(faceItem.id) && TextUtils.isEmpty(faceItem.faceExchangeImage)) || ((!TextUtils.isEmpty(faceItem.id) && faceItem.id.equals(NativeProtocol.WEB_DIALOG_ACTION)) || (!TextUtils.isEmpty(faceItem.id) && faceItem.id.equals(SlookAirButtonRecentMediaAdapter.AUDIO_TYPE))))) {
