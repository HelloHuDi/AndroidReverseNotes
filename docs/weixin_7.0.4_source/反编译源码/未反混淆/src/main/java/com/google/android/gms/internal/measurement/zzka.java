...
public final class zzka extends zzhh {
    ...
    static boolean zzck(String str) {
        ...
        if (str == null || !str.matches("(\\+|-)?([0-9]+\\.?[0-9]*|[0-9]*\\.?[0-9]+)") || str.length() > d.MIC_PTU_DANNAI) {
            ...
            try {
                ...
                if (TextUtils.isEmpty(queryParameter) && TextUtils.isEmpty(queryParameter2) && TextUtils.isEmpty(queryParameter3) && TextUtils.isEmpty(queryParameter4)) {
                    ...
                    if (!TextUtils.isEmpty(queryParameter5)) {
                        bundle.putString(b.TERM, queryParameter5);
                    }
                    queryParameter5 = uri.getQueryParameter("utm_content");
                    if (!TextUtils.isEmpty(queryParameter5)) {
                        bundle.putString(b.CONTENT, queryParameter5);
                    }
                    queryParameter5 = uri.getQueryParameter(b.ACLID);
                    if (!TextUtils.isEmpty(queryParameter5)) {
                        bundle.putString(b.ACLID, queryParameter5);
                    }
                    queryParameter5 = uri.getQueryParameter(b.CP1);
                    if (!TextUtils.isEmpty(queryParameter5)) {
                        bundle.putString(b.CP1, queryParameter5);
                    }
