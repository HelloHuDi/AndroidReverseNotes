    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.BaseResponse == null) {
                ...
                bVar = new b("Not all required fields were included: RetText");
                AppMethodBeat.o(56988);
                throw bVar;
            } else {
                if (this.BaseResponse != null) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    return 0;
                case 3:
                    cgs.wxB = aVar3.BTU.vd();
                    AppMethodBeat.o(56988);
                    return 0;
                case 4:
                    cgs.wxC = aVar3.BTU.readString();
                    AppMethodBeat.o(56988);
                    return 0;
                case 5:
                    cgs.wxD = aVar3.BTU.vd();
                    AppMethodBeat.o(56988);
                    return 0;
                case 6:
                    cgs.wNe = aVar3.BTU.vd();
                    AppMethodBeat.o(56988);
                    return 0;
                case 7:
                    cgs.wNf = aVar3.BTU.readString();
                    AppMethodBeat.o(56988);
                    return 0;
                default:
                    AppMethodBeat.o(56988);
