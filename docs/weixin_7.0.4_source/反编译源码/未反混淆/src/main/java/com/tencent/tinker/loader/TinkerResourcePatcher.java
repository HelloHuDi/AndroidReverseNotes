...
class TinkerResourcePatcher {
    ...
    public static void jd(Context context) {
        ...
        ACK = ShareReflectUtil.d(context, cls2);
        try {
            cls = Class.forName("android.app.LoadedApk");
        } catch (ClassNotFoundException e) {
            cls = Class.forName("android.app.ActivityThread$PackageInfo");
        }
        ACQ = ShareReflectUtil.d(cls, "mResDir");
        ACR = ShareReflectUtil.d(cls2, "mPackages");
        if (VERSION.SDK_INT < 27) {
            ACS = ShareReflectUtil.d(cls2, "mResourcePackages");
        }
        Object assets = context.getAssets();
        ACM = ShareReflectUtil.b(assets, "addAssetPath", String.class);
        try {
            ACU = ShareReflectUtil.b(assets, "mStringBlocks");
            ACN = ShareReflectUtil.b(assets, "ensureStringBlocks", new Class[0]);
        } catch (Throwable th) {
        }
        ACL = (AssetManager) ShareReflectUtil.a(assets, new Class[0]).newInstance(new Object[0]);
        if (VERSION.SDK_INT >= 19) {
            ...
            try {
                ACJ = ((ArrayMap) ShareReflectUtil.d(cls2, "mActiveResources").get(invoke)).values();
            } catch (NoSuchFieldException e2) {
                ACJ = (Collection) ShareReflectUtil.d(cls2, "mResourceReferences").get(invoke);
            }
        } else {
            ACJ = ((HashMap) ShareReflectUtil.d(cls2, "mActiveResources").get(ACK)).values();
        }
        if (ACJ == null) {
        ...
        if (VERSION.SDK_INT >= 24) {
            try {
                ACP = ShareReflectUtil.b(resources, "mResourcesImpl");
            } catch (Throwable th2) {
                ACO = ShareReflectUtil.b(resources, "mAssets");
            }
        } else {
            ACO = ShareReflectUtil.b(resources, "mAssets");
        }
        try {
            ACT = ShareReflectUtil.d(ApplicationInfo.class, "publicSourceDir");
            ...
            for (WeakReference weakReference : ACJ) {
                ...
                if (resources != null) {
                    try {
                        ...
                        ShareReflectUtil.b(obj2, "mAssets").set(obj2, ACL);
                    }
                    h(resources);
