        ...
        if (i == 0) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    bjVar.nbs = aVar3.BTU.readString();
                    AppMethodBeat.o(111610);
                    return 0;
                case 3:
                    bjVar.nbX.add(aVar3.BTU.readString());
                    AppMethodBeat.o(111610);
                    return 0;
                case 4:
                    bjVar.guW = aVar3.BTU.readString();
                    AppMethodBeat.o(111610);
                    return 0;
                case 5:
                    Vh = aVar3.Vh(intValue);
                    ...
                    return 0;
                case 6:
                    bjVar.nbZ = aVar3.BTU.vd();
                    AppMethodBeat.o(111610);
                    return 0;
                case 7:
                    bjVar.nca = aVar3.BTU.ehX();
                    AppMethodBeat.o(111610);
                    return 0;
                case 8:
                    bjVar.nbt = aVar3.BTU.vd();
                    AppMethodBeat.o(111610);
                    return 0;
                default:
                    AppMethodBeat.o(111610);
