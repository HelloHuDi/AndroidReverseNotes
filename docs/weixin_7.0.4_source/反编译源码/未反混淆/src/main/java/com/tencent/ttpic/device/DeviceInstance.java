...
public class DeviceInstance {
    ...
    public SOC_CLASS getDeviceSocClass(String str) {
        ...
        LogUtils.d(TAG, "[getDeviceSocClass] + BEGIN, socInfo = ".concat(String.valueOf(str)));
        Object obj = "";
        if (!(TextUtils.isEmpty(str) || this.mSocMap == null || !this.mSocMap.containsKey(str))) {
            obj = (String) this.mSocMap.get(str);
        }
        LogUtils.d(TAG, "[getDeviceSocClass] scoreValue = ".concat(String.valueOf(obj)));
        ...
        if (!TextUtils.isEmpty(obj)) {
            ...
            LogUtils.d(TAG, "[getDeviceSocClass] + END, socClass = ".concat(String.valueOf(obj)));
    ...
    public boolean isXiaoMiDevice() {
        ...
        LogUtils.d(TAG, "[isXiaoMiDevice] + END, isXiaomi = ".concat(String.valueOf(z)));
    ...
    public boolean isViVoDevice() {
        ...
        LogUtils.d(TAG, "[isViVoDevice] + END, isViVo = ".concat(String.valueOf(z)));
    ...
    public boolean isMeiZuDevice() {
        ...
        LogUtils.d(TAG, "[isMeiZuDevice] + END, isMeizu = ".concat(String.valueOf(z)));
    ...
    private void showDeviceInfo() {
        ...
        LogUtils.d(TAG, "SDK_INT = " + VERSION.SDK_INT);
