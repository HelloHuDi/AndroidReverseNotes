            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        grVar.BaseRequest = hlVar;
                    }
                    AppMethodBeat.o(28330);
                    return 0;
                case 2:
                    grVar.vIN = aVar3.BTU.vd();
                    AppMethodBeat.o(28330);
                    return 0;
                case 3:
                    Vh = aVar3.Vh(intValue);
                    ...
                    return 0;
                case 4:
                    grVar.vIP = aVar3.BTU.readString();
                    AppMethodBeat.o(28330);
                    return 0;
                case 5:
                    grVar.vIQ = aVar3.BTU.readString();
                    AppMethodBeat.o(28330);
                    return 0;
                case 6:
                    grVar.Scene = aVar3.BTU.vd();
                    AppMethodBeat.o(28330);
                    return 0;
                case 7:
                    grVar.jBP = aVar3.BTU.ve();
                    AppMethodBeat.o(28330);
                    return 0;
                case 8:
                    grVar.vIR = aVar3.BTU.readString();
                    AppMethodBeat.o(28330);
                    return 0;
                default:
                    AppMethodBeat.o(28330);
