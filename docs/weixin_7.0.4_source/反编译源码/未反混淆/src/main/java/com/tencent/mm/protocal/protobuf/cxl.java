...
public final class cxl extends a {
    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            c = (e.a.a.a.c(1, 8, this.xsM) + 0) + e.a.a.b.b.a.bs(2, this.xsN);
            AppMethodBeat.o(115014);
            return c;
        } else if (i == 2) {
            bArr = (byte[]) objArr[0];
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        for (boolean z = true; z; z = cxk.populateBuilderWithField(aVar4, cxk, a.getNextFieldNumber(aVar4))) {
                        }
                        cxl.xsM.add(cxk);
                    }
                    AppMethodBeat.o(115014);
