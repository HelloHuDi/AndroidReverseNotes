...
public abstract class a {
    ...
    private boolean eZn;
    private b<? super Integer, y> eZo;
    private b<? super IntBuffer, y> eZp;
    ...
    public a(int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        asFloatBuffer = ByteBuffer.allocateDirect(com.tencent.mm.media.i.b.eZY.length * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
        j.o(asFloatBuffer, "ByteBuffer.allocateDirec…eOrder()).asFloatBuffer()");
        this.eZi = asFloatBuffer;
        if (this.eZa == 2) {
            com.tencent.mm.media.i.b.a aVar = com.tencent.mm.media.i.b.fad;
            this.eZj = com.tencent.mm.media.i.b.a.Vh();
            aVar = com.tencent.mm.media.i.b.fad;
            this.eZk = com.tencent.mm.media.i.b.a.Vi();
        } else if (this.eZa == 3) {
            Ve();
        }
    }
    ...
    public final void Vd() {
        ...
        if (this.scaleType == 1) {
            ...
            float f5;
            fArr = com.tencent.mm.media.i.b.eZZ;
        ...
        if (this.eZa == 3) {
            ...
            bVar = this.eZo;
            if (bVar != null) {
                bVar.am(Integer.valueOf(this.eZj));
            }
        }
        aVar = com.tencent.mm.media.i.b.fad;
        com.tencent.mm.media.i.b.a.Vj();
