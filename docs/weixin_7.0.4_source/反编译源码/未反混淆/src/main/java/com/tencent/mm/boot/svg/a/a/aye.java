...
public final class aye extends c {
    ...
    public final int a(int i, Object... objArr) {
        switch (i) {
            ...
            case 2:
                ...
                g = c.a(g, 1.0f, 0.0f, -85.0f, 0.0f, 1.0f, -1407.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
                g = c.a(g, 1.0f, 0.0f, 57.6f, 0.0f, 1.0f, 1391.04f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
                g = c.a(g, 1.0f, 0.0f, 28.8f, 0.0f, 1.0f, 17.28f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
