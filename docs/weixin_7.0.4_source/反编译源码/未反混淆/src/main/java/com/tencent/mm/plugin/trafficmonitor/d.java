...
public final class d {
    ...
    public final boolean a(List<c> list, long j, long j2, long j3) {
        ...
        while (true) {
            ...
            long min = Math.min(((c) list.get(i2)).endTime - ((c) list.get(i2)).startTime, j2);
            j4 += min;
            Object obj2 = ((c) list.get(i2)).sJY;
            if (obj2 == null) {
        ...
        double d = this.sKf;
        ab.i("Traf.TrafficModel", "compute Traffic realTraffic:%d , standardTraffic:%d, predictionTraffic:%d, realInterval:%d", Long.valueOf(j), Long.valueOf(this.sKb), Long.valueOf(this.sKe), Long.valueOf(j3));
        if (d > this.sKd) {
            AppMethodBeat.o(114778);
            return true;
        }
