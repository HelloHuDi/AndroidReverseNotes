...
public final class bxr extends bsr {
    ...
    public final int op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            int bs = (ix + e.a.a.b.b.a.bs(3, this.wXA)) + e.a.a.b.b.a.bs(4, this.wXB);
            AppMethodBeat.o(11808);
            return bs;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        bxr.BaseRequest = hlVar;
                    }
                    AppMethodBeat.o(11808);
                    return 0;
                case 2:
                    bxr.vNb = aVar3.BTU.readString();
                    AppMethodBeat.o(11808);
                    return 0;
                case 3:
                    bxr.wXA = aVar3.BTU.vd();
                    AppMethodBeat.o(11808);
                    return 0;
                case 4:
                    bxr.wXB = aVar3.BTU.vd();
                    AppMethodBeat.o(11808);
                    return 0;
                default:
                    AppMethodBeat.o(11808);
