...
public class ParticleFilter extends VideoFilterBase {
    ...
    private void updateParticle(ParticleEmitterParam particleEmitterParam) {
        ...
        if (this.particleEmitter.totalFinished()) {
            ...
            LogUtils.e(TAG, "AudioScaleFactor = ".concat(String.valueOf(audioScaleFactor)));
        ...
        if (activeParticleCount > 0) {
            ...
            addParam(new n("inputImageTexture2", this.particleEmitter.texture, 33986));
            addParam(new i("isPartical2", 1));
            ...
            setTexCords(fArr2);
            addParam(new i("u_opacityModifyRGB", this.particleEmitter.opacityModifyRGB ? 1 : 0));
            if (VideoMaterialUtil.isBodyDetectItem(this.item)) {
