...
public final class j {
    ...
    private static final int[] aSV = new int[]{32, 64, 96, 128, 160, az.CTRL_INDEX, 224, 256, d.MIC_PTU_YOUJIALI, 320, com.tencent.mm.plugin.appbrand.jsapi.nfc.d.CTRL_INDEX, 384, 416, FileUtils.S_IRWXU};
    private static final int[] aSW = new int[]{32, 48, 56, 64, 80, 96, 112, 128, 144, 160, ErrorCode.NEEDDOWNLOAD_FALSE_6, az.CTRL_INDEX, 224, 256};
    private static final int[] aSX = new int[]{32, 48, 56, 64, 80, 96, 112, 128, 160, az.CTRL_INDEX, 224, 256, 320, 384};
    private static final int[] aSY = new int[]{32, 40, 48, 56, 64, 80, 96, 112, 128, 160, az.CTRL_INDEX, 224, 256, 320};
