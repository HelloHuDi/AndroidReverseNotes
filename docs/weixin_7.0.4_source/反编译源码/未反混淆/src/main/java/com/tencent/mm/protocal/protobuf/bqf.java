...
public final class bqf extends a {
    public LinkedList<ue> wSy = new LinkedList();
    ...
    public final int op(int i, Object... objArr) {
        ...
        byte[] bArr;
        if (i == 0) {
            ((e.a.a.c.a) objArr[0]).e(1, 8, this.wSy);
            AppMethodBeat.o(124338);
            return 0;
        } else if (i == 1) {
            c = e.a.a.a.c(1, 8, this.wSy) + 0;
            AppMethodBeat.o(124338);
            return c;
        } else if (i == 2) {
            bArr = (byte[]) objArr[0];
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        for (boolean z = true; z; z = ueVar.populateBuilderWithField(aVar3, ueVar, a.getNextFieldNumber(aVar3))) {
                        }
                        bqf.wSy.add(ueVar);
                    }
                    AppMethodBeat.o(124338);
