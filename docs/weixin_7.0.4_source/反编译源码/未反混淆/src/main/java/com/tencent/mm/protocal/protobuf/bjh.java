            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        bjh.BaseRequest = hlVar;
                    }
                    AppMethodBeat.o(56895);
                    return 0;
                case 2:
                    bjh.fKh = aVar3.BTU.readString();
                    AppMethodBeat.o(56895);
                    return 0;
                case 3:
                    bjh.vYO = aVar3.BTU.readString();
                    AppMethodBeat.o(56895);
                    return 0;
                case 4:
                    bjh.vLo = aVar3.BTU.readString();
                    AppMethodBeat.o(56895);
                    return 0;
                case 5:
                    bjh.vYP = aVar3.BTU.readString();
                    AppMethodBeat.o(56895);
                    return 0;
                case 6:
                    bjh.vYQ = aVar3.BTU.readString();
                    AppMethodBeat.o(56895);
                    return 0;
                case 7:
                    bjh.vYR = aVar3.BTU.readString();
                    AppMethodBeat.o(56895);
                    return 0;
                case 8:
                    bjh.vXP = aVar3.BTU.readString();
                    AppMethodBeat.o(56895);
                    return 0;
                default:
                    AppMethodBeat.o(56895);
