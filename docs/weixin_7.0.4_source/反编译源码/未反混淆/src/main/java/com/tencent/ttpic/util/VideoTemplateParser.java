...
public class VideoTemplateParser {
    ...
    private static Comparator<Pair<Float, Integer>> mDivideValueComp = new Comparator<Pair<Float, Integer>>() {
    ...
    private static Comparator<Pair<Float, ? extends Object>> mDivideValueCompForObject = new Comparator<Pair<Float, ? extends Object>>() {
    ...
    private static Comparator<GridModel> mGridModelComparator = new Comparator<GridModel>() {
        public final int compare(GridModel gridModel, GridModel gridModel2) {
            return gridModel.zIndex - gridModel2.zIndex;
        }
    };
    private static Comparator<Pair<Float, Double>> mRangeValueComp = new Comparator<Pair<Float, Double>>() {
    ...
    private static FaceFeatureItem parseFaceFeatureItem(String str, JSONObject jSONObject, VideoMaterial videoMaterial, DecryptListener decryptListener) {
        ...
        if (optJSONArray != null) {
            ...
            if (parseItemListParams != null) {
                Collections.sort(parseItemListParams, new Comparator<StickerItem>() {
    ...
    private static void parseFaceExpressionParams(JSONObject jSONObject, VideoMaterial videoMaterial, boolean[] zArr) {
        ...
        if (optJSONObject != null) {
            ...
            faceExpression.id = optJSONObject.optString(FACE_EXPRESSION_ITEM_FILED.ID.value);
                ...
                for (i = 0; i < optJSONArray.length(); i++) {
                    ...
                    if (optJSONObject != null) {
                        ...
                        if (optJSONArray6 != null && optJSONArray6.length() == 4) {
                            ...
                            canvasItem.itemRect.x = optJSONArray6.optInt(0);
                            canvasItem.itemRect.y = optJSONArray6.optInt(1);
            ...
            if (optJSONArray2 != null) {
                ...
                for (int i3 = 0; i3 < optJSONArray2.length(); i3++) {
                    ...
                    if (opt instanceof JSONObject) {
                        ...
                        distortionItem.x = jSONObject2.optInt(DISTORTION_ITEM_FILED.X.value, 0);
                        distortionItem.y = jSONObject2.optInt(DISTORTION_ITEM_FILED.Y.value, 0);
        ...
        if (optJSONArray != null) {
            ...
            for (int i = 0; i < optJSONArray.length(); i++) {
                ...
                if (optJSONObject != null) {
                    ...
                    faceMeshItem.id = optJSONObject.optString(FACE_MESH_ITEM_LIST.ID.value);
        ...
        if (jSONArray != null) {
            ...
            for (int i3 = 0; i3 < jSONArray.length(); i3++) {
                ...
                if (optJSONObject != null) {
                    ...
                    faceItem.id = optJSONObject.optString(FACE_OFF_ITEM_FIELD.ID.value);
        ...
        try {
            ...
            if (optJSONArray != null) {
                for (int i = 0; i < optJSONArray.length(); i++) {
                    ...
                    faceMoveItem.dx = jSONObject2.optInt(FACE_MOVE_ITEM_FILED.X.value);
                    faceMoveItem.dy = jSONObject2.optInt(FACE_MOVE_ITEM_FILED.Y.value);
        ...
        if (jSONArray != null) {
            try {
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    ...
                    distortionItem.x = jSONObject.optInt(DISTORTION_ITEM_FILED.X.value);
                    distortionItem.y = jSONObject.optInt(DISTORTION_ITEM_FILED.Y.value);
        ...
        try {
            ...
            if (optJSONArray != null) {
                ...
                for (int i2 = 0; i2 < optJSONArray.length(); i2++) {
                    ...
                    stickerItem3D2.id = jSONObject2.optString("id");
                    ...
                    if (stickerItem3D2.frames > 0) {
                        ...
                        nodeParameter.nodeId = stickerItem3D2.id;
                    ...
                    if (stickerItem3D2.id.contains(VideoMaterialUtil.FRAMES_ID_SEPARATOR_3D)) {
                        String[] split = stickerItem3D2.id.split(VideoMaterialUtil.FRAMES_ID_SEPARATOR_3D);
                        if (split.length == 2) {
                            stickerItem3D2.subFolder = split[1];
                        }
                    } else {
                        stickerItem3D2.subFolder = stickerItem3D2.id;
                    }
                    ...
                    if (optJSONArray3 != null) {
                        ...
                        for (int i4 = 0; i4 < optJSONArray3.length(); i4++) {
                            ...
                            if (optJSONObject2 != null) {
                                ...
                                textWMElement.id = optJSONObject2.optString(WATERMARK_ELEMENT.ID.value);
                ...
                if (gameParams != null) {
                    for (i = 0; i < arrayList.size(); i++) {
                        ...
                        if (obj != null) {
                            gameParams.nodeInitialTransform += stickerItem3D3.id.split(VideoMaterialUtil.FRAMES_ID_SEPARATOR_3D)[0] + "/" + str3;
                        }
                    }
        ...
        try {
            ...
            if (jSONArray != null) {
                ...
                for (int i4 = 0; i4 < jSONArray.length(); i4++) {
                    ...
                    stickerItem.dx = jSONObject.optInt("dx", 0);
                    stickerItem.dy = jSONObject.optInt("dy", 0);
                    ...
                    if (optJSONObject2 != null) {
                        ...
                        stickerItem.transition.p0 = optJSONObject2.optString(TRANSITION.P0.value);
                        stickerItem.transition.p1 = optJSONObject2.optString(TRANSITION.P1.value);
                        stickerItem.transition.p2 = optJSONObject2.optString(TRANSITION.P2.value);
                    ...
                    stickerItem.particleConfig = parseParticleConfig(str + File.separator + stickerItem.id, jSONObject.optString("dexName"), decryptListener);
                }
                for (StickerItem stickerItem2 : arrayList) {
        ...
        while (i < jSONArray.length()) {
            try {
                ...
                if (optJSONObject != null) {
                    ...
                    textWMElement.dataPath = videoMaterial.getDataPath();
                    textWMElement.sid = videoMaterial.getId();
                    textWMElement.id = optJSONObject.optString(WATERMARK_ELEMENT.ID.value);
                ...
                if (optJSONObject != null) {
                    ...
                    if (optJSONObject2 != null) {
                        ...
                        if (!(TextUtils.isEmpty(optString2) && TextUtils.isEmpty(optString))) {
                            if (TextUtils.isEmpty(optString2)) {
                                ...
                                stickerItem.id = optString.substring(lastIndexOf2 + 1, optString.length());
                                stickerItem.subFolder = optString.substring(0, lastIndexOf2);
                                obj = null;
                            } else {
                                i = optString2.lastIndexOf("/");
                                stickerItem.id = optString2.substring(i + 1, optString2.length());
                    ...
                    if (optJSONObject3 != null) {
                        ...
                        if (!TextUtils.isEmpty(optString)) {
                            ...
                            stickerItem2.id = optString.substring(lastIndexOf3 + 1, optString.lastIndexOf("_"));
                                        ...
                                        if (optJSONArray2 != null && optJSONArray2.length() > 0) {
                                            for (lastIndexOf = 0; lastIndexOf < optJSONArray2.length(); lastIndexOf++) {
                                                ...
                                                if (optJSONObject6 != null) {
                                                    rect2.x = (int) optJSONObject6.optDouble("left", 0.0d);
                                                    rect2.y = (int) optJSONObject6.optDouble("top", 0.0d);
                    ...
                    if (optJSONObject3 != null) {
                        ...
                        if (TextUtils.isEmpty(optString3) && TextUtils.isEmpty(optString)) {
                            ...
                            lastIndexOf3 = optString.lastIndexOf("/");
                            stickerItem2.id = optString.substring(lastIndexOf3 + 1, optString.length());
                            stickerItem2.subFolder = optString.substring(0, lastIndexOf3);
                        } else {
                            i = optString3.lastIndexOf("/");
                            stickerItem2.id = optString3.substring(i + 1, optString3.length());
    ...
    public static JSONObject parseVideoMaterialFileAsJSONObject(String str, String str2, boolean z, DecryptListener decryptListener) {
        ...
        LogUtils.d(TAG, "[material str]".concat(String.valueOf(readMaterialFile)));
    ...
    /* JADX WARNING: Missing block: B:99:0x0166, code skipped:
            com.tencent.ttpic.baseutils.LogUtils.e(TAG, r0.getMessage(), r0, new java.lang.Object[0]);
     */
        ...
        try {
            ...
            if ((file.exists() && file.isFile()) || (file2.exists() && file2.isFile())) {
                ...
                try {
                    ...
                    if (i2 == 0) {
                        ...
                        try {
                            g.closeQuietly(drinkACupOfCoffee);
                        ...
                        try {
                            ...
                            if (bufferedReader != null) {
                                try {
                                    ...
                                    LogUtils.e(TAG, e72.getMessage(), e72, new Object[0]);
                                    AppMethodBeat.o(84274);
                                    throw th;
                                }
                            }
            ...
            if (drinkACupOfCoffee != null) {
                try {
                    ...
                    LogUtils.e(TAG, e11.getMessage(), e11, new Object[0]);
                }
            }
            if (fileInputStream != null) {
                fileInputStream.close();
    ...
    private static InputStream drinkACupOfCoffee(InputStream inputStream, DecryptListener decryptListener) {
        ...
        byte[] toByteArray = g.toByteArray(inputStream);
