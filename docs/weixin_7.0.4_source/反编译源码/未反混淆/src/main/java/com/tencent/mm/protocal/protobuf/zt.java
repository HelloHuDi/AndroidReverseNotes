            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        ztVar.BaseRequest = hlVar;
                    }
                    AppMethodBeat.o(56780);
                    return 0;
                case 2:
                    ztVar.nSX = aVar3.BTU.readString();
                    AppMethodBeat.o(56780);
                    return 0;
                case 3:
                    ztVar.latitude = Double.longBitsToDouble(aVar3.BTU.eib());
                    AppMethodBeat.o(56780);
                    return 0;
                case 4:
                    ztVar.longitude = Double.longBitsToDouble(aVar3.BTU.eib());
                    AppMethodBeat.o(56780);
                    return 0;
                default:
                    AppMethodBeat.o(56780);
