...
final class zzei extends zzjq {
    ...
    private static final String[] zzaew = new String[]{b.ORIGIN, "ALTER TABLE user_attributes ADD COLUMN origin TEXT;"};
    ...
    public final boolean zza(zzed zzed) {
        ...
        contentValues.put(b.ORIGIN, zzed.origin);
    ...
    public final boolean zza(zzjz zzjz) {
        ...
        contentValues.put(b.ORIGIN, zzjz.origin);
    ...
    public final List<zzjz> zzb(String str, String str2, String str3) {
        ...
        try {
            ...
            String[] strArr = new String[]{"name", "set_timestamp", "value", b.ORIGIN};
    ...
    public final List<zzed> zzb(String str, String[] strArr) {
        ...
        ArrayList arrayList = new ArrayList();
        try {
            query = getWritableDatabase().query("conditional_properties", new String[]{"app_id", b.ORIGIN, "name", "value", "active", "trigger_event_name", "trigger_timeout", "timed_out_event", "creation_timestamp", "triggered_event", "triggered_timestamp", "time_to_live", "expired_event"}, str, strArr, null, null, "rowid", "1001");
            try {
                if (query.moveToFirst()) {
                    do {
    ...
    public final List<zzjz> zzbb(String str) {
        ...
        ArrayList arrayList = new ArrayList();
        try {
            Cursor query = getWritableDatabase().query("user_attributes", new String[]{"name", b.ORIGIN, "set_timestamp", "value"}, "app_id=?", new String[]{str}, null, null, "rowid", "1000");
            try {
                if (query.moveToFirst()) {
                    do {
                        String string = query.getString(0);
            ...
            try {
                if (query.moveToFirst()) {
                    ...
                    do {
                        ...
                        try {
                            zzkr.zzb(zza);
                            aVar.put(Integer.valueOf(i), zzkr);
                        } catch (IOException e2) {
    ...
    public final void zzc(List<Long> list) {
        ...
        if (zzhv()) {
            ...
            try {
                getWritableDatabase().execSQL(new StringBuilder(String.valueOf(join).length() + d.MIC_SketchMark).append("UPDATE queue SET retry_count = IFNULL(retry_count, 0) + 1 WHERE rowid IN ").append(join).append(" AND (retry_count IS NULL OR retry_count < 2147483647)").toString());
    ...
    public final zzjz zzh(String str, String str2) {
        ...
        zzch();
        try {
            Cursor query = getWritableDatabase().query("user_attributes", new String[]{"set_timestamp", "value", b.ORIGIN}, "app_id=? and name=?", new String[]{str, str2}, null, null, null);
            try {
                if (query.moveToFirst()) {
                    String str3 = str;
    ...
    public final zzed zzi(String str, String str2) {
        ...
        zzch();
        try {
            query = getWritableDatabase().query("conditional_properties", new String[]{b.ORIGIN, "value", "active", "trigger_event_name", "trigger_timeout", "timed_out_event", "creation_timestamp", "triggered_event", "triggered_timestamp", "time_to_live", "expired_event"}, "app_id=? and name=?", new String[]{str, str2}, null, null, null);
            try {
                if (query.moveToFirst()) {
                    String string = query.getString(0);
