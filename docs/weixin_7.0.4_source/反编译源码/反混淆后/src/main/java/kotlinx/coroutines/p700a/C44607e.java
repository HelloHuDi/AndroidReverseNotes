...
public final class C44607e {
    private static final Method BRk;

    /* renamed from: UZ */
    public static final <E> Set<E> m81026UZ(int i) {
        AppMethodBeat.m2504i(118433);
        Set newSetFromMap = Collections.newSetFromMap(new IdentityHashMap(i));
        C25052j.m39375o(newSetFromMap, "Collections.newSetFromMa…ityHashMap(expectedSize))");
        AppMethodBeat.m2505o(118433);
        return newSetFromMap;
    }

    static {
        Method method;
        AppMethodBeat.m2504i(118434);
        try {
