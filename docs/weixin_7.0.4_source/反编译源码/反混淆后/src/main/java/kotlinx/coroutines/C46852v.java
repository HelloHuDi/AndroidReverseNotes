...
import kotlinx.coroutines.p701c.C36634c;
import p000a.C0220l;
...
public final class C46852v {
    ...
    /* JADX WARNING: Missing block: B:7:0x0024, code skipped:
            ...
            com.tencent.matrix.trace.core.AppMethodBeat.m2505o(118503);
     */
    ...
    static {
        boolean z;
        AppMethodBeat.m2504i(118503);
        String awA = C41151n.awA("kotlinx.coroutines.scheduler");
        if (awA != null) {
            switch (awA.hashCode()) {
                case 0:
                    break;
        ...
        z = true;
        BPI = z;
        AppMethodBeat.m2505o(118503);
    }

    public static final C24596w ekZ() {
        return BPI ? C36634c.BSC : C16464p.BPE;
    }

    /* renamed from: a */
    public static final C41366e m89092a(C36622ac c36622ac, C41366e c41366e) {
        C41366e plus;
        AppMethodBeat.m2504i(118501);
        C25052j.m39376p(c36622ac, "receiver$0");
        C25052j.m39376p(c41366e, "context");
        C41366e plus2 = c36622ac.ekT().plus(c41366e);
        if (C36623af.ela()) {
            plus = plus2.plus(new C6096aa(BPH.incrementAndGet()));
        } else {
            plus = plus2;
        }
        if (plus2 == C41154ao.elj() || plus2.get(C46863d.AVd) != null) {
            AppMethodBeat.m2505o(118501);
            return plus;
        }
        plus = plus.plus(C41154ao.elj());
        AppMethodBeat.m2505o(118501);
        return plus;
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    /* renamed from: a */
    public static final String m89093a(C41366e c41366e) {
        AppMethodBeat.m2504i(118502);
        C25052j.m39376p(c41366e, "receiver$0");
        if (C36623af.ela()) {
            C6096aa c6096aa = (C6096aa) c41366e.get(C6096aa.BPL);
            if (c6096aa == null) {
                AppMethodBeat.m2505o(118502);
                return null;
            }
            String str;
            ...
            str = "coroutine";
            String str2 = str + '#' + c6096aa.f1690id;
            AppMethodBeat.m2505o(118502);
            return str2;
        }
        AppMethodBeat.m2505o(118502);
