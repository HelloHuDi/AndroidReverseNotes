...
public final class C36623af {
    ...
    /* JADX WARNING: Missing block: B:7:0x0022, code skipped:
            ...
            com.tencent.matrix.trace.core.AppMethodBeat.m2505o(118546);
     */
    ...
    static {
        boolean z;
        AppMethodBeat.m2504i(118546);
        String awA = C41151n.awA("kotlinx.coroutines.debug");
        if (awA != null) {
            switch (awA.hashCode()) {
                case 0:
                    break;
        ...
        z = C6096aa.class.desiredAssertionStatus();
        DEBUG = z;
        AppMethodBeat.m2505o(118546);
    }
    ...
    /* renamed from: ee */
    public static final String m60717ee(Object obj) {
        AppMethodBeat.m2504i(118543);
        C25052j.m39376p(obj, "receiver$0");
        String toHexString = Integer.toHexString(System.identityHashCode(obj));
        C25052j.m39375o(toHexString, "Integer.toHexString(System.identityHashCode(this))");
        AppMethodBeat.m2505o(118543);
        return toHexString;
    }

    /* renamed from: d */
    public static final String m60716d(C36927c<?> c36927c) {
        AppMethodBeat.m2504i(118544);
        C25052j.m39376p(c36927c, "receiver$0");
        String obj;
        if (c36927c instanceof C31187al) {
            obj = c36927c.toString();
            AppMethodBeat.m2505o(118544);
            return obj;
        }
        obj = c36927c + '@' + C36623af.m60717ee(c36927c);
        AppMethodBeat.m2505o(118544);
        return obj;
    }

    /* renamed from: ef */
    public static final String m60718ef(Object obj) {
        AppMethodBeat.m2504i(118545);
        C25052j.m39376p(obj, "receiver$0");
        String simpleName = obj.getClass().getSimpleName();
        C25052j.m39375o(simpleName, "this::class.java.simpleName");
        AppMethodBeat.m2505o(118545);
        return simpleName;
    }
}
