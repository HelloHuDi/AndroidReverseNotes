...
/* renamed from: a.g.b */
public abstract class C8003b<T> implements C0015c<Object, T> {
    private T value;
    ...
    /* renamed from: a */
    public boolean mo17813a(C31815k<?> c31815k) {
        C25052j.m39376p(c31815k, "property");
        return true;
    }

    /* renamed from: b */
    public final T mo49b(C31815k<?> c31815k) {
        C25052j.m39376p(c31815k, "property");
        return this.value;
    }

    /* renamed from: a */
    public final void mo48a(C31815k<?> c31815k, T t) {
        C25052j.m39376p(c31815k, "property");
        mo17813a(c31815k);
        this.value = t;
        C25052j.m39376p(c31815k, "property");
