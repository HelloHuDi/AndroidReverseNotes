...
public class C7987l extends C25033k {
    ...
    /* renamed from: g */
    public static final C31599d m14174g(Collection<?> collection) {
        AppMethodBeat.m2504i(56210);
        C25052j.m39376p(collection, "receiver$0");
        C31599d c31599d = new C31599d(0, collection.size() - 1);
        AppMethodBeat.m2505o(56210);
        return c31599d;
    }

    /* renamed from: fH */
    public static final <T> int m14172fH(List<? extends T> list) {
        AppMethodBeat.m2504i(56211);
        C25052j.m39376p(list, "receiver$0");
        int size = list.size() - 1;
        AppMethodBeat.m2505o(56211);
        return size;
    }

    /* renamed from: fI */
    public static final <T> List<T> m14173fI(List<? extends T> list) {
        AppMethodBeat.m2504i(56212);
        C25052j.m39376p(list, "receiver$0");
        List<T> list2;
        switch (list.size()) {
            case 0:
                list2 = C17115v.AUP;
                AppMethodBeat.m2505o(56212);
                return list2;
            case 1:
                list2 = C25033k.listOf(list.get(0));
                AppMethodBeat.m2505o(56212);
                return list2;
            default:
                AppMethodBeat.m2505o(56212);
    ...
    public static final void dWs() {
        AppMethodBeat.m2504i(56213);
        Throwable arithmeticException = new ArithmeticException("Index overflow has happened.");
        AppMethodBeat.m2505o(56213);
        throw arithmeticException;
    }

    public static final void dWt() {
        AppMethodBeat.m2504i(56214);
        Throwable arithmeticException = new ArithmeticException("Count overflow has happened.");
        AppMethodBeat.m2505o(56214);
        throw arithmeticException;
    }
}
