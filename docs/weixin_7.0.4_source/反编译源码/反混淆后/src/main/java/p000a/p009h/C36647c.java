...
/* renamed from: a.h.c */
public final class C36647c extends C31585ab {
    private final int AVM;
    private boolean AVN;
    private int AVO;
    private final int hzv;

    public C36647c(int i, int i2, int i3) {
        boolean z = true;
        AppMethodBeat.m2504i(55994);
        this.hzv = i3;
        this.AVM = i2;
        if (this.hzv > 0) {
            if (i > i2) {
