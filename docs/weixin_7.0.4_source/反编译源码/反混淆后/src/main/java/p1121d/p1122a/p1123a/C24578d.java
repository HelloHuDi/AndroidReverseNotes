...
public final class C24578d extends C1331a {
    public String BTs;
    public String BTt;
    public int BTu;
    public C16442f BTv;
    ...
    public final int mo4669op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.BTv != null) {
                c6093a.mo13479iy(6, this.BTv.computeSize());
                this.BTv.writeFields(c6093a);
            }
            AppMethodBeat.m2505o(57009);
            return 0;
        } else if (i == 1) {
            if (this.BTs != null) {
            ...
            if (this.wqf != null) {
                f += C6091a.m9575f(4, this.wqf);
            }
            if (this.url != null) {
                f += C6091a.m9575f(5, this.url);
            }
            if (this.BTv != null) {
                f += C6087a.m9557ix(6, this.BTv.computeSize());
            }
            AppMethodBeat.m2505o(57009);
            return f;
        } else if (i == 2) {
            ...
            C24578d c24578d = (C24578d) objArr[1];
            int intValue = ((Integer) objArr[2]).intValue();
            switch (intValue) {
                case 1:
                    c24578d.BTs = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(57009);
                    return 0;
                case 2:
                    c24578d.BTt = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(57009);
                    return 0;
                case 3:
                    c24578d.BTu = c6086a2.BTU.mo13458vd();
                    AppMethodBeat.m2505o(57009);
                    return 0;
                case 4:
                    c24578d.wqf = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(57009);
                    return 0;
                case 5:
                    c24578d.url = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(57009);
                    return 0;
                case 6:
