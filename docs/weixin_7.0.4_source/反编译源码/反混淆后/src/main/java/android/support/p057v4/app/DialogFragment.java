...
public class DialogFragment extends Fragment implements OnCancelListener, OnDismissListener {
    ...
    public void show(C0336i c0336i, String str) {
        ...
        C0338m beginTransaction = c0336i.beginTransaction();
        beginTransaction.mo555a((Fragment) this, str);
        beginTransaction.commit();
    }

    public int show(C0338m c0338m, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        c0338m.mo555a((Fragment) this, str);
        this.mViewDestroyed = false;
        this.mBackStackId = c0338m.commit();
        return this.mBackStackId;
    }

    public void showNow(C0336i c0336i, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        C0338m beginTransaction = c0336i.beginTransaction();
        beginTransaction.mo555a((Fragment) this, str);
    ...
    public void dismissInternal(boolean z) {
        if (!this.mDismissed) {
            ...
            C0338m beginTransaction = getFragmentManager().beginTransaction();
            beginTransaction.mo554a(this);
            if (z) {
