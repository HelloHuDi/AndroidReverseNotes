...
public class ContentFrameLayout extends FrameLayout {
    ...
    /* renamed from: g */
    public final void mo1692g(Rect rect) {
        fitSystemWindows(rect);
    }

    public void setAttachListener(C0650a c0650a) {
        this.ahm = c0650a;
    }

    /* renamed from: j */
    public final void mo1699j(int i, int i2, int i3, int i4) {
        ...
        if (mode == C8415j.INVALID_ID) {
            ...
            if (!(typedValue2 == null || typedValue2.type == 0)) {
                ...
                if (dimension > 0) {
                    ...
                    if (obj == null && mode == C8415j.INVALID_ID) {
