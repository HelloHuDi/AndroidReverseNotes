...
final class C8351b {
    /* renamed from: wZ */
    private static Method f2288wZ;

    /* renamed from: a */
    static List<File> m14743a(Context context, ApplicationInfo applicationInfo, File file, boolean z) {
        List a;
        Object obj = null;
        new StringBuilder("MultiDexExtractor.load(").append(applicationInfo.sourceDir).append(", ").append(z).append(")");
        File file2 = new File(applicationInfo.sourceDir);
        long g = C25316c.m39921g(file2);
        if (g == -1) {
            g--;
        }
        if (!z) {
            SharedPreferences K = C8351b.m14742K(context);
            if (!(K.getLong(Param.TIMESTAMP, -1) == C8351b.m14748e(file2) && K.getLong("crc", -1) == g)) {
                obj = 1;
            }
            if (obj == null) {
                try {
                    a = C8351b.m14744a(context, file2, file);
                } catch (IOException e) {
                }
        ...
        a = C8351b.m14747c(file2, file);
        long e2 = C8351b.m14748e(file2);
        int size = a.size() + 1;
        Editor edit = C8351b.m14742K(context).edit();
        edit.putLong(Param.TIMESTAMP, e2);
        edit.putLong("crc", g);
        edit.putInt("dex.number", size);
        if (f2288wZ != null) {
            try {
                f2288wZ.invoke(edit, new Object[0]);
    ...
    /* renamed from: a */
    private static List<File> m14744a(Context context, File file, File file2) {
        String str = file.getName() + ".classes";
        int i = C8351b.m14742K(context).getInt("dex.number", 1);
    ...
    /* renamed from: e */
    private static long m14748e(File file) {
    ...
    /* renamed from: c */
    private static List<File> m14747c(File file, File file2) {
        String str = file.getName() + ".classes";
        C8351b.m14746b(file2, str);
        ...
        try {
            ...
            while (entry != null) {
                ...
                while (i2 < 3 && !z) {
                    i2++;
                    C8351b.m14745a(zipFile, entry, file3, str);
                    boolean f = C8351b.m14749f(file3);
    ...
    /* renamed from: K */
    private static SharedPreferences m14742K(Context context) {
        return context.getSharedPreferences("multidex.version", VERSION.SDK_INT < 11 ? 0 : 4);
    }

    /* renamed from: b */
    private static void m14746b(File file, final String str) {
        file.mkdirs();
        if (file.isDirectory()) {
    ...
    /* renamed from: a */
    private static void m14745a(ZipFile zipFile, ZipEntry zipEntry, File file, String str) {
        ...
        try {
            ...
            if (createTempFile.renameTo(file)) {
                C8351b.closeQuietly(inputStream);
    ...
    /* renamed from: f */
    static boolean m14749f(File file) {
        try {
    ...
    static {
        try {
            f2288wZ = Editor.class.getMethod("apply", new Class[0]);
