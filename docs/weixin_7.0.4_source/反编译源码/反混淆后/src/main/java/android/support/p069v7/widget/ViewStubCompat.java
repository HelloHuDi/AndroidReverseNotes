...
public final class ViewStubCompat extends View {
    ...
    public ViewStubCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        this.avd = 0;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0554a.ViewStubCompat, i, 0);
    ...
    public final void setOnInflateListener(C0672a c0672a) {
        this.avh = c0672a;
    }
}
