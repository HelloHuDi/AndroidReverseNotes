...
public class ReflectMethod {
    ...
    public String toString() {
        AppMethodBeat.m2504i(85520);
        String method;
        if (this.mMethod != null) {
            method = this.mMethod.toString();
            AppMethodBeat.m2505o(85520);
            return method;
        }
        method = "";
        if (this.mClass != null) {
    ...
    public Object invokeWithArguments() {
        AppMethodBeat.m2504i(85521);
        Object invoke = invoke(this.mArguments);
        AppMethodBeat.m2505o(85521);
        return invoke;
    }
}
