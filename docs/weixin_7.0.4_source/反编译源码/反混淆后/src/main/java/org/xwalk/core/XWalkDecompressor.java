...
import p1124g.p1125a.p1126b.C46842a;
...
public class XWalkDecompressor {
    ...
    public static boolean extractResource(String str, String str2) {
        IOException e;
        Throwable th;
        AppMethodBeat.m2504i(85592);
        Log.m81049i(TAG, "Extract resource from Apk ".concat(String.valueOf(str)));
        ...
        try {
            ...
            try {
                for (String str3 : MANDATORY_RESOURCES) {
                    ...
                    if (entry != null) {
                        Log.m81045d(TAG, "Extracting ".concat(String.valueOf(str3)));
                        ...
                        Log.m81049i(TAG, str3 + " not found, may be it is new version of package");
                    } else {
                        Log.m81046e(TAG, str3 + " not found");
                        try {
                            zipFile.close();
                        } catch (IOException | NullPointerException e2) {
                        }
                        AppMethodBeat.m2505o(85592);
                        return false;
                    }
                }
                try {
                ...
                System.gc();
                Log.m81045d(TAG, "Time to extract : " + (SystemClock.uptimeMillis() - uptimeMillis) + " ms");
                AppMethodBeat.m2505o(85592);
                return true;
            } catch (IOException e4) {
                e = e4;
                try {
                    Log.m81046e(TAG, "Extract error:" + e.getLocalizedMessage());
                    try {
                        zipFile.close();
    ...
    public static boolean decompressDownloadFullZip(String str, int i) {
        ...
        IOException e;
        Throwable th;
        AppMethodBeat.m2504i(85593);
        Log.m81049i(TAG, "decompress full zip from zip " + str + ",version:" + i);
        long uptimeMillis = SystemClock.uptimeMillis();
        ZipFile zipFile;
        try {
            zipFile = new ZipFile(str);
            try {
                ...
                while (entries.hasMoreElements()) {
                    ...
                    Log.m81049i(TAG, "decompressDownloadFullZip fileName:".concat(String.valueOf(encode)));
                    if (!(encode.contains("../") || encode.contains("..\\") || zipEntry.isDirectory())) {
                        ...
                        try {
                            ...
                            e = e3;
                            try {
                                Log.m81046e(TAG, "decompressDownloadPatchZip error:" + e.getLocalizedMessage());
                                if (zipFile != null) {
                                    try {
                                        zipFile.close();
                                    } catch (Exception e4) {
                ...
                System.gc();
                Log.m81045d(TAG, "Time to decompress : " + (SystemClock.uptimeMillis() - uptimeMillis) + " ms");
                AppMethodBeat.m2505o(85593);
                return true;
    ...
    public static boolean decompressDownloadPatchZip(String str, String str2) {
        ...
        Object obj;
        Throwable th;
        AppMethodBeat.m2504i(85594);
        Log.m81045d(TAG, "decompress from zip ".concat(String.valueOf(str)));
        long uptimeMillis = SystemClock.uptimeMillis();
        ZipFile zipFile;
        Closeable closeable;
    ...
    private static boolean isClassesDex(String str) {
        AppMethodBeat.m2504i(85597);
        if (TextUtils.isEmpty(str)) {
            AppMethodBeat.m2505o(85597);
            return false;
        }
    ...
    private static void extractLzmaToFile(InputStream inputStream, File file) {
        ...
        try {
            ...
            try {
                ...
                C46842a c46842a = new C46842a();
                if (c46842a.mo75985cR(bArr)) {
                    long j = 0;
                    for (int i = 0; i < 8; i++) {
                        int read = bufferedInputStream.read();
                        if (read < 0) {
                            Log.m81051w(TAG, "Can't read stream size");
                        }
                        j |= ((long) read) << (i * 8);
                    }
                    if (c46842a.mo75984a(bufferedInputStream, bufferedOutputStream, j)) {
                        try {
                            bufferedOutputStream.flush();
                        } catch (IOException | NullPointerException e6) {
                        }
    ...
    public static void copyApkToLocal(String str, String str2) {
        Exception e;
        Throwable th;
        AppMethodBeat.m2504i(85601);
        Log.m81045d(TAG, "Copy to local from Apk ".concat(String.valueOf(str)));
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    e = e2;
                    try {
                        Log.m81046e("copyApkToLocal error:", e.getMessage());
                        C41131b.tryClose(fileInputStream);
                        C41131b.tryClose(fileOutputStream);
                        AppMethodBeat.m2505o(85601);
                    } catch (Throwable th2) {
