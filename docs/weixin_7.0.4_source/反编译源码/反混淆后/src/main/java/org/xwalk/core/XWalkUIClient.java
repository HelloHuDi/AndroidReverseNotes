...
public class XWalkUIClient {
    ...
    /* renamed from: onConsoleMessageXWalkViewInternalStringintStringConsoleMessageTypeMethod */
    private ReflectMethod f14362xde6ca526 = new ReflectMethod(null, "onConsoleMessage", new Class[0]);
    /* renamed from: onCreateWindowRequestedXWalkViewInternalInitiateByInternalValueCallbackMethod */
    private ReflectMethod f14363xb5cc0caa = new ReflectMethod(null, "onCreateWindowRequested", new Class[0]);
    ...
    /* renamed from: onGeolocationPermissionsShowPromptStringXWalkGeolocationPermissionsCallbackInternalMethod */
    private ReflectMethod f14364xcb07caf3 = new ReflectMethod(null, "onGeolocationPermissionsShowPrompt", new Class[0]);
    ...
    /* renamed from: onJavascriptModalDialogXWalkViewInternalJavascriptMessageTypeInternalStringStringStringXWalkJavascriptResultInternalMethod */
    private ReflectMethod f14365x125f119f = new ReflectMethod(null, "onJavascriptModalDialog", new Class[0]);
    /* renamed from: onJsAlertXWalkViewInternalStringStringXWalkJavascriptResultInternalMethod */
    private ReflectMethod f14366xa4379738 = new ReflectMethod(null, "onJsAlert", new Class[0]);
    /* renamed from: onJsConfirmXWalkViewInternalStringStringXWalkJavascriptResultInternalMethod */
    private ReflectMethod f14367x25dcde9c = new ReflectMethod(null, "onJsConfirm", new Class[0]);
    /* renamed from: onJsPromptXWalkViewInternalStringStringStringXWalkJavascriptResultInternalMethod */
    private ReflectMethod f14368x5a70d47f = new ReflectMethod(null, "onJsPrompt", new Class[0]);
    ...
    /* renamed from: onSelectInfoChangedXWalkViewInternallongStringStringStringCallbackMethod */
    private ReflectMethod f14369xa50a628d = new ReflectMethod(null, "onSelectInfoChanged", new Class[0]);
    ...
    public XWalkUIClient(XWalkView xWalkView) {
        AppMethodBeat.m2504i(85864);
        this.constructorTypes.add("XWalkViewBridge");
        this.constructorParams = new ArrayList();
        this.constructorParams.add(xWalkView);
        reflectionInit();
        AppMethodBeat.m2505o(85864);
    }

    public boolean onSelectInfoChanged(XWalkView xWalkView, long j, String str, String str2, String str3) {
        AppMethodBeat.m2504i(85865);
        try {
            boolean booleanValue = ((Boolean) this.f14369xa50a628d.invoke(xWalkView.getBridge(), Long.valueOf(j), str, str2, str3)).booleanValue();
            AppMethodBeat.m2505o(85865);
            return booleanValue;
    ...
    public void onShowSos() {
        AppMethodBeat.m2504i(85867);
        try {
            this.onShowSosMethod.invoke(new Object[0]);
            AppMethodBeat.m2505o(85867);
        } catch (UnsupportedOperationException e) {
            if (this.coreWrapper == null) {
                RuntimeException runtimeException = new RuntimeException("Crosswalk's APIs are not ready yet");
                AppMethodBeat.m2505o(85867);
    ...
    public boolean onCreateWindowRequested(XWalkView xWalkView, InitiateBy initiateBy, ValueCallback<XWalkView> valueCallback) {
        AppMethodBeat.m2504i(85869);
        try {
            boolean booleanValue = ((Boolean) this.f14363xb5cc0caa.invoke(xWalkView.getBridge(), ConvertInitiateBy(initiateBy), valueCallback)).booleanValue();
            AppMethodBeat.m2505o(85869);
            return booleanValue;
        } catch (UnsupportedOperationException e) {
            if (this.coreWrapper == null) {
                RuntimeException runtimeException = new RuntimeException("Crosswalk's APIs are not ready yet");
    ...
    public boolean onJavascriptModalDialog(XWalkView xWalkView, JavascriptMessageType javascriptMessageType, String str, String str2, String str3, XWalkJavascriptResult xWalkJavascriptResult) {
        AppMethodBeat.m2504i(85875);
        try {
            boolean booleanValue = ((Boolean) this.f14365x125f119f.invoke(xWalkView.getBridge(), ConvertJavascriptMessageType(javascriptMessageType), str, str2, str3, ((XWalkJavascriptResultHandler) xWalkJavascriptResult).getBridge())).booleanValue();
            AppMethodBeat.m2505o(85875);
            return booleanValue;
        } catch (UnsupportedOperationException e) {
            if (this.coreWrapper == null) {
                RuntimeException runtimeException = new RuntimeException("Crosswalk's APIs are not ready yet");
    ...
    public boolean onConsoleMessage(XWalkView xWalkView, String str, int i, String str2, ConsoleMessageType consoleMessageType) {
        AppMethodBeat.m2504i(85881);
        try {
            boolean booleanValue = ((Boolean) this.f14362xde6ca526.invoke(xWalkView.getBridge(), str, Integer.valueOf(i), str2, ConvertConsoleMessageType(consoleMessageType))).booleanValue();
            AppMethodBeat.m2505o(85881);
            return booleanValue;
        } catch (UnsupportedOperationException e) {
            if (this.coreWrapper == null) {
                RuntimeException runtimeException = new RuntimeException("Crosswalk's APIs are not ready yet");
    ...
    public boolean onJsAlert(XWalkView xWalkView, String str, String str2, XWalkJavascriptResult xWalkJavascriptResult) {
        AppMethodBeat.m2504i(85885);
        try {
            boolean booleanValue = ((Boolean) this.f14366xa4379738.invoke(xWalkView.getBridge(), str, str2, ((XWalkJavascriptResultHandler) xWalkJavascriptResult).getBridge())).booleanValue();
            AppMethodBeat.m2505o(85885);
            return booleanValue;
        } catch (UnsupportedOperationException e) {
            if (this.coreWrapper == null) {
                RuntimeException runtimeException = new RuntimeException("Crosswalk's APIs are not ready yet");
    ...
    public boolean onJsConfirm(XWalkView xWalkView, String str, String str2, XWalkJavascriptResult xWalkJavascriptResult) {
        AppMethodBeat.m2504i(85886);
        try {
            boolean booleanValue = ((Boolean) this.f14367x25dcde9c.invoke(xWalkView.getBridge(), str, str2, ((XWalkJavascriptResultHandler) xWalkJavascriptResult).getBridge())).booleanValue();
            AppMethodBeat.m2505o(85886);
            return booleanValue;
        } catch (UnsupportedOperationException e) {
            if (this.coreWrapper == null) {
                RuntimeException runtimeException = new RuntimeException("Crosswalk's APIs are not ready yet");
    ...
    public boolean onJsPrompt(XWalkView xWalkView, String str, String str2, String str3, XWalkJavascriptResult xWalkJavascriptResult) {
        AppMethodBeat.m2504i(85887);
        try {
            boolean booleanValue = ((Boolean) this.f14368x5a70d47f.invoke(xWalkView.getBridge(), str, str2, str3, ((XWalkJavascriptResultHandler) xWalkJavascriptResult).getBridge())).booleanValue();
            AppMethodBeat.m2505o(85887);
            return booleanValue;
        } catch (UnsupportedOperationException e) {
            if (this.coreWrapper == null) {
                RuntimeException runtimeException = new RuntimeException("Crosswalk's APIs are not ready yet");
    ...
    public void onHideCustomView() {
        AppMethodBeat.m2504i(85890);
        try {
            this.onHideCustomViewMethod.invoke(new Object[0]);
            AppMethodBeat.m2505o(85890);
        } catch (UnsupportedOperationException e) {
            if (this.coreWrapper == null) {
                RuntimeException runtimeException = new RuntimeException("Crosswalk's APIs are not ready yet");
                AppMethodBeat.m2505o(85890);
    ...
    public void onGeolocationPermissionsShowPrompt(String str, XWalkGeolocationPermissionsCallback xWalkGeolocationPermissionsCallback) {
        AppMethodBeat.m2504i(85891);
        try {
            this.f14364xcb07caf3.invoke(str, ((XWalkGeolocationPermissionsCallbackHandler) xWalkGeolocationPermissionsCallback).getBridge());
            AppMethodBeat.m2505o(85891);
        } catch (UnsupportedOperationException e) {
            if (this.coreWrapper == null) {
                RuntimeException runtimeException = new RuntimeException("Crosswalk's APIs are not ready yet");
                AppMethodBeat.m2505o(85891);
    ...
    public void reflectionInit() {
        AppMethodBeat.m2504i(85894);
        XWalkCoreWrapper.initEmbeddedMode();
        this.coreWrapper = XWalkCoreWrapper.getInstance();
        if (this.coreWrapper == null) {
            XWalkCoreWrapper.reserveReflectObject(this);
            AppMethodBeat.m2505o(85894);
            return;
        }
        ...
        try {
            ...
            this.f14363xb5cc0caa.init(this.bridge, null, "onCreateWindowRequestedSuper", this.coreWrapper.getBridgeClass("XWalkViewBridge"), this.coreWrapper.getBridgeClass("XWalkUIClientInternal$InitiateByInternal"), ValueCallback.class);
            ...
            this.f14365x125f119f.init(this.bridge, null, "onJavascriptModalDialogSuper", this.coreWrapper.getBridgeClass("XWalkViewBridge"), this.coreWrapper.getBridgeClass("XWalkUIClientInternal$JavascriptMessageTypeInternal"), String.class, String.class, String.class, this.coreWrapper.getBridgeClass("XWalkJavascriptResultHandlerBridge"));
            ...
            this.f14362xde6ca526.init(this.bridge, null, "onConsoleMessageSuper", this.coreWrapper.getBridgeClass("XWalkViewBridge"), String.class, Integer.TYPE, String.class, this.coreWrapper.getBridgeClass("XWalkUIClientInternal$ConsoleMessageType"));
            ...
            this.f14366xa4379738.init(this.bridge, null, "onJsAlertSuper", this.coreWrapper.getBridgeClass("XWalkViewBridge"), String.class, String.class, this.coreWrapper.getBridgeClass("XWalkJavascriptResultHandlerBridge"));
            this.f14367x25dcde9c.init(this.bridge, null, "onJsConfirmSuper", this.coreWrapper.getBridgeClass("XWalkViewBridge"), String.class, String.class, this.coreWrapper.getBridgeClass("XWalkJavascriptResultHandlerBridge"));
            this.f14368x5a70d47f.init(this.bridge, null, "onJsPromptSuper", this.coreWrapper.getBridgeClass("XWalkViewBridge"), String.class, String.class, String.class, this.coreWrapper.getBridgeClass("XWalkJavascriptResultHandlerBridge"));
            ...
            this.f14364xcb07caf3.init(this.bridge, null, "onGeolocationPermissionsShowPromptSuper", String.class, this.coreWrapper.getBridgeClass("XWalkGeolocationPermissionsCallbackHandlerBridge"));
            ...
            this.f14369xa50a628d.init(this.bridge, null, "onSelectInfoChanged", this.coreWrapper.getBridgeClass("XWalkViewBridge"), Long.TYPE, String.class, String.class, String.class);
