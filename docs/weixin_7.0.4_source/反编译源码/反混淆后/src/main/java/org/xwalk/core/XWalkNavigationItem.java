...
public class XWalkNavigationItem {
    ...
    public XWalkNavigationItem(Object obj) {
        AppMethodBeat.m2504i(85729);
        this.bridge = obj;
        reflectionInit();
        AppMethodBeat.m2505o(85729);
    }

    public String getUrl() {
        AppMethodBeat.m2504i(85730);
        try {
            String str = (String) this.getUrlMethod.invoke(new Object[0]);
            AppMethodBeat.m2505o(85730);
            return str;
    ...
    public void reflectionInit() {
        AppMethodBeat.m2504i(85733);
        XWalkCoreWrapper.initEmbeddedMode();
        this.coreWrapper = XWalkCoreWrapper.getInstance();
        if (this.coreWrapper == null) {
            XWalkCoreWrapper.reserveReflectObject(this);
            AppMethodBeat.m2505o(85733);
            return;
        }
