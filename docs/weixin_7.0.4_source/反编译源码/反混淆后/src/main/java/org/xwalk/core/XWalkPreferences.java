...
public class XWalkPreferences {
    ...
    static {
        AppMethodBeat.m2504i(85742);
        AppMethodBeat.m2505o(85742);
    }

    public static void setValue(String str, int i) {
        AppMethodBeat.m2504i(85735);
        reflectionInit();
        try {
            setValueStringintMethod.invoke(str, Integer.valueOf(i));
            AppMethodBeat.m2505o(85735);
        } catch (UnsupportedOperationException e) {
            if (coreWrapper == null) {
    ...
    public static void setValue(String str, String str2) {
        AppMethodBeat.m2504i(85736);
        reflectionInit();
        try {
            setValueStringStringMethod.invoke(str, str2);
            AppMethodBeat.m2505o(85736);
        } catch (UnsupportedOperationException e) {
            if (coreWrapper == null) {
    ...
    static void reflectionInit() {
        AppMethodBeat.m2504i(85741);
        if (coreWrapper != null) {
            AppMethodBeat.m2505o(85741);
            return;
        }
