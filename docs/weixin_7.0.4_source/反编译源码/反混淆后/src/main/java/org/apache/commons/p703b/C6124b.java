...
final class C6124b {
    ...
    public static final C6124b BWT;
    public static final C6124b BWU;
    public static final C6124b BWV;
    private final C6127a BWW = new C6126b();

    /* renamed from: org.apache.commons.b.b$c */
    static class C6125c implements C6127a {
        private final Map BWX = new HashMap();
        private final C6128c BWY = new C6128c();

        C6125c() {
            AppMethodBeat.m2504i(116928);
            AppMethodBeat.m2505o(116928);
        }

        /* renamed from: h */
        public final void mo13571h(String str, int i) {
            AppMethodBeat.m2504i(116929);
            this.BWX.put(str, Integer.valueOf(i));
            this.BWY.mo13572v(i, str);
            AppMethodBeat.m2505o(116929);
        }

        public final int awK(String str) {
            AppMethodBeat.m2504i(116930);
            Object obj = this.BWX.get(str);
            if (obj == null) {
                AppMethodBeat.m2505o(116930);
                return -1;
            }
    ...
    /* renamed from: org.apache.commons.b.b$b */
    static class C6126b extends C6125c {
        C6126b() {
        }
    }
    ...
    interface C6127a {
        ...
        /* renamed from: h */
        void mo13571h(String str, int i);
    }

    static {
        AppMethodBeat.m2504i(116935);
        r0 = new String[4][];
        ...
        r0[3] = new String[]{C0252a.TAG_GAMMA, "915"};
        ...
        r0[C31128d.MIC_ALPHA_ADJUST_REAL] = new String[]{"rang", "9002"};
        r0[118] = new String[]{"loz", "9674"};
        r0[C31128d.MIC_AVROUND_BLUR] = new String[]{"spades", "9824"};
        ...
        r0[C31128d.MIC_SketchMark] = new String[]{"Yuml", "376"};
        ...
        r0[C19394e.CTRL_INDEX] = new String[]{"zwnj", "8204"};
        r0[C19392d.CTRL_INDEX] = new String[]{"zwj", "8205"};
        r0[C44697b.CTRL_INDEX] = new String[]{"lrm", "8206"};
        r0[C19395n.CTRL_INDEX] = new String[]{"rlm", "8207"};
        r0[137] = new String[]{"ndash", "8211"};
        r0[138] = new String[]{"mdash", "8212"};
        r0[C33333a.CTRL_INDEX] = new String[]{"lsquo", "8216"};
        ...
        c6124b.m9692a(BWS);
        BWV = c6124b;
        AppMethodBeat.m2505o(116935);
    }

    public C6124b() {
        AppMethodBeat.m2504i(116931);
        AppMethodBeat.m2505o(116931);
    }

    /* renamed from: a */
    private void m9692a(String[][] strArr) {
        AppMethodBeat.m2504i(116932);
        for (int i = 0; i < strArr.length; i++) {
            this.BWW.mo13571h(strArr[i][0], Integer.parseInt(strArr[i][1]));
        }
        AppMethodBeat.m2505o(116932);
    }

    public final String unescape(String str) {
        AppMethodBeat.m2504i(116933);
        int indexOf = str.indexOf(38);
        if (indexOf < 0) {
            AppMethodBeat.m2505o(116933);
            return str;
        }
        StringWriter stringWriter = new StringWriter((int) (((double) str.length()) + (((double) str.length()) * 0.1d)));
        try {
            m9691a(stringWriter, str, indexOf);
            str = stringWriter.toString();
            AppMethodBeat.m2505o(116933);
            return str;
        } catch (IOException e) {
            C36639g c36639g = new C36639g(e);
            AppMethodBeat.m2505o(116933);
            throw c36639g;
        }
    }
    ...
    /* renamed from: a */
    private void m9691a(Writer writer, String str, int i) {
        AppMethodBeat.m2504i(116934);
