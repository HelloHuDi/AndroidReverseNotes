...
public class XWalkExternalExtensionManagerImpl extends XWalkExternalExtensionManager implements XWalkExtensionContextClient {
    ...
    public XWalkExternalExtensionManagerImpl(XWalkView xWalkView) {
        super(xWalkView);
        AppMethodBeat.m2504i(86191);
        this.mXWalkView = xWalkView;
        if (getBridge() == null) {
            Log.m81046e(TAG, "Cannot load external extensions due to old version of runtime library");
            this.mContext = null;
            this.mLoadExternalExtensions = false;
            this.mNativeExtensionLoader = null;
            AppMethodBeat.m2505o(86191);
            return;
        }
    ...
    public void registerExtension(XWalkExternalExtension xWalkExternalExtension) {
        AppMethodBeat.m2504i(86192);
        if (this.mExtensions.get(xWalkExternalExtension.getExtensionName()) != null) {
            Log.m81046e(TAG, xWalkExternalExtension.getExtensionName() + "is already registered!");
            AppMethodBeat.m2505o(86192);
            return;
        }
                ...
                try {
                    ...
                    if (!(str3 == null || str3.length() == 0)) {
                        try {
                            ...
                            Log.m81051w(TAG, "Failed to read the file ".concat(String.valueOf(str3)));
                            AppMethodBeat.m2505o(86195);
                            return;
                        }
                    }
                    if (!(string == null || string2 == null)) {
                        Log.m81049i(TAG, "createExternalExtension: name: " + string + " className: " + string2);
                        createExternalExtension(string, string2, optString, this);
                    }
                    AppMethodBeat.m2505o(86195);
                    return;
                } catch (JSONException e2) {
                    Log.m81051w(TAG, "Failed to parse json file: ".concat(String.valueOf(str2)));
                    AppMethodBeat.m2505o(86195);
                    return;
                }
            } catch (IOException e3) {
                Log.m81051w(TAG, "Failed to read json file: ".concat(String.valueOf(str2)));
                AppMethodBeat.m2505o(86195);
                return;
            }
        }
    ...
    private String getFileContent(Context context, String str, boolean z) {
        ...
        if (z) {
            try {
                ...
                Log.m81051w(TAG, "Inputstream failed to open for R.raw." + str2 + ", try to find it in assets");
            } catch (Throwable th) {
                if (inputStream != null) {
                    inputStream.close();
                }
                AppMethodBeat.m2505o(86205);
            }
        }
        if (inputStream == null) {
    ...
    private void loadNativeExtensions() {
        ...
        AppMethodBeat.m2505o(86207);
    }

    private static void handleException(Exception exception) {
        AppMethodBeat.m2504i(86208);
        Log.m81046e(TAG, "Error in calling methods of external extensions. " + exception.toString());
        AppMethodBeat.m2505o(86208);
    }
}
