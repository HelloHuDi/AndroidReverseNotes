...
public class XWalkWebResourceResponse {
    ...
    public XWalkWebResourceResponse(Object obj) {
        AppMethodBeat.m2504i(86056);
        this.bridge = obj;
        reflectionInit();
        AppMethodBeat.m2505o(86056);
    }

    public void setMimeType(String str) {
        AppMethodBeat.m2504i(86057);
        try {
            this.setMimeTypeStringMethod.invoke(str);
            AppMethodBeat.m2505o(86057);
    ...
    public void setEncoding(String str) {
        AppMethodBeat.m2504i(86059);
        try {
            this.setEncodingStringMethod.invoke(str);
            AppMethodBeat.m2505o(86059);
        } catch (UnsupportedOperationException e) {
            if (this.coreWrapper == null) {
                RuntimeException runtimeException = new RuntimeException("Crosswalk's APIs are not ready yet");
                AppMethodBeat.m2505o(86059);
    ...
    public void setData(InputStream inputStream) {
        AppMethodBeat.m2504i(86061);
        try {
            this.setDataInputStreamMethod.invoke(inputStream);
            AppMethodBeat.m2505o(86061);
        } catch (UnsupportedOperationException e) {
            if (this.coreWrapper == null) {
                RuntimeException runtimeException = new RuntimeException("Crosswalk's APIs are not ready yet");
                AppMethodBeat.m2505o(86061);
    ...
    public void setResponseHeaders(Map<String, String> map) {
        AppMethodBeat.m2504i(86066);
        try {
            this.setResponseHeadersMapMethod.invoke(map);
            AppMethodBeat.m2505o(86066);
        } catch (UnsupportedOperationException e) {
            if (this.coreWrapper == null) {
                RuntimeException runtimeException = new RuntimeException("Crosswalk's APIs are not ready yet");
                AppMethodBeat.m2505o(86066);
    ...
    public void reflectionInit() {
        AppMethodBeat.m2504i(86068);
        XWalkCoreWrapper.initEmbeddedMode();
        this.coreWrapper = XWalkCoreWrapper.getInstance();
        if (this.coreWrapper == null) {
            XWalkCoreWrapper.reserveReflectObject(this);
            AppMethodBeat.m2505o(86068);
            return;
        }
