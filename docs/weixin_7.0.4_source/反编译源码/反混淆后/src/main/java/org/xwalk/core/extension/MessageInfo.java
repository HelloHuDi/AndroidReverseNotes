...
public class MessageInfo {
    ...
    public void postResult(JSONArray jSONArray) {
        ...
        try {
            ...
            Log.m81051w(this.TAG, "postResult: " + jSONArray2.toString());
            this.mExtension.postMessage(this.mInstanceId, jSONArray2.toString());
            AppMethodBeat.m2505o(86134);
        } catch (JSONException e) {
            Log.m81046e(this.TAG, e.toString());
            AppMethodBeat.m2505o(86134);
        }
