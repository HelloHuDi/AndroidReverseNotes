...
public class ReflectField {
    ...
    public ReflectField(Object obj, String str) {
        AppMethodBeat.m2504i(4194);
        init(obj, null, str);
        AppMethodBeat.m2505o(4194);
    }

    public ReflectField(Class<?> cls, String str) {
        AppMethodBeat.m2504i(4195);
        init(null, cls, str);
        AppMethodBeat.m2505o(4195);
    }

    public boolean init(Object obj, Class<?> cls, String str) {
        Class cls2;
        AppMethodBeat.m2504i(4196);
        this.mInstance = obj;
        if (cls2 == null) {
    ...
    public String toString() {
        AppMethodBeat.m2504i(4198);
        String field;
        if (this.mField != null) {
            field = this.mField.toString();
            AppMethodBeat.m2505o(4198);
            return field;
        }
        field = "";
        if (this.mClass != null) {
