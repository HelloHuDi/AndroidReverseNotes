...
public class MHMessageHandler implements MessageHandler {
    ...
    static {
        ...
        if (VERSION.SDK_INT < 27) {
            try {
                i = ShareReflectUtil.m9400d(Class.forName("android.app.ActivityThread$H"), "LAUNCH_ACTIVITY").getInt(null);
            } catch (Throwable th) {
            }
        }
        xHf = i;
        ...
        if (message.what == xHf) {
            try {
                ...
                if (obj == null) {
                    ...
                    Intent intent = (Intent) ShareReflectUtil.m9395b(obj, "intent").get(obj);
                    if (intent != null) {
                        ...
                        if (componentName == null) {
                            ...
                            ActivityInfo activityInfo = (ActivityInfo) ShareReflectUtil.m9395b(obj, "activityInfo").get(obj);
                            if (activityInfo != null) {
                                ...
                                if (aun == null) {
                                    ...
                                    try {
                                        Object obj2 = ShareReflectUtil.m9395b(obj, "token").get(obj);
                                        obj = ShareReflectUtil.m9398c(Class.forName("android.app.ActivityManagerNative"), "getDefault", new Class[0]).invoke(null, new Object[0]);
                                        ShareReflectUtil.m9396b(obj, "setRequestedOrientation", IBinder.class, Integer.TYPE).invoke(obj, new Object[]{obj2, Integer.valueOf(i)});
                                    } catch (Throwable th) {
                                    }
                                    m12653G(aun, activityInfo);
    ...
    /* renamed from: G */
    private static <T> void m12653G(T t, T t2) {
        if (t != null && t2 != null) {
