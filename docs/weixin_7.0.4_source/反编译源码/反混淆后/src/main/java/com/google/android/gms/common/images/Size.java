...
public final class Size {
    ...
    public final String toString() {
        AppMethodBeat.m2504i(61243);
        int i = this.zzps;
        String str = i + VideoMaterialUtil.CRAZYFACE_X + this.zzpt;
        AppMethodBeat.m2505o(61243);
        return str;
    }
}
