...
public class GoogleCloudMessaging {
    ...
    private final Map<String, Handler> zzae = Collections.synchronizedMap(new C6197a());
    ...
    static {
        AppMethodBeat.m2504i(69976);
        AppMethodBeat.m2505o(69976);
    }

    public GoogleCloudMessaging() {
        AppMethodBeat.m2504i(69962);
        AppMethodBeat.m2505o(69962);
    }
    ...
    private final Intent zzd(Bundle bundle, boolean z) {
        AppMethodBeat.m2504i(69970);
        IOException iOException;
        if (Looper.getMainLooper() == Looper.myLooper()) {
            iOException = new IOException("MAIN_THREAD");
            AppMethodBeat.m2505o(69970);
            throw iOException;
    ...
    static void zze(Context context) {
        ...
        AppMethodBeat.m2505o(69961);
    }

    private final synchronized void zze(Intent intent) {
        AppMethodBeat.m2504i(69972);
        if (this.zzad == null) {
        ...
        AppMethodBeat.m2505o(69972);
    }

    public static int zzf(Context context) {
        AppMethodBeat.m2504i(69974);
    ...
    private final synchronized void zzg() {
        AppMethodBeat.m2504i(69973);
        if (this.zzad != null) {
            this.zzad.cancel();
            this.zzad = null;
        }
        AppMethodBeat.m2505o(69973);
    }

    @Deprecated
    public void close() {
        AppMethodBeat.m2504i(69963);
        zzac = null;
        zzd.zzj = null;
        zzg();
        AppMethodBeat.m2505o(69963);
    }

    @Deprecated
    public String getMessageType(Intent intent) {
        AppMethodBeat.m2504i(69971);
        if ("com.google.android.c2dm.intent.RECEIVE".equals(intent.getAction())) {
            String stringExtra = intent.getStringExtra("message_type");
            if (stringExtra != null) {
                AppMethodBeat.m2505o(69971);
                return stringExtra;
            }
    ...
    public void send(String str, String str2, Bundle bundle) {
        AppMethodBeat.m2504i(69964);
        send(str, str2, -1, bundle);
        AppMethodBeat.m2505o(69964);
    }

    @Deprecated
    public synchronized void unregister() {
        AppMethodBeat.m2504i(69967);
        if (Looper.getMainLooper() == Looper.myLooper()) {
            IOException iOException = new IOException("MAIN_THREAD");
            AppMethodBeat.m2505o(69967);
            throw iOException;
        }
