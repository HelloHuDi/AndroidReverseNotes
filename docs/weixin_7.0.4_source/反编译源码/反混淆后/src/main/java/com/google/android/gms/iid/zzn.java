...
final class zzn {
    ...
    static void zzg(Context context, String str) {
        AppMethodBeat.m2504i(57578);
        File zzj = zzj(context, str);
        if (zzj.exists()) {
            zzj.delete();
        }
        AppMethodBeat.m2505o(57578);
    }

    private final zzo zzh(Context context, String str) {
        AppMethodBeat.m2504i(57580);
        zzp zzp;
        zzp e;
        try {
    ...
    private final zzo zzi(Context context, String str) {
        String valueOf;
        AppMethodBeat.m2504i(57582);
        File zzj = zzj(context, str);
        if (zzj.exists()) {
            zzo zzd;
            try {
                zzd = zzd(zzj);
                AppMethodBeat.m2505o(57582);
                return zzd;
            } catch (IOException e) {
    ...
    public final zzo zze(Context context, String str) {
        AppMethodBeat.m2504i(57576);
        zzo zzh = zzh(context, str);
        if (zzh != null) {
            AppMethodBeat.m2505o(57576);
            return zzh;
        }
        zzh = zzf(context, str);
        AppMethodBeat.m2505o(57576);
    ...
    public final zzo zzf(Context context, String str) {
        AppMethodBeat.m2504i(57577);
        zzo zzo = new zzo(zzd.zzk(), System.currentTimeMillis());
        try {
            zzo zzh = zzh(context, str);
            if (zzh != null) {
                Log.isLoggable("InstanceID", 3);
                AppMethodBeat.m2505o(57577);
                return zzh;
            }
        } catch (zzp e) {
        }
