...
public class NetworkSignalUtil {
    ...
    /* renamed from: com.tencent.voip.mars.comm.NetworkSignalUtil$1 */
    static class C365741 extends PhoneStateListener {
        C365741() {
        }

        public final void onSignalStrengthsChanged(SignalStrength signalStrength) {
            AppMethodBeat.m2504i(92789);
            super.onSignalStrengthsChanged(signalStrength);
            NetworkSignalUtil.access$000(signalStrength);
            AppMethodBeat.m2505o(92789);
        }
    }

    static /* synthetic */ void access$000(SignalStrength signalStrength) {
        AppMethodBeat.m2504i(92749);
        calSignalStrength(signalStrength);
        AppMethodBeat.m2505o(92749);
    }

    public static void InitNetworkSignalUtil(Context context) {
        AppMethodBeat.m2504i(92746);
        context = context;
        try {
            ((TelephonyManager) context.getSystemService("phone")).listen(new C365741(), 256);
            AppMethodBeat.m2505o(92746);
    ...
    public static long getWifiSignalStrength() {
        AppMethodBeat.m2504i(92747);
        WifiInfo connectionInfo = ((WifiManager) context.getSystemService("wifi")).getConnectionInfo();
        if (connectionInfo == null || connectionInfo.getBSSID() == null) {
            AppMethodBeat.m2505o(92747);
            return 0;
        }
