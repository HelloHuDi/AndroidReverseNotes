...
public abstract class PostHttpRequest {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            try {
                                ...
                                e = e2;
                                try {
                                    C4990ab.printErrStackTrace(PostHttpRequest.TAG, e, "", new Object[0]);
    ...
    public synchronized void cancleRequest() {
        if (!(this.mHttpPost == null || this.mHttpPost.isAborted())) {
            TMLog.m60588i(TAG, "BaseHttpRequest:" + this + " cancleRequest");
            try {
