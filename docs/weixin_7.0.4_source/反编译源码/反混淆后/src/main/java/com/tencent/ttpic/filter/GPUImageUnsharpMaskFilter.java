...
import com.tencent.filter.p138a.C37324aj;
    ...
    public void setParameterDic(Map<String, Object> map) {
        ...
        if (map.containsKey("intensity")) {
            ...
            if (this.unsharpMask != null) {
                this.unsharpMask.addParam(new C0933f("intensity", this.intensity));
            }
        }
        AppMethodBeat.m2505o(82555);
    }
