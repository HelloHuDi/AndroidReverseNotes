...
public final class zzkf extends zzaby<zzkf> {
    ...
    public final boolean equals(Object obj) {
        AppMethodBeat.m2504i(69658);
        if (obj == this) {
            AppMethodBeat.m2505o(69658);
            return true;
    ...
    public final int hashCode() {
        ...
        hashCode += i;
        AppMethodBeat.m2505o(69659);
        return hashCode;
    }

    /* Access modifiers changed, original: protected|final */
    public final int zza() {
        AppMethodBeat.m2504i(69661);
        int zza = super.zza();
        if (this.zzarv != null) {
        ...
        AppMethodBeat.m2505o(69661);
        return zza;
    }

    public final void zza(zzabw zzabw) {
        AppMethodBeat.m2504i(69660);
        if (this.zzarv != null) {
        ...
        super.zza(zzabw);
        AppMethodBeat.m2505o(69660);
    }

    public final /* synthetic */ zzace zzb(zzabv zzabv) {
        AppMethodBeat.m2504i(69662);
        while (true) {
            int zzuw = zzabv.zzuw();
            switch (zzuw) {
                case 0:
                    AppMethodBeat.m2505o(69662);
                    break;
                case 10:
                    if (this.zzarv == null) {
                        this.zzarv = new zzki();
