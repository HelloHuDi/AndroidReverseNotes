...
/* renamed from: com.tencent.mm.sdk.platformtools.bn */
public final class C15427bn {
    ...
    /* renamed from: mt */
    public static long m23705mt(long j) {
        return pfH > j ? pfH : j;
    }
    ...
    /* renamed from: mu */
    public static long m23706mu(long j) {
        return pfF > j ? pfF : j;
    }

    /* renamed from: mv */
    public static long m23707mv(long j) {
        return pfG > j ? pfG : j;
    }

    public static void reset() {
        AppMethodBeat.m2504i(52286);
        xBU = -1;
        xBV = -1;
        xBW = -1;
        xBX = -1;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:122:0x0331 A:{PHI: r6 , Splitter:B:5:0x0022, ExcHandler: all (th java.lang.Throwable)} */
    /* JADX WARNING: Removed duplicated region for block: B:115:0x031f  */
    /* JADX WARNING: Removed duplicated region for block: B:122:0x0331 A:{PHI: r6 , Splitter:B:5:0x0022, ExcHandler: all (th java.lang.Throwable)} */
    /* JADX WARNING: Removed duplicated region for block: B:115:0x031f  */
    /* JADX WARNING: Removed duplicated region for block: B:119:0x0327  */
        ...
        try {
            ...
            if (sJL != null) {
                ...
                try {
                    ...
                    if (xBU < 0) {
                        xBU = j;
                        C4990ab.m7419v("MicroMsg.SDK.TrafficStats", "fix loss newMobileTx %d", Long.valueOf(j));
                    }
                    if (xBV < 0) {
                        xBV = j2;
                        C4990ab.m7419v("MicroMsg.SDK.TrafficStats", "fix loss newMobileRx %d", Long.valueOf(j2));
                    }
                    if (xBW < 0) {
                        xBW = j3;
                        C4990ab.m7419v("MicroMsg.SDK.TrafficStats", "fix loss newWifiTx %d", Long.valueOf(j3));
                    }
                    if (xBX < 0) {
                        xBX = j6;
                        C4990ab.m7419v("MicroMsg.SDK.TrafficStats", "fix loss newWifiRx %d", Long.valueOf(j6));
                    }
                    if (j6 - xBX < 0) {
                        C4990ab.m7419v("MicroMsg.SDK.TrafficStats", "minu %d", Long.valueOf(j6 - xBX));
                    }
                    if (j3 - xBW < 0) {
                        C4990ab.m7419v("MicroMsg.SDK.TrafficStats", "minu %d", Long.valueOf(j3 - xBW));
                    }
                    xCc = j >= xBU ? j - xBU : j;
                    if (j2 >= xBV) {
                        j7 = j2 - xBV;
                    ...
                    scanner = scanner2;
                    try {
                        C4990ab.printErrStackTrace("MicroMsg.SDK.TrafficStats", e, "Failed retrieving TrafficStats.", new Object[0]);
                        if (scanner != null) {
                        }
                        C4990ab.m7417i("MicroMsg.SDK.TrafficStats", "current system traffic: wifi rx/tx=%d/%d, mobile rx/tx=%d/%d, wxWifi rx/tx=%d/%d wxMobile rx/tx=%d/%d", Long.valueOf(xCf), Long.valueOf(xCe), Long.valueOf(xCd), Long.valueOf(xCc), Long.valueOf(pfI), Long.valueOf(pfH), Long.valueOf(pfG), Long.valueOf(pfF));
                        AppMethodBeat.m2505o(52287);
                    } catch (Throwable th) {
                        e = th;
                        scanner2 = scanner;
                        if (scanner2 != null) {
