...
/* renamed from: com.tencent.mm.protocal.protobuf.aof */
public final class aof extends btd {
    public String kdS;

    /* renamed from: op */
    public final int mo4669op(int i, Object... objArr) {
        AppMethodBeat.m2504i(89105);
        C6092b c6092b;
        int ix;
        if (i == 0) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        aof.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.m2505o(89105);
                    return 0;
                case 2:
                    aof.kdS = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(89105);
                    return 0;
                default:
                    AppMethodBeat.m2505o(89105);
