...
public class AppIconView extends AppCompatImageView {
    ...
    static {
        AppMethodBeat.m2504i(136208);
        AppMethodBeat.m2505o(136208);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(C25738R.color.f11760ge));
        canvas.drawRoundRect(this.kPM, 32.0f, 32.0f, paint);
        AppMethodBeat.m2505o(136205);
    }

    /* Access modifiers changed, original: protected */
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        AppMethodBeat.m2504i(136206);
        this.kPM = new RectF(0.0f, 0.0f, (float) i, (float) i2);
        this.rect = new Rect(0, 0, i, i2);
        Bitmap createBitmap = Bitmap.createBitmap(i, i2, Config.ARGB_8888);
        Canvas canvas = new Canvas(createBitmap);
        Paint paint = new Paint(1);
        paint.setColor(getResources().getColor(C25738R.color.f11759gd));
        canvas.drawRoundRect(this.kPM, 32.0f, 32.0f, paint);
        this.kPN = createBitmap;
        AppMethodBeat.m2505o(136206);
    }

    public void setImageBitmap(Bitmap bitmap) {
        AppMethodBeat.m2504i(136207);
        this.bitmap = bitmap;
        super.setImageBitmap(bitmap);
        AppMethodBeat.m2505o(136207);
    }
}
