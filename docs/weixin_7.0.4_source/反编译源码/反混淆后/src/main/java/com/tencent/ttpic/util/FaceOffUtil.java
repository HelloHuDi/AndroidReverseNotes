...
public class FaceOffUtil {
    ...
    public static final int[] FaceMeshTriangles = new int[]{19, 118, 111, 118, 19, 20, 7, 67, 68, 67, 7, 6, 1, 0, 111, 56, 109, 114, 109, 56, 57, 2, 1, 109, 69, 8, 68, 8, 69, 9, 3, 2, 107, 58, 76, 75, 76, 58, 59, 4, 3, 107, 65, 75, 82, 65, 67, 74, 65, 82, 74, 5, 4, 107, 67, 6, 5, 109, 107, 2, 107, 109, 57, 114, 55, 56, 55, 114, 115, 8, 7, 68, 114, 113, 38, 113, 114, 109, 10, 9, 69, 11, 10, 70, 12, 11, 71, 36, 113, 112, 113, 36, 37, 13, 12, 66, 41, C31128d.MIC_AVROUND_BLUR, 40, C31128d.MIC_AVROUND_BLUR, 41, C31128d.MIC_ALPHA_ADJUST_REAL, 14, 13, 108, 37, 41, 38, 41, 37, 42, 15, 14, 108, 42, 118, 120, 118, 42, 35, 16, 15, 108, 1, 111, 112, 17, 16, 110, 109, 112, 113, 112, 109, 1, 18, 17, 121, 25, 20, 26, 20, 25, 21, 96, 26, 19, 26, 96, 95, 107, 57, 65, 19, 111, 90, 20, 19, 26, 21, 25, 22, 58, 64, 59, 64, 58, 57, 20, 21, 120, 33, 29, 30, 29, 33, 28, 51, GmsClientSupervisor.DEFAULT_BIND_FLAGS, C31128d.MIC_SketchMark, GmsClientSupervisor.DEFAULT_BIND_FLAGS, 51, 50, 21, 22, C31128d.MIC_ALPHA_ADJUST_REAL, 22, 24, 23, 24, 22, 25, 121, 17, 122, 22, 23, 116, 52, 128, 45, 128, 52, 130, 121, 128, 27, 128, 121, 45, 23, 24, 84, 92, 33, 32, 33, 92, 34, 24, 25, 95, 24, 95, 94, 25, 26, 95, 121, 91, 18, 91, 121, 27, 84, 94, 32, 94, 84, 24, 27, 93, 91, 93, 27, 34, 27, 28, 34, 28, 27, 128, 32, 30, 31, 30, 32, 33, 28, 33, 34, 29, 28, 130, 110, 122, 17, 122, 110, 123, 32, 31, 84, 30, 29, C31128d.MIC_SketchMark, 47, 52, 46, 52, 47, 51, 31, 30, GmsClientSupervisor.DEFAULT_BIND_FLAGS, 84, 31, 126, 92, 32, 94, 93, 34, 92, 42, 36, 35, 36, 42, 37, 35, 112, 111, 112, 35, 36, 120, C31128d.MIC_ALPHA_ADJUST_REAL, 41, C31128d.MIC_ALPHA_ADJUST_REAL, 120, 21, 38, 41, 40, 114, 38, 39, 22, 116, C31128d.MIC_AVROUND_BLUR, 61, 64, 62, 64, 61, 60, 37, 38, 113, 116, 39, 40, 39, 116, 115, 61, 108, 66, 108, 61, 110, 39, 38, 40, 63, 84, 126, 84, 63, 83, C31128d.MIC_AVROUND_BLUR, C31128d.MIC_ALPHA_ADJUST_REAL, 22, 120, 41, 42, 120, 118, 20, 45, 122, 46, 122, 45, 121, 46, 52, 45, C31128d.MIC_SketchMark, 130, 51, 130, C31128d.MIC_SketchMark, 29, 123, 46, 122, 46, 123, 47, 48, 51, 47, 51, 48, 50, 124, 48, 123, 48, 124, 49, 64, 60, 59, 48, 47, 123, 71, 11, 70, 31, GmsClientSupervisor.DEFAULT_BIND_FLAGS, 126, 48, 49, 50, 84, 116, 23, 116, 84, 55, 49, 126, 50, 126, 49, 125, C31128d.MIC_SketchMark, GmsClientSupervisor.DEFAULT_BIND_FLAGS, 30, 51, 130, 52, 128, 130, 28, 115, 114, 39, 83, 56, 55, 56, 83, 62, 64, 57, 56, 65, 57, 75, 5, 107, 65, 10, 69, 70, 57, 58, 75, 60, 79, 78, 79, 60, 61, 61, 66, 79, 108, 13, 66, 16, 108, 110, 59, 60, 78, 124, 123, 110, 110, 62, 124, 62, 110, 61, 124, 63, 125, 63, 124, 62, 56, 62, 64, 124, 125, 49, 63, 62, 83, 83, 55, 84, 5, 65, 67, 66, 12, 71, 74, 68, 67, 68, 74, 73, 68, 73, 69, 73, 70, 69, 70, 73, 72, 66, 71, 72, 66, 79, 80, 66, 80, 72, 71, 70, 72, 59, 78, 77, 72, 73, 80, 81, 80, 73, 80, 81, 78, 73, 74, 81, 82, 81, 74, 81, 82, 76, 75, 76, 82, 76, 59, 77, 77, 81, 76, 81, 77, 78, 78, 79, 80, 19, 90, 96, 0, 90, 111, 35, 111, 118, 55, 115, 116, 116, 40, C31128d.MIC_AVROUND_BLUR, 125, 63, 126, 50, 126, GmsClientSupervisor.DEFAULT_BIND_FLAGS, 99, 106, 96, 106, 105, 93, 105, 104, 91, 104, 103, 14, 103, 102, 11, 102, 101, 7, 101, 100, 4, 100, 99, 90, 0, 1, 100, 1, 2, 100, 2, 3, 100, 3, 4, 100, 4, 5, 101, 5, 6, 101, 6, 7, 101, 7, 8, 102, 8, 9, 102, 9, 10, 102, 10, 11, 102, 11, 12, 103, 12, 13, 103, 13, 14, 103, 14, 15, 104, 15, 16, 104, 16, 17, 104, 17, 18, 104, 18, 91, 104, 91, 93, 105, 93, 92, 106, 92, 94, 106, 94, 95, 106, 95, 96, 106, 96, 90, 99, 90, 0, 100};
    ...
    static {
        AppMethodBeat.m2504i(83910);
        AppMethodBeat.m2505o(83910);
    }

    public static List<PointF> loadTexCoords(String str) {
        AppMethodBeat.m2504i(83887);
        if (TextUtils.isEmpty(str)) {
            ArrayList arrayList = new ArrayList();
            AppMethodBeat.m2505o(83887);
            return arrayList;
        }
    ...
    private static List<PointF> loadTexCoords(String str, String str2) {
        AppMethodBeat.m2504i(83888);
        List<PointF> arrayList = new ArrayList();
        if (TextUtils.isEmpty(str) || TextUtils.isEmpty(str2)) {
            AppMethodBeat.m2505o(83888);
            return arrayList;
        }
    ...
    public static float[] initFacePositions(List<PointF> list, int i, int i2, float[] fArr) {
        AppMethodBeat.m2504i(83890);
        if (BaseUtils.isEmpty(list) || fArr == null || i <= 0 || i2 <= 0 || fArr.length != 1380) {
            fArr = new float[0];
            AppMethodBeat.m2505o(83890);
            return fArr;
        }
        PointF[] pointFArr = new PointF[3];
        int i3 = 0;
    ...
    public static float[] initFacePositionsFaceAverage(List<PointF> list, int i, int i2, float[] fArr) {
        AppMethodBeat.m2504i(83893);
        if (BaseUtils.isEmpty(list) || fArr == null || i <= 0 || i2 <= 0 || fArr.length != 1104) {
            fArr = new float[0];
            AppMethodBeat.m2505o(83893);
            return fArr;
        }
        PointF[] pointFArr = new PointF[3];
        int i3 = 0;
    ...
    public static float[] initFaceLinePositions(List<PointF> list, int i, int i2, float[] fArr) {
        AppMethodBeat.m2504i(83894);
        if (BaseUtils.isEmpty(list) || i <= 0 || i2 <= 0) {
            fArr = new float[0];
            AppMethodBeat.m2505o(83894);
            return fArr;
        }
        PointF[] pointFArr = new PointF[3];
        int i3 = 0;
    ...
    public static float[] initIrisLinePositions(List<PointF> list, int i, int i2, float[] fArr) {
        AppMethodBeat.m2504i(83895);
        if (BaseUtils.isEmpty(list) || i <= 0 || i2 <= 0) {
            fArr = new float[0];
            AppMethodBeat.m2505o(83895);
            return fArr;
        }
        PointF[] pointFArr = new PointF[3];
        int i3 = 0;
    ...
    public static List<PointF> getFullCoords(List<PointF> list) {
        AppMethodBeat.m2504i(83896);
        if (BaseUtils.isEmpty(list) || list.size() < 90) {
            ArrayList arrayList = new ArrayList();
            AppMethodBeat.m2505o(83896);
            return arrayList;
        }
        int i;
        PointF pointF;
    ...
    public static List<PointF> getFullCoordsForFaceOffFilter(List<PointF> list, float f) {
        AppMethodBeat.m2504i(83897);
        if (BaseUtils.isEmpty(list) || list.size() < 90) {
            ArrayList arrayList = new ArrayList();
            AppMethodBeat.m2505o(83897);
            return arrayList;
        }
        int i;
        double toRadians;
    ...
    public static List<PointF> getFullCoords(List<PointF> list, float f) {
        AppMethodBeat.m2504i(83898);
        if (BaseUtils.isEmpty(list) || list.size() < 90) {
            ArrayList arrayList = new ArrayList();
            AppMethodBeat.m2505o(83898);
            return arrayList;
        }
        if (list.size() > 97) {
    ...
    public static List<PointF> genPoints(List<Float> list) {
        AppMethodBeat.m2504i(83900);
        ArrayList arrayList = new ArrayList();
        if (BaseUtils.isEmpty(list)) {
            AppMethodBeat.m2505o(83900);
            return arrayList;
        }
        int i = 0;
        while (true) {
    ...
    public static List<PointF> genPointsDouble(List<Double> list) {
        AppMethodBeat.m2504i(83901);
        ArrayList arrayList = new ArrayList();
        if (BaseUtils.isEmpty(list)) {
            AppMethodBeat.m2505o(83901);
            return arrayList;
        }
        int i = 0;
        while (true) {
    ...
    public static void scalePoints(List<PointF> list, double d) {
        AppMethodBeat.m2504i(83908);
        if (list == null) {
            AppMethodBeat.m2505o(83908);
            return;
        }
