...
public class ProtocolPackage {
    ...
    public static JceStruct buildReportRequest(byte b, List<byte[]> list, String str, int i, String str2) {
        ...
        AppMethodBeat.m2505o(76014);
        return reportLogRequest;
    }

    public static ReqHead getReqHead(JceStruct jceStruct) {
        AppMethodBeat.m2504i(76015);
        if (jceStruct == null) {
            AppMethodBeat.m2505o(76015);
            return null;
        }
    ...
    public static Request buildRequest(JceStruct jceStruct) {
        AppMethodBeat.m2504i(76016);
        if (jceStruct == null) {
            AppMethodBeat.m2505o(76016);
            return null;
        }
    ...
    public static byte[] buildPostData(Request request) {
        AppMethodBeat.m2504i(76017);
        if (request == null) {
            AppMethodBeat.m2505o(76017);
            return null;
        }
    ...
    public static Response unpackPackage(byte[] bArr) {
        AppMethodBeat.m2504i(76018);
        if (bArr == null || bArr.length < 4) {
            AppMethodBeat.m2505o(76018);
            return null;
        }
    ...
    private static JceStruct createFromRequest(JceStruct jceStruct) {
        AppMethodBeat.m2504i(76020);
        if (jceStruct == null) {
            AppMethodBeat.m2505o(76020);
            return null;
        }
    ...
    public static byte[] jceStructToUTF8Byte(JceStruct jceStruct) {
        AppMethodBeat.m2504i(76021);
        if (jceStruct == null) {
            AppMethodBeat.m2505o(76021);
            return null;
        }
    ...
    public static JceStruct bytes2JceObj(byte[] bArr, Class<? extends JceStruct> cls) {
        AppMethodBeat.m2504i(76022);
        if (bArr == null) {
            AppMethodBeat.m2505o(76022);
            return null;
        }
        try {
            JceInputStream jceInputStream = new JceInputStream(bArr);
                ...
                try {
                    ...
                    if (dataOutputStream != null) {
                        try {
                            ...
                            C4990ab.printErrStackTrace(TAG, e52, "", new Object[0]);
                        }
                    }
                    AppMethodBeat.m2505o(76023);
                    return null;
    ...
    public static byte[] encrypt(byte[] bArr, byte[] bArr2) {
        AppMethodBeat.m2504i(76024);
        byte[] encrypt = new Cryptor().encrypt(bArr, bArr2);
        AppMethodBeat.m2505o(76024);
        return encrypt;
    }

    public static byte[] decrypt(byte[] bArr, byte[] bArr2) {
        AppMethodBeat.m2504i(76025);
        byte[] decrypt = new Cryptor().decrypt(bArr, bArr2);
        AppMethodBeat.m2505o(76025);
        return decrypt;
    }
}
