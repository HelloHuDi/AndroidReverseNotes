...
/* renamed from: com.tencent.mm.protocal.protobuf.cdy */
public final class cdy extends btd {
    ...
    public final int mo4669op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            int bs = ix + C6091a.m9572bs(3, this.wZG);
            AppMethodBeat.m2505o(56505);
            return bs;
        } else if (i == 2) {
