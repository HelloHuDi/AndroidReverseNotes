...
/* renamed from: com.tencent.mm.protocal.protobuf.bum */
public final class bum extends btd {
    public String vGi;

    /* renamed from: op */
    public final int mo4669op(int i, Object... objArr) {
        AppMethodBeat.m2504i(10236);
        C6092b c6092b;
        int ix;
        if (i == 0) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        bum.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.m2505o(10236);
                    return 0;
                case 3:
                    bum.vGi = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(10236);
                    return 0;
                default:
                    AppMethodBeat.m2505o(10236);
