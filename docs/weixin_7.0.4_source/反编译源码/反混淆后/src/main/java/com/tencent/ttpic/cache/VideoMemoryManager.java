...
public class VideoMemoryManager {
    ...
    private VideoMemoryManager() {
        AppMethodBeat.m2504i(81833);
        AppMethodBeat.m2505o(81833);
    }
    ...
    public void loadAllImages(final VideoMaterial videoMaterial) {
        AppMethodBeat.m2504i(81834);
        clear();
        this.mHandler.post(new Runnable() {
            public void run() {
                AppMethodBeat.m2504i(81832);
                ...
                AppMethodBeat.m2505o(81832);
            }
        });
        AppMethodBeat.m2505o(81834);
    }

    private void loadImportMaterial(VideoMaterial videoMaterial, int i) {
        AppMethodBeat.m2504i(81835);
        ...
        AppMethodBeat.m2505o(81835);
    }

    private void loadAllItemsAppend(VideoMaterial videoMaterial, int i) {
        AppMethodBeat.m2504i(81836);
        if (videoMaterial == null) {
            AppMethodBeat.m2505o(81836);
            return;
        }
        if (videoMaterial.getFaceOffItemList() != null) {
            for (FaceItem faceItem : videoMaterial.getFaceOffItemList()) {
                if (!VideoMaterialUtil.isEmptyItem(faceItem)) {
                    this.managers.put(TextUtils.isEmpty(faceItem.f3494id) ? faceItem.faceExchangeImage : faceItem.f3494id, new LoadFaceItemManager(this.mCache, this.mGrayCache, videoMaterial.getDataPath(), faceItem, i));
                }
            }
        }
                ...
                if (!(faceFeatureItem == null || faceFeatureItem.getFaceOffItemList() == null)) {
                    for (FaceItem faceItem2 : faceFeatureItem.getFaceOffItemList()) {
                        if (!VideoMaterialUtil.isEmptyItem(faceItem2)) {
                            this.managers.put(TextUtils.isEmpty(faceItem2.f3494id) ? faceItem2.faceExchangeImage : faceItem2.f3494id, new LoadFaceItemManager(this.mCache, this.mGrayCache, faceFeatureItem.getDataPath(), faceItem2, i));
                        }
                    }
                }
            }
        ...
        for (StickerItem stickerItem : arrayList) {
            if (!(this.managers.containsKey(stickerItem.f18271id) || VideoMaterialUtil.isEmptyItem(stickerItem))) {
                if (stickerItem.stickerType == STICKER_TYPE.ETC.type) {
                    this.managers.put(stickerItem.f18271id, new LoadETCItemManager(this.mETCCache, videoMaterial.getDataPath(), stickerItem));
                } else {
                    this.managers.put(stickerItem.f18271id, new LoadStickerItemManager(this.mCache, videoMaterial.getDataPath(), stickerItem, LOAD_TYPE.LOAD_ALL, i));
                }
            }
        }
        ...
        if (itemList3D != null) {
            ...
            for (StickerItem3D stickerItem3D : itemList3D) {
                if (stickerItem3D.f18271id.contains(VideoMaterialUtil.FRAMES_ID_SEPARATOR_3D)) {
                    String[] split = stickerItem3D.f18271id.split(VideoMaterialUtil.FRAMES_ID_SEPARATOR_3D);
                    if (split.length == 2) {
                        Object obj = split[1];
                        if (!hashSet.contains(obj)) {
                            this.managers.put(stickerItem3D.f18271id, new LoadStickerItemManager3D(videoMaterial.getDataPath(), stickerItem3D, obj, LOAD_TYPE.LOAD_ALL));
                            hashSet.add(obj);
                        }
                    }
                }
    ...
    private long getMaterialImageSizeInKB(VideoMaterial videoMaterial) {
        long j = 0;
        AppMethodBeat.m2504i(81837);
        if (videoMaterial == null) {
            AppMethodBeat.m2505o(81837);
        } else {
            ArrayList<StickerItem> arrayList = new ArrayList();
            if (videoMaterial.getItemList() != null) {
                arrayList.addAll(videoMaterial.getItemList());
            ...
            if (videoMaterial.getFaceOffItemList() != null) {
                for (FaceItem faceItem : videoMaterial.getFaceOffItemList()) {
                    if (!TextUtils.isEmpty(faceItem.f3494id)) {
                        j += (long) (VideoMaterialUtil.getAllImageSize(videoMaterial.getDataPath() + File.separator + faceItem.f3494id) / WXMediaMessage.DESCRIPTION_LENGTH_LIMIT);
                    }
                }
            }
            if (videoMaterial.getFaceFeatureItemList() != null) {
                for (FaceFeatureItem faceFeatureItem2 : videoMaterial.getFaceFeatureItemList()) {
                    if (!(faceFeatureItem2 == null || faceFeatureItem2.getFaceOffItemList() == null)) {
                        for (FaceItem faceItem2 : faceFeatureItem2.getFaceOffItemList()) {
                            if (!TextUtils.isEmpty(faceItem2.f3494id)) {
                                j += (long) (VideoMaterialUtil.getAllImageSize(videoMaterial.getDataPath() + File.separator + faceItem2.f3494id) / WXMediaMessage.DESCRIPTION_LENGTH_LIMIT);
                            }
                        }
                    }
                }
    ...
    public Bitmap loadImage(String str, int i) {
        AppMethodBeat.m2504i(81839);
        LoadItemManager loadItemManager = (LoadItemManager) this.managers.get(str);
        if (loadItemManager != null) {
            Bitmap loadImage = loadItemManager.loadImage(i);
            AppMethodBeat.m2505o(81839);
            return loadImage;
        }
        AppMethodBeat.m2505o(81839);
        return null;
    ...
    public void reset(String str) {
        AppMethodBeat.m2504i(81844);
        LoadItemManager loadItemManager = (LoadItemManager) this.managers.get(str);
        if (loadItemManager != null) {
            loadItemManager.reset();
        }
        AppMethodBeat.m2505o(81844);
    }
