...
public class DebugHandler implements Releasable {
    ...
    class BreakpointHandler implements JavaVoidCallback {
        ...
        public void invoke(V8Object v8Object, V8Array v8Array) {
            AppMethodBeat.m2504i(74826);
            if (v8Array == null || v8Array.isUndefined()) {
                AppMethodBeat.m2505o(74826);
                return;
            }
        ...
        private void safeRelease(Releasable releasable) {
            AppMethodBeat.m2504i(74829);
            if (releasable != null) {
                releasable.release();
            }
            AppMethodBeat.m2505o(74829);
        }
    }
    ...
    public int setBreakpoint(V8Function v8Function) {
        ...
        try {
            ...
            v8Array.release();
            AppMethodBeat.m2505o(74836);
        }
    }

    public int setScriptBreakpoint(String str, int i) {
        AppMethodBeat.m2504i(74837);
        V8Array v8Array = new V8Array(this.runtime);
        v8Array.push(str);
        v8Array.push(i);
        try {
            ...
            v8Array.release();
            AppMethodBeat.m2505o(74837);
        }
    }

    public void enableScriptBreakPoint(int i) {
        AppMethodBeat.m2504i(74838);
        V8Array v8Array = new V8Array(this.runtime);
        v8Array.push(i);
        try {
            ...
            v8Array.release();
            AppMethodBeat.m2505o(74838);
        }
    }

    public void disableScriptBreakPoint(int i) {
        AppMethodBeat.m2504i(74839);
        V8Array v8Array = new V8Array(this.runtime);
        v8Array.push(i);
        try {
            ...
            v8Array.release();
            AppMethodBeat.m2505o(74839);
        }
    }

    public void clearBreakPoint(int i) {
        AppMethodBeat.m2504i(74840);
        V8Array v8Array = new V8Array(this.runtime);
        v8Array.push(i);
        try {
    ...
    public int getScriptBreakPointCount() {
        ...
        try {
            ...
            AppMethodBeat.m2505o(74842);
        }
    }

    public int[] getScriptBreakPointIDs() {
        AppMethodBeat.m2504i(74843);
        V8Array executeArrayFunction = this.debugObject.executeArrayFunction(SCRIPT_BREAK_POINTS, null);
        V8Object object;
        try {
    ...
    public void changeBreakPointCondition(int i, String str) {
        ...
        try {
            ...
            v8Array.release();
            AppMethodBeat.m2505o(74845);
        }
    }

    public void release() {
        AppMethodBeat.m2504i(74846);
        this.debugObject.release();
        AppMethodBeat.m2505o(74846);
    }

    private void setupDebugObject(C45010V8 c45010v8) {
        AppMethodBeat.m2504i(74847);
        V8Object object = c45010v8.getObject(DEBUG_OBJECT_NAME);
        try {
            this.debugObject = object.getObject(V8_DEBUG_OBJECT);
        } finally {
            object.release();
            AppMethodBeat.m2505o(74847);
        }
    }
