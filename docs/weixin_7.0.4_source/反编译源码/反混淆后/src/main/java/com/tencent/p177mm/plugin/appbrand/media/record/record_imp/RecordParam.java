...
import com.tencent.p177mm.plugin.appbrand.media.record.C45656f;
...
public class RecordParam implements Parcelable {
    public static final Creator<RecordParam> CREATOR = new C272041();
    public String appId = "";
    ...
    public C38444b imn = C38444b.MIC;
    public C45656f imo;
    public String processName = "";
    public int sampleRate = 0;
    public int scene = 0;

    /* renamed from: com.tencent.mm.plugin.appbrand.media.record.record_imp.RecordParam$1 */
    static class C272041 implements Creator<RecordParam> {
        C272041() {
        }
        ...
        public final /* synthetic */ Object createFromParcel(Parcel parcel) {
            AppMethodBeat.m2504i(105660);
            RecordParam recordParam = new RecordParam(parcel);
            AppMethodBeat.m2505o(105660);
            return recordParam;
        }
    }
    ...
    public RecordParam(Parcel parcel) {
        ...
        this.imn = C38444b.values()[parcel.readInt()];
        AppMethodBeat.m2505o(105661);
    }

    public void writeToParcel(Parcel parcel, int i) {
        AppMethodBeat.m2504i(105662);
        ...
        AppMethodBeat.m2505o(105662);
    }

    static {
        AppMethodBeat.m2504i(105663);
        AppMethodBeat.m2505o(105663);
    }
}
