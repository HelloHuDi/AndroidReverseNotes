...
public class IOUtils {
    ...
    static {
        AppMethodBeat.m2504i(49765);
        StringWriter stringWriter = new StringWriter(4);
        new PrintWriter(stringWriter).println();
        LINE_SEPARATOR = stringWriter.toString();
        AppMethodBeat.m2505o(49765);
    }

    public static void closeQuietly(Reader reader) {
        AppMethodBeat.m2504i(49717);
        if (reader != null) {
            try {
                reader.close();
            } catch (IOException e) {
                AppMethodBeat.m2505o(49717);
                return;
            }
        }
        AppMethodBeat.m2505o(49717);
    ...
    public static void closeQuietly(Writer writer) {
        AppMethodBeat.m2504i(49718);
        if (writer != null) {
            try {
                writer.close();
            } catch (IOException e) {
                AppMethodBeat.m2505o(49718);
                return;
            }
        }
        AppMethodBeat.m2505o(49718);
    ...
    public static void closeQuietly(InputStream inputStream) {
        AppMethodBeat.m2504i(49719);
        if (inputStream != null) {
            try {
                inputStream.close();
            } catch (IOException e) {
                AppMethodBeat.m2505o(49719);
                return;
            }
        }
        AppMethodBeat.m2505o(49719);
    ...
    public static void closeQuietly(OutputStream outputStream) {
        AppMethodBeat.m2504i(49720);
        if (outputStream != null) {
            try {
                outputStream.close();
            } catch (IOException e) {
                AppMethodBeat.m2505o(49720);
                return;
            }
        }
        AppMethodBeat.m2505o(49720);
    ...
    public static void closeQuietly(Closeable closeable) {
        AppMethodBeat.m2504i(49721);
        if (closeable != null) {
            try {
                closeable.close();
                AppMethodBeat.m2505o(49721);
                return;
            } catch (Throwable th) {
                LogUtils.m50206e(th);
            }
    ...
    public static void writeLines(Collection collection, String str, OutputStream outputStream) {
        AppMethodBeat.m2504i(49752);
        if (collection == null) {
            AppMethodBeat.m2505o(49752);
            return;
        }
        if (str == null) {
            str = LINE_SEPARATOR;
    ...
    public static void writeLines(Collection collection, String str, OutputStream outputStream, String str2) {
        AppMethodBeat.m2504i(49753);
        if (str2 == null) {
            writeLines(collection, str, outputStream);
            AppMethodBeat.m2505o(49753);
    ...
    public static void writeLines(Collection collection, String str, Writer writer) {
        AppMethodBeat.m2504i(49754);
        if (collection == null) {
            AppMethodBeat.m2505o(49754);
            return;
        }
        if (str == null) {
            str = LINE_SEPARATOR;
    ...
    public static int copy(InputStream inputStream, OutputStream outputStream) {
        AppMethodBeat.m2504i(49755);
        long copyLarge = copyLarge(inputStream, outputStream);
        if (copyLarge > 2147483647L) {
            AppMethodBeat.m2505o(49755);
            return -1;
        }
        int i = (int) copyLarge;
        AppMethodBeat.m2505o(49755);
    ...
    public static int copy(Reader reader, Writer writer) {
        AppMethodBeat.m2504i(49759);
        long copyLarge = copyLarge(reader, writer);
        if (copyLarge > 2147483647L) {
            AppMethodBeat.m2505o(49759);
            return -1;
        }
        int i = (int) copyLarge;
        AppMethodBeat.m2505o(49759);
