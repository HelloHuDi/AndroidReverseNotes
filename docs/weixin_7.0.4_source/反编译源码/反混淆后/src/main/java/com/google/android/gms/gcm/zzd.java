            ...
            if (TextUtils.isEmpty(zzd2)) {
                ...
                if (intent2 == null) {
                    ...
                    if (PlatformVersion.isAtLeastO() || this.zzk.getApplicationInfo().targetSdkVersion < 26) {
                        as = new C0358c(this.zzk).mo628z(true).mo616as(i);
                        if (!TextUtils.isEmpty(loadLabel2)) {
                            as.mo621d(loadLabel2);
                        }
                            ...
                            if (this.zzl != null) {
                                ...
                                if (TextUtils.isEmpty(this.zzl) || notificationManager.getNotificationChannel(this.zzl) == null) {
                                    if (notificationManager.getNotificationChannel("fcm_fallback_notification_channel") == null) {
                                        notificationManager.createNotificationChannel(new NotificationChannel("fcm_fallback_notification_channel", this.zzk.getString(C25738R.string.f8613r), 3));
                                    }
