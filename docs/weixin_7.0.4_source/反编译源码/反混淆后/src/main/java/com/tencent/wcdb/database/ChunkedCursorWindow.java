...
public class ChunkedCursorWindow extends SQLiteClosable {
    ...
    private void dispose() {
        AppMethodBeat.m2504i(12212);
        if (this.mWindowPtr != 0) {
            nativeDispose(this.mWindowPtr);
            this.mWindowPtr = 0;
        }
        AppMethodBeat.m2505o(12212);
    }

    /* Access modifiers changed, original: protected */
    public void finalize() {
        AppMethodBeat.m2504i(12213);
        try {
            dispose();
        } finally {
            super.finalize();
            AppMethodBeat.m2505o(12213);
        }
    }

    /* Access modifiers changed, original: protected */
    public void onAllReferencesReleased() {
        AppMethodBeat.m2504i(12214);
        dispose();
        AppMethodBeat.m2505o(12214);
    }

    public void clear() {
        AppMethodBeat.m2504i(12215);
        acquireReference();
        try {
            nativeClear(this.mWindowPtr);
        } finally {
            releaseReference();
            AppMethodBeat.m2505o(12215);
        }
    }

    public long removeChunk(int i) {
        AppMethodBeat.m2504i(12216);
        acquireReference();
        try {
            ...
            releaseReference();
            AppMethodBeat.m2505o(12216);
        }
    }

    public int getNumChunks() {
        AppMethodBeat.m2504i(12217);
        acquireReference();
        try {
    ...
    public long getRowUnsafe(int i) {
        AppMethodBeat.m2504i(12219);
        acquireReference();
        long nativeGetRow = nativeGetRow(this.mWindowPtr, i);
        if (nativeGetRow == 0) {
            releaseReference();
        }
        AppMethodBeat.m2505o(12219);
        return nativeGetRow;
    }

    /* Access modifiers changed, original: 0000 */
    public void endRowUnsafe(long j) {
        AppMethodBeat.m2504i(12220);
        if (j == 0) {
            AppMethodBeat.m2505o(12220);
            return;
        }
    ...
    public byte[] getBlob(int i, int i2) {
        AppMethodBeat.m2504i(12227);
        long rowUnsafe = getRowUnsafe(i);
        if (rowUnsafe == 0) {
            IllegalStateException illegalStateException = new IllegalStateException("Couldn't read row " + i + ", column " + i2 + " from ChunkedCursorWindow.");
            AppMethodBeat.m2505o(12227);
            throw illegalStateException;
        }
        try {
    ...
    public String getString(int i, int i2) {
        AppMethodBeat.m2504i(12228);
        long rowUnsafe = getRowUnsafe(i);
        if (rowUnsafe == 0) {
            IllegalStateException illegalStateException = new IllegalStateException("Couldn't read row " + i + ", column " + i2 + " from ChunkedCursorWindow.");
            AppMethodBeat.m2505o(12228);
            throw illegalStateException;
        }
        try {
    ...
    public long getLong(int i, int i2) {
        AppMethodBeat.m2504i(12229);
        long rowUnsafe = getRowUnsafe(i);
        if (rowUnsafe == 0) {
            IllegalStateException illegalStateException = new IllegalStateException("Couldn't read row " + i + ", column " + i2 + " from ChunkedCursorWindow.");
            AppMethodBeat.m2505o(12229);
            throw illegalStateException;
        }
        try {
    ...
    public double getDouble(int i, int i2) {
        AppMethodBeat.m2504i(12230);
        long rowUnsafe = getRowUnsafe(i);
        if (rowUnsafe == 0) {
            IllegalStateException illegalStateException = new IllegalStateException("Couldn't read row " + i + ", column " + i2 + " from ChunkedCursorWindow.");
            AppMethodBeat.m2505o(12230);
            throw illegalStateException;
        }
        try {
