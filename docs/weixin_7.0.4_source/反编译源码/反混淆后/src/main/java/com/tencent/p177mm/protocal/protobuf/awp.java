...
/* renamed from: com.tencent.mm.protocal.protobuf.awp */
public final class awp extends bsr {
    public String Url;

    /* renamed from: op */
    public final int mo4669op(int i, Object... objArr) {
        AppMethodBeat.m2504i(62572);
        C6092b c6092b;
        int ix;
        if (i == 0) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        awp.BaseRequest = c7267hl;
                    }
                    AppMethodBeat.m2505o(62572);
                    return 0;
                case 2:
                    awp.Url = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(62572);
                    return 0;
                default:
                    AppMethodBeat.m2505o(62572);
