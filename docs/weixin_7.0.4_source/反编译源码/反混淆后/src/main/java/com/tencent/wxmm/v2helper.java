...
public class v2helper {
    ...
    public static void writeLogToFile(String str) {
        AppMethodBeat.m2504i(35414);
        if (mOutputStream == null) {
            AppMethodBeat.m2505o(35414);
            return;
        }
        try {
    ...
    public static void flushLogFile() {
        AppMethodBeat.m2504i(35415);
        if (mOutputStream == null) {
            AppMethodBeat.m2505o(35415);
            return;
        }
        try {
            mOutputStream.flush();
    ...
    public static void closeLogFile() {
        ...
        mOutputStream = null;
        AppMethodBeat.m2505o(35416);
    }

    public static void Loge(String str, String str2) {
        AppMethodBeat.m2504i(35417);
        ...
        AppMethodBeat.m2505o(35417);
    }

    public static void Logi(String str, String str2) {
        AppMethodBeat.m2504i(35418);
        new StringBuilder("[").append(Thread.currentThread().getId()).append("]").append(str2);
        writeLogToFile(str + VideoMaterialUtil.FRAMES_ID_SEPARATOR_3D + str2 + " \n");
        AppMethodBeat.m2505o(35418);
    }

    public static void Logd(String str, String str2) {
        AppMethodBeat.m2504i(35419);
        new StringBuilder("[").append(Thread.currentThread().getId()).append("]").append(str2);
        writeLogToFile(str + VideoMaterialUtil.FRAMES_ID_SEPARATOR_3D + str2 + " \n");
        AppMethodBeat.m2505o(35419);
    }

    public static void Logw(String str, String str2) {
        AppMethodBeat.m2504i(35420);
        new StringBuilder("[").append(Thread.currentThread().getId()).append("]").append(str2);
        writeLogToFile(str + VideoMaterialUtil.FRAMES_ID_SEPARATOR_3D + str2 + " \n");
        AppMethodBeat.m2505o(35420);
    }

    public static void outputJniLog(byte[] bArr, String str, int i) {
        AppMethodBeat.m2504i(35421);
        String str2 = new String(bArr);
        if (str.equals("MicroMsg.v2Core")) {
            writeLogToFile(str + VideoMaterialUtil.FRAMES_ID_SEPARATOR_3D + str2);
            AppMethodBeat.m2505o(35421);
            return;
        }
        writeLogToFile(str + VideoMaterialUtil.FRAMES_ID_SEPARATOR_3D + str2 + " \n");
        AppMethodBeat.m2505o(35421);
