...
public class ExdeviceStepChartView extends View {
    ...
    public ExdeviceStepChartView(Context context, AttributeSet attributeSet) {
        ...
        AppMethodBeat.m2504i(20223);
        this.lDV = -1;
        this.lDW = -1;
        this.lDX = getResources().getColor(C25738R.color.f11967ng);
        this.lDY = 12.0f;
        this.lDZ = 28.0f;
        this.lEa = 33.0f;
        this.lEb = 12.0f;
        this.lEc = 12.0f;
        this.lEd = getResources().getColor(C25738R.color.f11968nh);
        this.lEe = -1;
        this.lEf = getResources().getColor(C25738R.color.f11968nh);
        this.lEg = -1;
        ...
        this.lEi = 10.0f;
        this.lEj = 2.5f;
        this.lEk = (int) m19529m(1, 2.5f);
        this.lEl = 4.0f;
        this.lEm = (int) m19529m(1, 4.0f);
        this.lEn = 1.8f;
        this.lEo = (int) m19529m(1, 1.8f);
        this.lEp = 1.0f;
        this.lEq = (int) m19529m(1, 1.0f);
        this.lEr = 8.0f;
        this.lEs = (int) m19529m(1, 8.0f);
        this.lEt = 22.0f;
        this.lEu = (int) m19529m(1, 22.0f);
        this.lEv = 67.0f;
        this.lEw = (int) m19529m(1, 67.0f);
        this.lEx = 40.0f;
        this.lEy = (int) m19529m(1, 40.0f);
        this.lEz = 22.0f;
        this.lEA = (int) m19529m(1, 22.0f);
        this.lEB = 55.0f;
        this.lEC = (int) m19529m(1, 55.0f);
        this.lED = 35.0f;
        this.lEE = (int) m19529m(1, 35.0f);
        this.lEF = 45.0f;
        this.lEG = (int) m19529m(1, 45.0f);
        this.lEH = 8.0f;
        this.lEI = (float) ((int) m19529m(1, 8.0f));
        this.lEJ = 8.0f;
        this.lEK = (float) ((int) m19529m(1, 8.0f));
        this.lEL = 2;
        this.lEM = (int) m19529m(1, 2.0f);
        this.lEN = 15;
        this.lEO = (int) m19529m(1, 15.0f);
        this.lEP = 33.0f;
        this.lEQ = (int) m19529m(1, 33.0f);
        this.lER = 8.0f;
        this.lES = (int) m19529m(1, 8.0f);
        this.lET = 35.0f;
        this.lEU = (int) m19529m(1, 35.0f);
        this.lEV = 10.0f;
        this.lEW = (int) m19529m(1, 10.0f);
        this.lEX = 58.0f;
        this.lEY = (int) m19529m(1, 58.0f);
        this.lEZ = (int) m19529m(1, 1.0f);
        this.lFa = 102;
        this.lFb = 102;
    ...
    public ExdeviceStepChartView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.lFv = new DashPathEffect(new float[]{5.0f, 5.0f}, 0.0f);
        bqd();
        AppMethodBeat.m2505o(20224);
    }

    /* renamed from: c */
    private void m19528c(Canvas canvas, boolean z) {
        int i = 0;
        AppMethodBeat.m2504i(20225);
        if (z) {
            this.lFs.reset();
    ...
    /* renamed from: m */
    private float m19529m(int i, float f) {
        Resources system;
        AppMethodBeat.m2504i(20226);
        ...
        AppMethodBeat.m2505o(20226);
        return applyDimension;
    }

    /* renamed from: a */
    private void m19526a(Canvas canvas, List<String> list) {
        AppMethodBeat.m2504i(20227);
        if (list != null && list.size() == 7) {
            this.aFY.reset();
            this.aFY.setAntiAlias(true);
            this.aFY.setStrokeWidth(0.0f);
            this.aFY.setTextSize(m19529m(2, 12.0f));
        ...
        AppMethodBeat.m2505o(20227);
    }

    private void bqd() {
        AppMethodBeat.m2504i(20228);
        this.aFY = new Paint();
        this.lFr = new Path();
        this.lFs = new Path();
    ...
    private void bqf() {
        AppMethodBeat.m2504i(20229);
        this.aFY.reset();
        this.aFY.setAntiAlias(true);
        this.aFY.setStrokeWidth((float) this.lEo);
        this.aFY.setStyle(Style.STROKE);
        this.aFY.setColor(-1);
        AppMethodBeat.m2505o(20229);
    }

    /* Access modifiers changed, original: protected */
    public void onDraw(Canvas canvas) {
        AppMethodBeat.m2504i(20230);
        getData();
        super.onDraw(canvas);
        if (!this.lFu) {
            int i;
        ...
        if (!this.lFu) {
            ...
            this.aFY.setTextSize(m19529m(2, 12.0f));
            this.aFY.setTextAlign(Align.RIGHT);
            canvas.drawText(getResources().getString(C25738R.string.bhh), (float) (this.iZn - this.lEM), (float) (((double) this.lFh) + (((double) this.aFY.getTextSize()) * 0.34d)), this.aFY);
        }
        this.aFY.reset();
        this.aFY.setColor(-1);
        this.aFY.setAntiAlias(true);
        ...
        this.aFY.setTextSize(m19529m(2, 28.0f));
        canvas.drawText(getResources().getString(C25738R.string.bhj), (float) this.lES, (float) this.lEQ, this.aFY);
        this.aFY.setTextAlign(Align.RIGHT);
        this.aFY.setTextSize(m19529m(2, 33.0f));
        ...
        if (this.points.size() > 2) {
            ...
            bqf();
            if (!this.lFu) {
                m19528c(canvas, false);
            }
        }
        m19526a(canvas, this.lFt);
        AppMethodBeat.m2505o(20230);
    }

    private void getData() {
        int i;
        int i2 = 0;
        AppMethodBeat.m2504i(20231);
        this.points.clear();
        View findViewById = findViewById(2131823695);
        ...
        AppMethodBeat.m2505o(20231);
    }

    /* renamed from: aB */
    private int m19527aB(float f) {
        int i;
        AppMethodBeat.m2504i(20232);
        this.lEh = BaseClientBuilder.API_PRIORITY_OTHER;
        ...
        i = this.lEh;
        AppMethodBeat.m2505o(20232);
        return i;
    }

    public boolean onTouchEvent(MotionEvent motionEvent) {
        AppMethodBeat.m2504i(20233);
        float x = motionEvent.getX();
        motionEvent.getY();
        C4990ab.m7416i("MicroMsg.exdevice.ExdeviceStepChartView", "mOnTouchLinePsition:" + this.lEh);
        switch (motionEvent.getAction()) {
            case 0:
                C4990ab.m7410d("MicroMsg.exdevice.ExdeviceStepChartView", "ACTION_DOWN");
                AppMethodBeat.m2505o(20233);
                return true;
            case 1:
                C4990ab.m7410d("MicroMsg.exdevice.ExdeviceStepChartView", "ACTION_UP");
                this.lEh = m19527aB(x);
                bqe();
                this.lFx = false;
                invalidate();
                ...
                return false;
            default:
                C4990ab.m7410d("MicroMsg.exdevice.ExdeviceStepChartView", "default");
                AppMethodBeat.m2505o(20233);
                return false;
        }
    }
