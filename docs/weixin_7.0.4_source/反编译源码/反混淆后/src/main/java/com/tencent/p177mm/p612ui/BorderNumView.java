...
import com.tencent.p177mm.platformtools.C37985b.C9786a;
...
public class BorderNumView extends View {
    ...
    public BorderNumView(Context context, AttributeSet attributeSet) {
        ...
        AppMethodBeat.m2504i(29137);
        this.context = context;
        init();
        AppMethodBeat.m2505o(29137);
    }

    public BorderNumView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        AppMethodBeat.m2504i(29138);
        this.context = context;
        init();
        AppMethodBeat.m2505o(29138);
    }

    private void init() {
        AppMethodBeat.m2504i(29139);
        this.mPaint = new Paint();
        AppMethodBeat.m2505o(29139);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        float b = (float) C9786a.m17425b(this.context, (float) yfy);
        float b2 = (float) C9786a.m17425b(this.context, (float) yfz);
        String str = this.yfx;
