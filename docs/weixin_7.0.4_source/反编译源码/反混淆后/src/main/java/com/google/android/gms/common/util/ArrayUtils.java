...
public final class ArrayUtils {
    ...
    static class zza {
        ...
        zza(int i) {
            AppMethodBeat.m2504i(89995);
            this.zzzb = new HashMap(i);
            AppMethodBeat.m2505o(89995);
        }

        private final zza zzd(Object obj) {
            AppMethodBeat.m2504i(89998);
            zza zza = (zza) this.zzzb.get(obj);
            if (zza == null) {
                zza = new zza();
                this.zzzb.put(obj, zza);
            }
            AppMethodBeat.m2505o(89998);
            return zza;
        }

        /* Access modifiers changed, original: final */
        public final void zzb(Object obj) {
            AppMethodBeat.m2504i(89996);
            zza zzd = zzd(obj);
            zzd.count++;
            AppMethodBeat.m2505o(89996);
        }

        /* Access modifiers changed, original: final */
        public final void zzc(Object obj) {
            AppMethodBeat.m2504i(89997);
            zza zzd = zzd(obj);
            zzd.count--;
            AppMethodBeat.m2505o(89997);
        }
    }
    ...
    public static byte[] concatByteArrays(byte[]... bArr) {
        AppMethodBeat.m2504i(90019);
        if (bArr.length == 0) {
            byte[] bArr2 = new byte[0];
            AppMethodBeat.m2505o(90019);
            return bArr2;
        }
        int i;
        int i2 = 0;
    ...
    public static <T> boolean contains(T[] tArr, T t) {
        AppMethodBeat.m2504i(90000);
        if (indexOf(tArr, t) >= 0) {
            AppMethodBeat.m2505o(90000);
            return true;
        }
        AppMethodBeat.m2505o(90000);
        return false;
    ...
    public static boolean containsIgnoreCase(String[] strArr, String str) {
        AppMethodBeat.m2504i(90001);
        if (strArr == null) {
            AppMethodBeat.m2505o(90001);
            return false;
        }
    ...
    public static boolean equalsAnyOrder(Object[] objArr, Object[] objArr2) {
        AppMethodBeat.m2504i(90002);
        if (objArr == objArr2) {
            AppMethodBeat.m2505o(90002);
            return true;
        }
    ...
    public static <T> int indexOf(T[] tArr, T t) {
        int i = 0;
        AppMethodBeat.m2504i(89999);
        int length = tArr != null ? tArr.length : 0;
        while (i < length) {
            if (Objects.equal(tArr[i], t)) {
                AppMethodBeat.m2505o(89999);
                return i;
            }
            i++;
        }
    ...
    public static <T> ArrayList<T> newArrayList() {
        AppMethodBeat.m2504i(90027);
        ArrayList arrayList = new ArrayList();
        AppMethodBeat.m2505o(90027);
        return arrayList;
    }

    public static <T> int rearrange(T[] tArr, Predicate<T> predicate) {
        AppMethodBeat.m2504i(90026);
        if (tArr == null || tArr.length == 0) {
            AppMethodBeat.m2505o(90026);
            return 0;
        }
    ...
    public static int[] removeAll(int[] iArr, int... iArr2) {
        AppMethodBeat.m2504i(90023);
        int[] copyOf;
        if (iArr == null) {
            AppMethodBeat.m2505o(90023);
            return null;
    ...
    public static <T> T[] removeAll(T[] tArr, T... tArr2) {
        AppMethodBeat.m2504i(90022);
        Object[] copyOf;
        if (tArr == null) {
            AppMethodBeat.m2505o(90022);
            return null;
    ...
    public static int[] resize(int[] iArr, int i) {
        AppMethodBeat.m2504i(90025);
        if (iArr == null) {
            AppMethodBeat.m2505o(90025);
            return null;
        }
        if (i != iArr.length) {
    ...
    public static <T> T[] resize(T[] tArr, int i) {
        AppMethodBeat.m2504i(90024);
        if (tArr == null) {
            AppMethodBeat.m2505o(90024);
            return null;
        }
        if (i != tArr.length) {
    ...
    public static <T> ArrayList<T> toArrayList(Collection<T> collection) {
        AppMethodBeat.m2504i(90029);
        if (collection == null) {
            AppMethodBeat.m2505o(90029);
            return null;
        }
    ...
    public static <T> ArrayList<T> toArrayList(T[] tArr) {
        AppMethodBeat.m2504i(90028);
        ArrayList arrayList = new ArrayList(r1);
        for (Object add : tArr) {
            arrayList.add(add);
        }
        AppMethodBeat.m2505o(90028);
        return arrayList;
    }

    public static long[] toLongArray(Collection<Long> collection) {
        AppMethodBeat.m2504i(90032);
        if (collection == null || collection.size() == 0) {
            long[] jArr = new long[0];
            AppMethodBeat.m2505o(90032);
            return jArr;
        }
    ...
    public static long[] toLongArray(Long[] lArr) {
        int i = 0;
        AppMethodBeat.m2504i(90033);
        if (lArr == null) {
            long[] jArr = new long[0];
            AppMethodBeat.m2505o(90033);
            return jArr;
        }
    ...
    public static int[] toPrimitiveArray(Collection<Integer> collection) {
        AppMethodBeat.m2504i(90030);
        if (collection == null || collection.size() == 0) {
            int[] iArr = new int[0];
            AppMethodBeat.m2505o(90030);
            return iArr;
        }
    ...
    public static int[] toPrimitiveArray(Integer[] numArr) {
        int i = 0;
        AppMethodBeat.m2504i(90031);
        if (numArr == null) {
            int[] iArr = new int[0];
            AppMethodBeat.m2505o(90031);
            return iArr;
        }
    ...
    public static String[] toStringArray(Collection<String> collection) {
        AppMethodBeat.m2504i(90034);
        String[] strArr;
        if (collection == null || collection.size() == 0) {
            strArr = new String[0];
            AppMethodBeat.m2505o(90034);
            return strArr;
        }
    ...
    public static Boolean[] toWrapperArray(boolean[] zArr) {
        AppMethodBeat.m2504i(90009);
        if (zArr == null) {
            AppMethodBeat.m2505o(90009);
            return null;
        }
    ...
    public static Byte[] toWrapperArray(byte[] bArr) {
        AppMethodBeat.m2504i(90008);
        if (bArr == null) {
            AppMethodBeat.m2505o(90008);
            return null;
        }
    ...
    public static Character[] toWrapperArray(char[] cArr) {
        AppMethodBeat.m2504i(90004);
        if (cArr == null) {
            AppMethodBeat.m2505o(90004);
            return null;
        }
    ...
    public static Double[] toWrapperArray(double[] dArr) {
        AppMethodBeat.m2504i(90006);
        if (dArr == null) {
            AppMethodBeat.m2505o(90006);
            return null;
        }
    ...
    public static Float[] toWrapperArray(float[] fArr) {
        AppMethodBeat.m2504i(90007);
        if (fArr == null) {
            AppMethodBeat.m2505o(90007);
            return null;
        }
    ...
    public static Integer[] toWrapperArray(int[] iArr) {
        AppMethodBeat.m2504i(90003);
        if (iArr == null) {
            AppMethodBeat.m2505o(90003);
            return null;
        }
    ...
    public static Long[] toWrapperArray(long[] jArr) {
        AppMethodBeat.m2504i(90005);
        if (jArr == null) {
            AppMethodBeat.m2505o(90005);
            return null;
        }
    ...
    public static Short[] toWrapperArray(short[] sArr) {
        AppMethodBeat.m2504i(90010);
        if (sArr == null) {
            AppMethodBeat.m2505o(90010);
            return null;
        }
