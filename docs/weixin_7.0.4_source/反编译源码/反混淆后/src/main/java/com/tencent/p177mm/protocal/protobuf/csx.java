...
/* renamed from: com.tencent.mm.protocal.protobuf.csx */
public final class csx extends btd {
    public String vOy;

    /* renamed from: op */
    public final int mo4669op(int i, Object... objArr) {
        AppMethodBeat.m2504i(93812);
        int ix;
        if (i == 0) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        csx.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.m2505o(93812);
                    return 0;
                case 2:
                    csx.vOy = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(93812);
                    return 0;
                default:
                    AppMethodBeat.m2505o(93812);
