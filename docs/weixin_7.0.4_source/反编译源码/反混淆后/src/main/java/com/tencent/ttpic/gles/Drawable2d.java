...
public class Drawable2d {
    ...
    public enum Prefab {
        ...
        static {
            AppMethodBeat.m2505o(49951);
        }
    }

    static {
        AppMethodBeat.m2504i(49954);
        AppMethodBeat.m2505o(49954);
    }

    public Drawable2d(Prefab prefab) {
        AppMethodBeat.m2504i(49952);
        switch (prefab) {
            case TRIANGLE:
    ...
    public String toString() {
        AppMethodBeat.m2504i(49953);
        String str;
        if (this.mPrefab != null) {
            str = "[Drawable2d: " + this.mPrefab + "]";
            AppMethodBeat.m2505o(49953);
            return str;
        }
        str = "[Drawable2d: ...]";
        AppMethodBeat.m2505o(49953);
