...
public class FacialFeatureFilter extends VideoFilterBase {
    ...
    public void initParams() {
        AppMethodBeat.m2504i(82448);
        addParam(new C25628k("inputImageTexture2", FaceOffUtil.getFaceBitmap(this.mFaceFeatureItem.getDataPath() + File.separator + this.mFaceItem.faceExchangeImage), 33987, true));
        addParam(new C25626j("posMatRotate", this.mt4));
        if (this.mTransformFilter != null) {
            this.mTransformFilter.initParams();
        }
        AppMethodBeat.m2505o(82448);
    }

    public C41672h getFrame() {
        return this.mFrame;
    }

    public void updatePreview(PTDetectInfo pTDetectInfo) {
        AppMethodBeat.m2504i(82449);
    ...
    private void updateFacePoints(List<PointF> list, float f) {
        ...
        AppMethodBeat.m2505o(82450);
    }

    public void initAttribParams() {
        AppMethodBeat.m2504i(82451);
        ...
        setCoordNum(690);
        AppMethodBeat.m2505o(82451);
    }

    public void ApplyGLSLFilter() {
        AppMethodBeat.m2504i(82452);
        ...
        AppMethodBeat.m2505o(82452);
    }

    public void updateVideoSize(int i, int i2, double d) {
        AppMethodBeat.m2504i(82453);
        ...
        AppMethodBeat.m2505o(82453);
    }

    public void RenderProcess(int i, int i2, int i3, int i4, double d, C41672h c41672h) {
        AppMethodBeat.m2504i(82454);
        C41672h c41672h2 = this.mFrame;
        int i5 = FRAME_EDGE;
        c41672h2.mo67189a(-1, i5, i5, d);
        ...
        AppMethodBeat.m2505o(82454);
    }

    public void clearGLSLSelf() {
        AppMethodBeat.m2504i(82455);
        if (this.mTransformFilter != null) {
        ...
        this.mTFrame.clear();
        super.clearGLSLSelf();
        AppMethodBeat.m2505o(82455);
    }

    public boolean setRenderMode(int i) {
        AppMethodBeat.m2504i(82456);
    ...
    public void updateStickerFilterList(List<PointF> list, float[] fArr, C41672h c41672h) {
        AppMethodBeat.m2504i(82458);
        updatePreview(new Builder().facePoints(list).faceAngles(fArr).build());
        RenderProcess(c41672h.texture[0], c41672h.width, c41672h.height, c41672h.texture[0], 0.0d, c41672h);
        for (NormalVideoFilter normalVideoFilter : this.mStickerFilters) {
            if (!normalVideoFilter.needLoadImage()) {
                ...
                float f = (((float) normalVideoFilter.item.f18269dx) * distance) / ((float) normalVideoFilter.item.originalScaleFactor);
                float f2 = (((float) normalVideoFilter.item.f18270dy) * distance) / ((float) normalVideoFilter.item.originalScaleFactor);
        ...
        AppMethodBeat.m2505o(82458);
    }

    public void reset() {
        AppMethodBeat.m2504i(82459);
