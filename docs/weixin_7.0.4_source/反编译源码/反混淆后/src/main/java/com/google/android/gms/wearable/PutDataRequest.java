...
public class PutDataRequest extends AbstractSafeParcelable {
    ...
    public boolean hasAsset(String str) {
        AppMethodBeat.m2504i(70883);
        Asserts.checkNotNull(str, "key must not be null");
        boolean containsKey = this.zzv.containsKey(str);
        AppMethodBeat.m2505o(70883);
        return containsKey;
    }
    ...
    public PutDataRequest putAsset(String str, Asset asset) {
        AppMethodBeat.m2504i(70884);
        Preconditions.checkNotNull(str);
        Preconditions.checkNotNull(asset);
        this.zzv.putParcelable(str, asset);
        AppMethodBeat.m2505o(70884);
        return this;
    }

    public PutDataRequest removeAsset(String str) {
        AppMethodBeat.m2504i(70885);
        Asserts.checkNotNull(str, "key must not be null");
        this.zzv.remove(str);
        AppMethodBeat.m2505o(70885);
        return this;
    }
    ...
    public String toString() {
        AppMethodBeat.m2504i(70886);
        String putDataRequest = toString(Log.isLoggable(DataMap.TAG, 3));
        AppMethodBeat.m2505o(70886);
        return putDataRequest;
    }

    public String toString(boolean z) {
        AppMethodBeat.m2504i(70887);
