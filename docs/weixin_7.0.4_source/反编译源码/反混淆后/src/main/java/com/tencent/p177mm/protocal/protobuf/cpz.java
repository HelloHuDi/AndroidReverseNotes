...
/* renamed from: com.tencent.mm.protocal.protobuf.cpz */
public final class cpz extends bsr {
    ...
    public final int mo4669op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.xmK != null) {
                c6093a.mo13479iy(5, this.xmK.computeSize());
            ...
            if (this.xmK != null) {
                ix += C6087a.m9557ix(5, this.xmK.computeSize());
            }
            int o = ix + C6091a.m9578o(6, this.xlQ);
            AppMethodBeat.m2505o(5265);
            return o;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        cpz.BaseRequest = c7267hl;
                    }
                    AppMethodBeat.m2505o(5265);
                    return 0;
                case 2:
                    cpz.wPm = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(5265);
                    return 0;
                case 3:
                    cpz.wem = c6086a2.BTU.mo13458vd();
                    AppMethodBeat.m2505o(5265);
                    return 0;
                case 4:
                    cpz.wen = c6086a2.BTU.mo13459ve();
                    AppMethodBeat.m2505o(5265);
                    return 0;
                case 5:
                    Vh = c6086a2.mo13445Vh(intValue);
