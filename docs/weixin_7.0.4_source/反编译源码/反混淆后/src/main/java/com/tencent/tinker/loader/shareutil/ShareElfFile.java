...
public class ShareElfFile implements Closeable {
    ...
    public static class ElfHeader {
        ...
        private ElfHeader(FileChannel fileChannel) {
            ...
            if (this.AEa[0] == Byte.MAX_VALUE && this.AEa[1] == (byte) 69 && this.AEa[2] == (byte) 76 && this.AEa[3] == (byte) 70) {
                ShareElfFile.m9347D(this.AEa[4], 2, "bad elf class: " + this.AEa[4]);
                ShareElfFile.m9347D(this.AEa[5], 2, "bad elf data encoding: " + this.AEa[5]);
                ...
                ShareElfFile.m9349a(fileChannel, allocate, "failed to read rest part of ehdr.");
                this.AEb = allocate.getShort();
                this.AEc = allocate.getShort();
                this.AEd = allocate.getInt();
                ShareElfFile.m9347D(this.AEd, 1, "bad elf version: " + this.AEd);
                switch (this.AEa[4]) {
                    case (byte) 1:
    ...
    public ShareElfFile(File file) {
        ...
        for (i = 0; i < this.ADY.length; i++) {
            m9349a(channel, allocate, "failed to read phdr.");
        ...
        for (i = 0; i < this.ADZ.length; i++) {
            m9349a(channel, allocate, "failed to read shdr.");
        ...
        if (this.ADX.AEn > (short) 0) {
            ...
            m9349a(this.ADV.getChannel(), allocate2, "failed to read section: " + sectionHeader.AEG);
            ...
            while (i2 < length) {
                ...
                sectionHeader2.AEG = m9348K(allocate2);
    ...
    /* renamed from: an */
    public static int m9350an(File file) {
        Throwable th;
    ...
    /* renamed from: a */
    public static void m9349a(FileChannel fileChannel, ByteBuffer byteBuffer, String str) {
        byteBuffer.rewind();
    ...
    /* renamed from: K */
    private static String m9348K(ByteBuffer byteBuffer) {
    ...
    /* renamed from: D */
    static /* synthetic */ void m9347D(int i, int i2, String str) {
        if (i <= 0 || i > i2) {
