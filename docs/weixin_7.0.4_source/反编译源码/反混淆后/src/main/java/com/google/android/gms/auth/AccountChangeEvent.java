...
public class AccountChangeEvent extends AbstractSafeParcelable {
    ...
    static {
        AppMethodBeat.m2504i(76927);
        AppMethodBeat.m2505o(76927);
    }
    ...
    AccountChangeEvent(@Param(id = 1) int i, @Param(id = 2) long j, @Param(id = 3) String str, @Param(id = 4) int i2, @Param(id = 5) int i3, @Param(id = 6) String str2) {
        ...
        this.zzl = i3;
        this.zzm = str2;
        AppMethodBeat.m2505o(76921);
    }

    public AccountChangeEvent(long j, String str, int i, int i2, String str2) {
        AppMethodBeat.m2504i(76922);
        this.zzh = 1;
        this.zzi = j;
        this.zzj = (String) Preconditions.checkNotNull(str);
        this.zzk = i;
        this.zzl = i2;
        this.zzm = str2;
        AppMethodBeat.m2505o(76922);
    }

    public boolean equals(Object obj) {
        AppMethodBeat.m2504i(76926);
        if (obj == this) {
            AppMethodBeat.m2505o(76926);
            return true;
    ...
    public int hashCode() {
        ...
        AppMethodBeat.m2505o(76925);
        return hashCode;
    }

    public String toString() {
        AppMethodBeat.m2504i(76924);
        Object obj = "UNKNOWN";
        switch (this.zzk) {
            case 1:
                obj = "ADDED";
        ...
        AppMethodBeat.m2505o(76924);
        return stringBuilder;
    }

    public void writeToParcel(Parcel parcel, int i) {
        AppMethodBeat.m2504i(76923);
