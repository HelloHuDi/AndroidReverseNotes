...
public class BeautyTransformList {
    ...
    public class FaceInfoOfPeople {
        ...
        public FaceInfoOfPeople() {
            AppMethodBeat.m2504i(82024);
            AppMethodBeat.m2505o(82024);
        }
    }
    ...
    public BeautyTransformList() {
        ...
        AppMethodBeat.m2505o(82025);
    }

    public void initial() {
        AppMethodBeat.m2504i(82026);
        ...
        AppMethodBeat.m2505o(82026);
    }

    public void setBeautyParam(BeautyParam beautyParam) {
        AppMethodBeat.m2504i(82027);
        if (beautyParam == null) {
            AppMethodBeat.m2505o(82027);
            return;
        }
    ...
    public void setBeautyParam(int i, DistortParam distortParam) {
        AppMethodBeat.m2504i(82028);
        if (distortParam == null) {
            AppMethodBeat.m2505o(82028);
            return;
        }
        ArrayList arrayList;
    ...
    private void rebuildFilterList() {
        ...
        clearTransFrame();
        AppMethodBeat.m2505o(82029);
    }

    private void clearTransFrame() {
        AppMethodBeat.m2504i(82030);
        for (C41672h clear : this.transFrame) {
            clear.clear();
        }
        AppMethodBeat.m2505o(82030);
    }

    public C41672h process(C41672h c41672h, List<List<PointF>> list, double d, List<float[]> list2, float f) {
        AppMethodBeat.m2504i(82031);
        updateVideoSize(c41672h.width, c41672h.height, d);
        C41672h updateAndRender = updateAndRender(c41672h, list, list2, f);
        AppMethodBeat.m2505o(82031);
        return updateAndRender;
    }

    private boolean samePeople(List<PointF> list, List<PointF> list2) {
        AppMethodBeat.m2504i(82032);
    ...
    private void updatePeopleList(List<List<PointF>> list, List<float[]> list2) {
        AppMethodBeat.m2504i(82033);
        if (BaseUtils.isEmpty(list)) {
            AppMethodBeat.m2505o(82033);
            return;
        }
    ...
    public boolean needFaceInfo() {
        AppMethodBeat.m2504i(82041);
        if (this.mFilters.size() != 0) {
            AppMethodBeat.m2505o(82041);
            return true;
        }
        AppMethodBeat.m2505o(82041);
        return false;
