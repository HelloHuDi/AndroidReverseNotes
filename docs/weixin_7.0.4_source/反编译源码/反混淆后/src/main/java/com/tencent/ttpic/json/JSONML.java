...
public class JSONML {
    ...
    /* JADX WARNING: Missing block: B:87:0x017c, code skipped:
            ...
            com.tencent.matrix.trace.core.AppMethodBeat.m2505o(50107);
     */
                ...
                if (nextToken instanceof Character) {
                    if (nextToken == XML.SLASH) {
                        ...
                        if (!(nextContent instanceof String)) {
                            ...
                            AppMethodBeat.m2505o(50107);
                            throw jSONException;
                        } else if (xMLTokener.nextToken() != XML.f14329GT) {
                        ...
                        if (next == '-') {
                            ...
                            do {
                                ...
                                if (nextMeta == null) {
                                    ...
                                    AppMethodBeat.m2505o(50107);
                                    throw syntaxError;
                                } else if (nextMeta == XML.f14330LT) {
                                    i++;
                                    continue;
                                } else if (nextMeta == XML.f14329GT) {
                                    i--;
                                    continue;
                                } else {
                                    continue;
                        ...
                        while (true) {
                            ...
                            if (nextMeta == null) {
                                ...
                                if (nextMeta == XML.SLASH) {
                                    if (xMLTokener.nextToken() != XML.f14329GT) {
                                        syntaxError = xMLTokener.syntaxError("Misshaped tag");
                                        AppMethodBeat.m2505o(50107);
                                        throw syntaxError;
                                    } else if (jSONArray == null) {
    ...
    public static String toString(JSONArray jSONArray) {
        ...
        AppMethodBeat.m2505o(50112);
        return string;
    }

    public static String toString(JSONObject jSONObject) {
        AppMethodBeat.m2504i(50113);
        StringBuffer stringBuffer = new StringBuffer();
        String optString = jSONObject.optString("tagName");
        if (optString == null) {
            optString = XML.escape(jSONObject.toString());
            AppMethodBeat.m2505o(50113);
            return optString;
        }
