...
public class GoogleApi<O extends ApiOptions> {
    ...
    public static class Settings {
        ...
        public static class Builder {
            ...
            public Settings build() {
                ...
                AppMethodBeat.m2505o(60505);
                return settings;
            }

            @KeepForSdk
            public Builder setLooper(Looper looper) {
                AppMethodBeat.m2504i(60504);
                Preconditions.checkNotNull(looper, "Looper must not be null.");
                this.zzcn = looper;
                AppMethodBeat.m2505o(60504);
                return this;
            }

            @KeepForSdk
            public Builder setMapper(StatusExceptionMapper statusExceptionMapper) {
                AppMethodBeat.m2504i(60503);
                Preconditions.checkNotNull(statusExceptionMapper, "StatusExceptionMapper must not be null.");
                this.zzcp = statusExceptionMapper;
                AppMethodBeat.m2505o(60503);
                return this;
            }
        }

        static {
            AppMethodBeat.m2504i(60506);
            AppMethodBeat.m2505o(60506);
        }
    ...
    public GoogleApi(Activity activity, Api<O> api, O o, StatusExceptionMapper statusExceptionMapper) {
        ...
        AppMethodBeat.m2504i(60511);
        AppMethodBeat.m2505o(60511);
    }

    @KeepForSdk
    protected GoogleApi(Context context, Api<O> api, Looper looper) {
        AppMethodBeat.m2504i(60507);
    ...
    public GoogleApi(Context context, Api<O> api, O o, Looper looper, StatusExceptionMapper statusExceptionMapper) {
        ...
        AppMethodBeat.m2504i(60508);
        AppMethodBeat.m2505o(60508);
    }

    @KeepForSdk
    public GoogleApi(Context context, Api<O> api, O o, Settings settings) {
        AppMethodBeat.m2504i(60510);
        Preconditions.checkNotNull(context, "Null context is not permitted.");
        Preconditions.checkNotNull(api, "Api must not be null.");
        Preconditions.checkNotNull(settings, "Settings must not be null; use Settings.DEFAULT_SETTINGS instead.");
        this.mContext = context.getApplicationContext();
