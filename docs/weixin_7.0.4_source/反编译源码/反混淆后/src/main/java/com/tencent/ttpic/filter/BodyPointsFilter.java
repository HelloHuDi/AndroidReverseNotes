...
public class BodyPointsFilter extends VideoFilterBase {
    ...
    public BodyPointsFilter() {
        ...
        AppMethodBeat.m2504i(82051);
        AppMethodBeat.m2505o(82051);
    }
    ...
    public void initAttribParams() {
        AppMethodBeat.m2504i(82052);
        setPositions(GlUtil.ORIGIN_POSITION_COORDS);
        AppMethodBeat.m2505o(82052);
    }

    public void ApplyGLSLFilter() {
        AppMethodBeat.m2504i(82053);
        super.ApplyGLSLFilter();
        AppMethodBeat.m2505o(82053);
    }

    public void clearGLSLSelf() {
        AppMethodBeat.m2504i(82054);
        super.clearGLSLSelf();
        AppMethodBeat.m2505o(82054);
    }

    public void updatePoints(List<PointF> list, int i, int i2) {
        AppMethodBeat.m2504i(82055);
        if (list == null || list.size() != 59) {
            this.mNoPoints = true;
            AppMethodBeat.m2505o(82055);
            return;
        }
    ...
    public void render(int i, int i2, int i3) {
        ...
        AppMethodBeat.m2505o(82056);
    }

    private void normalizePoints(List<PointF> list, int i, int i2) {
        int i3 = 0;
        AppMethodBeat.m2504i(82057);
        if (list == null || list.size() == 0) {
            AppMethodBeat.m2505o(82057);
            return;
        }
        int i4;
