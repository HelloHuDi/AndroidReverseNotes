...
public class InstanceID {
    ...
    private static Map<String, InstanceID> zzbq = new C6197a();
    ...
    static {
        AppMethodBeat.m2504i(57518);
        AppMethodBeat.m2505o(57518);
    }

    private InstanceID(Context context, String str) {
        AppMethodBeat.m2504i(57502);
        this.zzk = context.getApplicationContext();
        this.zzbv = str;
        AppMethodBeat.m2505o(57502);
    }

    @Deprecated
    public static InstanceID getInstance(Context context) {
        AppMethodBeat.m2504i(57505);
        InstanceID instance = getInstance(context, null);
        AppMethodBeat.m2505o(57505);
        return instance;
    }
    ...
    static int zzg(Context context) {
        int i = 0;
        AppMethodBeat.m2504i(57503);
        try {
            i = context.getPackageManager().getPackageInfo(context.getPackageName(), 0).versionCode;
            AppMethodBeat.m2505o(57503);
    ...
    static String zzh(Context context) {
        AppMethodBeat.m2504i(57504);
        String str;
        try {
            str = context.getPackageManager().getPackageInfo(context.getPackageName(), 0).versionName;
            AppMethodBeat.m2505o(57504);
            return str;
        } catch (NameNotFoundException e) {
    ...
    public void deleteInstanceID() {
        AppMethodBeat.m2504i(57511);
        zzd("*", "*", null);
        zzm();
        AppMethodBeat.m2505o(57511);
    }

    @Deprecated
    public void deleteToken(String str, String str2) {
        AppMethodBeat.m2504i(57513);
        zzd(str, str2, null);
        AppMethodBeat.m2505o(57513);
    }

    @Deprecated
    public long getCreationTime() {
        AppMethodBeat.m2504i(57510);
        long creationTime = zzbs.zzj(this.zzbv).getCreationTime();
        AppMethodBeat.m2505o(57510);
        return creationTime;
    }

    @Deprecated
    public String getId() {
        AppMethodBeat.m2504i(57508);
        String zzd = zzd(getKeyPair());
        AppMethodBeat.m2505o(57508);
        return zzd;
    }
    ...
    public String getToken(String str, String str2) {
        AppMethodBeat.m2504i(57515);
        String token = getToken(str, str2, null);
        AppMethodBeat.m2505o(57515);
        return token;
    }
    ...
    public final void zzd(String str, String str2, Bundle bundle) {
        AppMethodBeat.m2504i(57514);
        if (Looper.getMainLooper() == Looper.myLooper()) {
            IOException iOException = new IOException("MAIN_THREAD");
            AppMethodBeat.m2505o(57514);
            throw iOException;
        }
    ...
    public final void zzm() {
        AppMethodBeat.m2504i(57512);
        zzbs.zzk(this.zzbv);
        AppMethodBeat.m2505o(57512);
    }
}
