...
public class TriggerConfig {
    ...
    public void setTriggerWords(String str) {
        AppMethodBeat.m2504i(83553);
        if (str == null) {
            AppMethodBeat.m2505o(83553);
            return;
        }
    ...
    public boolean isSentenceTriggered(String str) {
        AppMethodBeat.m2504i(83554);
        if (this.triggerWordsPattern == null) {
            AppMethodBeat.m2505o(83554);
            return false;
        }
