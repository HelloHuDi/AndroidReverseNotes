...
public final class JceCmd implements Serializable {
    ...
    static {
        AppMethodBeat.m2504i(76065);
        AppMethodBeat.m2505o(76065);
    }

    public static JceCmd convert(int i) {
        AppMethodBeat.m2504i(76062);
        for (int i2 = 0; i2 < __values.length; i2++) {
            if (__values[i2].value() == i) {
                JceCmd jceCmd = __values[i2];
                AppMethodBeat.m2505o(76062);
                return jceCmd;
            }
        }
    ...
    public static JceCmd convert(String str) {
        AppMethodBeat.m2504i(76063);
        for (int i = 0; i < __values.length; i++) {
            if (__values[i].toString().equals(str)) {
                JceCmd jceCmd = __values[i];
                AppMethodBeat.m2505o(76063);
                return jceCmd;
            }
        }
        if ($assertionsDisabled) {
    ...
    private JceCmd(int i, int i2, String str) {
        AppMethodBeat.m2504i(76064);
        this.__T = str;
        this.__value = i2;
        __values[i] = this;
        AppMethodBeat.m2505o(76064);
    }
}
