...
public class ShakaMotionBlurFilter extends BaseFilter {
    ...
    public ShakaMotionBlurFilter() {
        ...
        AppMethodBeat.m2505o(82840);
    }

    private void recalculateTexelOffsets() {
        AppMethodBeat.m2504i(82841);
        ...
        if (this.mBlurSize <= 2.0f) {
            ...
            addParam(new C0934g("directionalTexelStep", fArr));
            fArr[0] = 0.0f;
            fArr[1] = 0.0f;
            this.blurFilter2.addParam(new C0934g("directionalTexelStep", fArr));
            AppMethodBeat.m2505o(82841);
            return;
        }
    ...
    public void updateParams(float f, float f2, int i, int i2) {
        AppMethodBeat.m2504i(82842);
        this.mBlurSize = f;
        this.mBlurAngle = f2;
        this.mWidth = (float) i;
        this.mHeight = (float) i2;
        recalculateTexelOffsets();
        AppMethodBeat.m2505o(82842);
    }
}
