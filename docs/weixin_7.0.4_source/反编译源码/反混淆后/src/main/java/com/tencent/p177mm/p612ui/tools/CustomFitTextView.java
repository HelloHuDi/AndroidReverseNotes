...
public class CustomFitTextView extends TextView {
    ...
    public CustomFitTextView(Context context, AttributeSet attributeSet) {
        ...
        AppMethodBeat.m2504i(107617);
        AppMethodBeat.m2505o(107617);
    }

    public CustomFitTextView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        AppMethodBeat.m2504i(107618);
        AppMethodBeat.m2505o(107618);
    }

    /* renamed from: a */
    public final void mo70245a(String str, int i, boolean z, int i2, int i3) {
        AppMethodBeat.m2504i(107619);
        this.maxLines = i;
        this.zBI = str;
        if (this.zBI == null) {
            C4990ab.m7420w("MicroMsg.CustomFitTextView", "ori text is null");
            this.zBI = "";
        }
        if (this.maxLines <= 0) {
            C4990ab.m7420w("MicroMsg.CustomFitTextView", "maxLines is invalid");
            this.maxLines = 2;
        }
        this.zBO = getResources().getDimensionPixelSize(C25738R.dimen.f9723do);
        this.zBN = z;
        this.zBL = i2;
        if (this.zBN) {
        ...
        m80210eG(this.zBI, getWidth());
        setHeight(Math.max(dJK(), C1338a.fromDPToPix(getContext(), 32)));
        AppMethodBeat.m2505o(107619);
    }

    private int dJK() {
        AppMethodBeat.m2504i(107620);
        ...
        AppMethodBeat.m2505o(107620);
        return size;
    }

    /* renamed from: eG */
    private boolean m80210eG(String str, int i) {
        AppMethodBeat.m2504i(107621);
        if (!this.gLJ || i <= 0 || str == null || "".equals(str)) {
            AppMethodBeat.m2505o(107621);
            return false;
        }
        int ceil;
        this.zBK.clear();
        ...
        for (int i4 = 0; i4 < ceil; i4++) {
            if (i4 == ceil - 1) {
                asf(str.substring(i2, m80209d(str, i2, length, intrinsicWidth, paddingLeft)).trim());
            } else {
                i3 = m80209d(str, i2, length, 0, paddingLeft);
                asf(str.substring(i2, i3).trim());
                if (i3 >= length) {
                    C4990ab.m7420w("MicroMsg.CustomFitTextView", "not match last line, but match text length end");
                    break;
                }
                i2 = i3;
            }
    ...
    private void asf(String str) {
        AppMethodBeat.m2504i(107622);
        if (this.zBK != null) {
            if (str == null || "".equals(str)) {
                AppMethodBeat.m2505o(107622);
                return;
            }
            this.zBK.add(str);
        }
    ...
    /* renamed from: d */
    private int m80209d(String str, int i, int i2, int i3, int i4) {
        AppMethodBeat.m2504i(107623);
        if (i2 <= i) {
            i2 = i + 1;
            AppMethodBeat.m2505o(107623);
            return i2;
            ...
            length = min;
            while (length >= 0 && C5046bo.m7590z(str.charAt(length))) {
                length--;
            }
    ...
    public void onDraw(Canvas canvas) {
        AppMethodBeat.m2504i(107624);
        if (!this.gLJ) {
            AppMethodBeat.m2505o(107624);
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        AppMethodBeat.m2504i(107625);
        boolean z = (i == i3 && i2 == i4) ? false : true;
        this.gLJ = z;
        if (this.gLJ) {
            m80210eG(this.zBI, i);
        }
        AppMethodBeat.m2505o(107625);
    }

    /* Access modifiers changed, original: protected */
    public void onMeasure(int i, int i2) {
        AppMethodBeat.m2504i(107626);
        super.onMeasure(i, i2);
        int size = MeasureSpec.getSize(i);
        int fromDPToPix = C1338a.fromDPToPix(getContext(), 32);
        if (m80210eG(this.zBI, size)) {
            fromDPToPix = Math.max(dJK(), fromDPToPix);
        }
        setMeasuredDimension(size, fromDPToPix);
        AppMethodBeat.m2505o(107626);
    }
}
