...
/* renamed from: com.tencent.mm.protocal.protobuf.awf */
public final class awf extends btd {
    ...
    public final int mo4669op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            int bs = ix + C6091a.m9572bs(3, this.wzV);
            AppMethodBeat.m2505o(96269);
            return bs;
        } else if (i == 2) {
