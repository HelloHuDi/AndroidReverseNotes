...
public class FaceFeatureFilter_573 extends VideoFilterBase {
    ...
    static {
        AppMethodBeat.m2504i(82395);
        AppMethodBeat.m2505o(82395);
    }

    public FaceFeatureFilter_573() {
        super(VERTEX_SHADER, FRAGMENT_SHADER);
        AppMethodBeat.m2504i(82376);
    ...
    public void initParams() {
        ...
        addParam(new C0933f("alphaNormal", this.alphaNormal * this.factorNormal));
        addParam(new C0933f("alphaMultiply", this.alphaMultiply));
        addParam(new C0933f("alphaSoftlight", this.alphaSoftlight));
        addParam(new C25629b("canvasSize", (float) this.width, (float) this.height));
        addParam(new C0933f("positionRotate", 0.0f));
        AppMethodBeat.m2505o(82378);
    }

    public void setFaceFeatureParam(FaceFeatureParam faceFeatureParam) {
        AppMethodBeat.m2504i(82379);
    ...
    private void initFaceTexCoords() {
        ...
        AppMethodBeat.m2505o(82385);
    }

    public void updateVideoSize(int i, int i2, double d) {
        AppMethodBeat.m2504i(82386);
        super.updateVideoSize(i, i2, d);
        addParam(new C25629b("canvasSize", (float) i, (float) i2));
        AppMethodBeat.m2505o(82386);
    }

    public boolean renderTexture(int i, int i2, int i3) {
        AppMethodBeat.m2504i(82387);
    ...
    public void updateTextureParams() {
        AppMethodBeat.m2504i(82388);
        initFaceImage();
        AppMethodBeat.m2505o(82388);
    }

    private boolean initFaceImage() {
        AppMethodBeat.m2504i(82389);
    ...
    public void updatePointParams(List<PointF> list) {
        ...
        setCoordNum(690);
        AppMethodBeat.m2505o(82390);
    }

    public void ApplyGLSLFilter() {
        AppMethodBeat.m2504i(82391);
        super.ApplyGLSLFilter();
        GLES20.glGenTextures(this.texture.length, this.texture, 0);
        AppMethodBeat.m2505o(82391);
    }

    public void clearGLSLSelf() {
        AppMethodBeat.m2504i(82392);
        GLES20.glDeleteTextures(this.texture.length, this.texture, 0);
        this.isSoftLiteImageReady = false;
        super.clearGLSLSelf();
        AppMethodBeat.m2505o(82392);
    }

    public boolean needRender() {
        AppMethodBeat.m2504i(82393);
        updateTextureParams();
        if (this.isSoftLiteImageReady && this.isMultiplyImageReady && this.isNormalImageReady) {
            AppMethodBeat.m2505o(82393);
            return true;
        }
        AppMethodBeat.m2505o(82393);
        return false;
    ...
    public void setNormalAlphaFactor(float f) {
        AppMethodBeat.m2504i(82394);
        this.factorNormal = f;
        setNormalAlphaValue(this.alphaNormal);
        AppMethodBeat.m2505o(82394);
    }
}
