...
public class ConfigStorage {
    ...
    public static SharedPreferences getSharedPreferences(Context context, String str, int i) {
        AppMethodBeat.m2504i(124457);
        SharedPreferences sharedPreferences = context.getSharedPreferences(str, i);
        AppMethodBeat.m2505o(124457);
        return sharedPreferences;
    }

    public static SharedPreferences getAppSharedPreferences(Context context) {
        AppMethodBeat.m2504i(124458);
        ...
        AppMethodBeat.m2505o(124458);
        return sharedPreferences;
    }

    public static String getDownProxyConfig(Context context) {
        AppMethodBeat.m2504i(124459);
        String str;
        if (context == null) {
            str = "";
            AppMethodBeat.m2505o(124459);
            return str;
        }
    ...
    private static String getConfigVersionFromSharedPreference(Context context) {
        AppMethodBeat.m2504i(124461);
        String str;
        if (context == null) {
            str = "";
            AppMethodBeat.m2505o(124461);
            return str;
        }
    ...
    private static void setConfigVersionToSharedPreference(Context context, String str) {
        AppMethodBeat.m2504i(124462);
        if (context == null || str == null) {
            AppMethodBeat.m2505o(124462);
            return;
        }
    ...
    public void stopGetServerConfig() {
        AppMethodBeat.m2504i(124464);
        try {
            if (this.thread != null) {
                this.thread.interrupt();
                AppMethodBeat.m2505o(124464);
                return;
            }
        } catch (Throwable th) {
            HttpproxyFacade.print(6, TAG, "thread create exception");
    ...
    static /* synthetic */ void access$0(ConfigStorage configStorage, Context context) {
        AppMethodBeat.m2504i(124471);
        configStorage.synGetConfig(context);
        AppMethodBeat.m2505o(124471);
    }

    private void synGetConfig(Context context) {
        AppMethodBeat.m2504i(124466);
        if (needGetConfig()) {
            int i = -1;
            try {
    ...
    private String getBkDomain(String str) {
        AppMethodBeat.m2504i(124470);
        if (TextUtils.isEmpty(str)) {
            str = "";
            AppMethodBeat.m2505o(124470);
            return str;
        }
        AppMethodBeat.m2505o(124470);
        return str;
