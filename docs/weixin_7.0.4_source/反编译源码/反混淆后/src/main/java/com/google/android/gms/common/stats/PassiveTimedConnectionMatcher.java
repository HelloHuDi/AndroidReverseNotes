...
public class PassiveTimedConnectionMatcher {
    ...
    private final C0417m<String, Long> zzyo;

    public PassiveTimedConnectionMatcher() {
        AppMethodBeat.m2504i(89961);
        this.zzym = 60000;
        this.zzyn = 10;
        this.zzyo = new C0417m(10);
        AppMethodBeat.m2505o(89961);
    }

    public PassiveTimedConnectionMatcher(int i, long j) {
        AppMethodBeat.m2504i(89962);
        this.zzym = j;
        this.zzyn = i;
        this.zzyo = new C0417m();
        AppMethodBeat.m2505o(89962);
    }

    public Long get(String str) {
        Long l;
        AppMethodBeat.m2504i(89963);
        synchronized (this) {
            try {
