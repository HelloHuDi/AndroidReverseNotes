...
public class BenchUtil {
    ...
    public static class LoggerAgent {
        /* renamed from: d */
        public void mo65617d(String str, String str2) {
            AppMethodBeat.m2504i(83809);
            if (BenchUtil.ENABLE_LOG) {
                LogUtils.m50199d(str, str2);
            }
            AppMethodBeat.m2505o(83809);
        }
    }

    static {
        AppMethodBeat.m2504i(83822);
        AppMethodBeat.m2505o(83822);
    }

    public static void init() {
        AppMethodBeat.m2504i(83810);
        startTimeMap.clear();
        totalTimeMap.clear();
        lastTimeMap.clear();
        AppMethodBeat.m2505o(83810);
    }

    public static void benchStart(String str) {
        AppMethodBeat.m2504i(83811);
        if (!ENABLE_LOG) {
            AppMethodBeat.m2505o(83811);
    ...
    public static long benchEnd(String str) {
        ...
        if (list.size() >= 10) {
            ...
            LogUtils.m50199d(TAG, new StringBuilder(PREFIX).append(str).append(": ").append(totalTime).append("ms").toString());
    ...
    public static long benchEndTotal(String str) {
        AppMethodBeat.m2504i(83813);
        if (!ENABLE_LOG) {
            AppMethodBeat.m2505o(83813);
            return 0;
    ...
    public static void flush() {
        AppMethodBeat.m2504i(83814);
        for (Entry entry : totalTimeMap.entrySet()) {
            sLogger.mo65617d(TAG, new StringBuilder(PREFIX).append((String) entry.getKey()).append(": ").append(getTotalTime((List) entry.getValue())).append("ms").toString());
        }
        totalTimeMap.clear();
        AppMethodBeat.m2505o(83814);
    }

    public static void benchEnd(String str, int i) {
        AppMethodBeat.m2504i(83815);
        if (!ENABLE_LOG) {
            AppMethodBeat.m2505o(83815);
        } else if (TextUtils.isEmpty(str) || startTimeMap.get(str) == null) {
            AppMethodBeat.m2505o(83815);
        } else {
            List list;
            ...
            if (list.size() >= 10) {
                sLogger.mo65617d(TAG, new StringBuilder(PREFIX).append(str).append(": ").append(getTotalTime(list) / ((long) (list.size() / i))).append("ms").toString());
                list.clear();
            }
            AppMethodBeat.m2505o(83815);
        }
    ...
    public static void benchEndReverse(String str, int i) {
        AppMethodBeat.m2504i(83816);
        if (TextUtils.isEmpty(str) || startTimeMap.get(str) == null) {
            AppMethodBeat.m2505o(83816);
            return;
        }
        List list;
        List list2 = (List) totalTimeMap.get(str);
        ...
        list.add(Long.valueOf(System.currentTimeMillis() - ((Long) startTimeMap.get(str)).longValue()));
        if (list.size() >= 10) {
            sLogger.mo65617d(TAG, new StringBuilder(PREFIX).append(str).append(": ").append(((long) (list.size() * i)) / getTotalTime(list)).append("fps").toString());
            list.clear();
        }
        AppMethodBeat.m2505o(83816);
    }
    ...
    private static long getTotalTime(List<Long> list) {
        long j = 0;
        AppMethodBeat.m2504i(83817);
        if (!ENABLE_LOG) {
            AppMethodBeat.m2505o(83817);
            return 0;
