...
public final class C46259n implements C22150y {
    ...
    /* renamed from: w */
    private int f17907w = -1;

    public C46259n(MMActivity mMActivity) {
        this.crP = mMActivity;
    }

    /* renamed from: M */
    public final void mo8910M(Bundle bundle) {
        AppMethodBeat.m2504i(38215);
        this.rim = C37952b.m64173u(this.crP.getIntent());
        this.f17907w = this.crP.getIntent().getIntExtra("Ksnsupload_width", -1);
        this.f17906h = this.crP.getIntent().getIntExtra("Ksnsupload_height", -1);
    ...
    public final boolean mo8912a(int i, int i2, C41173i c41173i, String str, List<String> list, ayt ayt, int i3, boolean z, List<String> list2, PInt pInt, String str2, int i4, int i5) {
        AppMethodBeat.m2504i(38217);
        C29054ax c29054ax = new C29054ax(23);
        ...
        if (!z2) {
            C4990ab.m7416i("MicroMsg.EmotionListShareWidget", "set userData user imgurl ");
            z2 = c29054ax.mo47159b(this.rid, this.rid, this.ril, this.rij, this.rik);
        }
        if (!z2) {
            C4990ab.m7412e("MicroMsg.EmotionListShareWidget", "set userData faild");
        }
    ...
    public final boolean crI() {
        AppMethodBeat.m2504i(38218);
        if (!(this.fru == null || this.fru.isRecycled())) {
            this.fru.recycle();
        }
        AppMethodBeat.m2505o(38218);
        return false;
    }
}
