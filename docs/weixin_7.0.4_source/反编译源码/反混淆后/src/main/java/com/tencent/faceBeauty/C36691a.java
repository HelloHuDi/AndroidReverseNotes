...
/* renamed from: com.tencent.faceBeauty.a */
public final class C36691a extends C32116b {
    ...
    public final void doDetectFace(Bitmap bitmap) {
        AppMethodBeat.m2504i(86274);
        this.mDetectedFace = false;
        this.mFaceParams.clear();
        this.faceCount = 0;
        if (bitmap == null) {
            AppMethodBeat.m2505o(86274);
            return;
        }
        int i;
        float eyesDistance;
        ...
        if (bitmap.getConfig() == Config.RGB_565) {
            ...
            try {
                ...
                m60875a(pointF, (float) (bitmap.getWidth() / 4), width, height);
                AppMethodBeat.m2505o(86274);
                return;
            }
        }
        ...
        for (i2 = 0; i2 < findFaces; i2++) {
            ...
            pointF.x *= (float) i;
            pointF.y *= (float) i;
            m60875a(pointF, eyesDistance * ((float) i), width, height);
        }
        AppMethodBeat.m2505o(86274);
    }

    /* renamed from: a */
    private void m60875a(PointF pointF, float f, int i, int i2) {
        AppMethodBeat.m2504i(86275);
