...
public class IPCPackageTools {
    ...
    public static int getCmdId(JceStruct jceStruct) {
        AppMethodBeat.m2504i(75971);
        if (jceStruct == null) {
            AppMethodBeat.m2505o(75971);
            return -1;
        }
    ...
    public static IPCRequest buildIpcRequest(JceStruct jceStruct) {
        AppMethodBeat.m2504i(75972);
        if (jceStruct == null) {
            AppMethodBeat.m2505o(75972);
            return null;
        }
    ...
    public static byte[] buildPostData(IPCRequest iPCRequest) {
        AppMethodBeat.m2504i(75973);
        if (iPCRequest == null) {
            AppMethodBeat.m2505o(75973);
            return null;
        }
    ...
    public static IPCResponse unpackPackage(byte[] bArr) {
        AppMethodBeat.m2504i(75974);
        if (bArr == null || bArr.length < 4) {
            AppMethodBeat.m2505o(75974);
            return null;
        }
    ...
    private static JceStruct createFromRequest(String str) {
        AppMethodBeat.m2504i(75976);
        if (TextUtils.isEmpty(str)) {
            AppMethodBeat.m2505o(75976);
            return null;
        }
        JceStruct jceStruct;
        try {
