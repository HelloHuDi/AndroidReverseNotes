...
public class LoadImageTask2 extends AsyncTask<Void, Integer, Boolean> {
    ...
    public LoadImageTask2(Map<String, Bitmap> map, List<String> list, String str, String str2, int i) {
        ...
        this.sampleSize = i;
        AppMethodBeat.m2505o(81796);
    }

    /* Access modifiers changed, original: protected|varargs */
    public Boolean doInBackground(Void... voidArr) {
        AppMethodBeat.m2504i(81797);
        Boolean bool;
        if (this.cache == null) {
            bool = Boolean.FALSE;
            AppMethodBeat.m2505o(81797);
            return bool;
        }
    ...
    public void onCancelled(Boolean bool) {
        AppMethodBeat.m2504i(81798);
        super.onCancelled(bool);
        if (this.cache == null) {
            AppMethodBeat.m2505o(81798);
            return;
        }
        for (Object obj : this.resourceList) {
            Object obj2;
