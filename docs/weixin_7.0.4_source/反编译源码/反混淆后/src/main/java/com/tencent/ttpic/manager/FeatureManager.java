...
public class FeatureManager {
    ...
    static {
        AppMethodBeat.m2504i(83432);
        checkFeaturesReady();
        AppMethodBeat.m2505o(83432);
    }

    public static void checkFeaturesReady() {
        String resPath;
        AppMethodBeat.m2504i(83425);
    ...
    public static int init3DGameplay() {
        AppMethodBeat.m2504i(83428);
        try {
            loadLibrary("gameplay");
            setIsGameplayReady(true);
            AppMethodBeat.m2505o(83428);
            return 1;
