...
public class SQLiteDirectQuery extends SQLiteProgram {
    ...
    public int step(int i) {
        ...
        try {
            ...
            AppMethodBeat.m2505o(12578);
            return nativeStep;
        } catch (RuntimeException e) {
            if (e instanceof SQLiteException) {
                Log.m9444e(TAG, "Got exception on stepping: " + e.getMessage() + ", SQL: " + getSql());
    ...
    public synchronized void reset(boolean z) {
        ...
        AppMethodBeat.m2505o(12579);
    }

    /* Access modifiers changed, original: protected */
    public void onAllReferencesReleased() {
        AppMethodBeat.m2504i(12580);
        synchronized (this) {
            try {
                if (this.mPreparedStatement != null) {
                    this.mPreparedStatement.detachCancellationSignal(this.mCancellationSignal);
