...
public final class DefaultDatabaseErrorHandler implements DatabaseErrorHandler {
    ...
    public final void onCorruption(SQLiteDatabase sQLiteDatabase) {
        AppMethodBeat.m2504i(12169);
        Log.m9444e(TAG, "Corruption reported by sqlite on database: " + sQLiteDatabase.getPath());
    ...
    private void deleteDatabaseFile(String str) {
        int i = 0;
        AppMethodBeat.m2504i(12170);
        if (str.equalsIgnoreCase(SQLiteDatabaseConfiguration.MEMORY_DB_PATH) || str.trim().length() == 0) {
            AppMethodBeat.m2505o(12170);
            return;
        }
        Log.m9444e(TAG, "Remove database file: ".concat(String.valueOf(str)));
        ...
        if (!file2.mkdirs()) {
            Log.m9444e(TAG, "Could not create directory for corrupted database. Corruption backup may be unavailable.");
        }
    ...
    private static boolean moveOrDeleteFile(String str, String str2) {
        AppMethodBeat.m2504i(12171);
        File file = new File(str);
        boolean renameTo = file.renameTo(new File(str2));
        if (!renameTo) {
            file.delete();
        }
        AppMethodBeat.m2505o(12171);
        return renameTo;
    }

    private static boolean deleteFile(String str) {
        AppMethodBeat.m2504i(12172);
        boolean delete = new File(str).delete();
        AppMethodBeat.m2505o(12172);
        return delete;
    }
}
