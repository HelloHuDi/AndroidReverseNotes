...
public class DynamicNumFilter extends NormalVideoFilter {
    ...
    protected C25628k mTextureParam;
    private long mTimestamp;
    protected int playCount;
    protected boolean triggered;

    static {
        AppMethodBeat.m2504i(82172);
        AppMethodBeat.m2505o(82172);
    }

    public DynamicNumFilter(StickerItem stickerItem, String str) {
        super(stickerItem, str);
        AppMethodBeat.m2504i(82159);
        ...
        this.mNum = -1;
        AppMethodBeat.m2505o(82159);
    }

    public void initParams() {
        AppMethodBeat.m2504i(82160);
        addParam(new C0935i("texNeedTransform", 1));
        addParam(new C25629b("canvasSize", 0.0f, 0.0f));
        addParam(new C25629b("texAnchor", 0.0f, 0.0f));
        addParam(new C0933f("texScale", 1.0f));
    ...
    private void updateTextureParam(String str, int i, long j, int i2) {
        ...
        try {
            if (this.mTextureParam != null) {
                this.mTextureParam.mo43360m(nextFrame);
            } else {
                this.mTextureParam = new C25628k("inputImageTexture2", nextFrame, 33986, false);
                this.mTextureParam.initialParams(getProgramIds());
                addParam(this.mTextureParam);
            }
        } catch (Exception e) {
            C16371i.m25188m(this, e.getMessage());
        }
    ...
    private void updateNumPosition(String str, int i, int i2) {
        ...
        addParam(new C25629b("texAnchor", pointF2.x - ((float) this.canvasCenter.x), ((float) this.canvasCenter.y) - pointF2.y));
        ...
        addParam(new C0933f("texScale", (float) (Math.sqrt(Math.pow((double) (pointF.y - pointF3.y), 2.0d) + Math.pow((double) (pointF.x - pointF3.x), 2.0d)) / ((double) this.item.scaleFactor))));
        if (this.item.support3D == 1) {
            addParam(new C25630d("texRotate", this.mFaceAngles[0], this.mFaceAngles[1], this.mFaceAngles[2] - this.item.angle));
        } else {
            addParam(new C25630d("texRotate", 0.0f, 0.0f, this.mFaceAngles[2] - this.item.angle));
        }
        addParam(new C0933f("positionRotate", -this.mAngle));
        AppMethodBeat.m2505o(82168);
    }

    public boolean renderTexture(int i, int i2, int i3) {
        int i4 = 0;
        AppMethodBeat.m2504i(82169);
        if (BaseUtils.isEmpty(this.mFacePoints) || this.mFaceAngles == null || this.mFaceAngles.length < 3 || this.mNum < 0) {
            AppMethodBeat.m2505o(82169);
        } else {
            int totalBit = getTotalBit(this.mNum);
            updateTextureParam(this.item.f18271id, -1, this.mTimestamp, 0);
            if (this.mIsUnitExists) {
                totalBit++;
                updateNumPosition(this.item.f18271id + "_x", 0, totalBit);
                OnDrawFrameGLSL();
            ...
            if (this.mNum < 10) {
                ...
                updateTextureParam(this.item.f18271id, this.mNum, this.mTimestamp, i4);
                updateNumPosition(this.item.f18271id + "_" + this.mNum, i4, totalBit);
                OnDrawFrameGLSL();
                super.renderTexture(i, i2, i3);
                ...
                i5 = this.mNum % 10;
                updateTextureParam(this.item.f18271id, i5, this.mTimestamp, i4);
                updateNumPosition(this.item.f18271id + "_" + i5, i4, totalBit);
                OnDrawFrameGLSL();
                super.renderTexture(i, i2, i3);
                this.mLastBitIndex = i4;
                i4++;
    ...
    public void destroy() {
        AppMethodBeat.m2504i(82170);
        clearGLSLSelf();
        PlayerUtil.destroyPlayer(this.mPlayer);
        AppMethodBeat.m2505o(82170);
    }

    public void destroyAudio() {
        AppMethodBeat.m2504i(82171);
        PlayerUtil.destroyPlayer(this.mPlayer);
        this.mPlayer = null;
        AppMethodBeat.m2505o(82171);
    }
