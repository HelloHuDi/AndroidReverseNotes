...
public final class zzhk<T> extends zzen {
    ...
    public final void zza(DataHolder dataHolder) {
        AppMethodBeat.m2504i(71425);
        if (this.zzfl != null) {
            this.zzfl.notifyListener(new zzhl(dataHolder));
            AppMethodBeat.m2505o(71425);
            return;
        }
        dataHolder.close();
        AppMethodBeat.m2505o(71425);
