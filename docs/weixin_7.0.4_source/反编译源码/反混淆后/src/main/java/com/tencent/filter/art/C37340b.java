...
/* renamed from: com.tencent.filter.art.b */
public final class C37340b extends BaseFilter {
    int type;

    public C37340b(int i) {
        super(GLSLRender.bJB);
        this.type = i;
    }

    public final void ApplyGLSLFilter(boolean z, float f, float f2) {
        AppMethodBeat.m2504i(86292);
        ClearGLSL();
        if (z) {
            ...
            baseFilter2.addParam(new C0933f("par", 0.15f));
            baseFilter.setNextFilter(baseFilter2, new int[]{4});
            baseFilter = new BaseFilter(GLSLRender.bKY);
            baseFilter.addParam(new C0933f("par", 0.35f));
            baseFilter.addParam(new C0933f("par_b", 0.2f));
            baseFilter2.setNextFilter(baseFilter, new int[]{4, 5});
            baseFilter2 = new BaseFilter(GLSLRender.bKX);
            baseFilter2.addParam(new C0933f("inv_2sigma", 12.0f));
            baseFilter.setNextFilter(baseFilter2, new int[]{4});
            if (this.type == 1) {
                baseFilter = new BaseFilter(GLSLRender.bKU);
                baseFilter.addParam(new C0933f("inv_2sigma2", 144.5f));
                baseFilter.addParam(new C0933f("inv_sigma_root_2pi", 0.02f));
                baseFilter2.setNextFilter(baseFilter, new int[]{5, 4});
                baseFilter2 = new BaseFilter(GLSLRender.bKT);
                baseFilter2.addParam(new C0933f("inv_2sigma2", 144.5f));
                baseFilter2.addParam(new C0933f("inv_sigma_root_2pi", 0.02f));
                baseFilter.setNextFilter(baseFilter2, new int[]{4});
