...
public class RecoveryHandleService extends IntentService {
    ...
    public static class InnerService extends Service {
        public void onCreate() {
            ...
            try {
                ...
                RecoveryLog.m8711e("Recovery.RecoveryHandleService", "InnerService set service for push exception:%s.", th);
            }
            stopSelf();
        }
    ...
    public void onCreate() {
        RecoveryLog.m8712i("Recovery.RecoveryHandleService", "onCreate", new Object[0]);
        super.onCreate();
    }

    public void onDestroy() {
        RecoveryLog.m8712i("Recovery.RecoveryHandleService", "onDestroy", new Object[0]);
        RecoveryLog.dQd();
        super.onDestroy();
    }
    ...
    public final void onHandleIntent(Intent intent) {
        ...
        if (recoveryData == null || recoveryData.processName == null) {
            RecoveryLog.m8712i("Recovery.RecoveryHandleService", "recoveryData is null %b %d %s %s", Boolean.valueOf(booleanExtra), Integer.valueOf(iB), stringExtra, stringExtra2);
            return;
        }
        ...
        if (running) {
            RecoveryLog.m8712i("Recovery.RecoveryHandleService", "handle already running", new Object[0]);
            try {
                mo12021a(recoveryData, arrayList, booleanExtra);
            } catch (Exception e) {
                RecoveryLog.printErrStackTrace("Recovery.RecoveryHandleService", e, "alreadyRunning", new Object[0]);
            }
        } else {
            running = true;
            RecoveryLog.m8712i("Recovery.RecoveryHandleService", "try to increase recovery process priority", new Object[0]);
            try {
                ...
                RecoveryLog.m8712i("Recovery.RecoveryHandleService", "try to increase recovery process priority error:".concat(String.valueOf(th)), new Object[0]);
            }
            RecoveryLog.m8712i("Recovery.RecoveryHandleService", "start to handle %s's exception uuid: %s threadId: %d", recoveryData.processName, recoveryData.eCq, Long.valueOf(Thread.currentThread().getId()));
            RecoveryHandleResult recoveryHandleResult = new RecoveryHandleResult();
            try {
                recoveryHandleResult = mo12020a(this, recoveryData, arrayList, booleanExtra);
            } catch (Exception e2) {
            ...
            if (recoveryHandleResult.retry && !booleanExtra) {
                ...
                RecoveryLog.m8712i("Recovery.RecoveryHandleService", "startAlarm pendingIntent success: %d will retry %s", Integer.valueOf(r2.hashCode()), Util.m8738nz(currentTimeMillis));
            }
            RecoveryLog.m8712i("Recovery.RecoveryHandleService", "handle recoveryHandleResult %s", recoveryHandleResult);
        }
        RecoveryLogic.m8701a((Context) this, arrayList, stringExtra);
        running = false;
        stopSelf();
    }
    ...
    /* renamed from: a */
    public void mo12021a(RecoveryData recoveryData, ArrayList<RecoveryHandleItem> arrayList, boolean z) {
    }

    /* Access modifiers changed, original: protected */
    /* renamed from: a */
    public RecoveryHandleResult mo12020a(Context context, RecoveryData recoveryData, ArrayList<RecoveryHandleItem> arrayList, boolean z) {
