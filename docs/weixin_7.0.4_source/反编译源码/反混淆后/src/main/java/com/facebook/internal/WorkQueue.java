...
public class WorkQueue {
    ...
    class WorkNode implements WorkItem {
        ...
        static {
            AppMethodBeat.m2504i(72600);
            AppMethodBeat.m2505o(72600);
        }
        ...
        public boolean cancel() {
            AppMethodBeat.m2504i(72595);
            synchronized (WorkQueue.this.workLock) {
                try {
                    if (isRunning()) {
                        AppMethodBeat.m2505o(72595);
                        return false;
                    }
        ...
        public WorkNode addToList(WorkNode workNode, boolean z) {
            AppMethodBeat.m2504i(72597);
            AssertionError assertionError;
            if (!$assertionsDisabled && this.next != null) {
                assertionError = new AssertionError();
                AppMethodBeat.m2505o(72597);
        ...
        public WorkNode removeFromList(WorkNode workNode) {
            AppMethodBeat.m2504i(72598);
            AssertionError assertionError;
            if (!$assertionsDisabled && this.next == null) {
                assertionError = new AssertionError();
                AppMethodBeat.m2505o(72598);
                throw assertionError;
            } else if ($assertionsDisabled || this.prev != null) {
                if (workNode == this) {
                    if (this.next == this) {
        ...
        public void verify(boolean z) {
            AppMethodBeat.m2504i(72599);
            AssertionError assertionError;
            if (!$assertionsDisabled && this.prev.next != this) {
                assertionError = new AssertionError();
                AppMethodBeat.m2505o(72599);
                throw assertionError;
    ...
    public WorkQueue(int i) {
        ...
        AppMethodBeat.m2504i(72601);
        AppMethodBeat.m2505o(72601);
    }

    public WorkQueue(int i, Executor executor) {
        AppMethodBeat.m2504i(72602);
        this.workLock = new Object();
        this.runningJobs = null;
        this.runningCount = 0;
        this.maxConcurrent = i;
        this.executor = executor;
        AppMethodBeat.m2505o(72602);
    }

    public WorkItem addActiveWorkItem(Runnable runnable) {
        AppMethodBeat.m2504i(72603);
        WorkItem addActiveWorkItem = addActiveWorkItem(runnable, true);
        AppMethodBeat.m2505o(72603);
        return addActiveWorkItem;
    }

    public WorkItem addActiveWorkItem(Runnable runnable, boolean z) {
        AppMethodBeat.m2504i(72604);
    ...
    private void startItem() {
        AppMethodBeat.m2504i(72606);
        finishItemAndStartNew(null);
        AppMethodBeat.m2505o(72606);
    }

    private void finishItemAndStartNew(WorkNode workNode) {
        AppMethodBeat.m2504i(72607);
    ...
    private void execute(final WorkNode workNode) {
        AppMethodBeat.m2504i(72608);
        this.executor.execute(new Runnable() {
            public void run() {
                AppMethodBeat.m2504i(72594);
                try {
                    workNode.getCallback().run();
                } finally {
                    WorkQueue.access$000(WorkQueue.this, workNode);
                    AppMethodBeat.m2505o(72594);
                }
            }
        });
        AppMethodBeat.m2505o(72608);
    }
}
