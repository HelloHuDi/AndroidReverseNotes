...
public class ViewSearchTool {
    ...
    private List<View> filter(View view, Matcher matcher) {
        ...
        AppMethodBeat.m2505o(118649);
        return arrayList3;
    }

    @Deprecated
    public static String findText(View view) {
        AppMethodBeat.m2504i(118650);
        if (view == null) {
            AppMethodBeat.m2505o(118650);
            return null;
        }
            ...
            if (view instanceof ViewGroup) {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (childAt != null && ((childAt instanceof ViewGroup) || (childAt instanceof TextView))) {
                        contentDescription = ViewSearchTool.findText(childAt);
                        if (contentDescription != null) {
                            break;
                        }
                    }
    ...
    public static String findViewDepth(View view, View view2, String str) {
        AppMethodBeat.m2504i(118651);
        if (view == null || view2 == null) {
            AppMethodBeat.m2505o(118651);
            return null;
        }
        if (str == null) {
            str = "";
        ...
        if (view instanceof ViewGroup) {
            ...
            int i = 0;
            while (i < childCount) {
                String findViewDepth = ViewSearchTool.findViewDepth(viewGroup.getChildAt(i), view2, str + "_" + i);
