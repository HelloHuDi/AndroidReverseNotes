...
public interface C30258b extends IInterface {

    /* renamed from: com.tencent.mm.remoteservice.b$a */
    public static abstract class C30259a extends Binder implements C30258b {

        /* renamed from: com.tencent.mm.remoteservice.b$a$a */
        static class C30260a implements C30258b {
            private IBinder mRemote;

            C30260a(IBinder iBinder) {
        ...
        public static C30258b asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.tencent.mm.remoteservice.ICommClientCallback");
            if (queryLocalInterface == null || !(queryLocalInterface instanceof C30258b)) {
                return new C30260a(iBinder);
            }
            return (C30258b) queryLocalInterface;
        }
