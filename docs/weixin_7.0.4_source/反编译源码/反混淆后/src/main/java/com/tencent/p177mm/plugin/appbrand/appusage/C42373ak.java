...
/* renamed from: com.tencent.mm.plugin.appbrand.appusage.ak */
final class C42373ak implements C45413i<AppIdentity, IPCBoolean> {
    /* renamed from: am */
    public final /* synthetic */ Object mo4785am(Object obj) {
        boolean z;
        AppMethodBeat.m2504i(134567);
        AppIdentity appIdentity = (AppIdentity) obj;
        if (!C1720g.m3531RK() || appIdentity == null) {
            z = false;
        } else {
            z = ((C10118af) C1720g.m3528K(C10118af.class)).mo21473aD(C38130h.m64523a(appIdentity), C38130h.m64524b(appIdentity));
        }
        IPCBoolean iPCBoolean = new IPCBoolean(z);
        AppMethodBeat.m2505o(134567);
        return iPCBoolean;
    }
}
