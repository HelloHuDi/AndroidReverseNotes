...
public class SlookAirButton {
    ...
    /* renamed from: com.samsung.android.sdk.look.airbutton.SlookAirButton$1 */
    class C87511 implements OnItemSelectedListener {
        C87511() {
        }

        public void onItemSelected(View view, int i, Object obj) {
            AppMethodBeat.m2504i(117271);
            SlookAirButton.this.mItemSelectListener.onItemSelected(view, i, obj);
            AppMethodBeat.m2505o(117271);
        }
    }
    ...
    public SlookAirButton(View view, SlookAirButtonAdapter slookAirButtonAdapter, int i) {
        AppMethodBeat.m2504i(117251);
        if (!isSupport(1)) {
            AppMethodBeat.m2505o(117251);
    ...
    public void setItemSelectListener(ItemSelectListener itemSelectListener) {
        AppMethodBeat.m2504i(117252);
        if (isSupport(1)) {
            this.mItemSelectListener = itemSelectListener;
            if (this.mItemSelectListener != null) {
                this.mAirButtonImpl.setOnItemSelectedListener(new C87511());
            }
            AppMethodBeat.m2505o(117252);
            return;
        }
        AppMethodBeat.m2505o(117252);
    }
    ...
    public int getGravity() {
        AppMethodBeat.m2504i(117254);
        if (isSupport(1)) {
            int gravity = this.mAirButtonImpl.getGravity();
            AppMethodBeat.m2505o(117254);
            return gravity;
        }
        AppMethodBeat.m2505o(117254);
        return 0;
    ...
    public int getDirection() {
        AppMethodBeat.m2504i(117256);
        if (isSupport(1)) {
            int direction = this.mAirButtonImpl.getDirection();
            AppMethodBeat.m2505o(117256);
            return direction;
        }
        AppMethodBeat.m2505o(117256);
        return 0;
    ...
    public void setPosition(int i, int i2) {
        AppMethodBeat.m2504i(117257);
        if (isSupport(1)) {
            this.mAirButtonImpl.setPosition(i, i2);
            AppMethodBeat.m2505o(117257);
            return;
        }
        AppMethodBeat.m2505o(117257);
    }
    ...
    public void setScrollEnabled(boolean z) {
        AppMethodBeat.m2504i(117258);
        if (isSupport(1)) {
            this.mAirButtonImpl.setScrollEnabled(z);
            AppMethodBeat.m2505o(117258);
            return;
        }
        AppMethodBeat.m2505o(117258);
    }
    ...
    private boolean isSupport(int i) {
        AppMethodBeat.m2504i(117260);
        if (this.mSlook.isFeatureEnabled(1)) {
            AppMethodBeat.m2505o(117260);
            return true;
        }
        AppMethodBeat.m2505o(117260);
        return false;
    ...
    public void setBounceEffectEnabled(boolean z) {
        AppMethodBeat.m2504i(117261);
        if (isSupport(1)) {
            this.mAirButtonImpl.setBounceEffectEnabled(z);
            AppMethodBeat.m2505o(117261);
            return;
        }
        AppMethodBeat.m2505o(117261);
    }
    ...
    public void hide() {
        AppMethodBeat.m2504i(117263);
        if (isSupport(1)) {
            this.mAirButtonImpl.hide();
            AppMethodBeat.m2505o(117263);
            return;
        }
        AppMethodBeat.m2505o(117263);
    }
    ...
    public void dismiss() {
        AppMethodBeat.m2504i(117264);
        if (isSupport(1)) {
            this.mAirButtonImpl.dismiss();
            AppMethodBeat.m2505o(117264);
            return;
        }
        AppMethodBeat.m2505o(117264);
    }
    ...
    public void setAutoControlEnabled(boolean z) {
        AppMethodBeat.m2504i(117265);
        if (isSupport(1)) {
            this.mAirButtonImpl.setEnabled(z);
            AppMethodBeat.m2505o(117265);
            return;
        }
        AppMethodBeat.m2505o(117265);
    }
    ...
    public boolean isAutoControlEnabled() {
        AppMethodBeat.m2504i(117266);
        if (isSupport(1)) {
            boolean isEnabled = this.mAirButtonImpl.isEnabled();
            AppMethodBeat.m2505o(117266);
            return isEnabled;
        }
        AppMethodBeat.m2505o(117266);
        return false;
    ...
    public void startAnimationIcon(MotionEvent motionEvent) {
        AppMethodBeat.m2504i(117267);
        if (!isSupport(1)) {
            AppMethodBeat.m2505o(117267);
    ...
    public void moveAnimationIcon(MotionEvent motionEvent) {
        AppMethodBeat.m2504i(117268);
        if (!isSupport(1)) {
            AppMethodBeat.m2505o(117268);
        } else if (this.mAirButtonImpl.isEnabled()) {
            IllegalStateException illegalStateException = new IllegalStateException("The mode is auto control. Please disable auto control.");
            AppMethodBeat.m2505o(117268);
            throw illegalStateException;
    ...
    public void stopAnimationIcon(MotionEvent motionEvent) {
        AppMethodBeat.m2504i(117269);
        if (!isSupport(1)) {
            AppMethodBeat.m2505o(117269);
        } else if (this.mAirButtonImpl.isEnabled()) {
            IllegalStateException illegalStateException = new IllegalStateException("The mode is auto control. Please disable auto control.");
            AppMethodBeat.m2505o(117269);
            throw illegalStateException;
    ...
    public void show(MotionEvent motionEvent) {
        AppMethodBeat.m2504i(117270);
        if (!isSupport(1)) {
            AppMethodBeat.m2505o(117270);
        } else if (this.mAirButtonImpl.isEnabled()) {
            IllegalStateException illegalStateException = new IllegalStateException("The mode is auto control. Please disable auto control.");
            AppMethodBeat.m2505o(117270);
            throw illegalStateException;
