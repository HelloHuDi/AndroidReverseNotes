...
public class StaticStickerFilter extends NormalVideoFilter {
    ...
    public void initParams() {
        AppMethodBeat.m2504i(82964);
        super.initParams();
        addParam(new C0935i("texNeedTransform", -1));
        initRelativeParams();
        AppMethodBeat.m2505o(82964);
    }

    public void updateFabbyProgress(long j) {
        AppMethodBeat.m2504i(82965);
        if (!this.triggered) {
    ...
    public void updateVideoSize(int i, int i2, double d) {
        AppMethodBeat.m2504i(82966);
        super.updateVideoSize(i, i2, d);
        if (this.item.isFabbyMvItem) {
            initFabbyPositionAdjust();
            AppMethodBeat.m2505o(82966);
            return;
        }
    ...
    public void updatePositions(List<PointF> list, float[] fArr, float f) {
        AppMethodBeat.m2504i(82967);
        if (this.initialized) {
            AppMethodBeat.m2505o(82967);
    ...
    public void initPositionAdjusted() {
        AppMethodBeat.m2504i(82970);
        if (this.item == null || this.item.position == null || this.item.position.length < 2) {
            setPositions(GlUtil.EMPTY_POSITIONS);
            AppMethodBeat.m2505o(82970);
            return;
        }
    ...
    private void initFabbyPositionAdjust() {
        AppMethodBeat.m2504i(82971);
        if (this.item.aspectMode == 1) {
            setPositions(GlUtil.ORIGIN_POSITION_COORDS);
            AppMethodBeat.m2505o(82971);
            return;
        }
