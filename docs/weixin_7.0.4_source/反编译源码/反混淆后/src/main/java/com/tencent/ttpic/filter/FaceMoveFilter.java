...
public class FaceMoveFilter extends VideoFilterBase {
    ...
    public void ApplyGLSLFilter() {
        AppMethodBeat.m2504i(82405);
        super.ApplyGLSLFilter();
        setDrawMode(DRAW_MODE.TRIANGLES);
        AppMethodBeat.m2505o(82405);
    }
}
