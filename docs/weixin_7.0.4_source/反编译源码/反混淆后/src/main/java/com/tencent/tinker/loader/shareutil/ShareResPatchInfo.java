...
public class ShareResPatchInfo {
    ...
    /* renamed from: a */
    public static void m9402a(String str, ShareResPatchInfo shareResPatchInfo) {
    ...
    /* renamed from: a */
    public static boolean m9404a(HashSet<Pattern> hashSet, String str) {
        if (!hashSet.isEmpty()) {
    ...
    /* renamed from: a */
    public static boolean m9403a(ShareResPatchInfo shareResPatchInfo) {
    ...
    /* renamed from: b */
    public static void m9405b(String str, ShareResPatchInfo shareResPatchInfo) {
        if (str != null && str.length() != 0) {
