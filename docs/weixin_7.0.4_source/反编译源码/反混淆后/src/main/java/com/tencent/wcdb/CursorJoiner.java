...
public final class CursorJoiner implements Iterable<Result>, Iterator<Result> {
    ...
    private void incrementCursors() {
        ...
        AppMethodBeat.m2505o(12000);
    }

    private static int compareStrings(String... strArr) {
        AppMethodBeat.m2504i(TXCStreamDownloader.TXE_DOWNLOAD_INFO_CONNECT_SUCCESS);
        if (strArr.length % 2 != 0) {
            ...
            AppMethodBeat.m2505o(TXCStreamDownloader.TXE_DOWNLOAD_INFO_CONNECT_SUCCESS);
            throw illegalArgumentException;
        }
