...
/* renamed from: com.tencent.mm.boot.svg.a.a.aoo */
public final class aoo extends C5163c {
    ...
    public final int mo10620a(int i, Object... objArr) {
        switch (i) {
            ...
            case 2:
                ...
                canvas.saveLayerAlpha(null, C33250az.CTRL_INDEX, 4);
                Paint a = C5163c.m7876a(k, looper);
                a.setColor(WebView.NIGHT_MODE_COLOR);
                canvas.save();
                g = C5163c.m7878a(g, 1.0f, 0.0f, 92.0f, 0.0f, 1.0f, 95.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
