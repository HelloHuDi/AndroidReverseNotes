...
public class RadarSpecialSmoothScrollView extends ScrollView {
    ...
    private final C39559a pCN = new C39559a();
    ...
    static final class C39559a implements Interpolator {
        private static final float pCP = pCP;
        public static final C39560a pCQ = new C39560a();
        ...
        /* renamed from: com.tencent.mm.plugin.radar.ui.RadarSpecialSmoothScrollView$a$a */
        public static final class C39560a {
            private C39560a() {
            }

            public /* synthetic */ C39560a(byte b) {
                this();
            }
        }
        ...
        static {
            AppMethodBeat.m2504i(103008);
            AppMethodBeat.m2505o(103008);
        }
    }
    ...
    public RadarSpecialSmoothScrollView(Context context, AttributeSet attributeSet) {
        ...
        AppMethodBeat.m2504i(103011);
        AppMethodBeat.m2505o(103011);
    }

    /* Access modifiers changed, original: protected */
    public void onFinishInflate() {
        AppMethodBeat.m2504i(103009);
        if (getChildCount() > 0) {
        ...
        AppMethodBeat.m2505o(103009);
    }

    public boolean onTouchEvent(MotionEvent motionEvent) {
        int i = 1;
        AppMethodBeat.m2504i(103010);
        C25052j.m39376p(motionEvent, "ev");
        boolean onTouchEvent;
        if (this.pCL == null) {
            onTouchEvent = super.onTouchEvent(motionEvent);
            AppMethodBeat.m2505o(103010);
            return onTouchEvent;
        }
        ...
        switch (motionEvent.getAction()) {
            ...
            case 1:
                ...
                if (i != 0) {
                    ...
                    radarSpecialTableLayout2.mo74105D(this.mRect.left, this.mRect.top, this.mRect.right, this.mRect.bottom);
                    this.mRect.setEmpty();
                    break;
                }
                break;
            case 2:
                ...
                if (i != 0) {
                    ...
                    radarSpecialTableLayout.mo74105D(measuredHeight, scrollY, right, radarSpecialTableLayout6.getBottom() - (i / 2));
                } else {
