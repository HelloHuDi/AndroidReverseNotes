...
/* renamed from: com.tencent.mm.plugin.story.ui.view.editor.PhotoEditText */
public final class PhotoEditText extends AppCompatEditText {
    ...
    public PhotoEditText(Context context, AttributeSet attributeSet) {
        ...
        AppMethodBeat.m2504i(110617);
        this.eAv = new Path();
        this.aFY = new Paint();
        this.kPM = new RectF();
        this.radius = (float) C1338a.fromDPToPix(context, 12);
        this.aFY.setStyle(Style.FILL);
        this.aFY.setAntiAlias(true);
        AppMethodBeat.m2505o(110617);
    }

    public PhotoEditText(Context context) {
        C25052j.m39376p(context, "context");
        this(context, null);
        AppMethodBeat.m2504i(110618);
        AppMethodBeat.m2505o(110618);
    }

    public final void setTextBackground(int i) {
        AppMethodBeat.m2504i(110615);
        this.eHE = i;
        invalidate();
        AppMethodBeat.m2505o(110615);
    }

    /* Access modifiers changed, original: protected|final */
    public final void onDraw(Canvas canvas) {
        AppMethodBeat.m2504i(110616);
