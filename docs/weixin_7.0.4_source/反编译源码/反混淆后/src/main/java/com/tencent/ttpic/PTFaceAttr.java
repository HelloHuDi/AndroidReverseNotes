...
public class PTFaceAttr {
    ...
    private C41672h mOrigFrame;
    private C41672h mOrigLargeFrame;
    ...
    public static class PTFace {
        ...
        public PTFace() {
            AppMethodBeat.m2504i(81568);
            AppMethodBeat.m2505o(81568);
        }
    ...
    public List<List<PointF>> getAllFacePoints() {
        AppMethodBeat.m2504i(81569);
        ArrayList arrayList = new ArrayList();
        if (this.mFaceInfos == null) {
            AppMethodBeat.m2505o(81569);
            return arrayList;
        }
    ...
    public List<List<PointF>> getAllIrisPoints() {
        AppMethodBeat.m2504i(81570);
        if (this.mFaceInfos == null) {
            AppMethodBeat.m2505o(81570);
            return null;
        }
        ArrayList arrayList = new ArrayList();
    ...
    public List<float[]> getAllFaceAngles() {
        AppMethodBeat.m2504i(81571);
        if (this.mFaceInfos == null) {
            AppMethodBeat.m2505o(81571);
            return null;
        }
        ArrayList arrayList = new ArrayList();
    ...
    public void setOrigFrame(C41672h c41672h) {
        this.mOrigFrame = c41672h;
    }

    public C41672h getOrigLargeFrame() {
        return this.mOrigLargeFrame;
    }

    public void setOrigLargeFrame(C41672h c41672h) {
        this.mOrigLargeFrame = c41672h;
    }

    public C41672h getOrigFrame() {
        return this.mOrigFrame;
    }

    public void setCorrectFrame(C41672h c41672h) {
        this.mCorrectFrame = c41672h;
    }

    public C41672h getCorrectFrame() {
    ...
    public static PTFaceAttr genFaceAttr(List<List<PointF>> list, List<List<PointF>> list2, List<float[]> list3, Set<Integer> set, List<PointF> list4, float[] fArr, List<FaceStatus> list5, List<BodyDetectResult> list6, double d, byte[] bArr, boolean z, C41672h c41672h, C41672h c41672h2, C41672h c41672h3, int i, int[] iArr, Map<Integer, FaceActionCounter> map, Pair<Integer, int[]> pair, VideoPreviewFaceOutlineDetector videoPreviewFaceOutlineDetector) {
        int i2;
        AppMethodBeat.m2504i(81572);
        ...
        pTFaceAttr.setOrigFrame(c41672h);
        pTFaceAttr.setOrigLargeFrame(c41672h2);
        pTFaceAttr.setCorrectFrame(c41672h3);
        pTFaceAttr.setFaceActionCounter(map);
        pTFaceAttr.setHistogram(pair);
        if (iArr != null) {
            pTFaceAttr.setBrightnessAdjustmentCurve(iArr);
        }
        AppMethodBeat.m2505o(81572);
        return pTFaceAttr;
    }
    ...
    public int getFaceCount() {
        AppMethodBeat.m2504i(81573);
        int size = this.mFaceInfos.size();
        AppMethodBeat.m2505o(81573);
        return size;
    }
