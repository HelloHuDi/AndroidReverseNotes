...
public class MMSwitchBtn extends View {
    ...
    private String zNa;
    private String zNb;
    private C24085b zNc = new C24085b(this, (byte) 0);
    private C30795a zNd;

    /* renamed from: com.tencent.mm.ui.widget.MMSwitchBtn$b */
    class C24085b extends Animation {
        int direction;
        float startX;
        long zNe;

        /* synthetic */ C24085b(MMSwitchBtn mMSwitchBtn, byte b) {
            this();
        }

        private C24085b() {
            AppMethodBeat.m2504i(112576);
            this.direction = 0;
            this.startX = 0.0f;
            this.zNe = 0;
            ...
            setAnimationListener(new AnimationListener(MMSwitchBtn.this) {
                ...
                /* renamed from: com.tencent.mm.ui.widget.MMSwitchBtn$b$1$1 */
                class C240841 implements Runnable {
                    C240841() {
                    }

                    public final void run() {
                        AppMethodBeat.m2504i(112574);
                        if (MMSwitchBtn.this.zNd != null) {
                            MMSwitchBtn.this.zNd.mo6646di(MMSwitchBtn.this.zMU);
                        }
                        AppMethodBeat.m2505o(112574);
                    }
                }
                ...
                public final void onAnimationEnd(Animation animation) {
                    boolean z = true;
                    AppMethodBeat.m2504i(112575);
                    if (MMSwitchBtn.this.zMU != (C24085b.this.direction == 1)) {
                        MMSwitchBtn mMSwitchBtn = MMSwitchBtn.this;
                        if (C24085b.this.direction != 1) {
                            z = false;
                        }
                        mMSwitchBtn.zMU = z;
                        MMSwitchBtn.this.post(new C240841());
                    }
                    MMSwitchBtn.this.zMM = false;
                    AppMethodBeat.m2505o(112575);
                }
            });
            AppMethodBeat.m2505o(112576);
        }

        /* Access modifiers changed, original: protected|final */
        public final void applyTransformation(float f, Transformation transformation) {
            AppMethodBeat.m2504i(112577);
            if (this.direction == 0) {
                MMSwitchBtn.this.zMW.left = this.startX - (((float) this.zNe) * f);
            } else {
                MMSwitchBtn.this.zMW.left = this.startX + (((float) this.zNe) * f);
            }
            MMSwitchBtn.m59879e(MMSwitchBtn.this);
            MMSwitchBtn.this.invalidate();
            AppMethodBeat.m2505o(112577);
        }
    }

    /* renamed from: com.tencent.mm.ui.widget.MMSwitchBtn$a */
    public interface C30795a {
        /* renamed from: di */
        void mo6646di(boolean z);
    }

    /* renamed from: e */
    static /* synthetic */ void m59879e(MMSwitchBtn mMSwitchBtn) {
        AppMethodBeat.m2504i(112590);
        mMSwitchBtn.dKF();
        AppMethodBeat.m2505o(112590);
    }

    public MMSwitchBtn(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        AppMethodBeat.m2504i(112578);
        init();
        m59876b(context.obtainStyledAttributes(attributeSet, C41921a.MMSwitchBtn));
        AppMethodBeat.m2505o(112578);
    }

    public MMSwitchBtn(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        AppMethodBeat.m2504i(112579);
        init();
        m59876b(context.obtainStyledAttributes(attributeSet, C41921a.MMSwitchBtn));
        AppMethodBeat.m2505o(112579);
    }

    public MMSwitchBtn(Context context) {
        super(context);
        AppMethodBeat.m2504i(112580);
        init();
        AppMethodBeat.m2505o(112580);
    }

    private void init() {
        AppMethodBeat.m2504i(112581);
        this.edgePadding = getResources().getDimensionPixelSize(C25738R.dimen.f10017nj);
        this.zMO = (float) getResources().getDimensionPixelSize(C25738R.dimen.f10024nq);
        this.zMP = (float) getResources().getDimensionPixelSize(C25738R.dimen.f10023np);
        this.zMQ = getResources().getColor(C25738R.color.a69);
        this.zMR = getResources().getColor(C25738R.color.a2f);
        this.zMS = getResources().getColor(C25738R.color.a2g);
        this.zMT = getResources().getColor(C25738R.color.f11786h8);
        this.zMY = this.zMS;
        this.zMX = this.zMR;
        this.zMZ = this.zMQ;
        this.nfE = ViewConfiguration.get(getContext()).getScaledTouchSlop();
        AppMethodBeat.m2505o(112581);
    }

    /* renamed from: b */
    private void m59876b(TypedArray typedArray) {
        AppMethodBeat.m2504i(112582);
    ...
    public void setCheck(boolean z) {
        ...
        if (z) {
            string = getContext().getString(C25738R.string.etw);
        } else {
            string = getContext().getString(C25738R.string.eu7);
        }
        setContentDescription(string);
        AppMethodBeat.m2505o(112583);
    }

    public void setSwitchListener(C30795a c30795a) {
        this.zNd = c30795a;
    }

    /* Access modifiers changed, original: protected */
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        AppMethodBeat.m2504i(112584);
        super.onLayout(z, i, i2, i3, i4);
        this.maxWidth = i3 - i;
        this.maxHeight = i4 - i2;
        this.zMK = (this.maxWidth - ((int) (this.zMP * 2.0f))) - (this.edgePadding * 2);
        this.zMJ = this.zMK / 2;
        this.zML = getResources().getDimensionPixelSize(C25738R.dimen.f10022no);
    ...
    /* renamed from: qW */
    private void m59881qW(boolean z) {
        AppMethodBeat.m2504i(112585);
        this.zMM = true;
        this.zNc.reset();
        if (z) {
        ...
        AppMethodBeat.m2505o(112585);
    }

    /* renamed from: gq */
    private void m59880gq(boolean z) {
        AppMethodBeat.m2504i(112586);
        ViewParent parent = getParent();
        if (parent != null) {
            parent.requestDisallowInterceptTouchEvent(z);
        }
        AppMethodBeat.m2505o(112586);
    }

    private void dKb() {
        AppMethodBeat.m2504i(112587);
        if (this.zMW.left > ((float) this.zMJ)) {
            m59881qW(true);
            AppMethodBeat.m2505o(112587);
            return;
        }
        m59881qW(false);
        AppMethodBeat.m2505o(112587);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        boolean z = false;
        AppMethodBeat.m2504i(112588);
        if (this.zMM) {
            AppMethodBeat.m2505o(112588);
        } else if (isEnabled()) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (!(this.zNa == null || this.zNb == null)) {
            ...
            paint.setTextSize(getResources().getDimension(C25738R.dimen.f10012nd));
            paint.setTextAlign(Align.CENTER);
            paint.setColor(getResources().getColor(C25738R.color.a6a));
            ...
            paint.setAlpha(min);
            float height = ((((float) rect.height()) / 2.0f) + ((this.zMV.top + this.zMV.bottom) / 2.0f)) - ((float) C5229aj.fromDPToPix(getContext(), 1));
            canvas.drawText(this.zNa, (((this.zMV.left + this.zMV.right) / 2.0f) - this.zMP) + ((float) C5229aj.fromDPToPix(getContext(), 1)), height, paint);
            float fromDPToPix = (((this.zMV.left + this.zMV.right) / 2.0f) + this.zMP) - ((float) C5229aj.fromDPToPix(getContext(), 1));
            paint.setAlpha(255 - min);
            canvas.drawText(this.zNb, fromDPToPix, height, paint);
        }
        AppMethodBeat.m2505o(112589);
    }
}
