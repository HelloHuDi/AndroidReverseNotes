...
/* renamed from: com.tencent.mm.protocal.protobuf.ail */
public final class ail extends C1331a {
    public String ProductID;
    public SKBuiltinBuffer_t ReqBuf;

    /* renamed from: op */
    public final int mo4669op(int i, Object... objArr) {
        AppMethodBeat.m2504i(62560);
        C6092b c6092b;
        int f;
        if (i == 0) {
            ...
            if (this.ReqBuf != null) {
                f += C6087a.m9557ix(2, this.ReqBuf.computeSize());
            }
            AppMethodBeat.m2505o(62560);
            return f;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ail.ProductID = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(62560);
                    return 0;
                case 2:
