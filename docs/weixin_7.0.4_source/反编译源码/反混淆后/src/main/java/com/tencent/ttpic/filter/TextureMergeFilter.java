...
public class TextureMergeFilter extends BaseFilter {
    ...
    public void ApplyGLSLFilter(boolean z, float f, float f2) {
        AppMethodBeat.m2504i(82973);
        addParam(new C25627n("inputImageTexture2", this.mBgTex, 33986));
        addParam(new C25627n("inputImageTexture3", this.mFgTex, 33987));
        super.ApplyGLSLFilter(z, f, f2);
        AppMethodBeat.m2505o(82973);
    }
}
