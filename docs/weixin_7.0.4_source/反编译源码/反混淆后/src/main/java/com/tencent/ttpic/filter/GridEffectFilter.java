...
public class GridEffectFilter extends BaseFilter {
    ...
    public GridEffectFilter() {
        ...
        AppMethodBeat.m2504i(82573);
        initParams();
        AppMethodBeat.m2505o(82573);
    }

    private void initParams() {
        AppMethodBeat.m2504i(82574);
        addParam(new C0935i("gridType", 0));
        AppMethodBeat.m2505o(82574);
    }

    public void setGridType(int i) {
        AppMethodBeat.m2504i(82575);
        addParam(new C0935i("gridType", i));
        AppMethodBeat.m2505o(82575);
    }
}
