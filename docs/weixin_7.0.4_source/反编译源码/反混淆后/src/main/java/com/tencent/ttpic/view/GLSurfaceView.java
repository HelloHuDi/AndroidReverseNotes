...
public class GLSurfaceView extends SurfaceView implements Callback2 {
    ...
    static class GLThreadManager {
        ...
        /* synthetic */ GLThreadManager(C245041 c245041) {
            this();
        }

        public synchronized void threadExiting(GLThread gLThread) {
            AppMethodBeat.m2504i(84464);
            gLThread.mExited = true;
            notifyAll();
            AppMethodBeat.m2505o(84464);
        }

        public void releaseEglContextLocked(GLThread gLThread) {
            AppMethodBeat.m2504i(84465);
            notifyAll();
            AppMethodBeat.m2505o(84465);
        }
    }
    ...
    class SimpleEGLConfigChooser extends ComponentSizeChooser {
        public SimpleEGLConfigChooser(boolean z) {
            ...
            super(8, 8, 8, 0, i, 0);
            AppMethodBeat.m2504i(84471);
            AppMethodBeat.m2505o(84471);
        }
    }
    ...
    static class DefaultWindowSurfaceFactory implements EGLWindowSurfaceFactory {
        ...
        /* synthetic */ DefaultWindowSurfaceFactory(C245041 c245041) {
            this();
        }

        public EGLSurface createWindowSurface(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig eGLConfig, Object obj) {
            EGLSurface eGLSurface = null;
            AppMethodBeat.m2504i(84433);
            try {
                eGLSurface = egl10.eglCreateWindowSurface(eGLDisplay, eGLConfig, obj, null);
            } catch (IllegalArgumentException e) {
            }
            AppMethodBeat.m2505o(84433);
            return eGLSurface;
        }

        public void destroySurface(EGL10 egl10, EGLDisplay eGLDisplay, EGLSurface eGLSurface) {
            AppMethodBeat.m2504i(84434);
            egl10.eglDestroySurface(eGLDisplay, eGLSurface);
            AppMethodBeat.m2505o(84434);
        }
    }
    ...
    static class EglHelper {
        ...
        public GL createGL() {
            ...
            AppMethodBeat.m2505o(84437);
            return gl;
        }

        public int swap() {
            AppMethodBeat.m2504i(84438);
            if (this.mEgl.eglSwapBuffers(this.mEglDisplay, this.mEglSurface)) {
                AppMethodBeat.m2505o(84438);
                return 12288;
            }
        ...
        public void destroySurface() {
            AppMethodBeat.m2504i(84439);
            destroySurfaceImp();
            AppMethodBeat.m2505o(84439);
        }

        private void destroySurfaceImp() {
            AppMethodBeat.m2504i(84440);
            if (!(this.mEglSurface == null || this.mEglSurface == EGL10.EGL_NO_SURFACE)) {
            ...
            AppMethodBeat.m2505o(84440);
        }

        public void finish() {
            AppMethodBeat.m2504i(84441);
            ...
            AppMethodBeat.m2505o(84441);
        }

        private void throwEglException(String str) {
            AppMethodBeat.m2504i(84442);
            throwEglException(str, this.mEgl.eglGetError());
            AppMethodBeat.m2505o(84442);
        }

        public static void throwEglException(String str, int i) {
            AppMethodBeat.m2504i(84443);
            RuntimeException runtimeException = new RuntimeException(formatEglError(str, i));
            AppMethodBeat.m2505o(84443);
            throw runtimeException;
        }

        public static void logEglErrorAsWarning(String str, String str2, int i) {
            AppMethodBeat.m2504i(84444);
            formatEglError(str2, i);
            AppMethodBeat.m2505o(84444);
        }

        public static String formatEglError(String str, int i) {
            AppMethodBeat.m2504i(84445);
            String str2 = str + " failed: " + i;
            AppMethodBeat.m2505o(84445);
            return str2;
        }
    }
    ...
    class DefaultContextFactory implements EGLContextFactory {
        ...
        /* synthetic */ DefaultContextFactory(GLSurfaceView gLSurfaceView, C245041 c245041) {
            this();
        }

        public EGLContext createContext(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig eGLConfig) {
            AppMethodBeat.m2504i(84431);
    ...
    static class GLThread extends Thread {
        ...
        GLThread(WeakReference<GLSurfaceView> weakReference) {
            AppMethodBeat.m2504i(84446);
            this.mGLSurfaceViewWeakRef = weakReference;
            AppMethodBeat.m2505o(84446);
        }

        public void run() {
            AppMethodBeat.m2504i(84447);
            ...
            try {
                ...
                AppMethodBeat.m2505o(84447);
            }
        }

        private void stopEglSurfaceLocked() {
            AppMethodBeat.m2504i(84448);
            if (this.mHaveEglSurface) {
                this.mHaveEglSurface = false;
                this.mEglHelper.destroySurface();
            }
            AppMethodBeat.m2505o(84448);
        }

        private void stopEglContextLocked() {
            AppMethodBeat.m2504i(84449);
            if (this.mHaveEglContext) {
                this.mEglHelper.finish();
                this.mHaveEglContext = false;
                GLSurfaceView.sGLThreadManager.releaseEglContextLocked(this);
            }
            AppMethodBeat.m2505o(84449);
        }
     ...
     */
        ...
        public void setRenderMode(int i) {
            AppMethodBeat.m2504i(84452);
            if (i < 0 || i > 1) {
                IllegalArgumentException illegalArgumentException = new IllegalArgumentException("renderMode");
                AppMethodBeat.m2505o(84452);
        ...
        public void requestRender() {
            ...
            synchronized (GLSurfaceView.sGLThreadManager) {
                try {
                    ...
                    AppMethodBeat.m2505o(84454);
                }
            }
        }

        public void requestRenderAndNotify(Runnable runnable) {
            AppMethodBeat.m2504i(84455);
            synchronized (GLSurfaceView.sGLThreadManager) {
                try {
    ...
    static class LogWriter extends Writer {
        ...
        LogWriter() {
            AppMethodBeat.m2504i(84466);
            AppMethodBeat.m2505o(84466);
        }

        public void close() {
            AppMethodBeat.m2504i(84467);
            flushBuilder();
            AppMethodBeat.m2505o(84467);
        }

        public void flush() {
            AppMethodBeat.m2504i(84468);
            flushBuilder();
            AppMethodBeat.m2505o(84468);
        }

        public void write(char[] cArr, int i, int i2) {
            AppMethodBeat.m2504i(84469);
            ...
            AppMethodBeat.m2505o(84469);
        }

        private void flushBuilder() {
            AppMethodBeat.m2504i(84470);
            if (this.mBuilder.length() > 0) {
                this.mBuilder.delete(0, this.mBuilder.length());
            }
            AppMethodBeat.m2505o(84470);
        }
    }
    ...
    class ComponentSizeChooser extends BaseConfigChooser {
        ...
        public ComponentSizeChooser(int i, int i2, int i3, int i4, int i5, int i6) {
            ...
            AppMethodBeat.m2505o(84428);
        }

        public EGLConfig chooseConfig(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig[] eGLConfigArr) {
            AppMethodBeat.m2504i(84429);
        ...
        private int findConfigAttrib(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i, int i2) {
            AppMethodBeat.m2504i(84430);
            if (egl10.eglGetConfigAttrib(eGLDisplay, eGLConfig, i, this.mValue)) {
                i2 = this.mValue[0];
                AppMethodBeat.m2505o(84430);
                return i2;
            }
            AppMethodBeat.m2505o(84430);
            return i2;
    ...
    public GLSurfaceView(Context context) {
        super(context);
        AppMethodBeat.m2504i(84472);
        init();
        AppMethodBeat.m2505o(84472);
    }

    public GLSurfaceView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        AppMethodBeat.m2504i(84473);
        init();
        AppMethodBeat.m2505o(84473);
    }

    /* Access modifiers changed, original: protected */
    public void finalize() {
        AppMethodBeat.m2504i(84474);
        try {
            if (this.mGLThread != null) {
                this.mGLThread.requestExitAndWait();
            }
            super.finalize();
            AppMethodBeat.m2505o(84474);
        } catch (Throwable th) {
            super.finalize();
            AppMethodBeat.m2505o(84474);
        }
    ...
    private void init() {
        AppMethodBeat.m2504i(84475);
        getHolder().addCallback(this);
        AppMethodBeat.m2505o(84475);
    }
    ...
    public void setRenderer(Renderer renderer) {
        ...
        AppMethodBeat.m2505o(84476);
    }

    public void setEGLContextFactory(EGLContextFactory eGLContextFactory) {
        AppMethodBeat.m2504i(84477);
        checkRenderThreadState();
        this.mEGLContextFactory = eGLContextFactory;
        AppMethodBeat.m2505o(84477);
    }

    public void setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory eGLWindowSurfaceFactory) {
        AppMethodBeat.m2504i(84478);
        checkRenderThreadState();
        this.mEGLWindowSurfaceFactory = eGLWindowSurfaceFactory;
        AppMethodBeat.m2505o(84478);
    }

    public void setEGLConfigChooser(EGLConfigChooser eGLConfigChooser) {
        AppMethodBeat.m2504i(84479);
        checkRenderThreadState();
        this.mEGLConfigChooser = eGLConfigChooser;
        AppMethodBeat.m2505o(84479);
    }

    public void setEGLConfigChooser(boolean z) {
        AppMethodBeat.m2504i(84480);
        setEGLConfigChooser(new SimpleEGLConfigChooser(z));
        AppMethodBeat.m2505o(84480);
    }

    public void setEGLConfigChooser(int i, int i2, int i3, int i4, int i5, int i6) {
        AppMethodBeat.m2504i(84481);
        setEGLConfigChooser(new ComponentSizeChooser(i, i2, i3, i4, i5, i6));
        AppMethodBeat.m2505o(84481);
    }

    public void setEGLContextClientVersion(int i) {
        AppMethodBeat.m2504i(84482);
        checkRenderThreadState();
        this.mEGLContextClientVersion = i;
        AppMethodBeat.m2505o(84482);
    }

    public void setRenderMode(int i) {
        AppMethodBeat.m2504i(84483);
        this.mGLThread.setRenderMode(i);
        AppMethodBeat.m2505o(84483);
    }

    public int getRenderMode() {
        AppMethodBeat.m2504i(84484);
        int renderMode = this.mGLThread.getRenderMode();
        AppMethodBeat.m2505o(84484);
        return renderMode;
    }

    public void requestRender() {
        AppMethodBeat.m2504i(84485);
        this.mGLThread.requestRender();
        AppMethodBeat.m2505o(84485);
    }

    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        AppMethodBeat.m2504i(84486);
        this.mGLThread.surfaceCreated();
        AppMethodBeat.m2505o(84486);
    }

    public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        AppMethodBeat.m2504i(84487);
        this.mGLThread.surfaceDestroyed();
        AppMethodBeat.m2505o(84487);
    }

    public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
        AppMethodBeat.m2504i(84488);
        this.mGLThread.onWindowResize(i2, i3);
        AppMethodBeat.m2505o(84488);
    }

    public void surfaceRedrawNeededAsync(SurfaceHolder surfaceHolder, Runnable runnable) {
        AppMethodBeat.m2504i(84489);
        if (this.mGLThread != null) {
            this.mGLThread.requestRenderAndNotify(runnable);
        }
        AppMethodBeat.m2505o(84489);
    }
    ...
    public void onPause() {
        AppMethodBeat.m2504i(84490);
        this.mGLThread.onPause();
        AppMethodBeat.m2505o(84490);
    }

    public void onResume() {
        AppMethodBeat.m2504i(84491);
        this.mGLThread.onResume();
        AppMethodBeat.m2505o(84491);
    }

    public void queueEvent(Runnable runnable) {
        AppMethodBeat.m2504i(84492);
        this.mGLThread.queueEvent(runnable);
        AppMethodBeat.m2505o(84492);
    }

    /* Access modifiers changed, original: protected */
    public void onAttachedToWindow() {
        AppMethodBeat.m2504i(84493);
        ...
        AppMethodBeat.m2505o(84493);
    }

    /* Access modifiers changed, original: protected */
    public void onDetachedFromWindow() {
        AppMethodBeat.m2504i(84494);
        if (this.mGLThread != null) {
            this.mGLThread.requestExitAndWait();
        }
        this.mDetached = true;
        super.onDetachedFromWindow();
        AppMethodBeat.m2505o(84494);
    }

    private void checkRenderThreadState() {
        AppMethodBeat.m2504i(84495);
        if (this.mGLThread != null) {
            IllegalStateException illegalStateException = new IllegalStateException("setRenderer has already been called for this instance.");
            AppMethodBeat.m2505o(84495);
    ...
    static {
        AppMethodBeat.m2504i(84496);
        AppMethodBeat.m2505o(84496);
    }
}
