...
public class Encrypt {
    ...
    public String getPasswdTimeStamp() {
        AppMethodBeat.m2504i(49570);
        String valueOf = String.valueOf(this.time_stamp);
        AppMethodBeat.m2505o(49570);
        return valueOf;
    }
