...
/* renamed from: com.tencent.mm.boot.svg.a.a.bco */
public final class bco extends C5163c {
    private final int height = C31128d.MIC_PTU_ZIPAI_GRADIENT_MILKBLUE;
    ...
    public final int mo10620a(int i, Object... objArr) {
        switch (i) {
            case 0:
                return 222;
            case 1:
                return C31128d.MIC_PTU_ZIPAI_GRADIENT_MILKBLUE;
            case 2:
                ...
                a.setColor(-1);
                canvas.save();
                g = C5163c.m7878a(g, 0.6293204f, -0.777146f, 114.51628f, 0.777146f, 0.6293204f, 1.1047013f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
