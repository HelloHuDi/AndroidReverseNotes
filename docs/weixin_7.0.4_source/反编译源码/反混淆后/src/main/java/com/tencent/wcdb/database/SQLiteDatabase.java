...
public final class SQLiteDatabase extends SQLiteClosable {
    ...
    private final ThreadLocal<SQLiteSession> mThreadSession = new C59961();

    /* renamed from: com.tencent.wcdb.database.SQLiteDatabase$1 */
    class C59961 extends ThreadLocal<SQLiteSession> {
        C59961() {
        }

        /* Access modifiers changed, original: protected */
        public SQLiteSession initialValue() {
            AppMethodBeat.m2504i(12422);
            SQLiteSession createSession = SQLiteDatabase.this.createSession();
            AppMethodBeat.m2505o(12422);
    ...
    private SQLiteDatabase(String str, int i, CursorFactory cursorFactory, DatabaseErrorHandler databaseErrorHandler) {
        ...
        AppMethodBeat.m2505o(12425);
    }

    /* Access modifiers changed, original: protected|final */
    public final void finalize() {
        AppMethodBeat.m2504i(12426);
        try {
            dispose(true);
        } finally {
            super.finalize();
            AppMethodBeat.m2505o(12426);
        }
    }

    /* Access modifiers changed, original: protected|final */
    public final void onAllReferencesReleased() {
        AppMethodBeat.m2504i(12427);
        dispose(false);
        AppMethodBeat.m2505o(12427);
    }

    private void dispose(boolean z) {
        SQLiteConnectionPool sQLiteConnectionPool;
        AppMethodBeat.m2504i(12428);
    ...
    public static int releaseMemory() {
        AppMethodBeat.m2504i(12429);
        int releaseMemory = SQLiteGlobal.releaseMemory();
        AppMethodBeat.m2505o(12429);
    ...
    public final int getThreadDefaultConnectionFlags(boolean z) {
        AppMethodBeat.m2504i(12433);
        int i = z ? 1 : 2;
        if (isMainThread()) {
            i |= 4;
        }
        AppMethodBeat.m2505o(12433);
        return i;
    }

    private static boolean isMainThread() {
        AppMethodBeat.m2504i(12434);
        Looper myLooper = Looper.myLooper();
        if (myLooper == null || myLooper != Looper.getMainLooper()) {
            AppMethodBeat.m2505o(12434);
            return false;
        }
        AppMethodBeat.m2505o(12434);
        return true;
    ...
    public final void beginTransaction() {
        AppMethodBeat.m2504i(12435);
        beginTransaction(null, true);
        AppMethodBeat.m2505o(12435);
    }

    public final void beginTransactionNonExclusive() {
        AppMethodBeat.m2504i(12436);
        beginTransaction(null, false);
        AppMethodBeat.m2505o(12436);
    }

    public final void beginTransactionWithListener(SQLiteTransactionListener sQLiteTransactionListener) {
        AppMethodBeat.m2504i(12437);
        beginTransaction(sQLiteTransactionListener, true);
        AppMethodBeat.m2505o(12437);
    }

    public final void beginTransactionWithListenerNonExclusive(SQLiteTransactionListener sQLiteTransactionListener) {
        AppMethodBeat.m2504i(12438);
        beginTransaction(sQLiteTransactionListener, false);
        AppMethodBeat.m2505o(12438);
    }

    private void beginTransaction(SQLiteTransactionListener sQLiteTransactionListener, boolean z) {
        AppMethodBeat.m2504i(12439);
        acquireReference();
        try {
            getThreadSession().beginTransaction(z ? 2 : 1, sQLiteTransactionListener, getThreadDefaultConnectionFlags(false), null);
        } finally {
            releaseReference();
            AppMethodBeat.m2505o(12439);
        }
    }

    public final void endTransaction() {
        AppMethodBeat.m2504i(12440);
        acquireReference();
        try {
            getThreadSession().endTransaction(null);
        } finally {
            releaseReference();
            AppMethodBeat.m2505o(12440);
        }
    }

    public final void setTransactionSuccessful() {
        AppMethodBeat.m2504i(12441);
        acquireReference();
        try {
            getThreadSession().setTransactionSuccessful();
        } finally {
            releaseReference();
            AppMethodBeat.m2505o(12441);
        }
    }

    public final boolean inTransaction() {
        AppMethodBeat.m2504i(12442);
        acquireReference();
        try {
            ...
            releaseReference();
            AppMethodBeat.m2505o(12442);
        }
    }

    public final boolean isDbLockedByCurrentThread() {
        AppMethodBeat.m2504i(12443);
        acquireReference();
        try {
        ...
        if (parentFile != null) {
            ...
            File[] listFiles = parentFile.listFiles(new FileFilter() {
                public final boolean accept(File file) {
                    AppMethodBeat.m2504i(12424);
                    boolean startsWith = file.getName().startsWith(str);
                    AppMethodBeat.m2505o(12424);
                    return startsWith;
                }
            });
            if (listFiles != null) {
...
*/
    ...
    private void open(byte[] bArr, SQLiteCipherSpec sQLiteCipherSpec, int i) {
        AppMethodBeat.m2504i(12473);
        try {
            openInner(bArr, sQLiteCipherSpec, i);
            try {
                AppMethodBeat.m2505o(12473);
            } catch (SQLiteException e) {
                Log.m9445e(TAG, "Failed to open database '" + getLabel() + "'.", e);
                close();
                AppMethodBeat.m2505o(12473);
                throw e;
            }
    ...
    public final Cursor rawQueryWithFactory(CursorFactory cursorFactory, String str, Object[] objArr, String str2, CancellationSignal cancellationSignal) {
        ...
        try {
            ...
            releaseReference();
            AppMethodBeat.m2505o(12494);
        }
    }

    public final long insert(String str, String str2, ContentValues contentValues) {
        AppMethodBeat.m2504i(12495);
        try {
            long insertWithOnConflict = insertWithOnConflict(str, str2, contentValues, 0);
            AppMethodBeat.m2505o(12495);
            return insertWithOnConflict;
        } catch (SQLiteDatabaseCorruptException e) {
            AppMethodBeat.m2505o(12495);
            throw e;
        } catch (SQLException e2) {
            Log.m9445e(TAG, "Error inserting %s: %s", contentValues, e2);
            AppMethodBeat.m2505o(12495);
            return -1;
        }
    }
    ...
    public final long insertOrThrow(String str, String str2, ContentValues contentValues) {
        AppMethodBeat.m2504i(12496);
        long insertWithOnConflict = insertWithOnConflict(str, str2, contentValues, 0);
        AppMethodBeat.m2505o(12496);
        return insertWithOnConflict;
    }

    public final long replace(String str, String str2, ContentValues contentValues) {
        AppMethodBeat.m2504i(12497);
        try {
            long insertWithOnConflict = insertWithOnConflict(str, str2, contentValues, 5);
            AppMethodBeat.m2505o(12497);
            return insertWithOnConflict;
        } catch (SQLiteDatabaseCorruptException e) {
            AppMethodBeat.m2505o(12497);
            throw e;
        } catch (SQLException e2) {
            Log.m9445e(TAG, "Error inserting ".concat(String.valueOf(contentValues)), e2);
            AppMethodBeat.m2505o(12497);
            return -1;
        }
    }
    ...
    public final long replaceOrThrow(String str, String str2, ContentValues contentValues) {
        AppMethodBeat.m2504i(12498);
        long insertWithOnConflict = insertWithOnConflict(str, str2, contentValues, 5);
        AppMethodBeat.m2505o(12498);
        return insertWithOnConflict;
    }

    private Set<String> keySet(ContentValues contentValues) {
        AppMethodBeat.m2504i(12499);
    ...
    public final long insertWithOnConflict(String str, String str2, ContentValues contentValues, int i) {
        int i2 = 0;
        AppMethodBeat.m2504i(GoogleSignInStatusCodes.SIGN_IN_FAILED);
        acquireReference();
        ...
        try {
            ...
            releaseReference();
            AppMethodBeat.m2505o(GoogleSignInStatusCodes.SIGN_IN_FAILED);
    ...
    public final int delete(String str, String str2, String[] strArr) {
        AppMethodBeat.m2504i(GoogleSignInStatusCodes.SIGN_IN_CANCELLED);
        acquireReference();
        SQLiteStatement sQLiteStatement;
        try {
            ...
            sQLiteStatement.close();
            releaseReference();
            AppMethodBeat.m2505o(GoogleSignInStatusCodes.SIGN_IN_CANCELLED);
    ...
    public final Pair<Integer, Integer> walCheckpoint(String str, boolean z) {
        ...
        try {
            ...
            releaseReference();
            AppMethodBeat.m2505o(12508);
        }
    }

    public final boolean isReadOnly() {
        boolean isReadOnlyLocked;
        AppMethodBeat.m2504i(12509);
        synchronized (this.mLock) {
            try {
    ...
    public final boolean needUpgrade(int i) {
        AppMethodBeat.m2504i(12511);
        if (i > getVersion()) {
            AppMethodBeat.m2505o(12511);
            return true;
        }
        AppMethodBeat.m2505o(12511);
        return false;
...
*/
    ...
    public final void setAsyncCheckpointEnabled(boolean z) {
        AppMethodBeat.m2504i(12518);
        setCheckpointCallback(z ? new SQLiteAsyncCheckpointer() : null);
        AppMethodBeat.m2505o(12518);
    }

    public final boolean enableWriteAheadLogging() {
        boolean z = true;
        AppMethodBeat.m2504i(12519);
        synchronized (this.mLock) {
            ...
            try {
                ...
                if ((this.mConfigurationLocked.openFlags & 536870912) != 0) {
                    ...
                    AppMethodBeat.m2505o(12519);
                    return false;
                } else if (this.mConfigurationLocked.isInMemoryDb()) {
                    Log.m9448i(TAG, "can't enable WAL for memory databases.");
                    AppMethodBeat.m2505o(12519);
                    return false;
                } else if (this.mHasAttachedDbsLocked) {
                    Log.m9448i(TAG, "this database: " + this.mConfigurationLocked.label + " has attached databases. can't  enable WAL.");
                    AppMethodBeat.m2505o(12519);
                    return false;
                } else {
...
*/
    ...
    private void collectDbStats(ArrayList<DbStats> arrayList) {
        ...
        synchronized (this.mLock) {
            try {
                ...
                AppMethodBeat.m2505o(12529);
            }
        }
    }

    private static ArrayList<SQLiteDatabase> getActiveDatabases() {
        AppMethodBeat.m2504i(12530);
    ...
    public static void dumpAll(Printer printer, boolean z) {
        AppMethodBeat.m2504i(12531);
        Iterator it = getActiveDatabases().iterator();
        while (it.hasNext()) {
            ((SQLiteDatabase) it.next()).dump(printer, z);
        }
        AppMethodBeat.m2505o(12531);
    }

    public final void dump(Printer printer, boolean z) {
        AppMethodBeat.m2504i(12532);
        synchronized (this.mLock) {
            try {
                if (this.mConnectionPoolLocked != null) {
    ...
    /* JADX WARNING: Missing block: B:27:0x005c, code skipped:
            com.tencent.matrix.trace.core.AppMethodBeat.m2505o(12533);
     */
                ...
                try {
                    ...
                    try {
                        ...
                        if (DatabaseUtils.objectEquals(simpleQueryForString, "ok")) {
                            ...
                            Log.m9444e(TAG, "PRAGMA integrity_check on " + ((String) pair.second) + " returned: " + simpleQueryForString);
                            if (compileStatement != null) {
                                compileStatement.close();
                            }
                            releaseReference();
    ...
    public final void releaseNativeConnection(long j, Exception exception) {
        AppMethodBeat.m2504i(12536);
        getThreadSession().releaseConnectionForNativeHandle(exception);
        AppMethodBeat.m2505o(12536);
    }

    public final String toString() {
        AppMethodBeat.m2504i(12537);
        String str = "SQLiteDatabase: " + getPath();
        AppMethodBeat.m2505o(12537);
        return str;
    }

    private void throwIfNotOpenLocked() {
        AppMethodBeat.m2504i(12538);
        if (this.mConnectionPoolLocked == null) {
