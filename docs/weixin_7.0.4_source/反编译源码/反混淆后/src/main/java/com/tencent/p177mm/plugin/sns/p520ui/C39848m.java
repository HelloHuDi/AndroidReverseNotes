...
public final class C39848m implements C22150y {
    ...
    /* renamed from: w */
    private int f16184w = -1;

    public C39848m(MMActivity mMActivity) {
        this.crP = mMActivity;
    }

    /* renamed from: M */
    public final void mo8910M(Bundle bundle) {
        AppMethodBeat.m2504i(38211);
        this.rim = C37952b.m64173u(this.crP.getIntent());
        this.f16184w = this.crP.getIntent().getIntExtra("Ksnsupload_width", -1);
        this.f16183h = this.crP.getIntent().getIntExtra("Ksnsupload_height", -1);
    ...
    public final boolean mo8912a(int i, int i2, C41173i c41173i, String str, List<String> list, ayt ayt, int i3, boolean z, List<String> list2, PInt pInt, String str2, int i4, int i5) {
        AppMethodBeat.m2504i(38213);
        C29054ax c29054ax = new C29054ax(17);
        ...
        if (!z2) {
            C4990ab.m7416i("MicroMsg.EmojiDesignerShareWidget", "set userData user imgurl ");
            z2 = c29054ax.mo47159b(this.rid, this.rid, this.ril, this.rij, this.rik);
        }
        if (!z2) {
            C4990ab.m7412e("MicroMsg.EmojiDesignerShareWidget", "set userData faild");
        }
        ...
        C13373af.cnB().cmp();
        this.crP.finish();
        ((C6835d) C1720g.m3530M(C6835d.class)).getEmojiMgr().mo35605Jm(this.rik);
        ((C6835d) C1720g.m3530M(C6835d.class)).getEmojiMgr().mo35606Jn(this.rik);
        AppMethodBeat.m2505o(38213);
        return false;
    }
    ...
    public final boolean crI() {
        AppMethodBeat.m2504i(38214);
        if (!(this.fru == null || this.fru.isRecycled())) {
            this.fru.recycle();
        }
        AppMethodBeat.m2505o(38214);
        return false;
    }
}
