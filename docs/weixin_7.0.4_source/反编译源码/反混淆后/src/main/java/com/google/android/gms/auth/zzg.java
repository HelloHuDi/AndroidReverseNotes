...
public class zzg {
    ...
    static {
        AppMethodBeat.m2504i(77073);
        AppMethodBeat.m2505o(77073);
    }
    ...
    private static <T> T zzd(Context context, ComponentName componentName, zzm<T> zzm) {
        ...
        if (instance.bindService(componentName, blockingServiceConnection, "GoogleAuthUtil")) {
            try {
                ...
                AppMethodBeat.m2505o(77071);
                return zze;
            } catch (RemoteException | InterruptedException e) {
                zzq.mo59632i("GoogleAuthUtil", "Error on service connection.", e);
    ...
    private static <T> T zzd(T t) {
        AppMethodBeat.m2504i(77070);
        if (t == null) {
            zzq.mo59638w("GoogleAuthUtil", "Binder call returned null.");
            IOException iOException = new IOException("Service unavailable.");
            AppMethodBeat.m2505o(77070);
            throw iOException;
        }
        AppMethodBeat.m2505o(77070);
        return t;
