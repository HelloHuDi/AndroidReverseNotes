...
/* renamed from: com.tencent.mm.plugin.appbrand.jsapi.bluetooth.sdk.scan.c */
final class C33268c {
    ...
    static {
        AppMethodBeat.m2504i(94308);
        AppMethodBeat.m2505o(94308);
    }

    /* renamed from: ai */
    public static ParcelUuid m54417ai(byte[] bArr) {
        AppMethodBeat.m2504i(94307);
        if (bArr == null) {
            IllegalArgumentException illegalArgumentException = new IllegalArgumentException("uuidBytes cannot be null");
            AppMethodBeat.m2505o(94307);
