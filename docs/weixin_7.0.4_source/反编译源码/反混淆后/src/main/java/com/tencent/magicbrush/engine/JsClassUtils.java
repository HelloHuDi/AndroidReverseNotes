...
public class JsClassUtils {
    ...
    public static Method[] getJavascriptInterfaceMethod(Object obj) {
        ...
        AppMethodBeat.m2505o(115873);
        return methodArr;
    }

    @Keep
    public static String getMethodSignature(Method method) {
        AppMethodBeat.m2504i(115874);
        ...
        AppMethodBeat.m2505o(115874);
        return stringBuilder2;
    }

    @Keep
    public static String getMethodName(Method method) {
        AppMethodBeat.m2504i(115875);
        String name = method.getName();
        AppMethodBeat.m2505o(115875);
        return name;
    }
    ...
    private static int getJavaType(Class<?> cls) {
        AppMethodBeat.m2504i(115877);
        if (cls == Integer.TYPE) {
            AppMethodBeat.m2505o(115877);
            return 5;
    ...
    public static int[] getMethodType(Method method) {
        ...
        AppMethodBeat.m2505o(115878);
        return iArr;
    }

    @Keep
    public static void jsLog(int i, String str) {
        AppMethodBeat.m2504i(115879);
        switch (i) {
            case 1:
                C17837c.m27916i(TAG, str, new Object[0]);
                AppMethodBeat.m2505o(115879);
                return;
            case 2:
                C17837c.m27915e(TAG, str, new Object[0]);
                AppMethodBeat.m2505o(115879);
                return;
            default:
                C17837c.m27914d(TAG, str, new Object[0]);
                AppMethodBeat.m2505o(115879);
                return;
        }
    }
    ...
    public static byte[] getStringUtf8(String str) {
        AppMethodBeat.m2504i(115880);
        try {
            byte[] bytes = str.getBytes("UTF-8");
            AppMethodBeat.m2505o(115880);
            return bytes;
