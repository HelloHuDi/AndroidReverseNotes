...
public abstract class PreLoader {
    ...
    /* renamed from: com.tencent.ttpic.cache.PreLoader$1 */
    class C163361 implements Runnable {
        C163361() {
        }

        public void run() {
            AppMethodBeat.m2504i(81830);
            PreLoader.this.prepareImages();
            AppMethodBeat.m2505o(81830);
        }
    }
    ...
    public void reset() {
        if (!this.prepared) {
            this.prepared = true;
            VideoThreadPool.getInstance().submit(new C163361());
        }
    }
    ...
    private void releaseExpiredBitmaps(int i, int i2) {
        while (i != i2) {
            Bitmap bitmap = (Bitmap) this.cache.remove(this.materialId + File.separator + this.item.f18271id + "_" + i + ".png");
