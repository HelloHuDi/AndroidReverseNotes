...
/* renamed from: com.tencent.mm.boot.svg.a.a.atg */
public final class atg extends C5163c {
    ...
    public final int mo10620a(int i, Object... objArr) {
        switch (i) {
            ...
            case 2:
                ...
                canvas.save();
                float[] a = C5163c.m7878a(g, 1.0f, 0.0f, 12.0f, 0.0f, 1.0f, 6.0f);
                h.reset();
                h.setValues(a);
                canvas.concat(h);
                ...
                k.setColor(-1907998);
                g = C5163c.m7878a(a, 1.0f, 0.0f, 9.0f, 0.0f, 1.0f, 8.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
