...
/* renamed from: com.tencent.mm.boot.svg.a.a.dl */
public final class C41806dl extends C5163c {
    ...
    public final int mo10620a(int i, Object... objArr) {
        switch (i) {
            ...
            case 2:
                ...
                canvas.save();
                g = C5163c.m7878a(g, 1.0f, 0.0f, -275.0f, 0.0f, 1.0f, -1626.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
                g = C5163c.m7878a(g, 1.0f, 0.0f, 126.0f, 0.0f, 1.0f, 1626.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
                g = C5163c.m7878a(g, 1.0f, 0.0f, 149.0f, 0.0f, 1.0f, 0.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
