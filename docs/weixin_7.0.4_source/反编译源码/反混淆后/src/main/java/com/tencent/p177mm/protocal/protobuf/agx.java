...
/* renamed from: com.tencent.mm.protocal.protobuf.agx */
public final class agx extends bsr {
    ...
    public final int mo4669op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            int bs = ix + C6091a.m9572bs(3, this.wns);
            AppMethodBeat.m2505o(58906);
            return bs;
        } else if (i == 2) {
