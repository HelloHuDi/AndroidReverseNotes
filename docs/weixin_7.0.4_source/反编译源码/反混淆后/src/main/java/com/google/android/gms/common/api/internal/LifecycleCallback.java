...
public class LifecycleCallback {
    ...
    public final Activity getActivity() {
        AppMethodBeat.m2504i(89484);
        Activity lifecycleActivity = this.mLifecycleFragment.getLifecycleActivity();
        AppMethodBeat.m2505o(89484);
