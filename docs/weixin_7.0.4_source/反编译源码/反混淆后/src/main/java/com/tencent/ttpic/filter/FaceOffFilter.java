...
public class FaceOffFilter extends VideoFilterBase {
    ...
    public void initParams() {
        ...
        if (this.item.blendMode == 13) {
            addParam(new C0933f("level1", 0.0f));
            addParam(new C0933f("level2", 0.0f));
        }
        if (this.item.blendMode == 14) {
            addParam(new C25628k("inputImageTexture4", FaceOffUtil.getFaceBitmap(this.dataPath + File.separator + this.item.irisImage), 33988, true));
            ...
            addParam(new C0933f("leftEyeClosed", 0.0f));
            addParam(new C0933f("rightEyeClosed", 0.0f));
        }
        AppMethodBeat.m2505o(82414);
    }

    public void setCosAlpha(float f) {
        AppMethodBeat.m2504i(82415);
        addParam(new C0933f("alpha", f));
        AppMethodBeat.m2505o(82415);
    }

    public void updatePreview(PTDetectInfo pTDetectInfo) {
        AppMethodBeat.m2504i(82416);
    ...
    public void initAttribParams() {
        AppMethodBeat.m2504i(82417);
        super.initAttribParams();
        initFaceTexCoords();
        initGrayTexCoords();
        setDrawMode(DRAW_MODE.TRIANGLES);
        setCoordNum(690);
        AppMethodBeat.m2505o(82417);
    }

    /* Access modifiers changed, original: protected */
    public void initFaceTexCoords() {
        AppMethodBeat.m2504i(82418);
        ...
        AppMethodBeat.m2505o(82418);
    }

    private void initGrayTexCoords() {
        AppMethodBeat.m2504i(82419);
    ...
    public void updateTextureParams(long j) {
        ...
        if (!initGrayImage()) {
            ...
            addParam(new C25627n("inputImageTexture2", nextFrame, 33986));
    ...
    public boolean initFaceImage() {
        AppMethodBeat.m2504i(82423);
        if (this.isFaceImageReady) {
            AppMethodBeat.m2505o(82423);
            return true;
        }
    ...
    public boolean initGrayImage() {
        AppMethodBeat.m2504i(82424);
        if (this.isGrayImageReady) {
            AppMethodBeat.m2505o(82424);
            return true;
        }
    ...
    public void updatePointParams(List<PointF> list) {
        ...
        if (this.item.blendMode == 13) {
            ...
            addParam(new C0933f("level1", this.level1 / 255.0f));
            addParam(new C0933f("level2", this.level2 / 255.0f));
        }
        if (this.item.blendMode == 14) {
            int i2;
            ...
            addParam(new C0934g("center1", fArr));
            addParam(new C0934g("center2", fArr2));
            addParam(new C0934g("size", fArr3));
            addParam(new C0933f("radius1", distance3));
            addParam(new C0933f("radius2", distance4));
            addParam(new C0933f("leftEyeClosed", i2 != 0 ? 1.0f : 0.0f));
            String str = "rightEyeClosed";
            if (i == 0) {
                f = 0.0f;
            }
            addParam(new C0933f(str, f));
        }
        AppMethodBeat.m2505o(82425);
    }

    public int getNextFrame(int i) {
        AppMethodBeat.m2504i(82426);
        Bitmap loadImage = VideoMemoryManager.getInstance().loadImage(this.item.f3494id, i);
        if (BitmapUtils.isLegal(loadImage)) {
            GlUtil.loadTexture(this.texture[0], loadImage);
            this.isFaceImageReady = true;
            int i2 = this.texture[0];
            AppMethodBeat.m2505o(82426);
            return i2;
        }
        AppMethodBeat.m2505o(82426);
        return -1;
    ...
    public void setRenderForBitmap(boolean z) {
        AppMethodBeat.m2504i(82431);
        this.triggerCtrlItem.setRenderForBitmap(z);
        AppMethodBeat.m2505o(82431);
    }

    public void reset() {
        AppMethodBeat.m2504i(82432);
        this.triggerCtrlItem.reset();
        AppMethodBeat.m2505o(82432);
    }

    public void setTriggerWords(String str) {
        AppMethodBeat.m2504i(82433);
        this.triggerCtrlItem.setTriggerWords(str);
        AppMethodBeat.m2505o(82433);
    }
}
