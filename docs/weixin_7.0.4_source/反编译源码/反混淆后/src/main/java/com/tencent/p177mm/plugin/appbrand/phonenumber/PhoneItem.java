...
public final class PhoneItem implements Parcelable {
    public static final Creator<PhoneItem> CREATOR = new C33495b();
    public static final C33496a ixO = new C33496a();
    final String biC;
    final String cFl;
    final String ixI;
    final String ixJ;
    ...
    public final class C33495b implements Creator<PhoneItem> {
        C33495b() {
        }

        public final /* synthetic */ Object createFromParcel(Parcel parcel) {
            AppMethodBeat.m2504i(134798);
            C25052j.m39376p(parcel, "source");
            PhoneItem phoneItem = new PhoneItem(parcel);
            AppMethodBeat.m2505o(134798);
            return phoneItem;
        }
    ...
    public static final class C33496a {
        private C33496a() {
        }

        public /* synthetic */ C33496a(byte b) {
            this();
        }

        /* renamed from: Ds */
        public static PhoneItem m54716Ds(String str) {
            AppMethodBeat.m2504i(134799);
            C25052j.m39376p(str, "jsonStr");
            try {
                ...
                C25052j.m39375o(optString, "mobile");
                C25052j.m39375o(optString2, "showMobile");
                C25052j.m39375o(optString3, "encryptedData");
                C25052j.m39375o(optString4, "iv");
                ...
                AppMethodBeat.m2505o(134799);
                return phoneItem;
            } catch (JSONException e) {
                C45124d.m82928e("MicroMsg.PhoneItem", "jsonStr:%s", str);
                AppMethodBeat.m2505o(134799);
                return null;
            }
        }
    ...
    public final int hashCode() {
        ...
        hashCode2 = i2 + i3;
        AppMethodBeat.m2505o(134806);
        return hashCode2;
    }

    public final String toString() {
        AppMethodBeat.m2504i(134805);
        ...
        AppMethodBeat.m2505o(134805);
        return str;
    }

    public PhoneItem(String str, String str2, String str3, String str4, boolean z, boolean z2, boolean z3, boolean z4) {
        C25052j.m39376p(str, "mobile");
        C25052j.m39376p(str2, "showMobile");
        C25052j.m39376p(str3, "encryptedData");
        C25052j.m39376p(str4, "iv");
        AppMethodBeat.m2504i(134802);
        this.cFl = str;
        this.ixI = str2;
        this.ixJ = str3;
        this.biC = str4;
    ...
    public final boolean equals(Object obj) {
        AppMethodBeat.m2504i(134800);
        if (!(obj instanceof PhoneItem)) {
            boolean equals = super.equals(obj);
            AppMethodBeat.m2505o(134800);
            return equals;
        } else if (C25052j.m39373j(((PhoneItem) obj).cFl, this.cFl) && ((PhoneItem) obj).ixM == this.ixM) {
            AppMethodBeat.m2505o(134800);
            return true;
        } else {
            AppMethodBeat.m2505o(134800);
    ...
    public PhoneItem(Parcel parcel) {
        ...
        C25052j.m39375o(readString, "source.readString()");
        String readString2 = parcel.readString();
        C25052j.m39375o(readString2, "source.readString()");
        String readString3 = parcel.readString();
        C25052j.m39375o(readString3, "source.readString()");
        String readString4 = parcel.readString();
        C25052j.m39375o(readString4, "source.readString()");
        if (1 == parcel.readInt()) {
            z = true;
        } else {
            z = false;
        ...
        AppMethodBeat.m2504i(134803);
        AppMethodBeat.m2505o(134803);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeInt(i3);
        AppMethodBeat.m2505o(134801);
    }

    static {
        AppMethodBeat.m2504i(134804);
        AppMethodBeat.m2505o(134804);
    }
}
