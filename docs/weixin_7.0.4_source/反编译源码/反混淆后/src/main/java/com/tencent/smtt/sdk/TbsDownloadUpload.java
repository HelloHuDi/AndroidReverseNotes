...
public class TbsDownloadUpload {
    /* renamed from: b */
    private static TbsDownloadUpload f17971b;
    /* renamed from: a */
    Map<String, Object> f17972a = new HashMap();
    /* renamed from: c */
    private Context f17973c;
    /* renamed from: d */
    private int f17974d;
    /* renamed from: e */
    private int f17975e;
    ...
    public TbsDownloadUpload(Context context) {
        AppMethodBeat.m2504i(64339);
        this.mPreferences = context.getSharedPreferences("tbs_download_upload", 4);
        this.f17973c = context.getApplicationContext();
        if (this.f17973c == null) {
            this.f17973c = context;
        }
        AppMethodBeat.m2505o(64339);
    }

    /* renamed from: a */
    private static File m88574a(Context context, String str) {
        AppMethodBeat.m2504i(64343);
        C5813an.m8800a();
        File t = C5813an.m8819t(context);
        if (t == null) {
            AppMethodBeat.m2505o(64343);
            return null;
        }
    ...
    public static synchronized TbsDownloadUpload getInstance(Context context) {
        TbsDownloadUpload tbsDownloadUpload;
        synchronized (TbsDownloadUpload.class) {
            AppMethodBeat.m2504i(64340);
            if (f17971b == null) {
                f17971b = new TbsDownloadUpload(context);
            }
            tbsDownloadUpload = f17971b;
            AppMethodBeat.m2505o(64340);
        }
        return tbsDownloadUpload;
    }

    public void clearUploadCode() {
        AppMethodBeat.m2504i(64341);
        this.f17972a.put(TbsUploadKey.KEY_NEEDDOWNLOAD_CODE, Integer.valueOf(0));
        this.f17972a.put(TbsUploadKey.KEY_STARTDOWNLOAD_CODE, Integer.valueOf(0));
        this.f17972a.put(TbsUploadKey.KEY_NEEDDOWNLOAD_RETURN, Integer.valueOf(0));
        this.f17972a.put(TbsUploadKey.KEY_NEEDDOWNLOAD_SENT, Integer.valueOf(0));
        this.f17972a.put(TbsUploadKey.KEY_STARTDOWNLOAD_SENT, Integer.valueOf(0));
        this.f17972a.put(TbsUploadKey.KEY_LOCAL_CORE_VERSION, Integer.valueOf(0));
        writeTbsDownloadInfo();
        AppMethodBeat.m2505o(64341);
    }

    public synchronized void commit() {
        AppMethodBeat.m2504i(64345);
        writeTbsDownloadInfo();
        AppMethodBeat.m2505o(64345);
    }
    ...
    public synchronized int getNeedDownloadCode() {
        return this.f17977g == 1 ? 148 : this.f17974d;
    }
    ...
    public synchronized int getStartDownloadCode() {
        return this.f17978h == 1 ? 168 : this.f17975e;
    }
    ...
    public synchronized void readTbsDownloadInfo(Context context) {
        ...
        AppMethodBeat.m2504i(64342);
        BufferedInputStream bufferedInputStream2;
        try {
            File a = m88574a(this.f17973c, "download_upload");
            if (a == null) {
                AppMethodBeat.m2505o(64342);
            } else {
    ...
    public synchronized void writeTbsDownloadInfo() {
        ...
        AppMethodBeat.m2504i(64344);
        TbsLog.m80434i("TbsDownloadUpload", "writeTbsDownloadInfo #1");
        BufferedInputStream bufferedInputStream;
        try {
            File a = m88574a(this.f17973c, "download_upload");
            if (a == null) {
                AppMethodBeat.m2505o(64344);
            } else {
                ...
                try {
                    ...
                    for (String str : this.f17972a.keySet()) {
                        Object obj = this.f17972a.get(str);
                        properties.setProperty(str, String.valueOf(obj));
                        TbsLog.m80434i("TbsDownloadUpload", "writeTbsDownloadInfo key is " + str + " value is " + obj);
                    }
                    this.f17972a.clear();
