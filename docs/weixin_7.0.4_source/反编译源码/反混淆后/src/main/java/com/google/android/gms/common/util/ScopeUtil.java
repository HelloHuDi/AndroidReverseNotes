...
public final class ScopeUtil {
    ...
    public static Set<Scope> fromScopeString(String... strArr) {
        ...
        AppMethodBeat.m2505o(90264);
        return hashSet;
    }

    public static String[] toScopeString(Set<Scope> set) {
        AppMethodBeat.m2504i(90266);
