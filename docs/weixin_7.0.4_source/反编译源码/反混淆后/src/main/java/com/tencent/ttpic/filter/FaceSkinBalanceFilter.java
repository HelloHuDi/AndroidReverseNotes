...
public class FaceSkinBalanceFilter extends BaseFilter {
    ...
    private void initParam() {
        AppMethodBeat.m2504i(82445);
        addParam(new C0935i("shouldBalance", this.shouldBalance));
        addParam(new C0934g("diffRGB", new float[]{0.0f, 0.0f, 0.0f}));
        addParam(new C0934g("userRGB", new float[]{this.modelY, this.modelU, this.modelV}));
        AppMethodBeat.m2505o(82445);
    }
    ...
    public void beforeRender(int i, int i2, int i3) {
        AppMethodBeat.m2504i(82446);
        if (total == 0 || this.data == null) {
            AppMethodBeat.m2505o(82446);
            return;
        }
        float f;
        float f2;
        ...
        addParam(new C0934g("diffRGB", new float[]{f6 - f3, f7 - f4, f8 - f5}));
        addParam(new C0934g("userRGB", new float[]{f3, f4, f5}));
        addParam(new C0935i("shouldBalance", this.shouldBalance));
        AppMethodBeat.m2505o(82446);
    }
