...
public class TinkerUncaughtHandler implements UncaughtExceptionHandler {
    ...
    public TinkerUncaughtHandler(Context context) {
        ...
        this.ACV = SharePatchFileUtil.m9385jj(context);
    }
        ...
        if (this.ACV != null && (Thread.getDefaultUncaughtExceptionHandler() instanceof TinkerUncaughtHandler)) {
            ...
            if (parentFile.exists() || parentFile.mkdirs()) {
                ...
                try {
                    ...
                    try {
                        printWriter.println("process:" + ShareTinkerInternals.m9416aD(this.context));
                        printWriter.println(ShareTinkerInternals.m9428m(th));
                        SharePatchFileUtil.m9369ah(printWriter);
