...
public final class DynamiteModule {
    ...
    static {
        AppMethodBeat.m2504i(90442);
        AppMethodBeat.m2505o(90442);
    }

    private DynamiteModule(Context context) {
        AppMethodBeat.m2504i(90441);
        this.zzabx = (Context) Preconditions.checkNotNull(context);
        AppMethodBeat.m2505o(90441);
    }

    public static int getLocalVersion(Context context, String str) {
        int i = 0;
        AppMethodBeat.m2504i(90426);
        String valueOf;
        try {
    ...
    public static Uri getQueryUri(String str, boolean z) {
        ...
        AppMethodBeat.m2505o(90432);
        return parse;
    }

    public static int getRemoteVersion(Context context, String str) {
        AppMethodBeat.m2504i(90430);
        int remoteVersion = getRemoteVersion(context, str, false);
        AppMethodBeat.m2505o(90430);
    ...
    private static int zza(Context context, String str, boolean z) {
        int i = 0;
        AppMethodBeat.m2504i(90428);
        IDynamiteLoader zzg = zzg(context);
        if (zzg == null) {
            AppMethodBeat.m2505o(90428);
        } else {
            try {
    ...
    private static DynamiteModule zzd(Context context, String str) {
        ...
        AppMethodBeat.m2505o(90433);
        return dynamiteModule;
    }

    /* JADX WARNING: Missing block: B:26:0x0061, code skipped:
            com.tencent.matrix.trace.core.AppMethodBeat.m2505o(90436);
     */
    ...
    private static IDynamiteLoader zzg(Context context) {
        AppMethodBeat.m2504i(90436);
        synchronized (DynamiteModule.class) {
            try {
                IDynamiteLoader iDynamiteLoader;
                if (zzabs != null) {
                    iDynamiteLoader = zzabs;
                    AppMethodBeat.m2505o(90436);
