...
/* renamed from: com.tencent.mm.protocal.protobuf.cld */
    ...
    public final int mo4669op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.BaseResponse == null) {
                ...
                if (this.xiP != null) {
                    c6093a.mo13479iy(3, this.xiP.computeSize());
            ...
            ix += C6091a.m9572bs(2, this.fJT);
            if (this.xiP != null) {
                ix += C6087a.m9557ix(3, this.xiP.computeSize());
            }
            AppMethodBeat.m2505o(116808);
            return ix;
        } else if (i == 2) {
