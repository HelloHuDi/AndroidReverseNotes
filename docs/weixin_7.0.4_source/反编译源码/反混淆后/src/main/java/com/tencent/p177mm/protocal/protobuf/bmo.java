...
/* renamed from: com.tencent.mm.protocal.protobuf.bmo */
public final class bmo extends btd {
    ...
    public final int mo4669op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.wPy != null) {
                ix += C6091a.m9575f(4, this.wPy);
            }
            if (this.vAg != null) {
                ix += C6091a.m9575f(5, this.vAg);
            }
            if (this.tgu != null) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    bmo.kdT = c6086a2.BTU.mo13458vd();
                    AppMethodBeat.m2505o(56937);
                    return 0;
                case 3:
                    bmo.kdU = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(56937);
                    return 0;
                case 4:
                    bmo.wPy = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(56937);
                    return 0;
                case 5:
                    bmo.vAg = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(56937);
                    return 0;
                case 100:
                    bmo.tgu = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(56937);
                    return 0;
                default:
                    AppMethodBeat.m2505o(56937);
