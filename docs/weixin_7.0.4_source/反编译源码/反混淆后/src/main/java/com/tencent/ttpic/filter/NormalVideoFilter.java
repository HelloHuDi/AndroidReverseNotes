    ...
    public void updateTextureParam(int i, long j) {
        if (needLoadImage() && i != this.lastImageIndex) {
            ...
            if (this.item.stickerType == STICKER_TYPE.ETC.type) {
                ETC1Texture loadETCRGBTexture = VideoMemoryManager.getInstance().loadETCRGBTexture(this.item.f18271id, i);
                ETC1Texture loadETCAlphaTexture = VideoMemoryManager.getInstance().loadETCAlphaTexture(this.item.f18271id, i);
                if (loadETCRGBTexture != null && loadETCAlphaTexture != null) {
                    ...
                    addParam(new C25627n("inputImageTexture2", this.tex[0], 33986));
                    addParam(new C25627n("inputImageTexture3", this.tex[1], 33987));
                    this.isImageReady = true;
            ...
            addParam(new C25627n("inputImageTexture2", getNextFrame(i), 33986));
        }
    }
