...
public class SafeParcelReader {
    ...
    public static class ParseException extends RuntimeException {
        public ParseException(String str, Parcel parcel) {
            ...
            AppMethodBeat.m2504i(89729);
            AppMethodBeat.m2505o(89729);
        }
    }
    ...
    public static BigDecimal createBigDecimal(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89750);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89750);
            return null;
        }
    ...
    public static BigDecimal[] createBigDecimalArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89764);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89764);
            return null;
        }
        int readInt = parcel.readInt();
    ...
    public static BigInteger createBigInteger(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89745);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89745);
            return null;
        }
        byte[] createByteArray = parcel.createByteArray();
        parcel.setDataPosition(readSize + dataPosition);
    ...
    public static BigInteger[] createBigIntegerArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89761);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89761);
            return null;
        }
        int readInt = parcel.readInt();
    ...
    public static boolean[] createBooleanArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89757);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89757);
            return null;
        }
    ...
    public static ArrayList<Boolean> createBooleanList(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89767);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89767);
            return null;
        }
    ...
    public static Bundle createBundle(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89754);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89754);
            return null;
        }
    ...
    public static byte[] createByteArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89755);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89755);
            return null;
        }
        byte[] createByteArray = parcel.createByteArray();
        parcel.setDataPosition(readSize + dataPosition);
    ...
    public static byte[][] createByteArrayArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89756);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89756);
            return null;
        }
        int readInt = parcel.readInt();
    ...
    public static SparseArray<byte[]> createByteArraySparseArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89778);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89778);
            return null;
        }
        int readInt = parcel.readInt();
    ...
    public static char[] createCharArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89758);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89758);
            return null;
        }
    ...
    public static double[] createDoubleArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89763);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89763);
            return null;
        }
    ...
    public static ArrayList<Double> createDoubleList(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89781);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89781);
            return null;
        }
    ...
    public static SparseArray<Double> createDoubleSparseArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89772);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89772);
            return null;
        }
    ...
    public static float[] createFloatArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89762);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89762);
            return null;
        }
    ...
    public static ArrayList<Float> createFloatList(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89780);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89780);
            return null;
        }
        ArrayList arrayList = new ArrayList();
        int readInt = parcel.readInt();
    ...
    public static SparseArray<Float> createFloatSparseArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89771);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89771);
            return null;
        }
        SparseArray sparseArray = new SparseArray();
        int readInt = parcel.readInt();
    ...
    public static IBinder[] createIBinderArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89766);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89766);
            return null;
        }
    ...
    public static ArrayList<IBinder> createIBinderList(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89783);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89783);
            return null;
        }
    ...
    public static SparseArray<IBinder> createIBinderSparseArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89777);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89777);
            return null;
        }
        int readInt = parcel.readInt();
        SparseArray sparseArray = new SparseArray(readInt);
    ...
    public static int[] createIntArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89759);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89759);
            return null;
        }
    ...
    public static ArrayList<Integer> createIntegerList(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89768);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89768);
            return null;
        }
        ArrayList arrayList = new ArrayList();
        int readInt = parcel.readInt();
    ...
    public static long[] createLongArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89760);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89760);
            return null;
        }
    ...
    public static ArrayList<Long> createLongList(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89779);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89779);
            return null;
        }
        ArrayList arrayList = new ArrayList();
        int readInt = parcel.readInt();
    ...
    public static Parcel createParcel(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89786);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89786);
            return null;
        }
    ...
    public static Parcel[] createParcelArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89787);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89787);
            return null;
        }
        int readInt = parcel.readInt();
    ...
    public static ArrayList<Parcel> createParcelList(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89788);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89788);
            return null;
        }
        int readInt = parcel.readInt();
    ...
    public static SparseArray<Parcel> createParcelSparseArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89775);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89775);
            return null;
        }
        int readInt = parcel.readInt();
    ...
    public static <T extends Parcelable> T createParcelable(Parcel parcel, int i, Creator<T> creator) {
        AppMethodBeat.m2504i(89753);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89753);
            return null;
        }
    ...
    public static SparseBooleanArray createSparseBooleanArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89769);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89769);
            return null;
        }
    ...
    public static SparseIntArray createSparseIntArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89770);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89770);
            return null;
        }
    ...
    public static SparseLongArray createSparseLongArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89773);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89773);
            return null;
        }
    ...
    public static String createString(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89751);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89751);
            return null;
        }
    ...
    public static String[] createStringArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89765);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89765);
            return null;
        }
    ...
    public static ArrayList<String> createStringList(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89782);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89782);
            return null;
        }
    ...
    public static SparseArray<String> createStringSparseArray(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89774);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89774);
            return null;
        }
        SparseArray sparseArray = new SparseArray();
        int readInt = parcel.readInt();
    ...
    public static <T> T[] createTypedArray(Parcel parcel, int i, Creator<T> creator) {
        AppMethodBeat.m2504i(89784);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89784);
            return null;
        }
    ...
    public static <T> ArrayList<T> createTypedList(Parcel parcel, int i, Creator<T> creator) {
        AppMethodBeat.m2504i(89785);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89785);
            return null;
        }
    ...
    public static <T> SparseArray<T> createTypedSparseArray(Parcel parcel, int i, Creator<T> creator) {
        AppMethodBeat.m2504i(89776);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89776);
            return null;
        }
        int readInt = parcel.readInt();
    ...
    public static boolean readBoolean(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89736);
        zza(parcel, i, 4);
        if (parcel.readInt() != 0) {
            AppMethodBeat.m2505o(89736);
            return true;
        }
        AppMethodBeat.m2505o(89736);
        return false;
    ...
    public static Boolean readBooleanObject(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89737);
        int readSize = readSize(parcel, i);
        if (readSize == 0) {
            AppMethodBeat.m2505o(89737);
            return null;
        }
    ...
    public static float readFloat(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89746);
        zza(parcel, i, 4);
        float readFloat = parcel.readFloat();
        AppMethodBeat.m2505o(89746);
        return readFloat;
    }

    public static Float readFloatObject(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89747);
        int readSize = readSize(parcel, i);
        if (readSize == 0) {
            AppMethodBeat.m2505o(89747);
            return null;
        }
        zza(parcel, i, readSize, 4);
    ...
    public static int readHeader(Parcel parcel) {
        AppMethodBeat.m2504i(89730);
        int readInt = parcel.readInt();
        AppMethodBeat.m2505o(89730);
        return readInt;
    }

    public static IBinder readIBinder(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89752);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89752);
            return null;
        }
    ...
    public static int readInt(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89741);
        zza(parcel, i, 4);
        int readInt = parcel.readInt();
        AppMethodBeat.m2505o(89741);
        return readInt;
    }

    public static Integer readIntegerObject(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89742);
        int readSize = readSize(parcel, i);
        if (readSize == 0) {
            AppMethodBeat.m2505o(89742);
            return null;
        }
        zza(parcel, i, readSize, 4);
    ...
    public static void readList(Parcel parcel, int i, List list, ClassLoader classLoader) {
        AppMethodBeat.m2504i(89789);
        int readSize = readSize(parcel, i);
        int dataPosition = parcel.dataPosition();
        if (readSize == 0) {
            AppMethodBeat.m2505o(89789);
            return;
        }
    ...
    public static long readLong(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89743);
        zza(parcel, i, 8);
        long readLong = parcel.readLong();
        AppMethodBeat.m2505o(89743);
        return readLong;
    }

    public static Long readLongObject(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89744);
        int readSize = readSize(parcel, i);
        if (readSize == 0) {
            AppMethodBeat.m2505o(89744);
            return null;
        }
        zza(parcel, i, readSize, 8);
    ...
    public static void skipUnknownField(Parcel parcel, int i) {
        AppMethodBeat.m2504i(89732);
        parcel.setDataPosition(readSize(parcel, i) + parcel.dataPosition());
        AppMethodBeat.m2505o(89732);
    }

    public static int validateObjectHeader(Parcel parcel) {
        AppMethodBeat.m2504i(89735);
