...
/* renamed from: com.tencent.mm.protocal.protobuf.ExchangeEmotionPackResponse */
public class ExchangeEmotionPackResponse extends btd {
    public EmotionCDNUrl DownloadInfo;

    /* renamed from: op */
    public final int mo4669op(int i, Object... objArr) {
        AppMethodBeat.m2504i(62547);
        C6092b c6092b;
        int ix;
        if (i == 0) {
            ...
            if (this.BaseResponse == null) {
                ...
                if (this.DownloadInfo != null) {
                    c6093a.mo13479iy(2, this.DownloadInfo.computeSize());
                    this.DownloadInfo.writeFields(c6093a);
                }
                AppMethodBeat.m2505o(62547);
                return 0;
            }
            ...
            if (this.DownloadInfo != null) {
                ix += C6087a.m9557ix(2, this.DownloadInfo.computeSize());
            }
            AppMethodBeat.m2505o(62547);
            return ix;
        } else if (i == 2) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        c6086a3 = new C6086a(bArr, unknownTagHandler);
                        for (z = true; z; z = emotionCDNUrl.populateBuilderWithField(c6086a3, emotionCDNUrl, C1331a.getNextFieldNumber(c6086a3))) {
                        }
