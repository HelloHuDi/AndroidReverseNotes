...
public class PlayerConfigManager {
    ...
    public int getBufRatio() {
        AppMethodBeat.m2504i(104502);
        if (this.mBufRatio <= 1) {
            this.mBufRatio = 4;
        } else if (this.mBufRatio > 8) {
            this.mBufRatio = 8;
        }
        Logger.m71025i(TAG, "getBufRatio = " + this.mBufRatio);
        this.count = 0;
        int i = this.mBufRatio;
        AppMethodBeat.m2505o(104502);
        return i;
    }

    public void calDTSCostStart() {
        AppMethodBeat.m2504i(104503);
        if (this.mBufRatio == 8) {
            AppMethodBeat.m2505o(104503);
            return;
        }
    ...
    public void calDTSCostEnd() {
        AppMethodBeat.m2504i(104504);
        if (this.mBufRatio == 8) {
            AppMethodBeat.m2505o(104504);
            return;
        }
    ...
    public boolean isSingleCpuOrScreenOff() {
        AppMethodBeat.m2504i(104505);
        this.mProcessorNumber = Runtime.getRuntime().availableProcessors();
        if (this.mProcessorNumber <= 1) {
            AppMethodBeat.m2505o(104505);
            return true;
        }
        AppMethodBeat.m2505o(104505);
        return false;
    ...
    public void setCommonPlayerRef(CorePlayer corePlayer) {
        ...
        if (corePlayer != null) {
            ...
            if (currentAudioInformation != null) {
                ...
                Logger.m71025i(TAG, "setCommonPlayerRef info = " + currentAudioInformation + ",mPlaySpeed = " + this.mPlaySpeed);
            }
        }
        AppMethodBeat.m2505o(104506);
    }

    public void changeDecodeThreadPriority() {
        AppMethodBeat.m2504i(104507);
        ...
        try {
            ...
            if (isSingleCpuOrScreenOff() && ENABLE_CHANGE_THREAD_PRIORITY) {
                ...
                if (i2 != this.mCurrPriorityIndex || i2 < 0 || i2 >= this.THREAD_PRIORITY.length) {
                    ...
                    Logger.m71025i(TAG, "changeDecodeThreadPriorityIfNeed don't change Priority mCurrPriorityIndex = " + this.THREAD_PRIORITY[this.mCurrPriorityIndex]);
                    AppMethodBeat.m2505o(104508);
                    return;
                }
            }
