...
/* renamed from: com.tencent.mm.protocal.protobuf.ahy */
public final class ahy extends btd {
    ...
    public final int mo4669op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.guW != null) {
                ix += C6091a.m9575f(2, this.guW);
            }
            if (this.guO != null) {
                ix += C6091a.m9575f(3, this.guO);
            }
            if (this.guP != null) {
                ix += C6091a.m9575f(4, this.guP);
            }
            AppMethodBeat.m2505o(28433);
            return ix;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    ahy.guW = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(28433);
                    return 0;
                case 3:
                    ahy.guO = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(28433);
                    return 0;
                case 4:
                    ahy.guP = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(28433);
                    return 0;
                default:
                    AppMethodBeat.m2505o(28433);
