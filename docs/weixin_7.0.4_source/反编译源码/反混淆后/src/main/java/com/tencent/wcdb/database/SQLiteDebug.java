...
public final class SQLiteDebug {
    ...
    public static class DbStats {
        ...
        public DbStats(String str, long j, long j2, int i, int i2, int i3, int i4) {
            AppMethodBeat.m2504i(12544);
            this.dbName = str;
            this.pageSize = j2 / 1024;
            this.dbSize = (j * j2) / 1024;
            this.lookaside = i;
            this.cache = i2 + "/" + i3 + "/" + i4;
            AppMethodBeat.m2505o(12544);
        }
    }
    ...
    static {
        AppMethodBeat.m2504i(12551);
        SQLiteGlobal.loadLib();
        AppMethodBeat.m2505o(12551);
    }
    ...
    static void collectLastIOTraceStats(SQLiteConnection sQLiteConnection) {
        ...
        try {
            ...
            AppMethodBeat.m2505o(12548);
        } catch (RuntimeException e) {
            Log.m9444e(TAG, "Cannot collect I/O trace statistics: " + e.getMessage());
            AppMethodBeat.m2505o(12548);
        }
    }

    static void collectLastIOTraceStats(SQLiteDatabase sQLiteDatabase) {
        AppMethodBeat.m2504i(12549);
        try {
            sLastErrorLine = nativeGetLastErrorLine();
            ArrayList arrayList = new ArrayList();
