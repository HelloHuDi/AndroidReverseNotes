...
/* renamed from: com.google.android.exoplayer2.f.a.f */
final class C37249f implements C17659d {
    private final List<C32044a> blz;

    public C37249f(List<C32044a> list) {
        this.blz = list;
    }
    ...
    public final long mo2577et(int i) {
        AppMethodBeat.m2504i(95617);
        C45039a.checkArgument(i == 0);
        AppMethodBeat.m2505o(95617);
        return 0;
    }

    /* renamed from: ak */
    public final List<C32044a> mo2576ak(long j) {
        AppMethodBeat.m2504i(95618);
        if (j >= 0) {
            List list = this.blz;
            AppMethodBeat.m2505o(95618);
            return list;
        }
