...
/* renamed from: com.tencent.filter.art.f */
public final class C8785f extends BaseFilter {
    private float bNE;
    private int type;
    ...
    public final void setParameterDic(Map<String, Object> map) {
        ...
        AppMethodBeat.m2505o(86311);
    }

    public final void ApplyGLSLFilter(boolean z, float f, float f2) {
        AppMethodBeat.m2504i(86312);
        ClearGLSL();
        if (z) {
            ...
            baseFilter.addParam(new C0933f("threshold", 0.0f));
            baseFilter2.setNextFilter(baseFilter, null);
            baseFilter2 = new BaseFilter(GLSLRender.bLg);
            baseFilter.setNextFilter(baseFilter2, null);
            baseFilter = new BaseFilter(GLSLRender.bLh);
            baseFilter.addParam(new C0933f("inv_2sigma2", 127.00195f));
            baseFilter.addParam(new C0933f("inv_sigma_root_2pi", 8.0E-4f));
            baseFilter.addParam(new C0933f("edge_factor", this.bNE));
            baseFilter2.setNextFilter(baseFilter, new int[]{2});
            baseFilter2 = new BaseFilter(GLSLRender.bLi);
            baseFilter2.addParam(new C0933f("par", 0.35f));
            baseFilter2.addParam(new C0933f("par_b", 0.2f));
            if (this.type == 0) {
                ...
                baseFilter2.addParam(new C0934g(AttributeConst.f17262A, new float[]{1.0f, 1.0f, 1.0f, 1.0f}));
                baseFilter2.addParam(new C0934g(AttributeConst.f17263B, fArr));
                baseFilter2.addParam(new C0934g("colorC", fArr2));
                baseFilter2.addParam(new C0934g("colorD", fArr3));
            }
            if (this.type == 1) {
                ...
                baseFilter2.addParam(new C0934g(AttributeConst.f17262A, new float[]{0.8117647f, 0.9647059f, 0.9607843f, 1.0f}));
                baseFilter2.addParam(new C0934g(AttributeConst.f17263B, fArr));
                baseFilter2.addParam(new C0934g("colorC", fArr2));
                baseFilter2.addParam(new C0934g("colorD", fArr3));
            }
            if (this.type == 2) {
                ...
                baseFilter2.addParam(new C0934g(AttributeConst.f17262A, new float[]{0.7411765f, 0.8627451f, 0.827451f, 1.0f}));
                baseFilter2.addParam(new C0934g(AttributeConst.f17263B, fArr));
                baseFilter2.addParam(new C0934g("colorC", fArr2));
                baseFilter2.addParam(new C0934g("colorD", fArr3));
            }
            if (this.type == 3) {
                ...
                baseFilter2.addParam(new C0934g(AttributeConst.f17262A, new float[]{0.9882353f, 0.99607843f, 0.88235295f, 1.0f}));
                baseFilter2.addParam(new C0934g(AttributeConst.f17263B, fArr));
                baseFilter2.addParam(new C0934g("colorC", fArr2));
                baseFilter2.addParam(new C0934g("colorD", fArr3));
            }
            if (this.type == 4) {
                ...
                baseFilter2.addParam(new C0934g(AttributeConst.f17262A, new float[]{1.0f, 0.9529412f, 0.78431374f, 1.0f}));
                baseFilter2.addParam(new C0934g(AttributeConst.f17263B, fArr));
                baseFilter2.addParam(new C0934g("colorC", fArr2));
                baseFilter2.addParam(new C0934g("colorD", fArr3));
            }
            if (this.type == 5) {
                ...
                baseFilter2.addParam(new C0934g(AttributeConst.f17262A, new float[]{1.0f, 0.9137255f, 0.6862745f, 1.0f}));
                baseFilter2.addParam(new C0934g(AttributeConst.f17263B, fArr));
                baseFilter2.addParam(new C0934g("colorC", fArr2));
                baseFilter2.addParam(new C0934g("colorD", fArr3));
            }
            ...
            if (GLES20.glGetString(7937).indexOf("NVIDIA Tegra") != -1) {
                ...
                baseFilter.addParam(new C0935i("radius", 2));
            }
            baseFilter.addParam(new C0933f("inv_2sigma", 4.4f));
            baseFilter2.setNextFilter(baseFilter, new int[]{4});
        }
        super.ApplyGLSLFilter(z, f, f2);
        AppMethodBeat.m2505o(86312);
    }
}
