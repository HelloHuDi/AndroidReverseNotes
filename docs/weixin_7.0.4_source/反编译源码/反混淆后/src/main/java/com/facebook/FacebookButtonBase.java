...
public abstract class FacebookButtonBase extends Button {
    ...
    class C372081 implements OnClickListener {
        C372081() {
        }

        public void onClick(View view) {
            AppMethodBeat.m2504i(96593);
    ...
    protected FacebookButtonBase(Context context, AttributeSet attributeSet, int i, int i2, String str, String str2) {
        ...
        if (defaultStyleResource == 0) {
            defaultStyleResource = C25738R.style.f11399z_;
        }
        ...
        if (!isInEditMode()) {
            ...
            try {
                if (obtainStyledAttributes.hasValue(0)) {
                    ...
                    setBackgroundColor(C0380b.m652i(context, C25738R.color.f11884km));
                }
    ...
    private void setupOnClickListener() {
        super.setOnClickListener(new C372081());
    }
}
