...
import com.eclipsesource.p097v8.V8Object.Undefined;
import com.eclipsesource.p097v8.utils.V8Executor;
import com.eclipsesource.p097v8.utils.V8Map;
import com.eclipsesource.p097v8.utils.V8Runnable;
...
public class C45010V8 extends V8Object {
    ...
    private static ILoadLibraryDelegate sLoadLibraryDelegate = new C319901();
    ...
    /* renamed from: com.eclipsesource.v8.V8$1 */
    static class C319901 implements ILoadLibraryDelegate {
        C319901() {
        }

        public final void loadLibrary(String str) {
            AppMethodBeat.m2504i(75160);
            LibraryLoader.loadLibrary(str);
            AppMethodBeat.m2505o(75160);
        }
    }
    ...
    class MethodDescriptor {
        ...
        /* synthetic */ MethodDescriptor(C45010V8 c45010v8, C319901 c319901) {
            this();
        }
    }
    ...
    static {
        AppMethodBeat.m2504i(75343);
        AppMethodBeat.m2505o(75343);
    }

    private static synchronized void load(String str) {
        synchronized (C45010V8.class) {
            AppMethodBeat.m2504i(75161);
            try {
                sLoadLibraryDelegate.loadLibrary(str);
                nativeLibraryLoaded = true;
                AppMethodBeat.m2505o(75161);
            } catch (Error e) {
                nativeLoadError = e;
                AppMethodBeat.m2505o(75161);
            } catch (Exception e2) {
    ...
    public static C45010V8 createV8Runtime() {
        AppMethodBeat.m2504i(75162);
        C45010V8 createV8Runtime = C45010V8.createV8Runtime(null, null);
        AppMethodBeat.m2505o(75162);
        return createV8Runtime;
    }

    public static C45010V8 createV8Runtime(String str) {
        AppMethodBeat.m2504i(75163);
        C45010V8 createV8Runtime = C45010V8.createV8Runtime(str, null);
        AppMethodBeat.m2505o(75163);
        return createV8Runtime;
    }

    public static C45010V8 createV8Runtime(String str, String str2) {
        AppMethodBeat.m2504i(75164);
        C45010V8 createV8Runtime = C45010V8.createV8Runtime(str, str2, true, null, null);
        AppMethodBeat.m2505o(75164);
        return createV8Runtime;
    }

    protected static C45010V8 createV8Runtime(String str, String str2, boolean z) {
        AppMethodBeat.m2504i(75165);
        C45010V8 createV8Runtime = C45010V8.createV8Runtime(str, str2, z, null, null);
        AppMethodBeat.m2505o(75165);
        return createV8Runtime;
    }

    protected static C45010V8 createV8Runtime(String str, String str2, boolean z, String str3, byte[] bArr) {
        AppMethodBeat.m2504i(75166);
        if (!nativeLibraryLoaded) {
            synchronized (lock) {
                try {
                    ...
                    while (true) {
                        AppMethodBeat.m2505o(75166);
                    }
                }
            }
        }
        C45010V8.checkNativeLibraryLoaded();
        if (!initialized) {
            C45010V8._setFlags(v8Flags);
            synchronized (lock) {
                if (str3 != null) {
                    try {
                        C45010V8._setCodeCacheDir(str3);
                    } catch (Throwable th2) {
                        while (true) {
                            AppMethodBeat.m2505o(75166);
                        }
                ...
                if (bArr != null) {
                    C45010V8._setSnapshotBlob(bArr);
                }
            }
            initialized = true;
        }
        C45010V8 c45010v8 = new C45010V8(str, z);
        synchronized (lock) {
            try {
                runtimeCounter++;
            } finally {
    ...
    protected C45010V8(String str, boolean z) {
        super(null);
        AppMethodBeat.m2504i(75182);
    ...
    public static String getV8Version() {
        AppMethodBeat.m2504i(75184);
        String _getVersion = C45010V8._getVersion();
        AppMethodBeat.m2505o(75184);
        return _getVersion;
    }
    ...
    public void release() {
        AppMethodBeat.m2504i(75185);
        release(true);
        AppMethodBeat.m2505o(75185);
    }

    public void terminateExecution() {
        AppMethodBeat.m2504i(75186);
        this.forceTerminateExecutors = true;
        terminateExecution(this.v8RuntimePtr);
        AppMethodBeat.m2505o(75186);
    }

    public void release(boolean z) {
        AppMethodBeat.m2504i(75187);
        if (isReleased()) {
            AppMethodBeat.m2505o(75187);
            return;
        }
        checkThread();
        IllegalStateException illegalStateException;
    ...
    public V8Executor getExecutor(V8Object v8Object) {
        AppMethodBeat.m2504i(75192);
        checkThread();
        if (this.executors == null) {
            AppMethodBeat.m2505o(75192);
            return null;
        }
    ...
    public void shutdownExecutors(boolean z) {
        AppMethodBeat.m2504i(75193);
        checkThread();
        if (this.executors == null) {
            AppMethodBeat.m2505o(75193);
            return;
        }
    ...
    public long getBuildID() {
        AppMethodBeat.m2504i(75220);
        long _getBuildID = _getBuildID();
        AppMethodBeat.m2505o(75220);
        return _getBuildID;
    }

    public void lowMemoryNotification() {
        AppMethodBeat.m2504i(75221);
        checkThread();
        lowMemoryNotification(getV8RuntimePtr());
        AppMethodBeat.m2505o(75221);
    }

    public void memoryPressureNotification(int i) {
        AppMethodBeat.m2504i(75222);
        _memoryPressureNotification(this.v8RuntimePtr, i);
        AppMethodBeat.m2505o(75222);
    }

    /* Access modifiers changed, original: 0000 */
    public void checkRuntime(V8Value v8Value) {
        AppMethodBeat.m2504i(75223);
        if (v8Value == null || v8Value.isUndefined()) {
            AppMethodBeat.m2505o(75223);
            return;
        }
        C45010V8 runtime = v8Value.getRuntime();
    ...
    private Object checkResult(Object obj) {
        AppMethodBeat.m2504i(75235);
        V8RuntimeException v8RuntimeException;
        if (obj == null) {
            AppMethodBeat.m2505o(75235);
            return obj;
    ...
    public void createNodeRuntime(String str) {
        AppMethodBeat.m2504i(75244);
        C45010V8._startNodeJS(this.v8RuntimePtr, str);
        AppMethodBeat.m2505o(75244);
    }

    /* Access modifiers changed, original: 0000 */
    public boolean pumpMessageLoop() {
        AppMethodBeat.m2504i(75245);
        boolean _pumpMessageLoop = C45010V8._pumpMessageLoop(this.v8RuntimePtr);
        AppMethodBeat.m2505o(75245);
        return _pumpMessageLoop;
    }

    /* Access modifiers changed, original: 0000 */
    public boolean isRunning() {
        AppMethodBeat.m2504i(75246);
        boolean _isRunning = C45010V8._isRunning(this.v8RuntimePtr);
        AppMethodBeat.m2505o(75246);
        return _isRunning;
    }

    /* Access modifiers changed, original: protected */
    public long initNewV8Object(long j) {
        AppMethodBeat.m2504i(75247);
        long _initNewV8Object = _initNewV8Object(j);
        AppMethodBeat.m2505o(75247);
        return _initNewV8Object;
    }

    /* Access modifiers changed, original: protected */
    public long getGlobalObject() {
        AppMethodBeat.m2504i(75248);
        long _getGlobalObject = _getGlobalObject(this.v8RuntimePtr);
        AppMethodBeat.m2505o(75248);
        return _getGlobalObject;
    }

    /* Access modifiers changed, original: protected */
    public void acquireLock(long j) {
        AppMethodBeat.m2504i(75249);
        _acquireLock(j);
        AppMethodBeat.m2505o(75249);
    }

    /* Access modifiers changed, original: protected */
    public void releaseLock(long j) {
        AppMethodBeat.m2504i(75250);
        _releaseLock(j);
        AppMethodBeat.m2505o(75250);
    }

    /* Access modifiers changed, original: protected */
    public void lowMemoryNotification(long j) {
        AppMethodBeat.m2504i(75251);
        _lowMemoryNotification(j);
        AppMethodBeat.m2505o(75251);
    }

    /* Access modifiers changed, original: protected */
    public void createTwin(long j, long j2, long j3) {
        AppMethodBeat.m2504i(75252);
        _createTwin(j, j2, j3);
        AppMethodBeat.m2505o(75252);
    }

    /* Access modifiers changed, original: protected */
    public int executeIntegerScript(long j, String str, String str2, int i, String str3, String str4) {
        AppMethodBeat.m2504i(75253);
        int _executeIntegerScript = _executeIntegerScript(j, str, str2, i, str3, str4);
        AppMethodBeat.m2505o(75253);
    ...
    public String executeDebugScript(String str, String str2) {
        AppMethodBeat.m2504i(75340);
        checkThread();
        C45010V8.checkScript(str);
        String _executeDebugScript = C45010V8._executeDebugScript(this.v8RuntimePtr, str, str2);
        AppMethodBeat.m2505o(75340);
        return _executeDebugScript;
    }

    public void waitForDebugger(String str) {
        AppMethodBeat.m2504i(75341);
        checkThread();
        C45010V8._waitForDebuger(this.v8RuntimePtr, str);
        AppMethodBeat.m2505o(75341);
    }

    public void debuggerMessageLoop() {
        AppMethodBeat.m2504i(75342);
        checkThread();
        C45010V8._debugMessageLoop(this.v8RuntimePtr);
        AppMethodBeat.m2505o(75342);
    }
}
