...
public class StaticNumFilter extends NormalVideoFilter {
    ...
    public boolean renderTexture(int i, int i2, int i3) {
        int i4 = 0;
        AppMethodBeat.m2504i(82963);
        if (this.mNum < 0) {
            AppMethodBeat.m2505o(82963);
        } else {
            int totalBit = getTotalBit(this.mNum);
            updateTextureParam(this.item.f18271id, -1, 0);
            ...
            if (this.mNum < 10) {
                ...
                updateTextureParam(this.item.f18271id, this.mNum, i4);
                ...
                i5 = this.mNum % 10;
                updateTextureParam(this.item.f18271id, i5, i4);
