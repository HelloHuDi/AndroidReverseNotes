...
public class YTFileUtils {
    private YTFileUtils() {
        AppMethodBeat.m2504i(118086);
        AssertionError assertionError = new AssertionError();
        AppMethodBeat.m2505o(118086);
    ...
    public static void copyFileOrDir(AssetManager assetManager, String str, String str2) {
        AppMethodBeat.m2504i(118090);
        try {
            String[] list = assetManager.list(str);
            if (list.length == 0) {
                copyAsset(assetManager, str, str2 + "/" + str);
                AppMethodBeat.m2505o(118090);
                return;
            }
            String str3;
    ...
    public static Bitmap drawableToBitmap(Drawable drawable) {
        Bitmap bitmap;
        AppMethodBeat.m2504i(118092);
        if (drawable instanceof BitmapDrawable) {
            BitmapDrawable bitmapDrawable = (BitmapDrawable) drawable;
            if (bitmapDrawable.getBitmap() != null) {
                bitmap = bitmapDrawable.getBitmap();
                AppMethodBeat.m2505o(118092);
                return bitmap;
            }
        }
    ...
    private static void zipSubFolder(ZipOutputStream zipOutputStream, File file, int i) {
        ...
        AppMethodBeat.m2505o(118094);
    }

    public static String getLastPathComponent(String str) {
        AppMethodBeat.m2504i(118095);
        String[] split = str.split("/");
        String str2;
        if (split.length == 0) {
            str2 = "";
            AppMethodBeat.m2505o(118095);
            return str2;
        }
    ...
    public static void deleteFile(File file) {
        AppMethodBeat.m2504i(118096);
        if (file.isFile()) {
            file.delete();
            AppMethodBeat.m2505o(118096);
            return;
        }
        if (file.isDirectory()) {
