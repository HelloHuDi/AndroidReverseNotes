...
public class RecoveryLogic {
    ...
    /* renamed from: a */
    public static void m8701a(Context context, ArrayList<RecoveryHandleItem> arrayList, String str) {
        RecoveryLog.m8712i("Recovery.RecoveryLogic", "startReportService %s", "HandleStatus");
    ...
    /* renamed from: a */
    public static boolean m8702a(Context context, CommonOptions commonOptions, RecoveryContext recoveryContext) {
        if (commonOptions.Aro == null) {
            RecoveryLog.m8712i("Recovery.RecoveryLogic", "startRecoveryProcess not set handle service", new Object[0]);
            return false;
        }
        String name;
        String name2;
        RecoveryLog.m8712i("Recovery.RecoveryLogic", "startHandleService %s", Util.m8737iC(context));
        ...
        recoveryData.processName = Util.m8737iC(context);
    ...
    /* renamed from: bW */
    public static int m8703bW(Context context, String str) {
        if (AqZ != 17) {
            return AqZ;
        }
        AqZ = 16;
        ...
        if (AqY != null) {
            ...
            if (runningAppProcesses == null || runningAppProcesses.isEmpty()) {
                RecoveryLog.m8712i("Recovery.RecoveryLogic", "can not get running app process", new Object[0]);
            } else {
                ...
                if (runningAppProcessInfo2 != null) {
                    RecoveryLog.m8712i("Recovery.RecoveryLogic", "%s %s", str, runningAppProcessInfo2.processName);
                    ...
                    RecoveryLog.m8712i("Recovery.RecoveryLogic", "foregroundInfo is null %s %s", Integer.valueOf(runningAppProcesses.size()), stringBuffer.toString());
                }
            }
        }
        return AqZ;
