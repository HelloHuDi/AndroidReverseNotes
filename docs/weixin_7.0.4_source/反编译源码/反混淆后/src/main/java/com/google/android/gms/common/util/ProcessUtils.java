...
public class ProcessUtils {
    ...
    public static String getCallingProcessName() {
        AppMethodBeat.m2504i(90256);
        int callingPid = Binder.getCallingPid();
        String myProcessName;
        if (callingPid == zzde()) {
            myProcessName = getMyProcessName();
            AppMethodBeat.m2505o(90256);
    ...
    public static String getMyProcessName() {
        AppMethodBeat.m2504i(90257);
        if (zzaai == null) {
            zzaai = zzl(zzde());
        }
        String str = zzaai;
        AppMethodBeat.m2505o(90257);
        return str;
    }

    public static boolean hasSystemGroups() {
        AppMethodBeat.m2504i(90258);
        Closeable closeable = null;
        try {
            closeable = zzm("/proc/" + zzde() + "/status");
            boolean zzk = zzk(closeable);
            IOUtils.closeQuietly(closeable);
            AppMethodBeat.m2505o(90258);
            return zzk;
        } catch (IOException e) {
    ...
    private static int zzde() {
        AppMethodBeat.m2504i(90262);
        if (zzaaj == 0) {
            zzaaj = Process.myPid();
        }
        int i = zzaaj;
        AppMethodBeat.m2505o(90262);
        return i;
    }

    private static boolean zzk(BufferedReader bufferedReader) {
        AppMethodBeat.m2504i(90259);
    ...
    private static String zzl(int i) {
        ...
        Closeable closeable;
        String str = null;
        AppMethodBeat.m2504i(90260);
        if (i <= 0) {
            AppMethodBeat.m2505o(90260);
        } else {
            Closeable zzm;
            try {
