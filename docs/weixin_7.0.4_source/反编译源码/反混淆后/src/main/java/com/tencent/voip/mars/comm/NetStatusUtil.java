...
public class NetStatusUtil {
    ...
    public static void dumpNetStatus(Context context) {
        AppMethodBeat.m2504i(92764);
        try {
            Log.m25197i(TAG, ((ConnectivityManager) context.getSystemService("connectivity")).getActiveNetworkInfo().toString());
            AppMethodBeat.m2505o(92764);
        } catch (Exception e) {
            Log.m25194e(TAG, "", e);
            AppMethodBeat.m2505o(92764);
        }
    ...
    public static int getNetWorkType(Context context) {
        AppMethodBeat.m2504i(92767);
        try {
            NetworkInfo activeNetworkInfo = ((ConnectivityManager) context.getSystemService("connectivity")).getActiveNetworkInfo();
            if (activeNetworkInfo != null) {
                int type = activeNetworkInfo.getType();
                AppMethodBeat.m2505o(92767);
                return type;
            }
        } catch (Exception e) {
        }
    ...
    public static int getNetType(Context context) {
        AppMethodBeat.m2504i(92768);
        ConnectivityManager connectivityManager = (ConnectivityManager) context.getSystemService("connectivity");
        if (connectivityManager == null) {
            AppMethodBeat.m2505o(92768);
            return -1;
        }
        NetworkInfo activeNetworkInfo = connectivityManager.getActiveNetworkInfo();
        if (activeNetworkInfo == null) {
    ...
    public static int getISPCode(Context context) {
        AppMethodBeat.m2504i(92769);
        TelephonyManager telephonyManager = (TelephonyManager) context.getSystemService("phone");
        if (telephonyManager == null) {
            AppMethodBeat.m2505o(92769);
            return 0;
        }
    ...
    public static String getISPName(Context context) {
        AppMethodBeat.m2504i(92770);
        TelephonyManager telephonyManager = (TelephonyManager) context.getSystemService("phone");
        String str;
        if (telephonyManager == null) {
            str = "";
            AppMethodBeat.m2505o(92770);
            return str;
    ...
    public static int guessNetSpeed(Context context) {
        AppMethodBeat.m2504i(92771);
        try {
            NetworkInfo activeNetworkInfo = ((ConnectivityManager) context.getSystemService("connectivity")).getActiveNetworkInfo();
            if (activeNetworkInfo.getType() == 1) {
                AppMethodBeat.m2505o(92771);
                return 102400;
            }
    ...
    public static boolean isMobile(Context context) {
        AppMethodBeat.m2504i(92772);
        try {
            if (((ConnectivityManager) context.getSystemService("connectivity")).getActiveNetworkInfo().getType() != 1) {
                AppMethodBeat.m2505o(92772);
                return true;
            }
            AppMethodBeat.m2505o(92772);
            return false;
    ...
    public static boolean is2G(Context context) {
        AppMethodBeat.m2504i(92773);
        try {
            NetworkInfo activeNetworkInfo = ((ConnectivityManager) context.getSystemService("connectivity")).getActiveNetworkInfo();
            if (activeNetworkInfo.getType() == 1) {
                AppMethodBeat.m2505o(92773);
                return false;
            }
    ...
    public static boolean is4G(Context context) {
        AppMethodBeat.m2504i(92774);
        try {
            NetworkInfo activeNetworkInfo = ((ConnectivityManager) context.getSystemService("connectivity")).getActiveNetworkInfo();
            if (activeNetworkInfo.getType() == 1) {
                AppMethodBeat.m2505o(92774);
                return false;
            }
    ...
    public static boolean isWap(Context context) {
        AppMethodBeat.m2504i(92775);
        boolean isWap = isWap(getNetType(context));
        AppMethodBeat.m2505o(92775);
        return isWap;
    }
    ...
    public static boolean is3G(Context context) {
        AppMethodBeat.m2504i(92776);
        try {
            NetworkInfo activeNetworkInfo = ((ConnectivityManager) context.getSystemService("connectivity")).getActiveNetworkInfo();
            if (activeNetworkInfo.getType() == 1) {
                AppMethodBeat.m2505o(92776);
                return false;
            }
    ...
    public static boolean isWifi(Context context) {
        AppMethodBeat.m2504i(92777);
        boolean isWifi = isWifi(getNetType(context));
        AppMethodBeat.m2505o(92777);
        return isWifi;
    }
    ...
    public static WifiInfo getWifiInfo(Context context) {
        AppMethodBeat.m2504i(92778);
        try {
            ConnectivityManager connectivityManager = (ConnectivityManager) context.getSystemService("connectivity");
            if (connectivityManager == null) {
                AppMethodBeat.m2505o(92778);
                return null;
            }
            NetworkInfo activeNetworkInfo = connectivityManager.getActiveNetworkInfo();
    ...
    public static void startSettingItent(Context context, int i) {
        AppMethodBeat.m2504i(92780);
        Intent intent;
        switch (i) {
            case 0:
                AppMethodBeat.m2505o(92780);
                return;
            case 1:
                try {
                    intent = new Intent("/");
    ...
    public static boolean isNetworkConnected(Context context) {
        AppMethodBeat.m2504i(92786);
        ConnectivityManager connectivityManager = (ConnectivityManager) context.getSystemService("connectivity");
        if (connectivityManager == null) {
            AppMethodBeat.m2505o(92786);
            return false;
        }
        NetworkInfo activeNetworkInfo = connectivityManager.getActiveNetworkInfo();
        if (activeNetworkInfo == null) {
    ...
    public static int getNetTypeForStat(Context context) {
        AppMethodBeat.m2504i(92787);
        if (context == null) {
            AppMethodBeat.m2505o(92787);
            return 999;
        }
        try {
            ConnectivityManager connectivityManager = (ConnectivityManager) context.getSystemService("connectivity");
    ...
    public static int getStrength(Context context) {
        AppMethodBeat.m2504i(92788);
        if (context == null) {
            AppMethodBeat.m2505o(92788);
            return 0;
        }
        try {
            int abs;
