...
public final class GmsClientEventManager implements Callback {
    ...
    public GmsClientEventManager(Looper looper, GmsClientEventState gmsClientEventState) {
        AppMethodBeat.m2504i(61334);
        this.zztf = gmsClientEventState;
        this.mHandler = new Handler(looper, this);
        AppMethodBeat.m2505o(61334);
    }
    ...
    public final void disableCallbacks() {
        AppMethodBeat.m2504i(61335);
        this.zztj = false;
        this.zztk.incrementAndGet();
        AppMethodBeat.m2505o(61335);
    }
