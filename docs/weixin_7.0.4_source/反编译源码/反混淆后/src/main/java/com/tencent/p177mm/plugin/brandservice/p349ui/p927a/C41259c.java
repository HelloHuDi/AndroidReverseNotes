...
/* renamed from: com.tencent.mm.plugin.brandservice.ui.a.c */
public final class C41259c extends C39153a {
    public C41259c(Context context, C39133b c39133b, int i) {
        super(context, c39133b, i);
    }

    /* renamed from: a */
    public final C3154a mo7331a(int i, C34203a c34203a) {
        AppMethodBeat.m2504i(14090);
    ...
    public final C28106a mo7330a(C7306ak c7306ak, HashSet<String> hashSet) {
        AppMethodBeat.m2504i(14088);
        C28106a search = ((C12029n) C1720g.m3530M(C12029n.class)).search(2, C20846i.m32057a(this.query, new int[]{131076}, null, -1, hashSet, C39132b.mEV, this, c7306ak));
        AppMethodBeat.m2505o(14088);
        return search;
    }

    /* renamed from: a */
    public final void mo7332a(C28109j c28109j, HashSet<String> hashSet) {
        AppMethodBeat.m2504i(14089);
