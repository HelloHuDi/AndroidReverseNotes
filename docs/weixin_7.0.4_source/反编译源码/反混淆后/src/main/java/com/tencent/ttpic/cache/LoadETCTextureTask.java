...
public class LoadETCTextureTask extends AsyncTask<Void, Integer, Boolean> {
    ...
    public Boolean doInBackground(Void... voidArr) {
        AppMethodBeat.m2504i(81784);
        Boolean bool;
        if (this.cache == null) {
            bool = Boolean.FALSE;
            AppMethodBeat.m2505o(81784);
            return bool;
        }
    ...
    private void fillCache(int i, String str) {
        AppMethodBeat.m2504i(81785);
        for (int i2 = 0; i2 < i; i2++) {
            Object obj = this.materialId + File.separator + (this.f14327id + "_" + String.format("%0" + LoadETCItemManager.FORMAT_COUNT + "d", new Object[]{Integer.valueOf(i2)}) + str);
            if (!this.cache.containsKey(obj)) {
                int i3 = i2;
                while (!this.cache.containsKey(obj) && i3 > 0) {
                    i3--;
                    obj = this.materialId + File.separator + (this.f14327id + "_" + String.format("%0" + LoadETCItemManager.FORMAT_COUNT + "d", new Object[]{Integer.valueOf(i3)}) + str);
                }
                if (this.cache.containsKey(obj)) {
                    this.cache.put(this.materialId + File.separator + (this.f14327id + "_" + String.format("%0" + LoadETCItemManager.FORMAT_COUNT + "d", new Object[]{Integer.valueOf(i2)}) + str), this.cache.get(obj));
                }
            }
        }
        AppMethodBeat.m2505o(81785);
    }
}
