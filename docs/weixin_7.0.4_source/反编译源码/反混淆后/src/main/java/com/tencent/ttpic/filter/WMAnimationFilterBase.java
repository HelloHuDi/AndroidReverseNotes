...
public abstract class WMAnimationFilterBase extends BaseFilter {
    ...
    private void initParams(WMElement wMElement, int i, int i2, int i3) {
        ...
        addParam(new C25629b("texAnchor", ((wMElement.finalContentRect.left + wMElement.finalContentRect.right) / 2.0f) - ((float) (i / 2)), ((wMElement.finalContentRect.top + wMElement.finalContentRect.bottom) / 2.0f) - ((float) (i2 / 2))));
