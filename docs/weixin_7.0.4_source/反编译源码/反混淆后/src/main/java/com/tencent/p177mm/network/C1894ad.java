...
/* renamed from: com.tencent.mm.network.ad */
public final class C1894ad {
    public static final String gen = (C6457e.eSl + "/tencent/noop.dat");
    private static long geo;
    private static long lastUpdateTime;

    static {
        long j;
        AppMethodBeat.m2504i(58692);
        lastUpdateTime = 0;
        SharedPreferences sharedPreferences = C4996ah.getContext().getSharedPreferences("noop_prefs", 0);
    ...
    /* renamed from: y */
    public static void m4015y(long j, long j2) {
        Exception e;
        Throwable th;
        AppMethodBeat.m2504i(58690);
        new StringBuilder("setNoopInterval interval:").append(j).append(", svr:").append(j2);
        if (j2 > 0) {
            C4996ah.getContext().getSharedPreferences("noop_prefs", 0).edit().putInt("noop_strategy", 2).commit();
            if (j < 180 || j > 3600) {
                AppMethodBeat.m2505o(58690);
            ...
            C4996ah.getContext().getSharedPreferences("noop_prefs", 0).edit().putInt("noop_strategy", 1).commit();
            AppMethodBeat.m2505o(58690);
        } else if (j < 180 || j > 3600) {
            new StringBuilder("setNoopInterval value invalid interval:").append(j).append(", _svrTime:").append(j2);
            AppMethodBeat.m2505o(58690);
        } else {
            C4996ah.getContext().getSharedPreferences("noop_prefs", 0).edit().putInt("noop_strategy", 3).putLong("noop_min_interval", j).commit();
            AppMethodBeat.m2505o(58690);
        }
    }
