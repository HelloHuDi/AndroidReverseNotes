...
public class StatisticsUtils {
    public static String getDeviceUid(Context context) {
        AppMethodBeat.m2504i(118057);
        String str;
        if (context.getPackageName().startsWith("com.tencent")) {
            str = "com.tencent";
            AppMethodBeat.m2505o(118057);
            return str;
        }
    ...
    public static String getMacAddr(Context context) {
        AppMethodBeat.m2504i(118058);
        if (context == null) {
            AppMethodBeat.m2505o(118058);
            return null;
        }
        String macAddress;
    ...
    public static String getIMEI(Context context) {
        String deviceId;
        AppMethodBeat.m2504i(118059);
        String string = Secure.getString(context.getContentResolver(), "android_id");
        if (TextUtils.isEmpty(string)) {
            TelephonyManager telephonyManager = (TelephonyManager) context.getApplicationContext().getSystemService("phone");
            if (telephonyManager != null) {
                deviceId = telephonyManager.getDeviceId();
                AppMethodBeat.m2505o(118059);
                return deviceId;
            }
        }
        deviceId = string;
    ...
    public static String toMD5(String str) {
        AppMethodBeat.m2504i(118060);
        String str2;
        if (TextUtils.isEmpty(str)) {
            str2 = "";
            AppMethodBeat.m2505o(118060);
            return str2;
        }
        try {
    ...
    private static char getChar(byte b, int i) {
        AppMethodBeat.m2504i(118061);
        char offset = (char) (b - getOffset(i & 1));
        AppMethodBeat.m2505o(118061);
        return offset;
    }
    ...
    private static String encryptUid(String str) {
        AppMethodBeat.m2504i(118062);
        String str2;
        if (TextUtils.isEmpty(str)) {
            str2 = "";
            AppMethodBeat.m2505o(118062);
            return str2;
        }
