...
public class AudioUtil {
    ...
    public static int getDecodeBufferSizeForPlay(NativeDecoder nativeDecoder) {
        ...
        AppMethodBeat.m2505o(104696);
        return i;
    }

    public static NativeDecoder getDecoderFromTrack(String str, long j, long j2) {
        AppMethodBeat.m2504i(104697);
        if (TextUtils.isEmpty(str)) {
            AppMethodBeat.m2505o(104697);
            return null;
        } else if (j >= j2) {
            AppMethodBeat.m2505o(104697);
            return null;
            ...
            try {
                ...
                if (nativeDecoder.init(trackDataSource) != 0) {
                    Logger.m71021e(TAG, "init decoder from track failed!");
                    AppMethodBeat.m2505o(104697);
                    return null;
                }
                long seek = new NativeSeekTable(nativeDecoder).seek(j2);
                if (seek <= 0) {
                    Logger.m71021e(TAG, "endPos from track <= 0");
                    AppMethodBeat.m2505o(104697);
                    return null;
                }
    ...
    public static int getPlaybackHeadPositionSafely(AudioTrack audioTrack) {
        AppMethodBeat.m2504i(104699);
        int i = 0;
        if (audioTrack != null) {
            try {
                i = audioTrack.getPlaybackHeadPosition();
            } catch (Exception e) {
                Logger.m71022e(TAG, "getPlaybackHeadPositionSafely", e);
            }
        }
        AppMethodBeat.m2505o(104699);
        return i;
    }
}
