...
/* renamed from: com.tencent.mm.plugin.backup.i.f */
public final class C11154f extends C1331a {
    public long jxD;

    /* renamed from: op */
    public final int mo4669op(int i, Object... objArr) {
        AppMethodBeat.m2504i(18049);
        int o;
        if (i == 0) {
            ((C6093a) objArr[0]).mo13472ai(1, this.jxD);
            AppMethodBeat.m2505o(18049);
            return 0;
        } else if (i == 1) {
            ...
            C11154f c11154f = (C11154f) objArr[1];
            switch (((Integer) objArr[2]).intValue()) {
                case 1:
                    c11154f.jxD = c6086a2.BTU.mo13459ve();
                    AppMethodBeat.m2505o(18049);
                    return 0;
                default:
                    AppMethodBeat.m2505o(18049);
