...
public final class zzl extends AbstractSafeParcelable {
    ...
    static {
        AppMethodBeat.m2504i(71453);
        AppMethodBeat.m2505o(71453);
    }
    ...
    public final boolean equals(Object obj) {
        AppMethodBeat.m2504i(71451);
        if (this == obj) {
            AppMethodBeat.m2505o(71451);
            return true;
    ...
    public final int hashCode() {
        int i = 0;
        AppMethodBeat.m2504i(71452);
        int hashCode = ((((((((((this.zzbk != null ? this.zzbk.hashCode() : 0) + (((((((((this.zzbg != null ? this.zzbg.hashCode() : 0) + ((((this.f2440id + 31) * 31) + this.zzbf.hashCode()) * 31)) * 31) + this.zzbh.hashCode()) * 31) + this.zzbi.hashCode()) * 31) + this.zzbj.hashCode()) * 31)) * 31) + this.zzbl) * 31) + this.zzbm) * 31) + this.zzbn) * 31) + this.zzbo) * 31;
        if (this.packageName != null) {
            i = this.packageName.hashCode();
        }
        hashCode += i;
        AppMethodBeat.m2505o(71452);
        return hashCode;
    }

    public final String toString() {
        AppMethodBeat.m2504i(71450);
        int i = this.f2440id;
        ...
        AppMethodBeat.m2505o(71450);
        return stringBuilder;
    }

    public final void writeToParcel(Parcel parcel, int i) {
        AppMethodBeat.m2504i(71449);
        int beginObjectHeader = SafeParcelWriter.beginObjectHeader(parcel);
        SafeParcelWriter.writeInt(parcel, 2, this.f2440id);
