        ...
        try {
            ...
            try {
                ...
                if (detect != null) {
                    ...
                    str = detect.getName();
                    Logger.m71025i(TAG, "Audio list file encode: " + str + " ,confidence: " + confidence);
                }
                try {
                    bufferedInputStream.close();
                } catch (IOException e2) {
                    Logger.m71022e(TAG, "guess encoding close fis ex", e2);
                }
            } catch (IOException e3) {
                e2 = e3;
                try {
                    Logger.m71022e(TAG, "guess encoding ex", e2);
                    if (bufferedInputStream != null) {
                        try {
                            bufferedInputStream.close();
                        } catch (IOException e22) {
                            Logger.m71022e(TAG, "guess encoding close fis ex", e22);
                        }
                    }
                    return str;
                } catch (Throwable th2) {
                    ...
                    if (bufferedInputStream != null) {
                        try {
                            ...
                            Logger.m71022e(TAG, "guess encoding close fis ex", e222);
                        }
                    }
                    throw th;
                }
            ...
            Logger.m71022e(TAG, "guess encoding ex", e222);
            if (bufferedInputStream != null) {
            }
            return str;
        } catch (Throwable th3) {
