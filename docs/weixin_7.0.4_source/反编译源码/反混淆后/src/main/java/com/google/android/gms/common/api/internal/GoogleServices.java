...
public final class GoogleServices {
    ...
    static {
        AppMethodBeat.m2504i(89479);
        AppMethodBeat.m2505o(89479);
    }
    ...
    GoogleServices(Context context) {
        boolean z = true;
        AppMethodBeat.m2504i(89470);
        Resources resources = context.getResources();
        int identifier = resources.getIdentifier("google_app_measurement_enable", "integer", resources.getResourcePackageName(C25738R.string.common_google_play_services_unknown_issue));
        if (identifier != 0) {
    ...
    GoogleServices(String str, boolean z) {
        AppMethodBeat.m2504i(89471);
        this.zzkv = str;
        this.zzkw = Status.RESULT_SUCCESS;
        this.zzkx = z;
        this.zzky = !z;
        AppMethodBeat.m2505o(89471);
    }

    @KeepForSdk
    private static GoogleServices checkInitialized(String str) {
        GoogleServices googleServices;
        AppMethodBeat.m2504i(89478);
        synchronized (sLock) {
            try {
                if (zzku == null) {
    ...
    public static String getGoogleAppId() {
        AppMethodBeat.m2504i(89475);
        String str = checkInitialized("getGoogleAppId").zzkv;
        AppMethodBeat.m2505o(89475);
        return str;
    }
    ...
    public final Status checkGoogleAppId(String str) {
        AppMethodBeat.m2504i(89473);
        Status status;
        if (this.zzkv == null || this.zzkv.equals(str)) {
            status = Status.RESULT_SUCCESS;
            AppMethodBeat.m2505o(89473);
            return status;
        }
