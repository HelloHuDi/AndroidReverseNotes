...
import com.tencent.p177mm.media.editor.p1203c.C42169b.C37892a;
...
/* renamed from: com.tencent.mm.media.editor.c.c */
public final class C42171c {
    ...
    private C18591b eUM = C18591b.NONE;
    public Rect eUN;
    public int eUO;
    private float eUP;
    private float eUQ;
    ...
    private C42170a eUV = C42170a.FREE;
    public int height;
    public int width;
    ...
    /* renamed from: com.tencent.mm.media.editor.c.c$b */
    public enum C18591b {
        NONE,
        DRAG,
        SCALE;
    ...
    /* renamed from: com.tencent.mm.media.editor.c.c$a */
    public enum C42170a {
        FREE,
        CENTER;

        static {
            AppMethodBeat.m2505o(12907);
        }
    }

    public C42171c() {
        AppMethodBeat.m2504i(12923);
        this.aKk.setScale(1.0f, 1.0f);
        AppMethodBeat.m2505o(12923);
    }

    public final void setMatrix(Matrix matrix) {
        AppMethodBeat.m2504i(12914);
        C25052j.m39376p(matrix, "<set-?>");
        this.aKk = matrix;
        AppMethodBeat.m2505o(12914);
    }

    /* renamed from: h */
    public final void mo67714h(float[] fArr) {
        AppMethodBeat.m2504i(12915);
        C25052j.m39376p(fArr, "<set-?>");
        this.eUR = fArr;
        AppMethodBeat.m2505o(12915);
    }

    /* JADX WARNING: Removed duplicated region for block: B:63:0x01ce  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    /* renamed from: u */
    public final boolean mo67716u(MotionEvent motionEvent) {
        AppMethodBeat.m2504i(12916);
        ...
        switch (motionEvent.getActionMasked()) {
            case 0:
                ...
                AppMethodBeat.m2505o(12916);
                return false;
                break;
            case 1:
            case 3:
                this.eUM = C18591b.NONE;
                this.eUH.clear();
                this.eUI.clear();
                break;
            case 2:
                ...
                float f2;
                Matrix matrix2;
                switch (C42172d.eQZ[this.eUM.ordinal()]) {
                    case 1:
                        obj = this.eUI.get(0);
                        C25052j.m39375o(obj, "pIndices[0]");
                    ...
                    case 2:
                        ...
                        obj = this.eUI.get(1);
                        C25052j.m39375o(obj, "pIndices[1]");
                        ...
                        C37892a c37892a = C42169b.eUG;
                        Matrix matrix4 = this.aKk;
                        y = this.aJg;
                        x = this.aJf;
                        C25052j.m39376p(matrix4, "matrix");
                        C25052j.m39376p(fArr4, "pivotSrc");
                        C25052j.m39376p(matrix4, "matrix");
    ...
    /* renamed from: v */
    private final void m74355v(MotionEvent motionEvent) {
        AppMethodBeat.m2504i(12917);
        Object obj;
        if (this.eUH.size() == 1) {
            this.eUM = C18591b.DRAG;
            float[] fArr = this.eUJ;
            ...
            AppMethodBeat.m2505o(12917);
            return;
        }
        if (this.eUH.size() == 2) {
            this.eUM = C18591b.SCALE;
            if (this.eUV == C42170a.CENTER) {
    ...
    /* renamed from: w */
    private final void m74356w(MotionEvent motionEvent) {
        AppMethodBeat.m2504i(12918);
        Iterator it = C7987l.m14174g(this.eUH).iterator();
        while (it.hasNext()) {
            int nextInt = ((C31585ab) it).nextInt();
            ArrayList arrayList = this.eUI;
            Object obj = this.eUH.get(nextInt);
            C25052j.m39375o(obj, "pIds[i]");
            arrayList.set(nextInt, Integer.valueOf(motionEvent.findPointerIndex(((Number) obj).intValue())));
        }
        AppMethodBeat.m2505o(12918);
    }

    /* renamed from: UK */
    private final float m74351UK() {
        AppMethodBeat.m2504i(12919);
        float f = this.eUS[0];
        float[] fArr = this.eUS;
        ...
        AppMethodBeat.m2505o(12919);
        return f;
    }

    /* renamed from: UL */
    private final float m74352UL() {
        AppMethodBeat.m2504i(12920);
        float f = this.eUS[1];
        float[] fArr = this.eUS;
        int length = fArr.length;
        int i = 0;
        ...
        AppMethodBeat.m2505o(12920);
        return f;
    }

    /* renamed from: UM */
    private final float m74353UM() {
        AppMethodBeat.m2504i(12921);
        float f = this.eUS[0];
        float[] fArr = this.eUS;
        int length = fArr.length;
        int i = 0;
        ...
        AppMethodBeat.m2505o(12921);
        return f;
    }

    /* renamed from: UN */
    private final float m74354UN() {
        AppMethodBeat.m2504i(12922);
        float f = this.eUS[1];
        float[] fArr = this.eUS;
        int length = fArr.length;
        int i = 0;
