...
/* renamed from: com.tencent.mm.boot.svg.a.a.azz */
public final class azz extends C5163c {
    private final int height = C31128d.MIC_PTU_ZIPAI_BLACKWHITEZIPAI;
    private final int width = C31128d.MIC_PTU_ZIPAI_BLACKWHITEZIPAI;
    ...
    public final int mo10620a(int i, Object... objArr) {
        switch (i) {
            ...
            case 2:
                ...
                k.setColor(-1);
                g = C5163c.m7878a(a, 1.0f, 0.0f, 3.0f, 0.0f, 1.0f, 3.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
