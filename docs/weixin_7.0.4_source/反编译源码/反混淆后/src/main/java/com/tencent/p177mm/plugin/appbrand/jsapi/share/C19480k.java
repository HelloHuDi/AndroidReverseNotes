    ...
    public final /* synthetic */ void mo5994a(C2241c c2241c, JSONObject jSONObject, int i) {
        ...
        if (currentPageView != null) {
            ...
            if (ps == null) {
                ...
                AppMethodBeat.m2505o(102014);
                return;
            }
            boolean optBoolean = jSONObject.optBoolean("updatable", false);
            String optString = jSONObject.optString("templateId", "");
            ps.hAx.mo53356j("enable_share_with_updateable_msg", Boolean.valueOf(optBoolean));
            ps.hAx.mo53356j("enable_share_with_updateable_msg_template_id", optString);
            c38492q.mo6107M(i, mo73394j("ok", null));
            C4990ab.m7417i("MicroMsg.JsApiUpdateShareMenuUpdatable", "update share menu updatable(%s)", Boolean.valueOf(optBoolean));
            AppMethodBeat.m2505o(102014);
            return;
        }
