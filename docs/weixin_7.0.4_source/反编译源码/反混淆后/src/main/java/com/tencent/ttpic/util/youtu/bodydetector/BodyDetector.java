...
public class BodyDetector {
    ...
    public BodyDetector() {
        AppMethodBeat.m2504i(84420);
        AppMethodBeat.m2505o(84420);
    }

    static /* synthetic */ void access$1800(BodyDetector bodyDetector, float[] fArr, float[] fArr2) {
        AppMethodBeat.m2504i(84426);
        bodyDetector.updatePreviousRect(fArr, fArr2);
        AppMethodBeat.m2505o(84426);
    }

    static {
        AppMethodBeat.m2504i(84427);
    ...
    public static synchronized BodyDetector getInstance() {
        ...
        synchronized (BodyDetector.class) {
            AppMethodBeat.m2504i(84421);
            if (mInstance == null) {
                mInstance = new BodyDetector();
            }
            bodyDetector = mInstance;
            AppMethodBeat.m2505o(84421);
        }
        return bodyDetector;
    }
    ...
    public void init() {
        ...
        AppMethodBeat.m2504i(84422);
        if (!FeatureManager.isBodyDetectionReady() || this.inited) {
            AppMethodBeat.m2505o(84422);
            return;
        }
        ...
        if (this.inited) {
            ...
            this.detectHandler.post(new Runnable() {
                public void run() {
                    ...
                    AppMethodBeat.m2505o(84419);
                }
            });
            AppMethodBeat.m2505o(84425);
            return;
        }
