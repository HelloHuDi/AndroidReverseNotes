...
public class ZipPkmReader {
    ...
    public boolean open() {
        AppMethodBeat.m2504i(84308);
        if (this.path == null) {
            AppMethodBeat.m2505o(84308);
            return false;
        }
        try {
    ...
    public void close() {
        ...
        AppMethodBeat.m2505o(84309);
    }

    private boolean hasElements() {
        AppMethodBeat.m2504i(84310);
        try {
            if (this.mZipStream != null) {
                this.mZipEntry = this.mZipStream.getNextEntry();
                if (this.mZipEntry != null) {
                    AppMethodBeat.m2505o(84310);
                    return true;
                }
            }
        } catch (IOException e) {
    ...
    public InputStream getNextStream() {
        AppMethodBeat.m2504i(84311);
        if (hasElements()) {
            ZipInputStream zipInputStream = this.mZipStream;
            AppMethodBeat.m2505o(84311);
    ...
    public void reset() {
        AppMethodBeat.m2504i(84315);
        close();
        open();
        AppMethodBeat.m2505o(84315);
    }
}
