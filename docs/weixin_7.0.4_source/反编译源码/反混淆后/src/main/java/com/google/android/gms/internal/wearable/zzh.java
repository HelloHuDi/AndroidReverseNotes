...
public final class zzh extends zzn<zzh> {
    ...
    public zzh() {
        AppMethodBeat.m2504i(70685);
        this.name = "";
        this.zzga = null;
        this.zzhc = null;
        this.zzhl = -1;
        AppMethodBeat.m2505o(70685);
    }
    ...
    public final boolean equals(Object obj) {
        AppMethodBeat.m2504i(70686);
        if (obj == this) {
            AppMethodBeat.m2505o(70686);
            return true;
    ...
    public final int hashCode() {
        ...
        hashCode += i;
        AppMethodBeat.m2505o(70687);
        return hashCode;
    }

    public final void zza(zzl zzl) {
        AppMethodBeat.m2504i(70688);
        zzl.zza(1, this.name);
        if (this.zzga != null) {
            zzl.zza(2, this.zzga);
        }
        super.zza(zzl);
        AppMethodBeat.m2505o(70688);
    }

    /* Access modifiers changed, original: protected|final */
    public final int zzg() {
        AppMethodBeat.m2504i(70689);
        int zzg = super.zzg() + zzl.zzb(1, this.name);
        if (this.zzga != null) {
            zzg += zzl.zzb(2, this.zzga);
        }
        AppMethodBeat.m2505o(70689);
        return zzg;
    }
}
