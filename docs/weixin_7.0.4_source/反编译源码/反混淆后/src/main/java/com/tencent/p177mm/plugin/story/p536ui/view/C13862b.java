...
/* renamed from: com.tencent.mm.plugin.story.ui.view.b */
public final class C13862b extends C28430b {
    ...
    public C13862b(Bitmap bitmap) {
        C25052j.m39376p(bitmap, "bitmap");
        AppMethodBeat.m2504i(110339);
        this.bitmap = bitmap;
        AppMethodBeat.m2505o(110339);
    }

    public final int getWidth() {
        AppMethodBeat.m2504i(110336);
        int width = this.bitmap.getWidth();
        AppMethodBeat.m2505o(110336);
        return width;
    }

    public final int getHeight() {
        AppMethodBeat.m2504i(110337);
        int height = this.bitmap.getHeight();
        AppMethodBeat.m2505o(110337);
        return height;
    }

    /* renamed from: a */
    public final void mo26034a(Canvas canvas, Matrix matrix, Paint paint, float f, float f2, float f3, float f4) {
        AppMethodBeat.m2504i(110338);
