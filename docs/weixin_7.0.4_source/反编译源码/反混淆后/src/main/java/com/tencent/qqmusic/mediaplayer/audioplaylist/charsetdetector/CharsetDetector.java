...
public class CharsetDetector {
    ...
    public CharsetDetector() {
        AppMethodBeat.m2504i(104747);
        AppMethodBeat.m2505o(104747);
    }
    ...
    public CharsetDetector setText(InputStream inputStream) {
        ...
        AppMethodBeat.m2505o(104748);
        return this;
    }

    public CharsetMatch detect() {
        AppMethodBeat.m2504i(104749);
        CharsetMatch[] detectAll = detectAll();
        if (detectAll == null || detectAll.length == 0) {
            AppMethodBeat.m2505o(104749);
            return null;
        }
    ...
    public Reader getReader(InputStream inputStream, String str) {
        Reader reader = null;
        AppMethodBeat.m2504i(104751);
        this.fDeclaredEncoding = str;
        try {
            setText(inputStream);
            CharsetMatch detect = detect();
            if (detect == null) {
                AppMethodBeat.m2505o(104751);
            } else {
    ...
    public String getString(byte[] bArr, String str) {
        String str2 = null;
        AppMethodBeat.m2504i(104752);
        this.fDeclaredEncoding = str;
        try {
            setText(bArr);
            CharsetMatch detect = detect();
            if (detect == null) {
                AppMethodBeat.m2505o(104752);
            } else {
    ...
    static {
        ...
        AppMethodBeat.m2505o(104757);
    }

    @Deprecated
    public String[] getDetectableCharsets() {
        AppMethodBeat.m2504i(104755);
