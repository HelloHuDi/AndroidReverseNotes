...
public class CosmeticsHandle {
    ...
    public CosmeticsHandle() {
        AppMethodBeat.m2504i(86257);
        this.bCk = false;
        this.bCn = null;
        this.bCj = nativeCosmeticsProcess();
        this.bCk = true;
        AppMethodBeat.m2505o(86257);
    }

    /* renamed from: a */
    public static void m52241a(byte[] bArr, int[][] iArr, int i, int i2) {
        AppMethodBeat.m2504i(86258);
        nativeSegmentLipsFast(bArr, iArr, i, i2);
        AppMethodBeat.m2505o(86258);
    }
}
