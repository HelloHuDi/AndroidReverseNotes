...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    public static class Builder {
        ...
        public Builder descendingSort(String str) {
            AppMethodBeat.m2504i(61080);
            if (zzg(str)) {
                AppMethodBeat.m2505o(61080);
            } else {
                sort(str);
        ...
        public int getCount() {
            AppMethodBeat.m2504i(61082);
            int size = this.zznu.size();
            AppMethodBeat.m2505o(61082);
            return size;
        }

        public void modifyUniqueRowValue(Object obj, String str, Object obj2) {
            AppMethodBeat.m2504i(61075);
            if (this.zznv == null) {
                AppMethodBeat.m2505o(61075);
                return;
            }
        ...
        public Builder withRow(ContentValues contentValues) {
            ...
            AppMethodBeat.m2505o(61076);
            return withRow;
        }

        public Builder withRow(HashMap<String, Object> hashMap) {
            int i;
            AppMethodBeat.m2504i(61074);
    ...
    static final class zza implements Comparator<HashMap<String, Object>> {
        ...
        zza(String str) {
            AppMethodBeat.m2504i(61086);
            this.zznz = (String) Preconditions.checkNotNull(str);
            AppMethodBeat.m2505o(61086);
        }

        public final /* synthetic */ int compare(Object obj, Object obj2) {
            AppMethodBeat.m2504i(61087);
    ...
    static {
        AppMethodBeat.m2504i(61122);
        AppMethodBeat.m2505o(61122);
    }
    ...
    public DataHolder(Cursor cursor, int i, Bundle bundle) {
        ...
        AppMethodBeat.m2504i(61090);
        AppMethodBeat.m2505o(61090);
    }

    private DataHolder(Builder builder, int i, Bundle bundle) {
        this(builder.zznm, zza(builder, -1), i, bundle);
        AppMethodBeat.m2504i(61091);
        AppMethodBeat.m2505o(61091);
    }

    private DataHolder(Builder builder, int i, Bundle bundle, int i2) {
        this(builder.zznm, zza(builder, i2), i, bundle);
        AppMethodBeat.m2504i(61092);
        AppMethodBeat.m2505o(61092);
    }
    ...
    public DataHolder(CursorWrapper cursorWrapper, int i, Bundle bundle) {
        ...
        AppMethodBeat.m2504i(61089);
        AppMethodBeat.m2505o(61089);
    }

    public DataHolder(String[] strArr, CursorWindow[] cursorWindowArr, int i, Bundle bundle) {
        AppMethodBeat.m2504i(61088);
        this.mClosed = false;
        this.zzns = true;
        this.zzal = 1;
        this.zznm = (String[]) Preconditions.checkNotNull(strArr);
    ...
    public final void clearColumn(String str, int i, int i2) {
        AppMethodBeat.m2504i(61110);
        zza(str, i);
        this.zzno[i2].putNull(i, this.zznn.getInt(str));
        AppMethodBeat.m2505o(61110);
    }

    public final void close() {
        AppMethodBeat.m2504i(61116);
        synchronized (this) {
            try {
                if (!this.mClosed) {
                    this.mClosed = true;
    ...
    public final boolean getBoolean(String str, int i, int i2) {
        AppMethodBeat.m2504i(61103);
        zza(str, i);
        if (this.zzno[i2].getLong(i, this.zznn.getInt(str)) == 1) {
            AppMethodBeat.m2505o(61103);
            return true;
        }
        AppMethodBeat.m2505o(61103);
        return false;
    ...
    public final String getString(String str, int i, int i2) {
        AppMethodBeat.m2504i(61102);
        zza(str, i);
        String string = this.zzno[i2].getString(i, this.zznn.getInt(str));
        AppMethodBeat.m2505o(61102);
        return string;
    }

    public final int getWindowIndex(int i) {
        int i2 = 0;
        AppMethodBeat.m2504i(61115);
        ...
        AppMethodBeat.m2505o(61115);
        return i2;
    }

    public final boolean hasColumn(String str) {
        AppMethodBeat.m2504i(61099);
        boolean containsKey = this.zznn.containsKey(str);
        AppMethodBeat.m2505o(61099);
        return containsKey;
    }

    public final boolean hasNull(String str, int i, int i2) {
        AppMethodBeat.m2504i(61109);
        zza(str, i);
        boolean isNull = this.zzno[i2].isNull(i, this.zznn.getInt(str));
        AppMethodBeat.m2505o(61109);
        return isNull;
    }
    ...
    public final void validateContents() {
        ...
        this.zznr = i2;
        AppMethodBeat.m2505o(61093);
    }

    public final void writeToParcel(Parcel parcel, int i) {
        AppMethodBeat.m2504i(61094);
