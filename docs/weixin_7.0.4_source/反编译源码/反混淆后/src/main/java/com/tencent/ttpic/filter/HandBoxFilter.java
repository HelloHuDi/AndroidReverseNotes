...
public class HandBoxFilter extends VideoFilterBase {
    ...
    public HandBoxFilter() {
        ...
        AppMethodBeat.m2504i(82589);
        AppMethodBeat.m2505o(82589);
    }
    ...
    public void initAttribParams() {
        AppMethodBeat.m2504i(82590);
        setPositions(GlUtil.ORIGIN_POSITION_COORDS);
        AppMethodBeat.m2505o(82590);
    }

    public void ApplyGLSLFilter() {
        AppMethodBeat.m2504i(82591);
        super.ApplyGLSLFilter();
        AppMethodBeat.m2505o(82591);
    }

    public void clearGLSLSelf() {
        AppMethodBeat.m2504i(82592);
        super.clearGLSLSelf();
        AppMethodBeat.m2505o(82592);
    }

    public void updatePoints(List<PointF> list, float f, int i, int i2) {
        AppMethodBeat.m2504i(82593);
        if (list == null || list.size() != 9) {
            this.mNoPoints = true;
            AppMethodBeat.m2505o(82593);
            return;
        }
    ...
    public void render(int i, int i2, int i3) {
        ...
        AppMethodBeat.m2505o(82594);
    }

    private void normalizePoints(List<PointF> list, int i, int i2) {
        AppMethodBeat.m2504i(82595);
        if (list == null || list.size() == 0) {
            AppMethodBeat.m2505o(82595);
            return;
        }
