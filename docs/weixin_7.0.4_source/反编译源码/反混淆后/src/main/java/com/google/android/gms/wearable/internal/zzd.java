...
public final class zzd extends AbstractSafeParcelable {
    ...
    static {
        AppMethodBeat.m2504i(71186);
        AppMethodBeat.m2505o(71186);
    }
    ...
    zzd(@Param(id = 2) IBinder iBinder, @Param(id = 3) IntentFilter[] intentFilterArr, @Param(id = 4) @Nullable String str, @Param(id = 5) @Nullable String str2) {
        ...
        this.zzbb = str;
        this.zzbc = str2;
        AppMethodBeat.m2505o(71183);
    }

    public zzd(zzhk zzhk) {
        AppMethodBeat.m2504i(71184);
        this.zzaz = zzhk;
        this.zzba = zzhk.zze();
        this.zzbb = zzhk.zzf();
        this.zzbc = null;
        AppMethodBeat.m2505o(71184);
    }

    public final void writeToParcel(Parcel parcel, int i) {
        AppMethodBeat.m2504i(71185);
