...
/* renamed from: com.tencent.mm.boot.svg.a.a.bct */
public final class bct extends C5163c {
    private final int height = 242;
    private final int width = C31128d.MIC_PTU_ZIPAI_LIGHTWHITE;
    ...
    public final int mo10620a(int i, Object... objArr) {
        switch (i) {
            ...
            case 2:
                ...
                a2.setColor(-3552823);
                g = C5163c.m7878a(g, 1.0f, 0.0f, 55.0f, 0.0f, 1.0f, 75.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
