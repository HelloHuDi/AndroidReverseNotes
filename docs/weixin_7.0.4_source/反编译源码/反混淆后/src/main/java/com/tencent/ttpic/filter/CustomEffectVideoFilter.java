...
public class CustomEffectVideoFilter extends VideoEffectFilterBase {
    ...
    static {
        AppMethodBeat.m2504i(82137);
        AppMethodBeat.m2505o(82137);
    }
        ...
        while (true) {
            ...
            if (i2 < this.mResourceList.size()) {
                ...
                if (BitmapUtils.isLegal(decodeSampledBitmapFromAssets)) {
                    addParam(new C25628k("inputImageTexture" + (i2 + 2), decodeSampledBitmapFromAssets, 33986 + i2, true));
                }
                i = i2 + 1;
            } else {
                AppMethodBeat.m2505o(82136);
