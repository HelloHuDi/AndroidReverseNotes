...
public class Cryptor {
    ...
    public Cryptor() {
        AppMethodBeat.m2504i(76224);
        AppMethodBeat.m2505o(76224);
    }

    public byte[] decrypt(byte[] bArr, byte[] bArr2) {
        AppMethodBeat.m2504i(76225);
        byte[] decrypt = decrypt(bArr, 0, bArr.length, bArr2);
        AppMethodBeat.m2505o(76225);
        return decrypt;
    }

    public byte[] decrypt(byte[] bArr, int i, int i2, byte[] bArr2) {
        AppMethodBeat.m2504i(76226);
        this.preCrypt = 0;
        this.crypt = 0;
        this.key = bArr2;
        byte[] bArr3 = new byte[(i + 8)];
        if (i2 % 8 != 0 || i2 < 16) {
            AppMethodBeat.m2505o(76226);
            return null;
        }
    ...
    public byte[] encrypt(byte[] bArr, byte[] bArr2) {
        AppMethodBeat.m2504i(76227);
        byte[] encrypt = encrypt(bArr, 0, bArr.length, bArr2);
        AppMethodBeat.m2505o(76227);
        return encrypt;
    }
    ...
    public byte[] encrypt(byte[] bArr, int i, int i2, byte[] bArr2) {
        ...
        this.plain[0] = (byte) ((rand() & C31128d.MIC_PTU_ZIPAI_THURSDAY) | this.pos);
        ...
        bArr3 = this.out;
        AppMethodBeat.m2505o(76228);
        return bArr3;
    }

    private byte[] encipher(byte[] bArr) {
        AppMethodBeat.m2504i(76229);
        int i = 16;
        try {
    ...
    private byte[] decipher(byte[] bArr) {
        AppMethodBeat.m2504i(76231);
        byte[] decipher = decipher(bArr, 0);
        AppMethodBeat.m2505o(76231);
        return decipher;
    }
    ...
    private int rand() {
        AppMethodBeat.m2504i(76234);
        int nextInt = this.random.nextInt();
        AppMethodBeat.m2505o(76234);
        return nextInt;
    }
