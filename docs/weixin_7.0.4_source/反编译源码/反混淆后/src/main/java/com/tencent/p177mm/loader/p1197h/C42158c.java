...
/* renamed from: com.tencent.mm.loader.h.c */
public final class C42158c<R> {
    ...
    public static final C42159a eRS = new C42159a();
    public int from;
    public int status;
    public R value;
    ...
    /* renamed from: com.tencent.mm.loader.h.c$a */
    public static final class C42159a {
        private C42159a() {
        }

        public /* synthetic */ C42159a(byte b) {
            this();
        }
    }
    ...
    public C42158c(int i, int i2, R r) {
        this.status = i;
        this.from = i2;
        this.value = r;
    }
    ...
    public final boolean isValid() {
        ...
        if (obj != null) {
            ...
            throw new C44941v("null cannot be cast to non-null type android.graphics.Bitmap");
        }
    }
}
