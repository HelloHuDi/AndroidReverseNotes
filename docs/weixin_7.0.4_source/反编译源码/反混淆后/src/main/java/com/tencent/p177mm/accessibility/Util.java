...
public class Util {
    public static Activity getActivityOfView(View view) {
        AppMethodBeat.m2504i(118645);
        if (view == null) {
            AppMethodBeat.m2505o(118645);
            return null;
        }
    ...
    public static String getViewIdName(View view) {
        AppMethodBeat.m2504i(118646);
        String str;
        if (view == null) {
            str = "NO_ID";
            AppMethodBeat.m2505o(118646);
            return str;
        }
        int id = view.getId();
        ...
        if (id != -1) {
            ...
            if (Util.resourceHasPackage(id) && resources != null) {
