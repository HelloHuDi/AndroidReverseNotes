...
public class IPCallCountryCodeScrollbar extends View {
    ...
    public interface C28341a {
        /* renamed from: kp */
        void mo46274kp(String str);
    }

    /* renamed from: Pf */
    public final void mo62163Pf(String str) {
        Object str2;
        AppMethodBeat.m2504i(22107);
        Object obj = null;
    ...
    public IPCallCountryCodeScrollbar(Context context, AttributeSet attributeSet) {
        ...
        AppMethodBeat.m2504i(22108);
        setFocusable(true);
        setFocusableInTouchMode(true);
        this.nBW = C4977b.m7371b(context, 3.0f);
        View inflate = IPCallCountryCodeScrollbar.inflate(context, getToastLayoutId(), null);
        int b = C4977b.m7371b(context, (float) this.nBR);
        this.nBU = new C46633o(inflate, b, b);
        this.nBV = (TextView) inflate.findViewById(2131827560);
        this.aFY = new Paint();
        this.aFY.setAntiAlias(true);
        this.aFY.setColor(-11119018);
        this.aFY.setTextAlign(Align.CENTER);
        AppMethodBeat.m2505o(22108);
    }

    public void setOnScrollBarTouchListener(C28341a c28341a) {
        this.nBX = c28341a;
    }
    ...
    public void onDraw(Canvas canvas) {
        int i = 0;
        AppMethodBeat.m2504i(22109);
        super.onDraw(canvas);
        final int measuredHeight = getMeasuredHeight();
        final int measuredWidth = getMeasuredWidth();
        this.eOg = ((float) measuredHeight) / (((float) this.nBS.length) * this.nBQ);
        int dimensionPixelSize = getResources().getDimensionPixelSize(C25738R.dimen.f9980m5);
        ...
        if (this.nBT != this.eOg) {
            ...
            post(new Runnable() {
                public final void run() {
                    AppMethodBeat.m2504i(22106);
                    if (IPCallCountryCodeScrollbar.this.nBS.length <= 0) {
                        AppMethodBeat.m2505o(22106);
                        return;
                    }
                    int measureText = ((int) IPCallCountryCodeScrollbar.this.aFY.measureText(IPCallCountryCodeScrollbar.this.nBS[IPCallCountryCodeScrollbar.this.nBS.length - 1])) + C1338a.fromDPToPix(IPCallCountryCodeScrollbar.this.getContext(), 8);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0 || motionEvent.getAction() == 2) {
            ...
            setBackgroundDrawable(C1338a.m2864g(getContext(), C25738R.drawable.f7033z6));
            ...
            if (this.nBX != null) {
                if (this.biG == -1) {
                    this.nBX.mo46274kp(C1338a.m2858an(getContext(), C25738R.string.dz6));
                } else {
                    this.nBX.mo46274kp(this.nBS[this.biG]);
                }
            }
            invalidate();
        }
