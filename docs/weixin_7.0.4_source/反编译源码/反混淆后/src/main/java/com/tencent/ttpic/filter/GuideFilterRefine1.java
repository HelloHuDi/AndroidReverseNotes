...
public class GuideFilterRefine1 extends BaseFilter {
    ...
    public GuideFilterRefine1() {
        ...
        AppMethodBeat.m2504i(82580);
        initParams();
        AppMethodBeat.m2505o(82580);
    }

    private void initParams() {
        AppMethodBeat.m2504i(82581);
        addParam(new C25627n("inputImageTexture2", 0, 33986));
        addParam(new C0933f("width", 0.0f));
        addParam(new C0933f("height", 0.0f));
        AppMethodBeat.m2505o(82581);
    }

    public void updateParams(int i, int i2, int i3) {
        AppMethodBeat.m2504i(82582);
        addParam(new C25627n("inputImageTexture2", i, 33986));
        addParam(new C0933f("width", (float) i2));
        addParam(new C0933f("height", (float) i3));
        AppMethodBeat.m2505o(82582);
    }
}
