...
public final class zzkr extends zzaby<zzkr> {
    ...
    public zzkr() {
        AppMethodBeat.m2504i(69731);
        this.zzauk = zzach.zzbxm;
        this.zzaul = zzach.zzbxm;
        this.zzbww = null;
        this.zzbxh = -1;
        AppMethodBeat.m2505o(69731);
    }

    public final boolean equals(Object obj) {
        AppMethodBeat.m2504i(69732);
        if (obj == this) {
            AppMethodBeat.m2505o(69732);
            return true;
    ...
    public final int zza() {
        ...
        AppMethodBeat.m2505o(69735);
        return i;
    }

    public final void zza(zzabw zzabw) {
        int i = 0;
        AppMethodBeat.m2504i(69734);
        if (this.zzauk != null && this.zzauk.length > 0) {
        ...
        super.zza(zzabw);
        AppMethodBeat.m2505o(69734);
    }

    public final /* synthetic */ zzace zzb(zzabv zzabv) {
        AppMethodBeat.m2504i(69736);
        while (true) {
            int zzuw = zzabv.zzuw();
            int zzb;
            long[] jArr;
