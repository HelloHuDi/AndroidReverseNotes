...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    class zza extends Handler {
        ...
        public zza(Context context) {
            ...
            AppMethodBeat.m2504i(60415);
            this.zzau = context.getApplicationContext();
            AppMethodBeat.m2505o(60415);
        }

        public final void handleMessage(Message message) {
            AppMethodBeat.m2504i(60416);
            switch (message.what) {
                case 1:
    ...
    static {
        AppMethodBeat.m2504i(60450);
        AppMethodBeat.m2505o(60450);
    }
    ...
    static Dialog zza(Context context, int i, DialogRedirect dialogRedirect, OnCancelListener onCancelListener) {
        ...
        AppMethodBeat.m2504i(60445);
        if (i == 0) {
            AppMethodBeat.m2505o(60445);
            return null;
        }
    ...
    public boolean showErrorDialogFragment(Activity activity, int i, int i2, OnCancelListener onCancelListener) {
        AppMethodBeat.m2504i(60422);
        Dialog errorDialog = getErrorDialog(activity, i, i2, onCancelListener);
        if (errorDialog == null) {
            AppMethodBeat.m2505o(60422);
            return false;
        }
        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    style.addAction(C25738R.drawable.acw, resources.getString(C25738R.string.common_open_on_phone), pendingIntent);
                } else {
                ...
                C0358c z = new C0358c(context).mo616as(17301642).mo625g(resources.getString(C25738R.string.common_google_play_services_notification_ticker)).mo626j(System.currentTimeMillis()).mo628z(true);
                z.f362EI = pendingIntent;
                C0358c e = z.mo621d(errorNotificationTitle).mo623e(errorNotificationMessage);
                e.f379Fa = true;
                e = e.mo613a(new C0364b().mo633c(errorNotificationMessage));
                if (PlatformVersion.isAtLeastO() && PlatformVersion.isAtLeastO()) {
