...
/* renamed from: com.tencent.mm.protocal.protobuf.auk */
public final class auk extends C1331a {
    public SKBuiltinBuffer_t vEF;
    public bts wyu;

    /* renamed from: op */
    public final int mo4669op(int i, Object... objArr) {
        AppMethodBeat.m2504i(80107);
        C6092b c6092b;
        int ix;
        if (i == 0) {
            ...
            if (this.vEF == null) {
                ...
                AppMethodBeat.m2505o(80107);
                throw c6092b;
            } else if (this.wyu == null) {
                c6092b = new C6092b("Not all required fields were included: Username");
                AppMethodBeat.m2505o(80107);
                throw c6092b;
            } else {
                if (this.vEF != null) {
                    c6093a.mo13479iy(1, this.vEF.computeSize());
            ...
            if (this.vEF != null) {
                ix = C6087a.m9557ix(1, this.vEF.computeSize()) + 0;
            } else {
                ix = 0;
            }
            if (this.wyu != null) {
