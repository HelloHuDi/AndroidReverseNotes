...
public class BaseApi {
    ...
    public static class FieldCollection<Parent> {
        ...
        protected FieldCollection(Parent parent, Collector collector) {
            Object parent2;
            AppMethodBeat.m2504i(61431);
            if (parent2 == null) {
                parent2 = this;
            }
            this.zzwc = parent2;
            this.zzvw = collector;
            AppMethodBeat.m2505o(61431);
        }
    ...
    public static abstract class BaseApiaryOptions<DerivedClassType extends BaseApiaryOptions<DerivedClassType>> {
        ...
        public final class Collector {
            ...
            public Collector() {
                AppMethodBeat.m2504i(61415);
                AppMethodBeat.m2505o(61415);
            }

            private final void append(String str) {
                AppMethodBeat.m2504i(61416);
                if (this.zzvx) {
                    this.zzvx = false;
                    this.zzwa.append(",");
                } else if (this.zzvy) {
                ...
                AppMethodBeat.m2505o(61416);
            }

            public final void addPiece(String str) {
                AppMethodBeat.m2504i(61417);
                append(str);
                this.zzvy = true;
                AppMethodBeat.m2505o(61417);
            }

            public final void beginSubCollection(String str) {
                AppMethodBeat.m2504i(61419);
                append(str);
                this.zzwa.append("(");
                this.zzvz++;
                AppMethodBeat.m2505o(61419);
            }

            public final void endSubCollection() {
                AppMethodBeat.m2504i(61420);
                this.zzwa.append(")");
                this.zzvz--;
                if (this.zzvz == 0) {
            ...
            public final void finishPiece(String str) {
                AppMethodBeat.m2504i(61418);
                append(str);
                if (this.zzvz == 0) {
                    BaseApiaryOptions.this.addField(this.zzwa.toString());
                    this.zzwa.setLength(0);
                    AppMethodBeat.m2505o(61418);
                    return;
                }
                this.zzvx = true;
                AppMethodBeat.m2505o(61418);
