...
public final class DeviceProperties {
    ...
    public static boolean isTablet(Resources resources) {
        boolean z = false;
        AppMethodBeat.m2504i(90168);
        if (resources == null) {
            AppMethodBeat.m2505o(90168);
            return false;
        }
        if (zzzl == null) {
    ...
    public static void setIsAutoForTest(boolean z) {
        AppMethodBeat.m2504i(90184);
        zzzt = Boolean.valueOf(z);
        AppMethodBeat.m2505o(90184);
    }

    @VisibleForTesting
    public static void setIsIoTForTest(boolean z) {
        AppMethodBeat.m2504i(90183);
        zzzr = Boolean.valueOf(z);
        AppMethodBeat.m2505o(90183);
    }

    @VisibleForTesting
    public static void setIsLatchskyForTest(boolean z) {
        AppMethodBeat.m2504i(90182);
        zzzp = Boolean.valueOf(z);
        AppMethodBeat.m2505o(90182);
    }

    @VisibleForTesting
    public static void setIsLowRamForTest(boolean z) {
        AppMethodBeat.m2504i(90186);
        zzzq = Boolean.valueOf(z);
        AppMethodBeat.m2505o(90186);
    }

    @VisibleForTesting
    public static void setIsPixelForTest(boolean z) {
        AppMethodBeat.m2504i(90187);
        zzzv = Boolean.valueOf(z);
        AppMethodBeat.m2505o(90187);
    }

    @VisibleForTesting
    public static void setIsSideWinderForTest(boolean z) {
        AppMethodBeat.m2504i(90181);
        zzzo = Boolean.valueOf(z);
        AppMethodBeat.m2505o(90181);
    }

    @VisibleForTesting
    public static void setIsTvForTest(boolean z) {
        AppMethodBeat.m2504i(90185);
        zzzu = Boolean.valueOf(z);
        AppMethodBeat.m2505o(90185);
    }

    @VisibleForTesting
    public static void setIsWearableForTest(boolean z) {
        AppMethodBeat.m2504i(90180);
        zzzn = Boolean.valueOf(z);
        AppMethodBeat.m2505o(90180);
    }
}
