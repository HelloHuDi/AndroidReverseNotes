...
/* renamed from: com.tencent.ttpic.ar.sensor.representation.MatrixF4x4 */
public class MatrixF4x4 {
    ...
    public MatrixF4x4() {
        AppMethodBeat.m2504i(81692);
        Matrix.setIdentityM(this.matrix, 0);
        AppMethodBeat.m2505o(81692);
    }
    ...
    public void setMatrix(float[] fArr) {
        AppMethodBeat.m2504i(81693);
        if (fArr.length == 16 || fArr.length == 9) {
            this.matrix = fArr;
            AppMethodBeat.m2505o(81693);
            return;
        }
    ...
    public void setY3(float f) {
        AppMethodBeat.m2504i(81699);
        if (this.matrix.length != 16) {
            IllegalStateException illegalStateException = new IllegalStateException("length of matrix should be 16");
            AppMethodBeat.m2505o(81699);
            throw illegalStateException;
        } else if (this.colMaj) {
    ...
    public void setZ3(float f) {
        AppMethodBeat.m2504i(81700);
        if (this.matrix.length != 16) {
            IllegalStateException illegalStateException = new IllegalStateException("length of matrix should be 16");
            AppMethodBeat.m2505o(81700);
            throw illegalStateException;
        } else if (this.colMaj) {
    ...
    public void setW0(float f) {
        AppMethodBeat.m2504i(81701);
        if (this.matrix.length != 16) {
            IllegalStateException illegalStateException = new IllegalStateException("length of matrix should be 16");
            AppMethodBeat.m2505o(81701);
            throw illegalStateException;
        } else if (this.colMaj) {
    ...
    public void setW1(float f) {
        AppMethodBeat.m2504i(81702);
        if (this.matrix.length != 16) {
            IllegalStateException illegalStateException = new IllegalStateException("length of matrix should be 16");
            AppMethodBeat.m2505o(81702);
            throw illegalStateException;
        } else if (this.colMaj) {
    ...
    public void setW2(float f) {
        AppMethodBeat.m2504i(81703);
        if (this.matrix.length != 16) {
            IllegalStateException illegalStateException = new IllegalStateException("length of matrix should be 16");
            AppMethodBeat.m2505o(81703);
            throw illegalStateException;
        } else if (this.colMaj) {
    ...
    public void setW3(float f) {
        AppMethodBeat.m2504i(81704);
        if (this.matrix.length != 16) {
            IllegalStateException illegalStateException = new IllegalStateException("length of matrix should be 16");
            AppMethodBeat.m2505o(81704);
            throw illegalStateException;
        } else if (this.colMaj) {
