...
final class zzi implements ServiceConnection {
    ...
    public zzi(zzh zzh, ConnectionStatusConfig connectionStatusConfig) {
        this.zzty = zzh;
        AppMethodBeat.m2504i(89870);
        this.zztx = connectionStatusConfig;
        AppMethodBeat.m2505o(89870);
    }
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        synchronized (this.zzty.zztr) {
            try {
                ...
                AppMethodBeat.m2505o(89871);
            }
        }
    }

    public final void onServiceDisconnected(ComponentName componentName) {
        AppMethodBeat.m2504i(89872);
        synchronized (this.zzty.zztr) {
            try {
                this.zzty.mHandler.removeMessages(1, this.zztx);
                this.zzry = null;
                ...
                AppMethodBeat.m2505o(89872);
            }
        }
    }

    public final void zza(ServiceConnection serviceConnection, String str) {
        AppMethodBeat.m2504i(89875);
    ...
    public final void zzk(String str) {
        AppMethodBeat.m2504i(89874);
        this.zzty.mHandler.removeMessages(1, this.zztx);
        this.zzty.zzts.unbindService(this.zzty.zzau, this);
        this.zztw = false;
        this.mState = 2;
        AppMethodBeat.m2505o(89874);
    }
}
