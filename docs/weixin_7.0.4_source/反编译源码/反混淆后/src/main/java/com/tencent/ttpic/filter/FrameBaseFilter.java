...
public class FrameBaseFilter extends BaseFilter {
    ...
    static {
        AppMethodBeat.m2504i(82548);
        AppMethodBeat.m2505o(82548);
    }

    public FrameBaseFilter() {
        super(VERTEX_SHADER, FRAGMENT_SHADER);
        AppMethodBeat.m2504i(82535);
        init();
        AppMethodBeat.m2505o(82535);
    }

    public FrameBaseFilter(String str) {
        super(VERTEX_SHADER, str);
        AppMethodBeat.m2504i(82536);
        init();
        AppMethodBeat.m2505o(82536);
    }

    public FrameBaseFilter(String str, String str2) {
        super(str, str2);
        AppMethodBeat.m2504i(82537);
        init();
        AppMethodBeat.m2505o(82537);
    }

    private void init() {
        AppMethodBeat.m2504i(82538);
        this.mAttrParams = new HashMap();
        this.mSTextureHandle = -1;
        AppMethodBeat.m2505o(82538);
    }

    public void initAttribParams() {
        AppMethodBeat.m2504i(82539);
        setPositions(GlUtil.ORIGIN_POSITION_COORDS);
        setTexCords(GlUtil.ORIGIN_TEX_COORDS);
        AppMethodBeat.m2505o(82539);
    }

    public boolean setPositions(float[] fArr) {
        AppMethodBeat.m2504i(82540);
        addAttribParam("position", fArr);
        AppMethodBeat.m2505o(82540);
        return true;
    }

    public boolean setTexCords(float[] fArr) {
        AppMethodBeat.m2504i(82541);
        addAttribParam("inputTextureCoordinate", fArr);
        AppMethodBeat.m2505o(82541);
        return true;
    }

    public void OnDrawFrameGLSL() {
        AppMethodBeat.m2504i(82542);
        super.OnDrawFrameGLSL();
        for (AttributeParam params : this.mAttrParams.values()) {
            params.setParams(getmProgramIds());
        }
        AppMethodBeat.m2505o(82542);
    }

    public boolean renderTexture(int i, int i2, int i3) {
        AppMethodBeat.m2504i(82543);
        ...
        AppMethodBeat.m2505o(82543);
        return true;
    }

    public void ApplyGLSLFilter() {
        AppMethodBeat.m2504i(82544);
        initAttribParams();
    ...
    public void clearGLSLSelf() {
        AppMethodBeat.m2504i(82547);
        super.clearGLSLSelf();
        for (AttributeParam clear : this.mAttrParams.values()) {
            clear.clear();
        }
        AppMethodBeat.m2505o(82547);
    }
