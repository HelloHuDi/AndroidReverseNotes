...
public class AccountChangeEventsRequest extends AbstractSafeParcelable {
    ...
    static {
        AppMethodBeat.m2504i(76930);
        AppMethodBeat.m2505o(76930);
    }
    ...
    AccountChangeEventsRequest(@Param(id = 1) int i, @Param(id = 2) int i2, @Param(id = 3) String str, @Param(id = 4) Account account) {
        AppMethodBeat.m2504i(76928);
        this.zzh = i;
        this.zzl = i2;
        this.zzj = str;
        if (account != null || TextUtils.isEmpty(str)) {
            this.zzn = account;
            AppMethodBeat.m2505o(76928);
            return;
        }
