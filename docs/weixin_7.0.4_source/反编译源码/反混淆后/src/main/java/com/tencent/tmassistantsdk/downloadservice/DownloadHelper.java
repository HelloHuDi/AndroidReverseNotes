...
public class DownloadHelper {
    ...
    static {
        AppMethodBeat.m2504i(75713);
        AppMethodBeat.m2505o(75713);
    }
    ...
    public static String correctURL(String str) {
        ...
        AppMethodBeat.m2505o(75700);
        return str2;
    }

    public static String genAPKFileName(String str) {
        AppMethodBeat.m2504i(75701);
        if (str.contains(".apk")) {
            ...
            if (!TextUtils.isEmpty(trim)) {
                TMLog.m60588i(TAG, "file name = ".concat(String.valueOf(trim)));
                String renameAPKFileName = renameAPKFileName(trim);
                AppMethodBeat.m2505o(75701);
    ...
    public static String decodeFileName(String str) {
        AppMethodBeat.m2504i(75702);
        if (str != null) {
            String decode = URLDecoder.decode(str);
            AppMethodBeat.m2505o(75702);
            return decode;
        }
        AppMethodBeat.m2505o(75702);
        return null;
    ...
    public static String correctFileName(String str) {
        ...
        AppMethodBeat.m2505o(75703);
        return replace;
    }

    public static String renameAPKFileName(String str) {
        AppMethodBeat.m2504i(75704);
        if (str == null) {
            AppMethodBeat.m2505o(75704);
            return null;
        }
    ...
    public static synchronized String getNetStatus() {
        ...
        synchronized (DownloadHelper.class) {
            AppMethodBeat.m2504i(75707);
            Context context = GlobalUtil.getInstance().getContext();
            if (context == null) {
                str = "";
                AppMethodBeat.m2505o(75707);
            } else {
                try {
                    if (context.checkCallingOrSelfPermission("android.permission.ACCESS_NETWORK_STATE") != 0) {
                        ...
                        if (activeNetworkInfo == null) {
                            ...
                            if (str == null) {
                                ...
                                str = str.toLowerCase();
                                TMLog.m60589v(TAG, "netInfo  =  ".concat(String.valueOf(str)));
                                AppMethodBeat.m2505o(75707);
                            }
                        }
                    }
    ...
    public static boolean isNetworkConncted() {
        AppMethodBeat.m2504i(75708);
        Context context = GlobalUtil.getInstance().getContext();
        if (context == null) {
            TMLog.m60590w(TAG, "GlobalUtil.getInstance().getContext() == null.");
            AppMethodBeat.m2505o(75708);
            return false;
        }
        boolean isAvailable;
        NetworkInfo activeNetworkInfo = ((ConnectivityManager) context.getSystemService("connectivity")).getActiveNetworkInfo();
    ...
    public static boolean isDownloadFileExisted(String str) {
        boolean z = false;
        AppMethodBeat.m2504i(75710);
        if (str == null) {
            AppMethodBeat.m2505o(75710);
        } else {
            try {
    ...
    public static int getStorePosition(String str) {
        AppMethodBeat.m2504i(75712);
        if (TextUtils.isEmpty(str)) {
            AppMethodBeat.m2505o(75712);
            return 0;
