...
public class TXCDRApi {
    ...
    public static void setCommonInfo(Context context) {
        ...
        txSetCommonInfo();
        AppMethodBeat.m2505o(66293);
    }

    public static void txSetCommonInfo() {
        AppMethodBeat.m2504i(66294);
        if (mDevType != null) {
            nativeSetCommonValue(C8795a.f2595f, mDevType);
        }
        if (mNetType != null) {
            nativeSetCommonValue(C8795a.f2596g, mNetType);
        }
        if (mDevId != null) {
            nativeSetCommonValue(C8795a.f2597h, mDevId);
        }
        if (mDevUUID != null) {
            nativeSetCommonValue(C8795a.f2598i, mDevUUID);
        }
        if (mAppName != null) {
            nativeSetCommonValue(C8795a.f2599j, mAppName);
        }
        if (mSysVersion != null) {
            nativeSetCommonValue(C8795a.f2601l, mSysVersion);
        }
        if (mMacAddr != null) {
            nativeSetCommonValue(C8795a.f2602m, mMacAddr);
        }
        AppMethodBeat.m2505o(66294);
    }

    public static void txSetAppVersion(String str) {
        AppMethodBeat.m2504i(66295);
        if (str != null) {
            nativeSetCommonValue(C8795a.f2600k, str);
        }
        AppMethodBeat.m2505o(66295);
    }

    public static String txCreateToken() {
        AppMethodBeat.m2504i(66296);
        String uuid = UUID.randomUUID().toString();
        AppMethodBeat.m2505o(66296);
        return uuid;
    }

    private static String byteArrayToHexString(byte[] bArr) {
        int i = 0;
        AppMethodBeat.m2504i(66297);
    ...
    public static String string2Md5(String str) {
        AppMethodBeat.m2504i(66298);
        String str2 = "";
        if (str == null) {
            AppMethodBeat.m2505o(66298);
        } else {
            try {
    ...
    public static String doRead(Context context) {
        ...
        TXCLog.m15675d("rtmpsdk", "deviceinfo:".concat(String.valueOf(deviceId2)));
        deviceId2 = string2Md5(deviceId2);
        AppMethodBeat.m2505o(66299);
        return deviceId2;
    }

    public static String getOrigAndroidID(Context context) {
        AppMethodBeat.m2504i(66300);
        String str = "";
        try {
        ...
        str = string2Md5(str);
        AppMethodBeat.m2505o(66300);
        return str;
    }

    public static String getOrigMacAddr(Context context) {
        String macAddress;
        AppMethodBeat.m2504i(66301);
        try {
    ...
    public static String getDevUUID(Context context, String str) {
        ...
        AppMethodBeat.m2505o(66303);
        return str2;
    }

    public static int getNetworkType(Context context) {
        AppMethodBeat.m2504i(66304);
        if (context == null) {
            AppMethodBeat.m2505o(66304);
            return 255;
        }
        TelephonyManager telephonyManager = (TelephonyManager) context.getSystemService("phone");
    ...
    public static String getApplicationNameByPackageName(Context context, String str) {
        ...
        AppMethodBeat.m2505o(66306);
        return charSequence;
    }

    public static void initCrashReport(Context context) {
        AppMethodBeat.m2504i(66307);
        try {
