...
import com.tencent.faceBeauty.C36691a;
...
public class FaceDetectUtil {
    ...
    public static List<FaceParam> cosFunDetect(Bitmap bitmap, int i, HashMap<FaceParam, float[]> hashMap) {
        Throwable th;
        C32116b c32116b;
        C32116b c32116b2 = null;
        AppMethodBeat.m2504i(83866);
        ArrayList arrayList = new ArrayList();
        if (bitmap == null || bitmap.isRecycled()) {
            AppMethodBeat.m2505o(83866);
            return arrayList;
        }
        ...
        try {
            ...
            try {
                ...
                if (tTpicBitmapFaceDetect.detectedFace()) {
                    ...
                    C32116b c36691a = new C36691a();
                    try {
                        c36691a.detectFace(bitmap);
                        boolean detectedFace = c36691a.detectedFace();
                        FaceParam faceParams = c36691a.getFaceParams(0);
    ...
    private static List<FaceParam> pickAvailableFaces(TTpicBitmapFaceDetect tTpicBitmapFaceDetect, int i, HashMap<FaceParam, float[]> hashMap) {
        ...
        AppMethodBeat.m2505o(83867);
        return arrayList;
    }

    public static int checkLegalFace(FaceParam faceParam, int i) {
        AppMethodBeat.m2504i(83868);
        if (faceParam == null) {
            AppMethodBeat.m2505o(83868);
            return 1;
        }
    ...
    private static int distance(Point point, Point point2) {
        ...
        AppMethodBeat.m2505o(83869);
        return sqrt;
    }

    static {
        AppMethodBeat.m2504i(83874);
        AppMethodBeat.m2505o(83874);
    }

    public static PointF[] flatArray2Points(float[] fArr) {
        AppMethodBeat.m2504i(83870);
        if (fArr == null) {
            AppMethodBeat.m2505o(83870);
            return null;
        }
    ...
    public static PointF[] ulsee2Orig(PointF[] pointFArr) {
        AppMethodBeat.m2504i(83871);
        if (pointFArr == null) {
            AppMethodBeat.m2505o(83871);
            return null;
        }
    ...
    public static List<PointF> array2List(PointF[] pointFArr) {
        AppMethodBeat.m2504i(83872);
        ArrayList arrayList = new ArrayList();
        if (pointFArr == null) {
            AppMethodBeat.m2505o(83872);
        } else {
    ...
    public static List<PointF> facePointf83to90(List<PointF> list) {
        AppMethodBeat.m2504i(83873);
        if (list == null || list.size() < 83) {
            AppMethodBeat.m2505o(83873);
        } else {
            while (list.size() < 90) {
                list.add(new PointF());
            }
