...
/* renamed from: com.tencent.recovery.wx.util.EncryptUtil */
public class EncryptUtil {
    /* renamed from: g */
    public static byte[] m8746g(byte[] bArr, String str) {
        byte[] doFinal;
    ...
    /* renamed from: x */
    public static final String m8747x(byte[] bArr) {
    ...
    /* renamed from: a */
    public static int m8745a(PByteArray pByteArray, byte[] bArr, byte[] bArr2) {
        ...
        if (MyDES.m8750a(pByteArray.value, bArr3, (long) bArr3.length, bArr2.length, bArr2) == 0) {
            return 11;
        }
