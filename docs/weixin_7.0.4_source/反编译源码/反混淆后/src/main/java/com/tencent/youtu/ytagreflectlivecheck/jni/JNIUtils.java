...
public class JNIUtils {
    ...
    private static ColorImgData translation(RawImgData rawImgData) {
        ...
        colorImgData.setX(rawImgData.f4898x);
        colorImgData.setY(rawImgData.f4899y);
        AppMethodBeat.m2505o(123174);
        return colorImgData;
    }
}
