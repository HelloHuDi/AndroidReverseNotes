...
/* renamed from: com.tencent.mm.protocal.protobuf.ahw */
public final class ahw extends btd {
    ...
    public final int mo4669op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.woi != null) {
                c6093a.mo13479iy(4, this.woi.computeSize());
                this.woi.writeFields(c6093a);
            }
            if (this.woj != null) {
                c6093a.mo13479iy(5, this.woj.computeSize());
            ...
            if (this.woi != null) {
                ix += C6087a.m9557ix(4, this.woi.computeSize());
            }
            if (this.woj != null) {
                ix += C6087a.m9557ix(5, this.woj.computeSize());
            }
            AppMethodBeat.m2505o(48853);
            return ix;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    ahw.kdT = c6086a2.BTU.mo13458vd();
                    AppMethodBeat.m2505o(48853);
                    return 0;
                case 3:
                    ahw.kdU = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(48853);
                    return 0;
                case 4:
                    Vh = c6086a2.mo13445Vh(intValue);
