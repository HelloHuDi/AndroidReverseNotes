...
public class NightRGBStretchImpFilter extends BaseFilter {
    ...
    static {
        AppMethodBeat.m2504i(82684);
        AppMethodBeat.m2505o(82684);
    }

    public NightRGBStretchImpFilter() {
        super(GLSLRender.bLl);
        AppMethodBeat.m2504i(82678);
        initParams();
        AppMethodBeat.m2505o(82678);
    }

    private void initParams() {
        AppMethodBeat.m2504i(82679);
        this.param = 0.0f;
        addParam(new C0933f("param", 0.5f));
        addParam(new C0933f(WMElement.ANIMATE_TYPE_SCALE, 2.0f));
        AppMethodBeat.m2505o(82679);
    }

    public void ApplyGLSLFilter() {
        AppMethodBeat.m2504i(82680);
        this.paramTEXTRUEID = C41106g.dSO();
        super.ApplyGLSLFilter();
        AppMethodBeat.m2505o(82680);
    }

    public void beforeRender(int i, int i2, int i3) {
        int i4 = 0;
        AppMethodBeat.m2504i(82681);
        if (this.mHistogram == null || this.mHistogram.length < 256) {
            AppMethodBeat.m2505o(82681);
            return;
        }
        int i5;
        if (((double) this.param) > 0.5d) {
            ...
            if (f > this.recordParam) {
                addParam(new C0933f("param", f));
                LogUtils.m50202e(TAG, "night filter param = ".concat(String.valueOf(f)));
                this.recordParam = f;
            }
        }
        int i6 = 0;
