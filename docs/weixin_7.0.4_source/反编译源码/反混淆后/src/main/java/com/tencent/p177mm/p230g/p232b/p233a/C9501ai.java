...
/* renamed from: com.tencent.mm.g.b.a.ai */
public final class C9501ai extends C46180a {
    private long cVG = 0;
    private long cVH = 0;
    private String cVM = "";
    private long cVO = 0;
    ...
    public C9501ai(String str) {
        AppMethodBeat.m2504i(50540);
        if (str != null) {
            ...
            if (split != null) {
                ...
                this.cYJ = mo74169t("SnsVideoUrl", strArr[0], true);
                this.cYK = mo74169t("SnsReserved1", strArr[1], true);
                ...
                this.cYL = C5046bo.getLong(strArr[14], 0);
                this.cYM = C5046bo.getInt(strArr[15], 0);
                ...
                this.cYN = mo74169t("postname", strArr[34], true);
                this.cVM = mo74169t("CDNIp", strArr[35], true);
                this.cYO = mo74169t("SnsPublishid", strArr[36], true);
                this.cXL = mo74169t("XClientIp", strArr[37], true);
                this.cXM = C5046bo.getInt(strArr[38], 0);
                this.cXN = C5046bo.getLong(strArr[39], 0);
                this.cVO = C5046bo.getLong(strArr[40], 0);
                this.cVP = C5046bo.getLong(strArr[41], 0);
            }
        }
        AppMethodBeat.m2505o(50540);
    }
    ...
    public final String mo4982Fj() {
        ...
        mo74164VX(str);
        AppMethodBeat.m2505o(50541);
        return str;
    }

    /* renamed from: Fk */
    public final String mo4983Fk() {
        AppMethodBeat.m2504i(50542);
        StringBuffer stringBuffer = new StringBuffer();
