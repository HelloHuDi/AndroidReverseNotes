...
public class VcSystemInfo {
    ...
    public static String getDeviceIMEI(Context context) {
        AppMethodBeat.m2504i(124429);
        String str;
        if (!TextUtils.isEmpty(deviceIMEI)) {
            str = deviceIMEI;
            AppMethodBeat.m2505o(124429);
            return str;
    ...
    public static String getDeviceIMSI(Context context) {
        AppMethodBeat.m2504i(124430);
        String str;
        if (!TextUtils.isEmpty(deviceIMSI)) {
            str = deviceIMSI;
            AppMethodBeat.m2505o(124430);
            return str;
        } else if (context == null) {
            str = "";
            AppMethodBeat.m2505o(124430);
    ...
    public static String getDeviceID(Context context) {
        AppMethodBeat.m2504i(124431);
        String str;
        if (!TextUtils.isEmpty(deviceID)) {
            str = deviceID;
            AppMethodBeat.m2505o(124431);
            return str;
        } else if (context == null) {
            str = "";
            AppMethodBeat.m2505o(124431);
    ...
    public static String getDeviceMacAddr(Context context) {
        AppMethodBeat.m2504i(124432);
        String str;
        if (!TextUtils.isEmpty(deviceMacAddr)) {
            str = deviceMacAddr;
            AppMethodBeat.m2505o(124432);
            return str;
        } else if (context == null) {
            str = "";
            AppMethodBeat.m2505o(124432);
    ...
    public static int GetNetAP(Context context) {
        AppMethodBeat.m2504i(124434);
        if (context == null) {
            AppMethodBeat.m2505o(124434);
            return 0;
        }
    ...
    public static String getAppName(Context context, String str) {
        AppMethodBeat.m2504i(124435);
        String str2;
        if (context == null) {
            str2 = "";
            AppMethodBeat.m2505o(124435);
            return str2;
        }
        try {
    ...
    public static String getAppVersionName(Context context) {
        AppMethodBeat.m2504i(124436);
        String str;
        if (TextUtils.isEmpty(appVersionName)) {
            String str2 = "";
            if (context == null) {
                AppMethodBeat.m2505o(124436);
                return str2;
            }
            try {
    ...
    public static int getAppVersionCode(Context context, String str) {
        AppMethodBeat.m2504i(124437);
        if (appVersionCode != 0) {
            int i = appVersionCode;
            AppMethodBeat.m2505o(124437);
            return i;
        } else if (context == null) {
            AppMethodBeat.m2505o(124437);
            return 0;
    ...
    public static boolean isNetworkAvailable(Context context) {
        AppMethodBeat.m2504i(124438);
        if (context != null) {
            ConnectivityManager connectivityManager = (ConnectivityManager) context.getApplicationContext().getSystemService("connectivity");
            if (connectivityManager == null) {
                AppMethodBeat.m2505o(124438);
                return false;
            }
            NetworkInfo activeNetworkInfo = connectivityManager.getActiveNetworkInfo();
    ...
    public static int getNetWorkType(Context context) {
        AppMethodBeat.m2504i(124439);
        if (context == null) {
            AppMethodBeat.m2505o(124439);
            return 0;
        }
        int i;
        try {
    ...
    public static int getWifiNetStrength(Context context) {
        AppMethodBeat.m2504i(124440);
        if (context == null) {
            AppMethodBeat.m2505o(124440);
            return 0;
        }
        try {
    ...
    public static long getRxBytesFromNetwork(Context context) {
        long j = -1;
        AppMethodBeat.m2504i(124441);
        if (context == null) {
            AppMethodBeat.m2505o(124441);
            return -1;
        }
        try {
    ...
    public static long getAppInstallTime(Context context) {
        long j = 0;
        AppMethodBeat.m2504i(124442);
        if (context == null) {
            AppMethodBeat.m2505o(124442);
        } else {
            try {
    ...
    public static int getScreenWidth(Context context) {
        AppMethodBeat.m2504i(124443);
        int i;
        if (context == null) {
            AppMethodBeat.m2505o(124443);
            return 0;
    ...
    public static int getScreenHeight(Context context) {
        AppMethodBeat.m2504i(124444);
        int i;
        if (context == null) {
            AppMethodBeat.m2505o(124444);
            return 0;
    ...
    public static boolean isNetworkTypeMobile(Context context) {
        AppMethodBeat.m2504i(124445);
        if (context == null) {
            AppMethodBeat.m2505o(124445);
            return true;
        }
        ConnectivityManager connectivityManager = (ConnectivityManager) context.getSystemService("connectivity");
        if (connectivityManager != null) {
    ...
    public static int getMarketId(Context context) {
        Throwable th;
        int i = -1;
        AppMethodBeat.m2504i(124446);
        if (context == null) {
            AppMethodBeat.m2505o(124446);
        } else {
            InputStream open;
    ...
    public static int getMCC(Context context) {
        AppMethodBeat.m2504i(124447);
        int i;
        if (mMCC != 0) {
            i = mMCC;
            AppMethodBeat.m2505o(124447);
            return i;
        } else if (context == null) {
            AppMethodBeat.m2505o(124447);
            return 0;
    ...
    public static int getMNC(Context context) {
        AppMethodBeat.m2504i(124448);
        int i;
        if (mMNC != 0) {
            i = mMNC;
            AppMethodBeat.m2505o(124448);
            return i;
        } else if (context == null) {
            AppMethodBeat.m2505o(124448);
            return 0;
    ...
    public static String PrintStack(Throwable th) {
        AppMethodBeat.m2504i(124449);
        if (th == null) {
            AppMethodBeat.m2505o(124449);
            return null;
        }
    ...
    public static int getSystemCpuUsage(String str, String str2) {
        AppMethodBeat.m2504i(124451);
        if (TextUtils.isEmpty(str) || TextUtils.isEmpty(str2)) {
            AppMethodBeat.m2505o(124451);
            return -1;
        }
        float f = -1.0f;
        try {
    ...
    public static long getSystemIdleTime(String[] strArr) {
        AppMethodBeat.m2504i(124453);
        try {
            long parseLong = Long.parseLong(strArr[4]);
            AppMethodBeat.m2505o(124453);
            return parseLong;
        } catch (Throwable th) {
            AppMethodBeat.m2505o(124453);
            return -1;
    ...
    public static int getNetworkClass(Context context) {
        AppMethodBeat.m2504i(124454);
        if (context == null) {
            AppMethodBeat.m2505o(124454);
            return 0;
        }
        int networkClass;
        ConnectivityManager connectivityManager = (ConnectivityManager) context.getSystemService("connectivity");
