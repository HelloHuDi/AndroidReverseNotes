...
/* renamed from: com.tencent.ttpic.ar.sensor.representation.Matrix */
public class Matrix {
    ...
    public static void frustumM(float[] fArr, int i, float f, float f2, float f3, float f4, float f5, float f6) {
        AppMethodBeat.m2504i(81684);
        IllegalArgumentException illegalArgumentException;
        if (f == f2) {
            illegalArgumentException = new IllegalArgumentException("left == right");
            AppMethodBeat.m2505o(81684);
            throw illegalArgumentException;
        } else if (f4 == f3) {
    ...
    public static void rotateM(float[] fArr, int i, float[] fArr2, int i2, float f, float f2, float f3, float f4) {
        AppMethodBeat.m2504i(81687);
        synchronized (TEMP_MATRIX_ARRAY) {
            try {
                Matrix.setRotateM(TEMP_MATRIX_ARRAY, 0, f, f2, f3, f4);
                Matrix.multiplyMM(fArr, i, fArr2, i2, TEMP_MATRIX_ARRAY, 0);
            } finally {
                while (true) {
                }
                AppMethodBeat.m2505o(81687);
            }
        }
    }

    public static void rotateM(float[] fArr, int i, float f, float f2, float f3, float f4) {
        AppMethodBeat.m2504i(81688);
        synchronized (TEMP_MATRIX_ARRAY) {
            try {
                Matrix.setRotateM(TEMP_MATRIX_ARRAY, 0, f, f2, f3, f4);
                Matrix.multiplyMM(TEMP_MATRIX_ARRAY, 16, fArr, i, TEMP_MATRIX_ARRAY, 0);
                System.arraycopy(TEMP_MATRIX_ARRAY, 16, fArr, i, 16);
            } finally {
                while (true) {
                }
                AppMethodBeat.m2505o(81688);
            }
        }
    }

    public static void setRotateM(float[] fArr, int i, float f, float f2, float f3, float f4) {
        AppMethodBeat.m2504i(81689);
        fArr[i + 3] = 0.0f;
        fArr[i + 7] = 0.0f;
        fArr[i + 11] = 0.0f;
        fArr[i + 12] = 0.0f;
    ...
    public static void setLookAtM(float[] fArr, int i, float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9) {
        ...
        float length2 = 1.0f / Matrix.length(length, f13, f14);
        length *= length2;
        f13 *= length2;
        f14 *= length2;
