...
public class AttributionIdentifiers {
    ...
    static final class GoogleAdInfo implements IInterface {
        ...
        public final String getAdvertiserId() {
            ...
            try {
                ...
                obtain2.recycle();
                obtain.recycle();
                AppMethodBeat.m2505o(72232);
            }
        }

        public final boolean isTrackingLimited() {
            boolean z = true;
            AppMethodBeat.m2504i(72233);
            Parcel obtain = Parcel.obtain();
            Parcel obtain2 = Parcel.obtain();
            try {
                obtain.writeInterfaceToken("com.google.android.gms.ads.identifier.internal.IAdvertisingIdService");
    ...
    static final class GoogleAdServiceConnection implements ServiceConnection {
        ...
        private GoogleAdServiceConnection() {
            AppMethodBeat.m2504i(72234);
            this.consumed = new AtomicBoolean(false);
            this.queue = new LinkedBlockingDeque();
            AppMethodBeat.m2505o(72234);
        }

        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            AppMethodBeat.m2504i(72235);
            if (iBinder != null) {
                try {
                    this.queue.put(iBinder);
                } catch (InterruptedException e) {
                    AppMethodBeat.m2505o(72235);
                    return;
                }
            }
            AppMethodBeat.m2505o(72235);
    ...
    static {
        AppMethodBeat.m2504i(72243);
        AppMethodBeat.m2505o(72243);
    }

    private static AttributionIdentifiers getAndroidId(Context context) {
        AppMethodBeat.m2504i(72237);
    ...
    private static String getInstallerPackageName(Context context) {
        AppMethodBeat.m2504i(72242);
        PackageManager packageManager = context.getPackageManager();
        if (packageManager != null) {
            String installerPackageName = packageManager.getInstallerPackageName(context.getPackageName());
            AppMethodBeat.m2505o(72242);
