...
public class GetAuthorizedHttpRequest extends GetHttpRequest {
    ...
    private AuthorizedResult jsonObjectToRespData(JSONObject jSONObject) {
        ...
        if (jSONObject2 != null && jSONObject2.length() > 0) {
            ...
            tipsInfo2.content = jSONObject2.getString(C8741b.CONTENT);
        ...
        TMLog.m60588i(TAG, "dataInfo :" + authorizedResult.toString());
        AppMethodBeat.m2505o(75834);
