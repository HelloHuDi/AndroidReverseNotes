...
public class UserDataStore {
    ...
    static class C175881 implements Runnable {
        C175881() {
        }

        public final void run() {
            AppMethodBeat.m2504i(72026);
            UserDataStore.access$000();
            AppMethodBeat.m2505o(72026);
        }
    }

    static /* synthetic */ void access$000() {
        AppMethodBeat.m2504i(72037);
        initAndWait();
        AppMethodBeat.m2505o(72037);
    }

    static /* synthetic */ String access$300(Bundle bundle) {
        AppMethodBeat.m2504i(72038);
        String hashUserData = hashUserData(bundle);
        AppMethodBeat.m2505o(72038);
        return hashUserData;
    }

    static {
        AppMethodBeat.m2504i(72039);
        AppMethodBeat.m2505o(72039);
    }

    public static void initStore() {
        AppMethodBeat.m2504i(72028);
        if (initialized) {
            AppMethodBeat.m2505o(72028);
            return;
        }
        AppEventsLogger.getAnalyticsExecutor().execute(new C175881());
        AppMethodBeat.m2505o(72028);
    }

    public static void setUserDataAndHash(final Bundle bundle) {
        AppMethodBeat.m2504i(72029);
        if (!initialized) {
            initAndWait();
        }
        AppEventsLogger.getAnalyticsExecutor().execute(new Runnable() {
            public final void run() {
                AppMethodBeat.m2504i(72027);
                ...
                try {
                    ...
                    AppMethodBeat.m2505o(72027);
                }
            }
        });
        AppMethodBeat.m2505o(72029);
    }
    ...
    public static void setUserDataAndHash(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10) {
        ...
        AppMethodBeat.m2505o(72030);
    }

    public static String getHashedUserData() {
        AppMethodBeat.m2504i(72031);
        if (!initialized) {
            initAndWait();
        }
        lock.readLock().lock();
        try {
            ...
            AppMethodBeat.m2505o(72031);
        }
    }

    private static void initAndWait() {
        AppMethodBeat.m2504i(72032);
        if (initialized) {
            AppMethodBeat.m2505o(72032);
            return;
        }
        lock.writeLock().lock();
        try {
    ...
    private static String hashUserData(Bundle bundle) {
        AppMethodBeat.m2504i(72033);
        if (bundle == null) {
            AppMethodBeat.m2505o(72033);
            return null;
        }
    ...
    private static String encryptData(String str) {
        String str2 = null;
        AppMethodBeat.m2504i(72034);
        if (str == null || str.isEmpty()) {
            AppMethodBeat.m2505o(72034);
            return str2;
        }
        try {
