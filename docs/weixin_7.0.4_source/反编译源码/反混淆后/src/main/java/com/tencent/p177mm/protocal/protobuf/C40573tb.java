...
/* renamed from: com.tencent.mm.protocal.protobuf.tb */
public final class C40573tb extends C1331a {
    public int wat;
    public SKBuiltinBuffer_t wau;

    /* renamed from: op */
    public final int mo4669op(int i, Object... objArr) {
        AppMethodBeat.m2504i(58902);
        C6092b c6092b;
        int bs;
        if (i == 0) {
            ...
            C40573tb c40573tb = (C40573tb) objArr[1];
            int intValue = ((Integer) objArr[2]).intValue();
            switch (intValue) {
                case 1:
                    c40573tb.wat = c6086a2.BTU.mo13458vd();
                    AppMethodBeat.m2505o(58902);
                    return 0;
                case 2:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        c40573tb.wau = sKBuiltinBuffer_t;
                    }
                    AppMethodBeat.m2505o(58902);
                    return 0;
                default:
