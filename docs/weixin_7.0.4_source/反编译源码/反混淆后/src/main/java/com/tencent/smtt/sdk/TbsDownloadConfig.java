...
public class TbsDownloadConfig {
    ...
    /* renamed from: b */
    private static TbsDownloadConfig f1367b;
    /* renamed from: a */
    Map<String, Object> f1368a = new HashMap();
    /* renamed from: c */
    ...
    public static synchronized TbsDownloadConfig getInstance(Context context) {
        TbsDownloadConfig tbsDownloadConfig;
        synchronized (TbsDownloadConfig.class) {
            AppMethodBeat.m2504i(64321);
            if (f1367b == null) {
                f1367b = new TbsDownloadConfig(context);
            }
            tbsDownloadConfig = f1367b;
            AppMethodBeat.m2505o(64321);
        }
        return tbsDownloadConfig;
    }

    public void clear() {
        AppMethodBeat.m2504i(64337);
        try {
            this.f1368a.clear();
            Editor edit = this.mPreferences.edit();
            edit.clear();
            edit.commit();
            AppMethodBeat.m2505o(64337);
        } catch (Exception e) {
            AppMethodBeat.m2505o(64337);
        }
    }
    ...
    public synchronized void commit() {
        AppMethodBeat.m2504i(64336);
        try {
            Editor edit = this.mPreferences.edit();
            for (String str : this.f1368a.keySet()) {
                Object obj = this.f1368a.get(str);
    ...
    public synchronized int getDownloadInterruptCode() {
        ...
        if (this.mPreferences.contains(TbsConfigKey.KEY_DOWNLOAD_INTERRUPT_CODE)) {
            ...
            try {
                i = !new File(new File(this.f1369c.getFilesDir(), "shared_prefs"), "tbs_download_config").exists() ? -97 : !this.mPreferences.contains(TbsConfigKey.KEY_NEEDDOWNLOAD) ? -96 : XWalkUpdater.ERROR_SET_VERNUM;
            } catch (Throwable th) {
                i = -95;
            }
        }
        if (this.f1369c == null || !TbsConfig.APP_QQ.equals(this.f1369c.getApplicationInfo().packageName) || "CN".equals(Locale.getDefault().getCountry())) {
            i = (i * 1000) + this.mPreferences.getInt(TbsConfigKey.KEY_INSTALL_INTERRUPT_CODE, -1);
            AppMethodBeat.m2505o(64333);
        } else {
            i = -320;
            AppMethodBeat.m2505o(64333);
        }
