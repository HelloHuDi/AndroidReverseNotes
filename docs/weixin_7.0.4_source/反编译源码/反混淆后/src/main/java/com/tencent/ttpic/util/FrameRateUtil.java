...
public class FrameRateUtil {
    ...
    static {
        AppMethodBeat.m2504i(83927);
        AppMethodBeat.m2505o(83927);
    }
    ...
    public static synchronized void clearFpsList() {
        synchronized (FrameRateUtil.class) {
            AppMethodBeat.m2504i(83922);
            C16371i.m25186k(TAG, "clearFpsList");
            fpsList.clear();
            AppMethodBeat.m2505o(83922);
        }
    }

    public static synchronized void checkFps(long j) {
        synchronized (FrameRateUtil.class) {
            AppMethodBeat.m2504i(83923);
            if (TIME_INTERVAL - j > 0) {
                try {
                    Thread.sleep(100);
                    AppMethodBeat.m2505o(83923);
    ...
    public static void upgrade() {
        ...
        AppMethodBeat.m2505o(83924);
    }

    private static void downgrade() {
        AppMethodBeat.m2504i(83925);
        if (mDowngradeLevel == null || listener == null) {
            AppMethodBeat.m2505o(83925);
            return;
        }
