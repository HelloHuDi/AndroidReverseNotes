...
/* renamed from: com.tencent.mm.plugin.appbrand.phonenumber.e */
public final class C27267e extends C37440a<bwy> {
    public C27267e(String str, String str2) {
        C25052j.m39376p(str, "appId");
        C25052j.m39376p(str2, "mobile");
        AppMethodBeat.m2504i(134782);
        bwx bwx = new bwx();
        bwx.csB = str;
        bwx.cFl = str2;
        ...
        c1196a.mo4450qq("/cgi-bin/mmbiz-bin/wxaapp/sendverifycode");
        c1196a.mo4447kU(WXMediaMessage.DESCRIPTION_LENGTH_LIMIT);
        c1196a.mo4448kV(0);
        c1196a.mo4449kW(0);
        mo60331a(c1196a.acD());
        AppMethodBeat.m2505o(134782);
    }
}
