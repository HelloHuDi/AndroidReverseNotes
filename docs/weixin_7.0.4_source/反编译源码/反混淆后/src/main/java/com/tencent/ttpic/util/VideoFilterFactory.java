...
public class VideoFilterFactory {
    ...
    static {
        AppMethodBeat.m2504i(83986);
        AppMethodBeat.m2505o(83986);
    }

    public static NormalVideoFilter createFilter(StickerItem stickerItem, String str) {
        AppMethodBeat.m2504i(83985);
        if (stickerItem == null) {
            AppMethodBeat.m2505o(83985);
            return null;
        }
