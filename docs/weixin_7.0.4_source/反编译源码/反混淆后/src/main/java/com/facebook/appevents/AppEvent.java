...
class AppEvent implements Serializable {
    ...
    public boolean isChecksumValid() {
        AppMethodBeat.m2504i(71869);
        if (this.checksum == null) {
            AppMethodBeat.m2505o(71869);
            return true;
        }
    ...
    private Object writeReplace() {
        ...
        AppMethodBeat.m2505o(71872);
        return serializationProxyV2;
    }

    public String toString() {
        AppMethodBeat.m2504i(71873);
        ...
        AppMethodBeat.m2505o(71873);
        return format;
    }

    private String calculateChecksum() {
        AppMethodBeat.m2504i(71874);
        String md5Checksum;
        if (VERSION.SDK_INT > 19) {
            md5Checksum = md5Checksum(this.jsonObject.toString());
            AppMethodBeat.m2505o(71874);
            return md5Checksum;
        }
