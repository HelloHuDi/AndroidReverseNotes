...
/* renamed from: com.tencent.d.e.a.b.g */
public final class C17730g extends JceStruct {
    static Map<Integer, ArrayList<C41666f>> Aus;
    public int AtW = 0;
    public int AtX = 0;
    public int AtY = 0;
    public int AtZ = 0;
    public long Aup = 0;
    public Map<Integer, ArrayList<C41666f>> Auq = null;
    public int Aur = 0;

    public final void writeTo(JceOutputStream jceOutputStream) {
        AppMethodBeat.m2504i(114586);
        ...
        AppMethodBeat.m2505o(114586);
    }

    public final void readFrom(JceInputStream jceInputStream) {
        AppMethodBeat.m2504i(114587);
        this.Aup = jceInputStream.read(this.Aup, 0, true);
        if (Aus == null) {
            Aus = new HashMap();
            Integer valueOf = Integer.valueOf(0);
            ArrayList arrayList = new ArrayList();
            arrayList.add(new C41666f());
