...
abstract class CharsetRecog_mbcs extends CharsetRecognizer {
    ...
    static class CharsetRecog_gb_18030 extends CharsetRecog_mbcs {
        ...
        public boolean nextChar(iteratedChar iteratedchar, CharsetDetector charsetDetector) {
            ...
            if (nextByte < 0) {
                ...
                if (nextByte >= GmsClientSupervisor.DEFAULT_BIND_FLAGS && nextByte <= C31128d.MIC_PTU_ZIPAI_LIGHTRED && ((nextByte2 < 64 || nextByte2 > 126) && (nextByte2 < 80 || nextByte2 > C31128d.MIC_PTU_ZIPAI_LIGHTRED))) {
                    if (nextByte2 >= 48 && nextByte2 <= 57) {
                        nextByte = iteratedchar.nextByte(charsetDetector);
                        if (nextByte >= GmsClientSupervisor.DEFAULT_BIND_FLAGS && nextByte <= C31128d.MIC_PTU_ZIPAI_LIGHTRED) {
        ...
        public CharsetMatch match(CharsetDetector charsetDetector) {
            AppMethodBeat.m2504i(104763);
            int match = match(charsetDetector, commonChars);
            if (match == 0) {
                AppMethodBeat.m2505o(104763);
                return null;
            }
    ...
    static class CharsetRecog_big5 extends CharsetRecog_mbcs {
        ...
        /* Access modifiers changed, original: 0000 */
        public boolean nextChar(iteratedChar iteratedchar, CharsetDetector charsetDetector) {
            AppMethodBeat.m2504i(104758);
            iteratedchar.error = false;
            int nextByte = iteratedchar.nextByte(charsetDetector);
            iteratedchar.charValue = nextByte;
            if (nextByte < 0) {
                AppMethodBeat.m2505o(104758);
                return false;
            } else if (nextByte <= C31128d.MIC_SketchMark || nextByte == 255) {
                AppMethodBeat.m2505o(104758);
                return true;
            } else {
                nextByte = iteratedchar.nextByte(charsetDetector);
                ...
                if (nextByte < 64 || nextByte == C31128d.MIC_SketchMark || nextByte == 255) {
                    iteratedchar.error = true;
                }
                AppMethodBeat.m2505o(104758);
                return true;
        ...
        /* Access modifiers changed, original: 0000 */
        public CharsetMatch match(CharsetDetector charsetDetector) {
            AppMethodBeat.m2504i(104759);
            int match = match(charsetDetector, commonChars);
            if (match == 0) {
                AppMethodBeat.m2505o(104759);
                return null;
            }
            CharsetMatch charsetMatch = new CharsetMatch(charsetDetector, this, match);
            AppMethodBeat.m2505o(104759);
    ...
    static abstract class CharsetRecog_euc extends CharsetRecog_mbcs {
        ...
        static class CharsetRecog_euc_kr extends CharsetRecog_euc {
            ...
            /* Access modifiers changed, original: 0000 */
            public CharsetMatch match(CharsetDetector charsetDetector) {
                AppMethodBeat.m2504i(104737);
                int match = match(charsetDetector, commonChars);
                if (match == 0) {
                    AppMethodBeat.m2505o(104737);
                    return null;
                }
                CharsetMatch charsetMatch = new CharsetMatch(charsetDetector, this, match);
                AppMethodBeat.m2505o(104737);
        ...
        static class CharsetRecog_euc_jp extends CharsetRecog_euc {
            ...
            /* Access modifiers changed, original: 0000 */
            public CharsetMatch match(CharsetDetector charsetDetector) {
                AppMethodBeat.m2504i(104723);
                int match = match(charsetDetector, commonChars);
                if (match == 0) {
                    AppMethodBeat.m2505o(104723);
                    return null;
                }
                CharsetMatch charsetMatch = new CharsetMatch(charsetDetector, this, match);
                AppMethodBeat.m2505o(104723);
        ...
        public boolean nextChar(iteratedChar iteratedchar, CharsetDetector charsetDetector) {
            ...
            if (nextByte < 0) {
                ...
                int nextByte2 = iteratedchar.nextByte(charsetDetector);
                iteratedchar.charValue = (iteratedchar.charValue << 8) | nextByte2;
                if (nextByte < 161 || nextByte > C31128d.MIC_PTU_ZIPAI_LIGHTRED) {
    ...
    static class CharsetRecog_sjis extends CharsetRecog_mbcs {
        ...
        /* Access modifiers changed, original: 0000 */
        public boolean nextChar(iteratedChar iteratedchar, CharsetDetector charsetDetector) {
            AppMethodBeat.m2504i(104735);
            iteratedchar.error = false;
            int nextByte = iteratedchar.nextByte(charsetDetector);
            iteratedchar.charValue = nextByte;
            if (nextByte < 0) {
                AppMethodBeat.m2505o(104735);
                return false;
            } else if (nextByte <= C31128d.MIC_SketchMark || (nextByte > 160 && nextByte <= 223)) {
                AppMethodBeat.m2505o(104735);
                return true;
            } else {
                int nextByte2 = iteratedchar.nextByte(charsetDetector);
                ...
                if ((nextByte2 < 64 || nextByte2 > C31128d.MIC_SketchMark) && (nextByte2 < 128 || nextByte2 > 255)) {
                    iteratedchar.error = true;
                }
                AppMethodBeat.m2505o(104735);
                return true;
        ...
        /* Access modifiers changed, original: 0000 */
        public CharsetMatch match(CharsetDetector charsetDetector) {
            AppMethodBeat.m2504i(104736);
            int match = match(charsetDetector, commonChars);
            if (match == 0) {
                AppMethodBeat.m2505o(104736);
                return null;
            }
            CharsetMatch charsetMatch = new CharsetMatch(charsetDetector, this, match);
            AppMethodBeat.m2505o(104736);
