...
public class CertUtil {
    ...
    static {
        AppMethodBeat.m2504i(49565);
        AppMethodBeat.m2505o(49565);
    }
    ...
    private boolean create_dir(String str) {
        ...
        AppMethodBeat.m2505o(49545);
        return z;
    }

    private boolean del_all_files(String str) {
        boolean z = false;
        AppMethodBeat.m2504i(49546);
        File file = new File(str);
        if (!file.exists()) {
            AppMethodBeat.m2505o(49546);
            return false;
    ...
    private void del_dir(String str, boolean z) {
        AppMethodBeat.m2504i(49547);
        try {
            del_all_files(str);
            if (z) {
                new File(str.toString()).delete();
            }
            AppMethodBeat.m2505o(49547);
        } catch (Exception e) {
            AppMethodBeat.m2505o(49547);
        }
    }
    ...
    private boolean isNotEmptyDir(String str) {
        AppMethodBeat.m2504i(49548);
        boolean z = true;
        File file = new File(str);
        if (!(file.exists() && file.isDirectory() && file.listFiles() != null)) {
            z = false;
        }
        AppMethodBeat.m2505o(49548);
        return z;
    }

    private boolean isValidDir(String str) {
        AppMethodBeat.m2504i(49549);
        boolean z = true;
        File file = new File(str);
        if (!(file.exists() && file.isDirectory())) {
            z = false;
        }
        AppMethodBeat.m2505o(49549);
        return z;
    }

    private String hexdigest(String str) {
        AppMethodBeat.m2504i(49550);
        String str2;
        if (str == null) {
            str2 = "";
            AppMethodBeat.m2505o(49550);
            return str2;
        }
    ...
    private boolean isNullOrEmpty(String str) {
        AppMethodBeat.m2504i(49551);
        if (str == null || str.length() == 0) {
            AppMethodBeat.m2505o(49551);
            return true;
        }
        AppMethodBeat.m2505o(49551);
        return false;
    ...
    public synchronized boolean importCert(String str, String str2) {
        boolean z;
        AppMethodBeat.m2504i(49554);
        if (str2.length() <= 0) {
            z = false;
            AppMethodBeat.m2505o(49554);
        } else {
            try {
    ...
    public synchronized boolean isCertExist(String str) {
        boolean z = false;
        synchronized (this) {
            AppMethodBeat.m2504i(49555);
            if (isNullOrEmpty(str)) {
                AppMethodBeat.m2505o(49555);
            } else {
                setDir(str);
    ...
    public synchronized String genUserSig(String str, String str2) {
        String str3 = null;
        synchronized (this) {
            AppMethodBeat.m2504i(49559);
            if (isNullOrEmpty(str) || isNullOrEmpty(str2)) {
                AppMethodBeat.m2505o(49559);
            } else {
                setAndCheckDir(str);
                if (isNotEmptyDir(this.cert_dir) && isNotEmptyDir(this.publ_dir) && isNotEmptyDir(this.priv_dir)) {
    ...
    public synchronized boolean setTokens(String str, String str2, boolean z, String str3) {
        ...
        int i = false;
        synchronized (this) {
            AppMethodBeat.m2504i(49561);
            if (isNullOrEmpty(str) || isNullOrEmpty(str2)) {
                AppMethodBeat.m2505o(49561);
            } else {
                if (z && str3 != null) {
                    if (str3.length() != 16) {
                        AppMethodBeat.m2505o(49561);
    ...
    public synchronized String getToken(String str) {
        String str2 = null;
        synchronized (this) {
            AppMethodBeat.m2504i(49562);
            if (isNullOrEmpty(str)) {
                AppMethodBeat.m2505o(49562);
            } else {
                setAndCheckDir(str);
    ...
    public synchronized void clearToken(String str) {
        AppMethodBeat.m2504i(49563);
        if (isNullOrEmpty(str)) {
            AppMethodBeat.m2505o(49563);
        } else {
            setDir(str);
    ...
    public synchronized int getTokenCount(String str) {
        int i;
        AppMethodBeat.m2504i(49564);
        if (isNullOrEmpty(str)) {
            i = 0;
            AppMethodBeat.m2505o(49564);
        } else {
            setDir(str);
            this.cert_id = str;
            i = getTokenCount();
