...
public final class StoryCommentBubbleView extends ImageView {
    ...
    public StoryCommentBubbleView(Context context, AttributeSet attributeSet, int i) {
        ...
        AppMethodBeat.m2504i(110378);
        AppMethodBeat.m2505o(110378);
    }

    public StoryCommentBubbleView(Context context, AttributeSet attributeSet) {
        C25052j.m39376p(context, "context");
        this(context, attributeSet, 0);
        AppMethodBeat.m2504i(110379);
        AppMethodBeat.m2505o(110379);
    }
    ...
    public final int getBubbleLeft() {
        AppMethodBeat.m2504i(138897);
        int[] iArr = new int[2];
        getLocationOnScreen(iArr);
        int i = iArr[0];
        AppMethodBeat.m2505o(138897);
        return i;
    }
    ...
    public final int getBubbleTop() {
        AppMethodBeat.m2504i(138898);
        int[] iArr = new int[2];
        getLocationOnScreen(iArr);
        int i = iArr[1];
        AppMethodBeat.m2505o(138898);
        return i;
    }

    public final boolean onTouchEvent(MotionEvent motionEvent) {
        AppMethodBeat.m2504i(110377);
