...
public class QUASetting {
    ...
    public String buildQUA() {
        ...
        AppMethodBeat.m2505o(76274);
        return str;
    }

    private int getDeviceWidth() {
        AppMethodBeat.m2504i(76275);
        int i = this.mContext.getResources().getDisplayMetrics().widthPixels;
        AppMethodBeat.m2505o(76275);
        return i;
    }

    private int getDeviceHeight() {
        AppMethodBeat.m2504i(76276);
        int i = this.mContext.getResources().getDisplayMetrics().heightPixels;
        AppMethodBeat.m2505o(76276);
        return i;
    }

    public static String getBuildNo() {
        AppMethodBeat.m2504i(76277);
        String str;
        if ("100".contains("BuildNo")) {
            str = "0000";
            AppMethodBeat.m2505o(76277);
            return str;
        }
        str = "100";
        AppMethodBeat.m2505o(76277);
    ...
    private String getAndroidVersion() {
        ...
        String stringBuffer2 = stringBuffer.toString();
        AppMethodBeat.m2505o(76279);
        return stringBuffer2;
    }

    private StringBuffer filter(String str) {
        AppMethodBeat.m2504i(76280);
        StringBuffer stringBuffer = new StringBuffer();
        if (TextUtils.isEmpty(str)) {
            stringBuffer.append(UN_DEFINED);
            AppMethodBeat.m2505o(76280);
            return stringBuffer;
        }
