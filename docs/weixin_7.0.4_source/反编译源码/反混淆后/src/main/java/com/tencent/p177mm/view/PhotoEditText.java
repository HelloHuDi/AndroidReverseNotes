...
public class PhotoEditText extends AppCompatEditText {
    ...
    public PhotoEditText(Context context) {
        super(context);
        AppMethodBeat.m2504i(116388);
        init();
        AppMethodBeat.m2505o(116388);
    }

    public PhotoEditText(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        AppMethodBeat.m2504i(116389);
        init();
        AppMethodBeat.m2505o(116389);
    }

    private void init() {
        AppMethodBeat.m2504i(116390);
        new TextView(getContext()).setTextSize(getTextSize());
        this.zZW = new PorterDuffXfermode(Mode.CLEAR);
        AppMethodBeat.m2505o(116390);
    }

    public void setTextBackground(int i) {
        AppMethodBeat.m2504i(116391);
        this.eHE = i;
        invalidate();
        AppMethodBeat.m2505o(116391);
    }

    /* Access modifiers changed, original: protected */
    public void onDraw(Canvas canvas) {
        int i = 0;
        AppMethodBeat.m2504i(116392);
        if (this.eHE == 0) {
            super.onDraw(canvas);
            AppMethodBeat.m2505o(116392);
            return;
        }
