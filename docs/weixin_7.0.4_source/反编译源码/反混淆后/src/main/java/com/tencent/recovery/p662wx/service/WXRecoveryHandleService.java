package com.tencent.recovery.p662wx.service;
...
import com.tencent.recovery.p662wx.RecoveryTinkerManager;
import com.tencent.recovery.p662wx.util.EncryptUtil;
...
/* renamed from: com.tencent.recovery.wx.service.WXRecoveryHandleService */
public class WXRecoveryHandleService extends RecoveryHandleService {
    private PowerManager tXN;

    public void onCreate() {
        super.onCreate();
        RecoveryLog.m8712i("Recovery.WXRecoveryHandleService", "onCreate", new Object[0]);
        this.tXN = (PowerManager) getSystemService("power");
    }

    public void onDestroy() {
        RecoveryLog.m8712i("Recovery.WXRecoveryHandleService", "onDestroy", new Object[0]);
        super.onDestroy();
    }

    /* renamed from: a */
    public final void mo12021a(RecoveryData recoveryData, ArrayList<RecoveryHandleItem> arrayList, boolean z) {
        arrayList.add(m12624a(recoveryData, String.format("%s[%b]", new Object[]{"KeyTotalCount", Boolean.valueOf(z)})));
        arrayList.add(m12624a(recoveryData, String.format("%s[%b]", new Object[]{"KeyAlreadyRunning", Boolean.valueOf(z)})));
    }
    ...
    /* renamed from: a */
    public final RecoveryHandleResult mo12020a(Context context, RecoveryData recoveryData, ArrayList<RecoveryHandleItem> arrayList, boolean z) {
        Throwable th;
        FileOutputStream fileOutputStream;
        RecoveryHandleResult recoveryHandleResult = new RecoveryHandleResult();
        arrayList.add(m12624a(recoveryData, String.format("%s[%b]", new Object[]{"KeyTotalCount", Boolean.valueOf(z)})));
        RecoveryHandleItem a = m12624a(recoveryData, "");
        if (NetUtil.isConnected(this)) {
            RecoveryLog.m8712i("Recovery.WXRecoveryHandleService", "recoveryConfigUrl %s", recoveryData.Arl);
            String a2 = WXRecoveryHandleService.m12625a(r0, a);
            if (a2 != null) {
                JSONObject jSONObject;
                RecoveryLog.m8712i("Recovery.WXRecoveryHandleService", "recoveryConfigStr is %s", a2);
                try {
                ...
                if (jSONObject != null) {
                    ...
                    if ((Util.m8736iB(this) % optInt == optInt2 ? 1 : 0) != 0) {
                        RecoveryLog.m8712i("Recovery.WXRecoveryHandleService", "patchPackageUrl=%s", optString);
                        byte[] a3 = WXRecoveryHandleService.m12626a(optString, optString2, a);
                        if (a3 != null) {
                            ...
                            if (file.exists()) {
                                int bY = RecoveryTinkerManager.m8741bY(context, str);
                                if (bY != 0) {
                                    a.key = "KeyPatchStartFailCount[" + bY + "]";
                                    RecoveryLog.m8712i("Recovery.WXRecoveryHandleService", "patch fail tinkerPatchCode=%d", Integer.valueOf(bY));
                                } else {
                                    a.key = "KeyPatchStartSuccessCount";
                                    RecoveryLog.m8712i("Recovery.WXRecoveryHandleService", "start patch file", new Object[0]);
                                }
                                recoveryHandleResult.csN = true;
                            } else {
                                a.key = "KeyCheckPatchMd5FailCount";
                                RecoveryLog.m8712i("Recovery.WXRecoveryHandleService", "patch file save fail", new Object[0]);
                            }
                        } else {
                            RecoveryLog.m8712i("Recovery.WXRecoveryHandleService", "get patch data fail", new Object[0]);
                        }
                    } else {
                        RecoveryLog.m8712i("Recovery.WXRecoveryHandleService", "no need recovery", new Object[0]);
                        a.key = "KeyPatchNoNeedCount";
                    }
                } else {
                    RecoveryLog.m8712i("Recovery.WXRecoveryHandleService", "parse config fail", new Object[0]);
                    a.key = "KeyConfigParseFailCount";
                }
            } else {
                RecoveryLog.m8712i("Recovery.WXRecoveryHandleService", "recoveryConfigStr is null", new Object[0]);
                if (Util.isNullOrNil(a.key)) {
                    a.key = "RecoveryConfigStrIsNull";
                }
            }
        } else {
            RecoveryLog.m8712i("Recovery.WXRecoveryHandleService", "no network", new Object[0]);
            if (!z) {
    ...
    /* renamed from: a */
    private RecoveryHandleItem m12624a(RecoveryData recoveryData, String str) {
        ...
        recoveryHandleItem.Arn = m12627iE(this);
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    /* renamed from: a */
    private static String m12625a(String str, RecoveryHandleItem recoveryHandleItem) {
        byte[] q;
        Throwable th;
        ...
        if (str.startsWith("file://")) {
            ...
            try {
                ...
                try {
                    q = FileUtil.m8749q(fileInputStream);
                    try {
        ...
        try {
            ...
            try {
                ...
                httpURLConnection2.setReadTimeout(C1625i.sHCENCODEVIDEOTIMEOUT);
                httpURLConnection2.connect();
                int responseCode = httpURLConnection2.getResponseCode();
                if (responseCode != 200) {
                    recoveryHandleItem.key = WXUtil.m8759QZ(responseCode);
                    inputStream = null;
                    q = null;
                } else {
                    ...
                    if (inputStream == null) {
                        ...
                        q = WXRecoveryHandleService.m12628q(inputStream);
                        if (q == null) {
        ...
        if (q != null) {
            try {
                RecoveryLog.m8712i("Recovery.WXRecoveryHandleService", "config data md5=%s", EncryptUtil.m8747x(q));
                byte[] g = EncryptUtil.m8746g(q, "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC0oMW80k4h7zmBbHGhzQzs5Jv1uy5j0JVUG//dWHeu0q6PF/xCU97h/e6h2Q9SXLu0M4TTd89QMXbab9MMUXrxqIqVjzm92A4WyNbAElAwhE9AGO16ryYn+tNzDfmwyjVz6dwLzZbNjjH7akYZRopJYqo17kKn+xrnqM+GRKMOJQIDAQAB");
                if (g == null) {
                    recoveryHandleItem.key = "KeyConfigDecryptFail[" + r0 + "]";
                    return null;
                }
                RecoveryLog.m8712i("Recovery.WXRecoveryHandleService", "config data decrypt md5=%s", EncryptUtil.m8747x(g));
                return new String(g);
            } catch (Exception e10) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    /* renamed from: a */
    private static byte[] m12626a(String str, String str2, RecoveryHandleItem recoveryHandleItem) {
        InputStream inputStream;
        Throwable th;
        Throwable e;
        HttpURLConnection httpURLConnection;
        ...
        if (str.startsWith("file://")) {
            try {
                ...
                try {
                    byte[] q = WXRecoveryHandleService.m12628q(fileInputStream);
                    try {
                        fileInputStream.close();
                        return q;
                    } catch (IOException e2) {
        ...
        try {
            ...
            try {
                ...
                int responseCode = httpURLConnection2.getResponseCode();
                if (responseCode != 200) {
                    recoveryHandleItem.key = WXUtil.m8760Ra(responseCode);
                    inputStream3 = null;
                    bArr = null;
                } else {
                    ...
                    if (inputStream3 == null) {
                        ...
                        bArr = FileUtil.m8749q(inputStream3);
                        if (bArr == null) {
                        ...
                        } else if (!EncryptUtil.m8747x(bArr).equals(str2)) {
    ...
    /* renamed from: q */
    private static byte[] m12628q(InputStream inputStream) {
    ...
    /* renamed from: iE */
    private String m12627iE(Context context) {
        String iF = NetUtil.m8758iF(context);
        boolean isScreenOn = this.tXN.isScreenOn();
        boolean atM = WXRecoveryHandleService.atM("dldir1.qq.com");
        return iF + "|" + isScreenOn + "|" + atM + "|" + WXRecoveryHandleService.atM("www.qq.com");
    }
}
