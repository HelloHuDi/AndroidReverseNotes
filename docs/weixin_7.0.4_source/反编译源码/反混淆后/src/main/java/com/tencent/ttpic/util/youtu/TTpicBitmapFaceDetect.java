...
import com.tencent.faceBeauty.C32116b;
import com.tencent.faceBeauty.FaceParam;
import com.tencent.matrix.trace.core.AppMethodBeat;
import com.tencent.ttpic.baseutils.BitmapUtils;

public class TTpicBitmapFaceDetect extends C32116b {
    ...
    public TTpicBitmapFaceDetect() {
        AppMethodBeat.m2504i(84365);
        if (YTFaceDetectorBase.getInstance().initFaceTrack() != 0) {
            this.inited = false;
            AppMethodBeat.m2505o(84365);
    ...
    public void destroy() {
        AppMethodBeat.m2504i(84366);
        if (this.inited) {
            nativeDestructor();
            this.inited = false;
        }
        AppMethodBeat.m2505o(84366);
    }
        ...
        if (this.inited && BitmapUtils.isLegal(bitmap)) {
            ...
            try {
                ...
                for (int i3 = 0; i3 < this.faceCount; i3++) {
                    ...
                    Rect rect2 = new Rect();
                    faceParam.bJk = rect2;
                    rect2.left = tTImageFeature.f14343x * i;
                    rect2.top = tTImageFeature.f14344y * i;
                    rect2.right = (tTImageFeature.f14343x * i) + (tTImageFeature.f14342w * i);
                    rect2.bottom = (tTImageFeature.f14344y * i) + (tTImageFeature.f14341h * i);
                    if (rect2.left < 0) {
                        rect2.left = 0;
                    }
                    if (rect2.top < 0) {
                    ...
                    int i4 = (int) (((double) (tTImageFeature.f14341h * i)) * 0.16d);
                    ...
                    i4 = (int) (((double) (tTImageFeature.f14342w * i)) * 0.4d);
                    i5 = (int) (((double) (tTImageFeature.f14341h * i)) * 0.16d);
                    rect3 = new Rect();
                    faceParam.bJq = rect3;
