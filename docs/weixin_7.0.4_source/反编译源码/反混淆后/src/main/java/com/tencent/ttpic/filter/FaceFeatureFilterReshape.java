...
public class FaceFeatureFilterReshape extends VideoFilterBase {
    ...
    static {
        AppMethodBeat.m2504i(82375);
        AppMethodBeat.m2505o(82375);
    }

    public FaceFeatureFilterReshape() {
        super(VERTEX_SHADER, FRAGMENT_SHADER);
        AppMethodBeat.m2504i(82360);
    ...
    private void initFaceTexCoords() {
        ...
        AppMethodBeat.m2505o(82366);
    }

    public void updateVideoSize(int i, int i2, double d) {
        AppMethodBeat.m2504i(82367);
        super.updateVideoSize(i, i2, d);
        addParam(new C25629b("canvasSize", (float) i, (float) i2));
        AppMethodBeat.m2505o(82367);
    }

    public boolean renderTexture(int i, int i2, int i3) {
        AppMethodBeat.m2504i(82368);
    ...
    public void updateTextureParams(long j) {
        AppMethodBeat.m2504i(82369);
        initFaceImage();
        AppMethodBeat.m2505o(82369);
    }

    private boolean initFaceImage() {
        AppMethodBeat.m2504i(82370);
        if (this.isFaceImageReady) {
            AppMethodBeat.m2505o(82370);
            return true;
        }
    ...
    private int decodeBitmaps() {
        ...
        AppMethodBeat.m2505o(82371);
        return 1;
    }

    public void updatePointParams(List<PointF> list) {
        AppMethodBeat.m2504i(82372);
        ...
        setCoordNum(690);
        AppMethodBeat.m2505o(82372);
    }

    public void ApplyGLSLFilter() {
        AppMethodBeat.m2504i(82373);
        super.ApplyGLSLFilter();
        GLES20.glGenTextures(this.texture.length, this.texture, 0);
        AppMethodBeat.m2505o(82373);
    }

    public void clearGLSLSelf() {
        AppMethodBeat.m2504i(82374);
