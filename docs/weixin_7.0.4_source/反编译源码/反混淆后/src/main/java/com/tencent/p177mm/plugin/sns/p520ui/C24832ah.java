...
/* renamed from: com.tencent.mm.plugin.sns.ui.ah */
public final class C24832ah implements C22150y {
    ...
    /* renamed from: w */
    private int f4955w = -1;

    public C24832ah(MMActivity mMActivity, int i) {
        this.crP = mMActivity;
        this.hog = i;
    }
    ...
    public final void mo8910M(Bundle bundle) {
        AppMethodBeat.m2504i(38521);
        this.rim = C37952b.m64173u(this.crP.getIntent());
        this.f4955w = this.crP.getIntent().getIntExtra("Ksnsupload_width", -1);
        this.f4954h = this.crP.getIntent().getIntExtra("Ksnsupload_height", -1);
    ...
    public final View crH() {
        ...
        if (this.hog == 13) {
            this.gne.setText(this.title + IOUtils.LINE_SEPARATOR_UNIX + this.ril);
        }
    ...
    public final boolean mo8912a(int i, int i2, C41173i c41173i, String str, List<String> list, ayt ayt, int i3, boolean z, List<String> list2, PInt pInt, String str2, int i4, int i5) {
        AppMethodBeat.m2504i(38523);
        C29054ax c29054ax = new C29054ax(this.hog);
        ...
        if (!C5046bo.isNullOrNil(this.imgPath)) {
            c29054ax.mo47155a(C5730e.m8632e(this.imgPath, 0, -1), this.ril, this.title, this.rij, this.rik);
        } else if (!(C5046bo.isNullOrNil(this.rid) || C32291o.ahk() == null)) {
            C32291o.ahk();
            Bitmap kR = C17937c.m28186kR(this.rid);
            if (kR != null) {
                c29054ax.mo47160b(C5056d.m7636ai(kR), "", "");
            }
        }
        if (c41173i != null) {
    ...
    public final boolean crI() {
        AppMethodBeat.m2504i(38524);
        if (!(this.fru == null || this.fru.isRecycled())) {
            this.fru.recycle();
        }
        AppMethodBeat.m2505o(38524);
        return false;
    }
}
