...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Optional, ReflectedParcelable {
    ...
    public static final class Builder {
        ...
        public Builder() {
            AppMethodBeat.m2504i(60349);
            AppMethodBeat.m2505o(60349);
        }

        public Builder(GoogleSignInOptions googleSignInOptions) {
            AppMethodBeat.m2504i(60350);
            ...
            AppMethodBeat.m2505o(60350);
        }

        private final String zza(String str) {
            AppMethodBeat.m2504i(60364);
            Preconditions.checkNotEmpty(str);
            boolean z = this.zzw == null || this.zzw.equals(str);
            Preconditions.checkArgument(z, "two different server client ids provided");
            AppMethodBeat.m2505o(60364);
            return str;
        }

        public final Builder addExtension(GoogleSignInOptionsExtension googleSignInOptionsExtension) {
            AppMethodBeat.m2504i(60362);
        ...
        public final GoogleSignInOptions build() {
            ...
            AppMethodBeat.m2505o(60363);
            return googleSignInOptions;
        }

        public final Builder requestEmail() {
            AppMethodBeat.m2504i(60352);
            this.mScopes.add(GoogleSignInOptions.SCOPE_EMAIL);
            AppMethodBeat.m2505o(60352);
            return this;
        }

        public final Builder requestId() {
            AppMethodBeat.m2504i(60351);
            this.mScopes.add(GoogleSignInOptions.SCOPE_OPEN_ID);
            AppMethodBeat.m2505o(60351);
            return this;
        }

        public final Builder requestIdToken(String str) {
            AppMethodBeat.m2504i(60355);
            this.zzt = true;
            this.zzw = zza(str);
            AppMethodBeat.m2505o(60355);
            return this;
        }

        public final Builder requestPhatIdToken(String str) {
            AppMethodBeat.m2504i(60356);
            Builder requestEmail = requestIdToken(str).requestProfile().requestEmail();
            AppMethodBeat.m2505o(60356);
            return requestEmail;
        }

        public final Builder requestProfile() {
            AppMethodBeat.m2504i(60353);
            this.mScopes.add(GoogleSignInOptions.SCOPE_PROFILE);
            AppMethodBeat.m2505o(60353);
            return this;
        }

        public final Builder requestScopes(Scope scope, Scope... scopeArr) {
            AppMethodBeat.m2504i(60354);
            this.mScopes.add(scope);
            this.mScopes.addAll(Arrays.asList(scopeArr));
            AppMethodBeat.m2505o(60354);
            return this;
        }

        public final Builder requestServerAuthCode(String str) {
            AppMethodBeat.m2504i(60357);
            Builder requestServerAuthCode = requestServerAuthCode(str, false);
            AppMethodBeat.m2505o(60357);
            return requestServerAuthCode;
        }

        public final Builder requestServerAuthCode(String str, boolean z) {
            AppMethodBeat.m2504i(60358);
            this.zzu = true;
            this.zzw = zza(str);
            this.zzv = z;
            AppMethodBeat.m2505o(60358);
            return this;
        }

        public final Builder setAccount(Account account) {
            AppMethodBeat.m2504i(60360);
            this.zzs = (Account) Preconditions.checkNotNull(account);
            AppMethodBeat.m2505o(60360);
            return this;
        }

        public final Builder setAccountName(String str) {
            AppMethodBeat.m2504i(60359);
            this.zzs = new Account(Preconditions.checkNotEmpty(str), "com.google");
            AppMethodBeat.m2505o(60359);
            return this;
        }

        public final Builder setHostedDomain(String str) {
            AppMethodBeat.m2504i(60361);
            this.zzx = Preconditions.checkNotEmpty(str);
            AppMethodBeat.m2505o(60361);
            return this;
        }
    }

    static {
        AppMethodBeat.m2504i(60379);
        AppMethodBeat.m2505o(60379);
    }
    ...
    GoogleSignInOptions(@Param(id = 1) int i, @Param(id = 2) ArrayList<Scope> arrayList, @Param(id = 3) Account account, @Param(id = 4) boolean z, @Param(id = 5) boolean z2, @Param(id = 6) boolean z3, @Param(id = 7) String str, @Param(id = 8) String str2, @Param(id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {
        ...
        AppMethodBeat.m2504i(60366);
        AppMethodBeat.m2505o(60366);
    }

    private GoogleSignInOptions(int i, ArrayList<Scope> arrayList, Account account, boolean z, boolean z2, boolean z3, String str, String str2, Map<Integer, GoogleSignInOptionsExtensionParcelable> map) {
        AppMethodBeat.m2504i(60367);
        this.versionCode = i;
        this.zzr = arrayList;
        this.zzs = account;
        this.zzt = z;
    ...
    public static GoogleSignInOptions fromJsonString(String str) {
        AppMethodBeat.m2504i(60365);
        if (TextUtils.isEmpty(str)) {
            AppMethodBeat.m2505o(60365);
            return null;
        }
    ...
    private static Map<Integer, GoogleSignInOptionsExtensionParcelable> zza(List<GoogleSignInOptionsExtensionParcelable> list) {
        AppMethodBeat.m2504i(60372);
        HashMap hashMap = new HashMap();
        if (list == null) {
            AppMethodBeat.m2505o(60372);
            return hashMap;
        }
    ...
    public boolean equals(Object obj) {
        AppMethodBeat.m2504i(60374);
        if (obj == null) {
            AppMethodBeat.m2505o(60374);
            return false;
        }
        try {
    ...
    public boolean hasExtension(@TypeId int i) {
        AppMethodBeat.m2504i(60370);
        boolean containsKey = this.zzz.containsKey(Integer.valueOf(i));
        AppMethodBeat.m2505o(60370);
        return containsKey;
    }

    public int hashCode() {
        AppMethodBeat.m2504i(60375);
    ...
    public String toJson() {
        AppMethodBeat.m2504i(60376);
        String jSONObject = zza().toString();
        AppMethodBeat.m2505o(60376);
        return jSONObject;
    }

    public void writeToParcel(Parcel parcel, int i) {
        AppMethodBeat.m2504i(60373);
