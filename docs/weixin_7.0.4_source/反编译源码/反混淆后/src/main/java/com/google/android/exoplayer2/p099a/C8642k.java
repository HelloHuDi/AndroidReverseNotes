...
final class C8642k {
    ...
    public C8642k(int i, int i2) {
        AppMethodBeat.m2504i(94722);
        this.sampleRate = i;
        this.aRy = i2;
        this.aRz = i / 400;
        this.aRA = i / 65;
        ...
        this.speed = 1.0f;
        this.pitch = 1.0f;
        AppMethodBeat.m2505o(94722);
    }

    /* renamed from: dz */
    private void m15308dz(int i) {
        AppMethodBeat.m2504i(94723);
        if (this.aRM + i > this.aRF) {
            this.aRF += (this.aRF / 2) + i;
            this.aRG = Arrays.copyOf(this.aRG, this.aRF * this.aRy);
        }
        AppMethodBeat.m2505o(94723);
    }

    /* Access modifiers changed, original: final */
    /* renamed from: dA */
    public final void mo19138dA(int i) {
        AppMethodBeat.m2504i(94724);
        if (this.aRL + i > this.aRD) {
            this.aRD += (this.aRD / 2) + i;
            this.aRE = Arrays.copyOf(this.aRE, this.aRD * this.aRy);
        }
        AppMethodBeat.m2505o(94724);
    }

    /* renamed from: a */
    private void m15306a(short[] sArr, int i, int i2) {
        AppMethodBeat.m2504i(94725);
        m15308dz(i2);
        System.arraycopy(sArr, this.aRy * i, this.aRG, this.aRM * this.aRy, this.aRy * i2);
        this.aRM += i2;
        AppMethodBeat.m2505o(94725);
    }

    /* renamed from: b */
    private void m15307b(short[] sArr, int i, int i2) {
        int i3 = this.aRB / i2;
        int i4 = this.aRy * i2;
        int i5 = i * this.aRy;
    ...
    /* renamed from: a */
    private int m15304a(short[] sArr, int i, int i2, int i3) {
        AppMethodBeat.m2504i(94726);
        int i4 = 0;
        int i5 = 255;
        int i6 = 1;
        int i7 = 0;
        ...
        this.aRR = i6 / i4;
        this.aRS = i7 / i5;
        AppMethodBeat.m2505o(94726);
        return i4;
    }

    /* Access modifiers changed, original: final */
    /* renamed from: qE */
    public final void mo19139qE() {
        int i;
        int min;
        int a;
        int i2;
        short[] sArr;
        AppMethodBeat.m2504i(94727);
        int i3 = this.aRM;
        float f = this.speed / this.pitch;
        if (((double) f) <= 1.00001d && ((double) f) >= 0.99999d) {
            m15306a(this.aRE, 0, this.aRL);
            this.aRL = 0;
            ...
            do {
                if (this.aRO > 0) {
                    ...
                    if (this.aRy == 1 && min == 1) {
                        min = m15304a(sArr2, i, this.aRz, this.aRA);
                    } else {
                        m15307b(sArr2, i, min);
                        a = m15304a(this.aRC, 0, this.aRz / min, this.aRA / min);
                        if (min != 1) {
                            i2 = a * min;
                            a = i2 - (min * 4);
                            i2 += min * 4;
                            ...
                            if (this.aRy == 1) {
                                min = m15304a(sArr2, i, min, a);
                            } else {
                                m15307b(sArr2, i, 1);
                                min = m15304a(this.aRC, 0, min, a);
                            }
                        } else {
                            min = a;
                        }
                    ...
                    if (((double) f) > 1.0d) {
                        ...
                        m15308dz(min);
                        C8642k.m15305a(min, this.aRy, this.aRG, this.aRM, sArr, i, sArr, i + i5);
                        this.aRM += min;
                        i += min + i5;
                    } else {
                        int i6;
                        ...
                        C8642k.m15305a(i6, this.aRy, this.aRG, this.aRM + i5, sArr3, i + i5, sArr3, i);
                        this.aRM += i5 + i6;
                        i += i6;
                    }
                }
        ...
        if (this.pitch != 1.0f) {
            ...
            if (this.aRM != i3) {
                ...
                while (true) {
                    ...
                    if (this.aRJ == i2) {
                        this.aRJ = 0;
                        C45039a.checkState(this.aRK == i7);
                        this.aRK = 0;
                    }
                    min = a + 1;
                }
        ...
        AppMethodBeat.m2505o(94727);
    }

    /* renamed from: a */
    private static void m15305a(int i, int i2, short[] sArr, int i3, short[] sArr2, int i4, short[] sArr3, int i5) {
