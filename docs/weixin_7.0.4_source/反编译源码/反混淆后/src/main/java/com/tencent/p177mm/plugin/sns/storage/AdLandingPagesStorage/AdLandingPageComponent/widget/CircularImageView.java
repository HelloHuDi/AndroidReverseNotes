package com.tencent.p177mm.plugin.sns.storage.AdLandingPagesStorage.AdLandingPageComponent.widget;
...
public class CircularImageView extends ImageView {
    ...
    static {
        AppMethodBeat.m2504i(37681);
        AppMethodBeat.m2505o(37681);
    }
    ...
    public CircularImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C3873a.CircularImageView, i, 0);
        ...
        AppMethodBeat.m2505o(37665);
    }

    public void setBorderWidth(int i) {
        AppMethodBeat.m2504i(37666);
        this.borderWidth = i;
        if (this.rdK != null) {
        ...
        requestLayout();
        invalidate();
        AppMethodBeat.m2505o(37666);
    }

    public void setBorderColor(int i) {
        AppMethodBeat.m2504i(37667);
        if (this.rdK != null) {
            this.rdK.setColor(i);
        }
        invalidate();
        AppMethodBeat.m2505o(37667);
    }

    public void setSelectorColor(int i) {
        AppMethodBeat.m2504i(37668);
        this.rdM = new PorterDuffColorFilter(i, Mode.SRC_ATOP);
        invalidate();
        AppMethodBeat.m2505o(37668);
    }

    public void setSelectorStrokeWidth(int i) {
        AppMethodBeat.m2504i(37669);
        this.rdF = i;
        requestLayout();
        invalidate();
        AppMethodBeat.m2505o(37669);
    }

    public void setSelectorStrokeColor(int i) {
        AppMethodBeat.m2504i(37670);
        if (this.rdL != null) {
            this.rdL.setColor(i);
        }
        invalidate();
        AppMethodBeat.m2505o(37670);
    }

    public void setShadowEnabled(boolean z) {
        AppMethodBeat.m2504i(37671);
        this.rdG = z;
        ...
        AppMethodBeat.m2505o(37671);
    }

    public void onDraw(Canvas canvas) {
        int i = 0;
        AppMethodBeat.m2504i(37672);
        if (this.rdJ == null) {
            AppMethodBeat.m2505o(37672);
    ...
    public void setImageURI(Uri uri) {
        AppMethodBeat.m2504i(37674);
        super.setImageURI(uri);
        this.rdJ = CircularImageView.drawableToBitmap(getDrawable());
        if (this.rdE > 0) {
            cqg();
        }
        AppMethodBeat.m2505o(37674);
    }

    public void setImageResource(int i) {
        AppMethodBeat.m2504i(37675);
        super.setImageResource(i);
        this.rdJ = CircularImageView.drawableToBitmap(getDrawable());
        if (this.rdE > 0) {
            cqg();
        }
        AppMethodBeat.m2505o(37675);
    }

    public void setImageDrawable(Drawable drawable) {
        AppMethodBeat.m2504i(37676);
        super.setImageDrawable(drawable);
        this.rdJ = CircularImageView.drawableToBitmap(getDrawable());
        if (this.rdE > 0) {
            cqg();
        }
        AppMethodBeat.m2505o(37676);
    }

    public void setImageBitmap(Bitmap bitmap) {
        AppMethodBeat.m2504i(37677);
        super.setImageBitmap(bitmap);
        this.rdJ = bitmap;
        if (this.rdE > 0) {
            cqg();
        }
        AppMethodBeat.m2505o(37677);
    }

    private static Bitmap drawableToBitmap(Drawable drawable) {
        AppMethodBeat.m2504i(37679);
        if (drawable == null) {
            AppMethodBeat.m2505o(37679);
            return null;
    ...
    private void cqg() {
        AppMethodBeat.m2504i(37680);
        if (this.rdJ == null) {
            AppMethodBeat.m2505o(37680);
            return;
        }
    ...
    public void onMeasure(int i, int i2) {
        AppMethodBeat.m2504i(37678);
        int mode = MeasureSpec.getMode(i);
        int size = MeasureSpec.getSize(i);
        if (!(mode == ErrorDialogData.SUPPRESSED || mode == C8415j.INVALID_ID)) {
            size = this.rdE;
        }
        int mode2 = MeasureSpec.getMode(i2);
        mode = MeasureSpec.getSize(i2);
        if (!(mode2 == ErrorDialogData.SUPPRESSED || mode2 == C8415j.INVALID_ID)) {
            mode = this.rdE;
        }
        setMeasuredDimension(size, mode + 2);
        AppMethodBeat.m2505o(37678);
    }
}
