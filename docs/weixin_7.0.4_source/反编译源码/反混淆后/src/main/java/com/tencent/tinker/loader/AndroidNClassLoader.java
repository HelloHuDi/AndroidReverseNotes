...
class AndroidNClassLoader extends PathClassLoader {
    ...
    /* renamed from: a */
    public static AndroidNClassLoader m9291a(PathClassLoader pathClassLoader, Application application) {
        AndroidNClassLoader androidNClassLoader = new AndroidNClassLoader("", pathClassLoader, application);
        Field b = ShareReflectUtil.m9395b(pathClassLoader, "pathList");
        Object obj = b.get(pathClassLoader);
        Constructor a = ShareReflectUtil.m9393a(obj, ClassLoader.class, String.class, String.class, File.class);
        Object[] objArr = (Object[]) ShareReflectUtil.m9395b(obj, "dexElements").get(obj);
        List<File> list = (List) ShareReflectUtil.m9395b(obj, "nativeLibraryDirectories").get(obj);
        StringBuilder stringBuilder = new StringBuilder();
        Field d = ShareReflectUtil.m9400d(objArr.getClass().getComponentType(), "dexFile");
        Object obj2 = 1;
        ...
        ShareReflectUtil.m9395b(obj, "definingContext").set(obj, androidNClassLoader);
        ACs = obj;
        Context context = (Context) ShareReflectUtil.m9395b(application, "mBase").get(application);
        Object obj5 = ShareReflectUtil.m9395b(context, "mPackageInfo").get(context);
        ShareReflectUtil.m9395b(obj5, "mClassLoader").set(obj5, androidNClassLoader);
        if (VERSION.SDK_INT < 27) {
            Resources resources = application.getResources();
            ShareReflectUtil.m9395b(resources, "mClassLoader").set(resources, androidNClassLoader);
            obj5 = ShareReflectUtil.m9395b(resources, "mDrawableInflater").get(resources);
            if (obj5 != null) {
                ShareReflectUtil.m9395b(obj5, "mClassLoader").set(obj5, androidNClassLoader);
            }
        }
