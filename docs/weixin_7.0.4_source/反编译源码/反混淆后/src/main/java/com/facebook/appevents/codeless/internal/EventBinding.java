...
public class EventBinding {
    ...
    public static List<EventBinding> parseArray(JSONArray jSONArray) {
        ...
        AppMethodBeat.m2505o(72097);
        return arrayList;
    }

    public static EventBinding getInstanceFromJson(JSONObject jSONObject) {
        int i = 0;
        AppMethodBeat.m2504i(72098);
        String string = jSONObject.getString("event_name");
        MappingMethod valueOf = MappingMethod.valueOf(jSONObject.getString(C8741b.METHOD).toUpperCase());
