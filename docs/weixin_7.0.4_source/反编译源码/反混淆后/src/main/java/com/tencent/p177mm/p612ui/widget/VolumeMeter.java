...
public class VolumeMeter extends ImageView implements Runnable {
    ...
    public void run() {
        ...
        AppMethodBeat.m2505o(108002);
    }

    public VolumeMeter(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        AppMethodBeat.m2504i(108003);
        this.mContext = context;
        init();
        AppMethodBeat.m2505o(108003);
    }

    public VolumeMeter(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        AppMethodBeat.m2504i(108004);
        this.mContext = context;
        init();
        AppMethodBeat.m2505o(108004);
    }

    private void init() {
        AppMethodBeat.m2504i(108005);
        this.aFY = new Paint();
        AppMethodBeat.m2505o(108005);
    }

    /* Access modifiers changed, original: protected */
    public void onDraw(Canvas canvas) {
        AppMethodBeat.m2504i(108006);
        super.onDraw(canvas);
        getWidth();
        getHeight();
