...
public final class StringToIntConverter extends AbstractSafeParcelable implements FieldConverter<String, Integer> {
    ...
    public static final class Entry extends AbstractSafeParcelable {
        ...
        static {
            AppMethodBeat.m2504i(61449);
            AppMethodBeat.m2505o(61449);
        }
        ...
        public final void writeToParcel(Parcel parcel, int i) {
            ...
            AppMethodBeat.m2505o(61448);
        }
    }

    static {
        AppMethodBeat.m2504i(61458);
        AppMethodBeat.m2505o(61458);
    }

    public StringToIntConverter() {
        AppMethodBeat.m2504i(61451);
        this.zzal = 1;
        this.zzwe = new HashMap();
        this.zzwf = new SparseArray();
        this.zzwg = null;
        AppMethodBeat.m2505o(61451);
    }

    @Constructor
    StringToIntConverter(@Param(id = 1) int i, @Param(id = 2) ArrayList<Entry> arrayList) {
        AppMethodBeat.m2504i(61450);
        this.zzal = i;
        this.zzwe = new HashMap();
        this.zzwf = new SparseArray();
        this.zzwg = null;
