                ...
                try {
                        ...
                        try {
                            ...
                            if (readLine == null || this.isStop) {
                                try {
                                    ...
                                    Logger.m71024e(CpuInfoUtil.TAG, e2);
                                }
                                if (exec != null) {
                                    exec.destroy();
                                    AppMethodBeat.m2505o(128388);
                                    return;
                                }
                            }
                            int i2 = i + 1;
                            ...
                            if (i2 > 15) {
                                try {
                                    Logger.m71020d(CpuInfoUtil.TAG, stringBuilder.toString());
                                    stringBuilder.delete(0, stringBuilder.length() - 1);
                                    sleep(5000);
                                    i = 0;
                                } catch (Exception e22) {
                                    Logger.m71024e(CpuInfoUtil.TAG, e22);
                                    i = i2;
                                }
                            } else {
                                i = i2;
                            ...
                            try {
                                ...
                                if (bufferedReader != null) {
                                    try {
                                        ...
                                        Logger.m71024e(CpuInfoUtil.TAG, e222);
                                    }
                                }
                                if (exec != null) {
                                    exec.destroy();
                    ...
                    if (bufferedReader != null) {
                        try {
                            ...
                            Logger.m71024e(CpuInfoUtil.TAG, e5);
                        }
                    }
                    if (exec != null) {
                        exec.destroy();
