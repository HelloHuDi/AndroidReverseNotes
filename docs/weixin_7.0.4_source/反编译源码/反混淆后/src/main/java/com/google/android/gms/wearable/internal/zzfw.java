...
public final class zzfw extends AbstractSafeParcelable {
    ...
    static {
        AppMethodBeat.m2504i(71345);
        AppMethodBeat.m2505o(71345);
    }

    @Constructor
    zzfw(@Param(id = 1) int i, @Param(id = 2) IBinder iBinder) {
        zzem zzem = null;
        AppMethodBeat.m2504i(71343);
        this.versionCode = i;
        if (iBinder != null) {
            if (iBinder != null) {
