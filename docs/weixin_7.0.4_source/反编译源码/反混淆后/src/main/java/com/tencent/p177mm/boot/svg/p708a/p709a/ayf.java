...
/* renamed from: com.tencent.mm.boot.svg.a.a.ayf */
public final class ayf extends C5163c {
    ...
    public final int mo10620a(int i, Object... objArr) {
        switch (i) {
            ...
            case 2:
                ...
                a.setColor(-855310);
                g = C5163c.m7878a(g, 1.0f, 0.0f, -80.0f, 0.0f, 1.0f, -322.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
                g = C5163c.m7878a(g, 1.0f, 0.0f, 34.0f, 0.0f, 1.0f, 318.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
                a = C5163c.m7876a(a, looper);
                g = C5163c.m7878a(g, -1.0f, 0.0f, 98.0f, 0.0f, -1.0f, 19.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
