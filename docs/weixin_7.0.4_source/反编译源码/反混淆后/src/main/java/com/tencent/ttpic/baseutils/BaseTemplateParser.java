...
public class BaseTemplateParser {
    ...
    public static String parseCameraAttrsFile(Context context, String str, String str2, String str3) {
        ...
        AppMethodBeat.m2504i(49582);
        LogUtils.m50210v("ContentValues", "[parseCameraAttrsFile] filePath = ".concat(String.valueOf(str)));
        try {
            File file = new File(str);
            InputStream fileInputStream2;
            InputStream drinkACupOfCoffeeForCamera;
            if (file.exists() && file.isFile()) {
                LogUtils.m50210v("ContentValues", "[parseCameraAttrsFile] parseFile file exists and isFile");
            ...
            InputStream open;
            LogUtils.m50210v("ContentValues", "[parseCameraAttrsFile] parseFile file is in Assets directory");
            if (context != null) {
                try {
    ...
    private static JSONObject parseFileProcess(Context context, String str, String str2, boolean z) {
        ...
        InputStreamReader inputStreamReader2;
        AppMethodBeat.m2504i(49584);
        String str3 = str + "/" + str2 + "." + (z ? POSTFIX_ORIG : "dat");
        String str4 = str + "/" + str2 + "." + (!z ? POSTFIX_ORIG : "dat");
        LogUtils.m50212v("ContentValues", "parseFile(), full path = %s", str3);
        try {
            File file = new File(str3);
            File file2 = new File(str4);
            InputStream fileInputStream2;
            if ((file.exists() && file.isFile()) || (file2.exists() && file2.isFile())) {
                LogUtils.m50210v("ContentValues", "parseFile file exists and isFile");
                if (file.exists() && file.isFile()) {
                    fileInputStream2 = new FileInputStream(file);
            ...
            LogUtils.m50210v("ContentValues", "parseFile file is in Assets directory");
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            LogUtils.m50199d("ContentValues", jSONObject2);
    ...
    public static String parseFastCaptureFile(Context context, String str, String str2) {
        ...
        Throwable th;
        InputStream inputStream2;
        AppMethodBeat.m2504i(49589);
        LogUtils.m50210v("ContentValues", "[parseFastCaptureFile] filePath = ".concat(String.valueOf(str)));
        try {
            InputStream open;
            LogUtils.m50210v("ContentValues", "[parseFastCaptureFile] parseFile file is in Assets directory");
            if (context != null) {
