...
/* renamed from: com.tencent.mm.protocal.protobuf.avz */
public final class avz extends btd {
    ...
    public final int mo4669op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.wzP != null) {
                c6093a.mo13475e(6, this.wzP);
            }
            c6093a.mo13480iz(7, this.wzQ);
            if (this.wzN != null) {
                c6093a.mo13475e(8, this.wzN);
            }
            if (this.guQ != null) {
            ...
            if (this.wzP != null) {
                ix += C6091a.m9575f(6, this.wzP);
            }
            ix += C6091a.m9572bs(7, this.wzQ);
            if (this.wzN != null) {
                ix += C6091a.m9575f(8, this.wzN);
            }
            if (this.guQ != null) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    return 0;
                case 3:
                    avz.wzO = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(96261);
                    return 0;
                case 4:
                    avz.vBa = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(96261);
                    return 0;
                case 5:
                    avz.vAN = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(96261);
                    return 0;
                case 6:
                    avz.wzP = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(96261);
                    return 0;
                case 7:
                    avz.wzQ = c6086a2.BTU.mo13458vd();
                    AppMethodBeat.m2505o(96261);
                    return 0;
                case 8:
                    avz.wzN = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(96261);
                    return 0;
                case 9:
                    avz.guQ = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(96261);
                    return 0;
                default:
                    AppMethodBeat.m2505o(96261);
