...
public final class C29231p implements C22150y {
    ...
    /* renamed from: w */
    private int f13707w = -1;

    public C29231p(MMActivity mMActivity) {
        this.crP = mMActivity;
    }

    /* renamed from: M */
    public final void mo8910M(Bundle bundle) {
        AppMethodBeat.m2504i(38223);
        this.rim = C37952b.m64173u(this.crP.getIntent());
        this.f13707w = this.crP.getIntent().getIntExtra("Ksnsupload_width", -1);
        this.f13706h = this.crP.getIntent().getIntExtra("Ksnsupload_height", -1);
    ...
    public final boolean mo8912a(int i, int i2, C41173i c41173i, String str, List<String> list, ayt ayt, int i3, boolean z, List<String> list2, PInt pInt, String str2, int i4, int i5) {
        AppMethodBeat.m2504i(38225);
        C29054ax c29054ax = new C29054ax(22);
    ...
    public final boolean crI() {
        AppMethodBeat.m2504i(38226);
        if (!(this.fru == null || this.fru.isRecycled())) {
            this.fru.recycle();
        }
        AppMethodBeat.m2505o(38226);
        return false;
    }
}
