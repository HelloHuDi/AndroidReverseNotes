...
/* renamed from: com.tencent.mm.plugin.story.ui.view.editor.item.d */
public final class C43665d {
    String snb;
    public int snc;
    int startTime;

    public C43665d(String str, int i, int i2) {
        C25052j.m39376p(str, "lrc");
        AppMethodBeat.m2504i(110676);
        this.snb = str;
        this.startTime = i;
        this.snc = i2;
        AppMethodBeat.m2505o(110676);
    }
}
