...
public final class C1096a {
    ...
    /* renamed from: com.tencent.matrix.resource.a$1 */
    static class C10921 implements OnAttachStateChangeListener {
        C10921() {
        }
        ...
        if (view != null && view.getContext() != null) {
            ...
            if (view != null) {
                ...
                if (view.getBackground() != null) {
                    view.addOnAttachStateChangeListener(new C10921());
                }
            }
            ...
            if (view instanceof ViewGroup) {
                ...
                for (int i = 0; i < childCount; i++) {
                    C1096a.m2412cc(viewGroup.getChildAt(i));
                }
            }
        }
    }
