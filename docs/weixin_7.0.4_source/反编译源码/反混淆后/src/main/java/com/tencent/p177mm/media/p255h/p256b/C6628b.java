...
/* renamed from: com.tencent.mm.media.h.b.b */
public final class C6628b extends C1786a {
    ...
    private C6628b(int i, int i2, int i3, int i4, int i5, int i6) {
        super(i, i2, i3, i4, i5, i6);
        AppMethodBeat.m2504i(13101);
        this.eZG = 1;
        ...
        this.eZF.position(0);
        this.eZF.put(C42175b.eZZ);
        this.eZF.position(0);
        AppMethodBeat.m2505o(13101);
    }

    public /* synthetic */ C6628b(int i, int i2, int i3, int i4, int i5, int i6, byte b) {
