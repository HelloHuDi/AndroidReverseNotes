...
public final class FacebookSdk {
    ...
    private static final ThreadFactory DEFAULT_THREAD_FACTORY = new C85791();
    ...
    static class C85791 implements ThreadFactory {
        private final AtomicInteger counter = new AtomicInteger(0);

        C85791() {
            AppMethodBeat.m2504i(71597);
            AppMethodBeat.m2505o(71597);
        }

        public final Thread newThread(Runnable runnable) {
            AppMethodBeat.m2504i(71598);
            Thread thread = new Thread(runnable, "FacebookSdk #" + this.counter.incrementAndGet());
            AppMethodBeat.m2505o(71598);
            return thread;
        }
    }

    /* renamed from: com.facebook.FacebookSdk$2 */
    static class C85802 implements FetchedAppSettingsCallback {
        C85802() {
        }

        public final void onSuccess(FetchedAppSettings fetchedAppSettings) {
            AppMethodBeat.m2504i(71599);
            FetchedAppGateKeepersManager.loadAppGateKeepersAsync();
            AppMethodBeat.m2505o(71599);
        }
    ...
    static class C85813 implements Callable<File> {
        C85813() {
        }

        public final File call() {
            AppMethodBeat.m2504i(71600);
            File cacheDir = FacebookSdk.applicationContext.getCacheDir();
            AppMethodBeat.m2505o(71600);
            return cacheDir;
        }
    }

    static {
        AppMethodBeat.m2504i(71638);
        AppMethodBeat.m2505o(71638);
    }

    @Deprecated
    public static synchronized void sdkInitialize(Context context, int i) {
        synchronized (FacebookSdk.class) {
            AppMethodBeat.m2504i(71605);
            sdkInitialize(context, i, null);
            AppMethodBeat.m2505o(71605);
        }
    }
    ...
    public static synchronized void sdkInitialize(Context context) {
        synchronized (FacebookSdk.class) {
            AppMethodBeat.m2504i(71607);
            sdkInitialize(context, null);
            AppMethodBeat.m2505o(71607);
        }
    }
    ...
    public static synchronized void sdkInitialize(final Context context, final InitializeCallback initializeCallback) {
        synchronized (FacebookSdk.class) {
            AppMethodBeat.m2504i(71608);
            if (sdkInitialized.booleanValue()) {
                if (initializeCallback != null) {
                    initializeCallback.onInitialized();
                }
                AppMethodBeat.m2505o(71608);
            } else {
    ...
    public static synchronized boolean isInitialized() {
        ...
        synchronized (FacebookSdk.class) {
            AppMethodBeat.m2504i(71609);
            booleanValue = sdkInitialized.booleanValue();
            AppMethodBeat.m2505o(71609);
        }
        return booleanValue;
    }
    ...
    public static void removeLoggingBehavior(LoggingBehavior loggingBehavior) {
        ...
        synchronized (loggingBehaviors) {
            try {
                ...
                AppMethodBeat.m2505o(71612);
            }
        }
    }

    public static void clearLoggingBehaviors() {
        AppMethodBeat.m2504i(71613);
        synchronized (loggingBehaviors) {
            try {
    ...
    /* JADX WARNING: Missing block: B:7:0x001c, code skipped:
            ...
            com.tencent.matrix.trace.core.AppMethodBeat.m2505o(71621);
     */
    ...
    public static String getApplicationSignature(Context context) {
        String str = null;
        AppMethodBeat.m2504i(71627);
        Validate.sdkInitialized();
        if (context == null) {
            AppMethodBeat.m2505o(71627);
            return str;
        }
    ...
    public static String getApplicationId() {
        AppMethodBeat.m2504i(71628);
        Validate.sdkInitialized();
        String str = applicationId;
        AppMethodBeat.m2505o(71628);
        return str;
    }
    ...
    public static String getApplicationName() {
        AppMethodBeat.m2504i(71629);
        Validate.sdkInitialized();
        String str = applicationName;
        AppMethodBeat.m2505o(71629);
        return str;
    }
    ...
    public static String getClientToken() {
        AppMethodBeat.m2504i(71630);
        Validate.sdkInitialized();
        String str = appClientToken;
        AppMethodBeat.m2505o(71630);
        return str;
    }
