...
public class EyeLightenAndPounchFilterReshape extends VideoFilterBase {
    ...
    static {
        AppMethodBeat.m2504i(82225);
        AppMethodBeat.m2505o(82225);
    }

    public EyeLightenAndPounchFilterReshape() {
        super(VERTEX_SHADER, FRAGMENT_SHADER);
        AppMethodBeat.m2504i(82207);
    ...
    private void initFaceTexCoords() {
        ...
        AppMethodBeat.m2505o(82215);
    }

    public void updateVideoSize(int i, int i2, double d) {
        AppMethodBeat.m2504i(82216);
        ...
        AppMethodBeat.m2505o(82216);
    }

    public boolean renderTexture(int i, int i2, int i3) {
        AppMethodBeat.m2504i(82217);
    ...
    public void updateTextureParams(long j) {
        AppMethodBeat.m2504i(82218);
        initFaceImage();
        AppMethodBeat.m2505o(82218);
    }

    private boolean initFaceImage() {
        AppMethodBeat.m2504i(82219);
        if (this.isFaceImageReady) {
            AppMethodBeat.m2505o(82219);
            return true;
        }
    ...
    private int decodeBitmaps() {
        ...
        AppMethodBeat.m2505o(82220);
        return 1;
    }

    public void updatePointParams(List<PointF> list) {
        AppMethodBeat.m2504i(82221);
        ...
        addParam(new C0934g("center1", new float[]{(float) (((double) (((PointF) list.get(44)).x + 0.0f)) / this.mFaceDetScale), (float) (((double) ((PointF) list.get(44)).y) / this.mFaceDetScale)}));
        addParam(new C0934g("center2", fArr));
        addParam(new C0934g("size", fArr2));
        addParam(new C0933f("radius1", distance));
        addParam(new C0933f("radius2", distance2));
        AppMethodBeat.m2505o(82221);
    }

    public void ApplyGLSLFilter() {
        AppMethodBeat.m2504i(82222);
        super.ApplyGLSLFilter();
        GLES20.glGenTextures(this.texture.length, this.texture, 0);
        AppMethodBeat.m2505o(82222);
    }

    public void clearGLSLSelf() {
        AppMethodBeat.m2504i(82223);
