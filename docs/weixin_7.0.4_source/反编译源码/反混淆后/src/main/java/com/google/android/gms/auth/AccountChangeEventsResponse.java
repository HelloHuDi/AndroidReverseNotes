...
public class AccountChangeEventsResponse extends AbstractSafeParcelable {
    ...
    static {
        AppMethodBeat.m2504i(76934);
        AppMethodBeat.m2505o(76934);
    }

    @Constructor
    AccountChangeEventsResponse(@Param(id = 1) int i, @Param(id = 2) List<AccountChangeEvent> list) {
        AppMethodBeat.m2504i(76931);
        this.zzh = i;
        this.zzo = (List) Preconditions.checkNotNull(list);
        AppMethodBeat.m2505o(76931);
    }

    public AccountChangeEventsResponse(List<AccountChangeEvent> list) {
        AppMethodBeat.m2504i(76932);
        this.zzh = 1;
        this.zzo = (List) Preconditions.checkNotNull(list);
        AppMethodBeat.m2505o(76932);
    }
