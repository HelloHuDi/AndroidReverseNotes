package com.tencent.p177mm.plugin.appbrand.game.preload.p1470ui;
...
public class BootstrapProgressBar extends View implements AnimatorListener, AnimatorUpdateListener {
    ...
    /* renamed from: com.tencent.mm.plugin.appbrand.game.preload.ui.BootstrapProgressBar$1 */
    class C332061 implements AnimatorUpdateListener {
        C332061() {
        }

        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            AppMethodBeat.m2504i(130309);
            BootstrapProgressBar.this.invalidate();
            AppMethodBeat.m2505o(130309);
        }
    }

    public BootstrapProgressBar(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        AppMethodBeat.m2504i(130310);
        aBE();
        AppMethodBeat.m2505o(130310);
    }

    public BootstrapProgressBar(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        AppMethodBeat.m2504i(130311);
        aBE();
        AppMethodBeat.m2505o(130311);
    }

    private void aBE() {
        AppMethodBeat.m2504i(130312);
        ...
        AppMethodBeat.m2505o(130312);
    }

    public void setProgressColor(int i) {
        AppMethodBeat.m2504i(130313);
        this.htZ = i;
        ...
        this.htW = null;
        invalidate();
        AppMethodBeat.m2505o(130313);
    }

    public void onAnimationUpdate(ValueAnimator valueAnimator) {
        AppMethodBeat.m2504i(130314);
        this.htN = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        invalidate();
        AppMethodBeat.m2505o(130314);
    }
    ...
    public void onAnimationEnd(Animator animator) {
        AppMethodBeat.m2504i(130315);
        aBF();
        AppMethodBeat.m2505o(130315);
    }
    ...
    private void aBF() {
        ...
        if (this.htP && this.htQ) {
            ...
            this.htU.addUpdateListener(new C332061());
            this.htU.start();
            AppMethodBeat.m2505o(130316);
            return;
        }
        AppMethodBeat.m2505o(130316);
    }
    ...
    public void onMeasure(int i, int i2) {
        AppMethodBeat.m2504i(130317);
        setMeasuredDimension(MeasureSpec.getSize(i), MeasureSpec.getSize(i2));
        AppMethodBeat.m2505o(130317);
    }

    /* Access modifiers changed, original: protected */
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        AppMethodBeat.m2504i(130318);
        if (i2 != i4) {
            this.htY = null;
        }
        super.onSizeChanged(i, i2, i3, i4);
        AppMethodBeat.m2505o(130318);
    }

    /* Access modifiers changed, original: protected */
    public void onDraw(Canvas canvas) {
        AppMethodBeat.m2504i(130319);
        float width = (float) getWidth();
        float height = (float) getHeight();
        if (width <= 0.0f || height <= 0.0f) {
            AppMethodBeat.m2505o(130319);
            return;
        }
        if (this.htX == null) {
    ...
    public void setStriped(boolean z) {
        AppMethodBeat.m2504i(130321);
        this.htP = z;
        invalidate();
        aBF();
        AppMethodBeat.m2505o(130321);
    }

    public void setAnimated(boolean z) {
        AppMethodBeat.m2504i(130322);
        this.htQ = z;
        invalidate();
        aBF();
        AppMethodBeat.m2505o(130322);
    }
    ...
    public void setMaxProgress(float f) {
        AppMethodBeat.m2504i(130323);
        if (getProgress() <= f) {
            this.htO = f;
            invalidate();
            AppMethodBeat.m2505o(130323);
            return;
        }
