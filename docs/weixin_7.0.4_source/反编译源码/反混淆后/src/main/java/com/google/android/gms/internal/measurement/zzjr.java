...
public class zzjr implements zzec {
    ...
    private final int zza(FileChannel fileChannel) {
        int i = 0;
        AppMethodBeat.m2504i(69469);
        zzab();
        if (fileChannel == null || !fileChannel.isOpen()) {
            zzge().zzim().log("Bad channel to read from");
            AppMethodBeat.m2505o(69469);
        } else {
    ...
    private final boolean zza(int i, FileChannel fileChannel) {
        AppMethodBeat.m2504i(69470);
        zzab();
        if (fileChannel == null || !fileChannel.isOpen()) {
            zzge().zzim().log("Bad channel to read from");
            AppMethodBeat.m2505o(69470);
            return false;
        }
        ByteBuffer allocate = ByteBuffer.allocate(4);
        allocate.putInt(i);
    ...
    private final boolean zza(String str, zzeu zzeu) {
        long round;
        AppMethodBeat.m2504i(69456);
        String string = zzeu.zzafq.getString(C8741b.CURRENCY);
        if (C8740a.ECOMMERCE_PURCHASE.equals(zzeu.name)) {
    ...
    private final void zzb(zzdy zzdy) {
        ...
        try {
            ...
            if (zzbu == null || TextUtils.isEmpty(gmpAppId)) {
                ...
                c6197a.put("If-Modified-Since", gmpAppId);
                map = c6197a;
            }
            this.zzaql = true;
            zzfk zzkn = zzkn();
    ...
    private final void zzc(zzeu zzeu, zzdz zzdz) {
        ...
        if (!zzka.zzd(zzeu, zzdz)) {
            ...
            zzg(zzdz);
            if (("_iap".equals(zzeu.name) || C8740a.ECOMMERCE_PURCHASE.equals(zzeu.name)) && !zza(str, zzeu)) {
    ...
    private final zzjn zzkp() {
        AppMethodBeat.m2504i(69441);
        zza(this.zzaqe);
        zzjn zzjn = this.zzaqe;
        AppMethodBeat.m2505o(69441);
        return zzjn;
    }

    private final long zzkr() {
        AppMethodBeat.m2504i(69452);
        ...
        AppMethodBeat.m2505o(69452);
        return j;
    }

    private final boolean zzkt() {
        AppMethodBeat.m2504i(69461);
        zzab();
        zzkq();
        if (zzix().zzhs() || !TextUtils.isEmpty(zzix().zzhn())) {
            AppMethodBeat.m2505o(69461);
            return true;
        }
        AppMethodBeat.m2505o(69461);
        return false;
    ...
    private final boolean zzky() {
        AppMethodBeat.m2504i(69472);
        zzab();
        zzkq();
        if (this.zzaqg) {
            AppMethodBeat.m2505o(69472);
            return true;
        }
        AppMethodBeat.m2505o(69472);
        return false;
    ...
    public Context getContext() {
        AppMethodBeat.m2504i(69444);
        Context context = this.zzacw.getContext();
        AppMethodBeat.m2505o(69444);
        return context;
    }

    /* Access modifiers changed, original: protected */
    public void start() {
        AppMethodBeat.m2504i(69432);
        zzab();
        zzix().zzhp();
        if (zzgf().zzaju.get() == 0) {
            zzgf().zzaju.set(zzbt().currentTimeMillis());
        ...
        zzku();
        AppMethodBeat.m2505o(69432);
    }

    /* Access modifiers changed, original: protected|final */
    @VisibleForTesting
    public final void zza(int i, Throwable th, byte[] bArr, String str) {
        AppMethodBeat.m2504i(69460);
        zzab();
        zzkq();
        if (bArr == null) {
            try {
    ...
    public final void zza(zzjw zzjw) {
        ...
        this.zzvo = true;
        AppMethodBeat.m2505o(69431);
    }

    public final byte[] zza(zzeu zzeu, String str) {
        AppMethodBeat.m2504i(69482);
        zzkq();
        zzab();
        zzgl.zzfr();
    ...
    public void zzab() {
        AppMethodBeat.m2504i(69448);
        zzgd().zzab();
        AppMethodBeat.m2505o(69448);
    }

    /* Access modifiers changed, original: final */
    public final void zzb(zzed zzed, zzdz zzdz) {
        boolean z = true;
        AppMethodBeat.m2504i(69479);
    ...
    public final void zzb(zzjx zzjx, zzdz zzdz) {
        int i = 0;
        AppMethodBeat.m2504i(69475);
        zzab();
        zzkq();
        if (TextUtils.isEmpty(zzdz.zzadm)) {
            AppMethodBeat.m2505o(69475);
        } else if (zzdz.zzadw) {
    ...
    public Clock zzbt() {
        AppMethodBeat.m2504i(69445);
        Clock zzbt = this.zzacw.zzbt();
        AppMethodBeat.m2505o(69445);
        return zzbt;
    }

    /* Access modifiers changed, original: final */
    public final void zzc(zzed zzed, zzdz zzdz) {
        AppMethodBeat.m2504i(69480);
        Preconditions.checkNotNull(zzed);
        Preconditions.checkNotEmpty(zzed.packageName);
        Preconditions.checkNotNull(zzed.zzaep);
        Preconditions.checkNotEmpty(zzed.zzaep.name);
    ...
    public final void zzc(zzjx zzjx, zzdz zzdz) {
        AppMethodBeat.m2504i(69476);
        zzab();
        zzkq();
        if (TextUtils.isEmpty(zzdz.zzadm)) {
            AppMethodBeat.m2505o(69476);
        } else if (zzdz.zzadw) {
    ...
    public final zzdz zzcb(String str) {
        AppMethodBeat.m2504i(69478);
        zzdy zzbc = zzix().zzbc(str);
        if (zzbc == null || TextUtils.isEmpty(zzbc.zzag())) {
            zzge().zzis().zzg("No app data available; dropping", str);
            AppMethodBeat.m2505o(69478);
            return null;
        }
        Boolean zzc = zzc(zzbc);
    ...
    public final void zzd(zzdz zzdz) {
        ...
        AppMethodBeat.m2505o(69473);
    }

    /* Access modifiers changed, original: final */
    public final void zze(zzdz zzdz) {
        AppMethodBeat.m2504i(69451);
        zzab();
        zzkq();
        Preconditions.checkNotEmpty(zzdz.packageName);
        zzg(zzdz);
        AppMethodBeat.m2505o(69451);
    }

    public final void zzf(zzdz zzdz) {
        AppMethodBeat.m2504i(69477);
        zzab();
        zzkq();
        Preconditions.checkNotNull(zzdz);
        Preconditions.checkNotEmpty(zzdz.packageName);
        if (TextUtils.isEmpty(zzdz.zzadm)) {
            AppMethodBeat.m2505o(69477);
            return;
        }
        zzdy zzbc = zzix().zzbc(zzdz.packageName);
    ...
    public zzeo zzfw() {
        AppMethodBeat.m2504i(69447);
        zzeo zzfw = this.zzacw.zzfw();
        AppMethodBeat.m2505o(69447);
        return zzfw;
    }

    /* Access modifiers changed, original: final */
    public final void zzg(Runnable runnable) {
        AppMethodBeat.m2504i(69465);
        zzab();
        if (this.zzaqi == null) {
            this.zzaqi = new ArrayList();
        }
        this.zzaqi.add(runnable);
        AppMethodBeat.m2505o(69465);
    }

    public zzfe zzga() {
        AppMethodBeat.m2504i(69443);
        zzfe zzga = this.zzacw.zzga();
        AppMethodBeat.m2505o(69443);
        return zzga;
    }

    public zzka zzgb() {
        AppMethodBeat.m2504i(69446);
        zzka zzgb = this.zzacw.zzgb();
        AppMethodBeat.m2505o(69446);
        return zzgb;
    }

    public zzgg zzgd() {
        AppMethodBeat.m2504i(69436);
        zzgg zzgd = this.zzacw.zzgd();
        AppMethodBeat.m2505o(69436);
        return zzgd;
    }

    public zzfg zzge() {
        AppMethodBeat.m2504i(69435);
        zzfg zzge = this.zzacw.zzge();
        AppMethodBeat.m2505o(69435);
        return zzge;
    }

    public zzfr zzgf() {
        AppMethodBeat.m2504i(69434);
        zzfr zzgf = this.zzacw.zzgf();
        AppMethodBeat.m2505o(69434);
        return zzgf;
    }

    public zzef zzgg() {
        AppMethodBeat.m2504i(69433);
        zzef zzgg = this.zzacw.zzgg();
        AppMethodBeat.m2505o(69433);
        return zzgg;
    }

    public final String zzh(zzdz zzdz) {
        AppMethodBeat.m2504i(69483);
        try {
            String str = (String) zzgd().zzb(new zzju(this, zzdz)).get(30000, TimeUnit.MILLISECONDS);
            AppMethodBeat.m2505o(69483);
            return str;
    ...
    public final zzeb zziw() {
        AppMethodBeat.m2504i(69442);
        zza(this.zzaqf);
        zzeb zzeb = this.zzaqf;
        AppMethodBeat.m2505o(69442);
        return zzeb;
    }

    public final zzei zzix() {
        AppMethodBeat.m2504i(69439);
        zza(this.zzaqc);
        zzei zzei = this.zzaqc;
        AppMethodBeat.m2505o(69439);
        return zzei;
    }

    public final zzfk zzkn() {
        AppMethodBeat.m2504i(69438);
        zza(this.zzaqb);
        zzfk zzfk = this.zzaqb;
        AppMethodBeat.m2505o(69438);
        return zzfk;
    }

    /* Access modifiers changed, original: final */
    public final void zzkq() {
        AppMethodBeat.m2504i(69449);
        if (this.zzvo) {
            AppMethodBeat.m2505o(69449);
            return;
        }
    ...
    public final void zzm(boolean z) {
        AppMethodBeat.m2504i(69484);
        zzku();
        AppMethodBeat.m2505o(69484);
    }
}
