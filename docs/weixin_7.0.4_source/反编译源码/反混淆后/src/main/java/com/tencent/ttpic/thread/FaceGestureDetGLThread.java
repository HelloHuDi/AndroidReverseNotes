...
public class FaceGestureDetGLThread {
    ...
    private OnBodyDetListener mBodyListener = new C163582();
    ...
    /* renamed from: com.tencent.ttpic.thread.FaceGestureDetGLThread$2 */
    class C163582 implements OnBodyDetListener {
        C163582() {
        }

        public void onBodyDataReady(List<BodyDetectResult> list) {
            AppMethodBeat.m2504i(83746);
            FaceGestureDetGLThread.access$700(FaceGestureDetGLThread.this, list);
            AppMethodBeat.m2505o(83746);
        }
    }

    /* renamed from: com.tencent.ttpic.thread.FaceGestureDetGLThread$4 */
    class C244964 implements Runnable {
        C244964() {
        }

        public void run() {
            AppMethodBeat.m2504i(83748);
    ...
    /* renamed from: com.tencent.ttpic.thread.FaceGestureDetGLThread$6 */
    class C445626 implements Runnable {
        C445626() {
        }

        public void run() {
            AppMethodBeat.m2504i(83750);
            ...
            AppMethodBeat.m2505o(83750);
        }
    }

    /* renamed from: com.tencent.ttpic.thread.FaceGestureDetGLThread$7 */
    class C445637 implements Runnable {
        C445637() {
        }

        public void run() {
            AppMethodBeat.m2504i(83751);
            if (FaceGestureDetGLThread.this.mListener == null) {
                AppMethodBeat.m2505o(83751);
                return;
            }
    ...
    /* renamed from: com.tencent.ttpic.thread.FaceGestureDetGLThread$5 */
    class C445655 implements Runnable {
        C445655() {
        }

        public void run() {
            AppMethodBeat.m2504i(83749);
            BodyDetector.getInstance().reset();
            AppMethodBeat.m2505o(83749);
        }
    }
    ...
    public void postFaceGestureDet(C41672h c41672h, boolean z, boolean z2, boolean z3, double d) {
        AppMethodBeat.m2504i(83754);
        postFaceGestureDet(c41672h, z, z2, z3, d, false);
        AppMethodBeat.m2505o(83754);
    }

    public void postFaceGestureDet(C41672h c41672h, boolean z, boolean z2, boolean z3, double d, boolean z4) {
        AppMethodBeat.m2504i(83755);
        if (this.mHandler == null) {
            AppMethodBeat.m2505o(83755);
            return;
        }
        final C41672h c41672h2 = c41672h;
        final double d2 = d;
        final boolean z5 = z;
        final boolean z6 = z4;
        final boolean z7 = z2;
        ...
        this.mHandler.post(new Runnable() {
            public void run() {
                AppMethodBeat.m2504i(83747);
                long j = 0;
                if (BenchUtil.ENABLE_PERFORMANCE_RECORD) {
                    j = System.currentTimeMillis();
                }
                if (FaceGestureDetGLThread.this.mListener == null) {
                    AppMethodBeat.m2505o(83747);
                    return;
                }
                SegmentDataPipe freeTexturePileMakeBusy = FaceGestureDetGLThread.this.sharedData.getFreeTexturePileMakeBusy();
                if (freeTexturePileMakeBusy == null) {
                ...
                freeTexturePileMakeBusy.mTimestamp = System.currentTimeMillis();
                int i = (int) (((double) c41672h2.width) * d2);
                int i2 = (int) (((double) c41672h2.height) * d2);
                freeTexturePileMakeBusy.mTexFrame = c41672h2;
                byte[] retrieveData = RetrieveDataManager.getInstance().retrieveData(DATA_TYPE.RGBA.value, c41672h2.texture[0], i, i2);
    ...
    public void postFaceDetectorDestroy() {
        AppMethodBeat.m2504i(83756);
        if (this.mHandler == null) {
            AppMethodBeat.m2505o(83756);
            return;
        }
        this.mHandler.post(new C244964());
        AppMethodBeat.m2505o(83756);
    }

    private void setBodyResult(List<BodyDetectResult> list) {
        AppMethodBeat.m2504i(83757);
        synchronized (this.mBodyDetLock) {
            try {
                ...
                AppMethodBeat.m2505o(83757);
            }
        }
    }

    public void resetBodyDetector() {
        AppMethodBeat.m2504i(83758);
        if (this.mHandler != null) {
            this.mHandler.post(new C445655());
        }
        AppMethodBeat.m2505o(83758);
    }

    public void destroy() {
        AppMethodBeat.m2504i(83759);
        if (this.mHandler != null) {
            this.mHandler.post(new C445626());
        }
        this.SINGLE_THREAD_EXECUTOR.shutdownNow();
        AppMethodBeat.m2505o(83759);
    }

    public boolean needWait() {
        AppMethodBeat.m2504i(83760);
        if (this.sharedData == null) {
            AppMethodBeat.m2505o(83760);
            return true;
        }
    ...
    public void postUpdateParams(VideoFilterList videoFilterList) {
        AppMethodBeat.m2504i(83761);
        if (this.mHandler == null) {
            AppMethodBeat.m2505o(83761);
            return;
        }
        this.mHandler.post(new C445637());
        AppMethodBeat.m2505o(83761);
    }
    ...
    private void switchBrightnessAdjustment(byte[] bArr, final int i, final int i2) {
        AppMethodBeat.m2504i(83762);
        if (bArr == null) {
            AppMethodBeat.m2505o(83762);
            return;
        }
    ...
    private void createBrightnessCurve(int i, int i2, int i3, int i4, int i5, int i6, byte[] bArr) {
        ...
        AppMethodBeat.m2505o(83763);
    }

    public String getHistogramInfo() {
        AppMethodBeat.m2504i(83764);
        String str;
        if (this.his == null) {
            str = "";
            AppMethodBeat.m2505o(83764);
            return str;
        }
    ...
    private double[] sRGB2XYZ(double[] dArr) {
        ...
        AppMethodBeat.m2505o(83765);
        return dArr2;
    }

    private double[] XYZ2Lab(double[] dArr) {
        double pow;
        AppMethodBeat.m2504i(83766);
        double[] dArr2 = new double[3];
        double d = dArr[0];
        d /= 95.04d;
    ...
    private double getInterpolateValue(double d, double[] dArr, double[] dArr2, List<Double> list, List<Double> list2, List<Double> list3) {
        AppMethodBeat.m2504i(83767);
        int length = dArr.length - 1;
        double d2;
        if (d == dArr[length]) {
            d2 = dArr2[length];
            AppMethodBeat.m2505o(83767);
            return d2;
        }
        double d3;
        int i = 0;
