...
final class zzacb implements Cloneable {
    ...
    zzacb() {
        AppMethodBeat.m2504i(3494);
        AppMethodBeat.m2505o(3494);
    }

    private final byte[] toByteArray() {
        AppMethodBeat.m2504i(3501);
        byte[] bArr = new byte[zza()];
        zza(zzabw.zzj(bArr));
        AppMethodBeat.m2505o(3501);
        return bArr;
    }

    private final zzacb zzvg() {
        int i = 0;
        AppMethodBeat.m2504i(3502);
    ...
    public final /* synthetic */ Object clone() {
        AppMethodBeat.m2504i(3503);
        zzacb zzvg = zzvg();
        AppMethodBeat.m2505o(3503);
        return zzvg;
    }

    public final boolean equals(Object obj) {
        AppMethodBeat.m2504i(3499);
        if (obj == this) {
            AppMethodBeat.m2505o(3499);
            return true;
    ...
    public final int zza() {
        ...
        AppMethodBeat.m2505o(3497);
        return i;
    }

    /* Access modifiers changed, original: final */
    public final void zza(zzabw zzabw) {
        AppMethodBeat.m2504i(3498);
        if (this.value != null) {
            zzabz zzabz = this.zzbxe;
            Object obj = this.value;
            if (zzabz.zzbwy) {
    ...
    public final void zza(zzacg zzacg) {
        AppMethodBeat.m2504i(3495);
        if (this.zzbxf != null) {
            this.zzbxf.add(zzacg);
            AppMethodBeat.m2505o(3495);
            return;
        }
        Object zzb;
        if (this.value instanceof zzace) {
