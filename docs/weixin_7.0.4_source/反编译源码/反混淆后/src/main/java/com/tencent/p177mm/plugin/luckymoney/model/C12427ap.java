...
/* renamed from: com.tencent.mm.plugin.luckymoney.model.ap */
public final class C12427ap extends C34442ak {
    public String nSX;
    public String nYX;
    public String nYY;

    public C12427ap(int i, String str, String str2, String str3, String str4, String str5, int i2, String str6, int i3, String str7, int i4, int i5, String str8) {
        this(i, str, str2, str3, str4, str5, i2, "", "", str6, i3, str7, i4, i5, str8);
    }

    private C12427ap(int i, String str, String str2, String str3, String str4, String str5, int i2, String str6, String str7, String str8, int i3, String str9, int i4, int i5, String str10) {
        AppMethodBeat.m2504i(42419);
        ...
        if (!C5046bo.isNullOrNil(str5)) {
            hashMap.put("nickName", URLEncoder.encode(C5046bo.nullAsNil(str5)));
        }
