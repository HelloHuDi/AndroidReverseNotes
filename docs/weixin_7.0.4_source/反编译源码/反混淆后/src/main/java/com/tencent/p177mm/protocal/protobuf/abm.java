...
/* renamed from: com.tencent.mm.protocal.protobuf.abm */
public final class abm extends C1331a {
    public int vTN;
    public SKBuiltinBuffer_t vTO;

    /* renamed from: op */
    public final int mo4669op(int i, Object... objArr) {
        AppMethodBeat.m2504i(51413);
        C6092b c6092b;
        int bs;
        if (i == 0) {
            ...
            if (this.vTO == null) {
                ...
                AppMethodBeat.m2505o(51413);
                throw c6092b;
            }
            c6093a.mo13480iz(1, this.vTN);
            if (this.vTO != null) {
            ...
            bs = C6091a.m9572bs(1, this.vTN) + 0;
            if (this.vTO != null) {
