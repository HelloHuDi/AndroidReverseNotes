...
public final class zzi extends zzn<zzi> {
    ...
    public zzi() {
        AppMethodBeat.m2504i(70691);
        this.type = 1;
        this.zzgc = null;
        this.zzhc = null;
        this.zzhl = -1;
        AppMethodBeat.m2505o(70691);
    }

    private final zzi zzb(zzk zzk) {
        AppMethodBeat.m2504i(70696);
        while (true) {
            int zzj = zzk.zzj();
            switch (zzj) {
                case 0:
                    AppMethodBeat.m2505o(70696);
                    break;
                case 8:
    ...
    public final boolean equals(Object obj) {
        AppMethodBeat.m2504i(70692);
        if (obj == this) {
            AppMethodBeat.m2505o(70692);
            return true;
    ...
    public final int hashCode() {
        ...
        hashCode += i;
        AppMethodBeat.m2505o(70693);
        return hashCode;
    }

    public final void zza(zzl zzl) {
        AppMethodBeat.m2504i(70694);
        zzl.zzd(1, this.type);
        if (this.zzgc != null) {
            zzl.zza(2, this.zzgc);
        }
        super.zza(zzl);
        AppMethodBeat.m2505o(70694);
    }

    /* Access modifiers changed, original: protected|final */
    public final int zzg() {
        AppMethodBeat.m2504i(70695);
        int zzg = super.zzg() + zzl.zze(1, this.type);
        if (this.zzgc != null) {
            zzg += zzl.zzb(2, this.zzgc);
        }
        AppMethodBeat.m2505o(70695);
        return zzg;
    }
}
