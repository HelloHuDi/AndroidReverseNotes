...
class LegacyBitmap implements IBitmap<Bitmap> {
    ...
    @Keep
    public void recycle() {
        AppMethodBeat.m2504i(115751);
        if (this.aLX != null) {
            this.aLX.recycle();
        }
        AppMethodBeat.m2505o(115751);
    }

    public void decodeInputStream(InputStream inputStream, Config config, C37223c c37223c) {
        AppMethodBeat.m2504i(115750);
        ...
        if (!(this.aLX == null || this.aLX.getConfig() == Config.ARGB_8888)) {
            C17837c.m27918w("Ni.LegacyBitmap", "hy: config not argb-8888", new Object[0]);
