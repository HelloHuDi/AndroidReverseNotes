...
public final class PositionFilteredDataBuffer<T> extends FilteredDataBuffer<T> {
    ...
    public PositionFilteredDataBuffer(AbstractDataBuffer<T> abstractDataBuffer) {
        ...
        AppMethodBeat.m2504i(61162);
        zzcl();
        AppMethodBeat.m2505o(61162);
    }

    private final void zzcl() {
        AppMethodBeat.m2504i(61168);
        this.zzob.clear();
        ...
        AppMethodBeat.m2505o(61168);
    }

    public final void clearFilters() {
        AppMethodBeat.m2504i(61167);
        this.zzoe.clear();
        zzcl();
        AppMethodBeat.m2505o(61167);
    }

    public final int computeRealPosition(int i) {
        AppMethodBeat.m2504i(61164);
        if (i < 0 || i >= getCount()) {
