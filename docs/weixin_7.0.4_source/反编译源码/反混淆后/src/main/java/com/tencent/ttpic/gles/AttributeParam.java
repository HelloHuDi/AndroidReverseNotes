...
public class AttributeParam {
    ...
    public void initialParams(int i) {
        AppMethodBeat.m2504i(49945);
        this.handle = GLES20.glGetAttribLocation(i, this.name);
        AppMethodBeat.m2505o(49945);
    }

    public void setParams(int i) {
        AppMethodBeat.m2504i(49946);
        if (this.vertices == null) {
            AppMethodBeat.m2505o(49946);
            return;
        }
