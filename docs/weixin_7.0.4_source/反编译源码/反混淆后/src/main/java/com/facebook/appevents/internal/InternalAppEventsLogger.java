...
class InternalAppEventsLogger extends AppEventsLogger {
    InternalAppEventsLogger(Context context) {
        ...
        AppMethodBeat.m2504i(72211);
        AppMethodBeat.m2505o(72211);
    }
