...
public class CanvasFilters {
    ...
    public CanvasFilters() {
        AppMethodBeat.m2504i(82068);
        AppMethodBeat.m2505o(82068);
    }

    public RenderParam drawOnFrame(GridModel gridModel, C41672h c41672h, int i, int i2) {
        AppMethodBeat.m2504i(82069);
        if (gridModel == null || gridModel.canvasRect == null) {
            AppMethodBeat.m2505o(82069);
            return null;
        }
        RenderParam renderParam = new RenderParam();
        renderParam.texture = c41672h.texture[0];
        renderParam.texCords = calculateTexPosTriangles(gridModel, i, i2, gridModel.canvasRect.width, gridModel.canvasRect.height, c41672h.width, c41672h.height);
        renderParam.position = calculateVerPosTriangles(gridModel, i, i2, ((float) c41672h.width) / ((float) c41672h.height));
    ...
    private float[] calculateVerPosTriangles(GridModel gridModel, int i, int i2, float f) {
        ...
        float f4;
        float f5;
        AppMethodBeat.m2504i(82070);
        float f6 = ((float) i) / ((float) i2);
        if (((double) Math.abs(f6 - f)) < 1.0E-4d || gridModel.positionMode == 0) {
            calPositionsTriangles = AlgoUtils.calPositionsTriangles((float) gridModel.canvasRect.f1681x, (float) gridModel.canvasRect.f1682y, (float) (gridModel.canvasRect.f1681x + gridModel.canvasRect.width), (float) (gridModel.canvasRect.f1682y + gridModel.canvasRect.height), i, i2);
        } else if (f6 > f) {
            f2 = ((float) i2) * f;
            f6 = ((float) gridModel.canvasRect.f1681x) - ((((float) i) - f2) / 2.0f);
            f3 = (float) gridModel.canvasRect.f1682y;
            ...
            f2 = ((float) i) / f;
            f6 = (float) gridModel.canvasRect.f1681x;
            f3 = ((float) gridModel.canvasRect.f1682y) - ((((float) i2) - f2) / 2.0f);
    ...
    public void clearGLSLSelf() {
        AppMethodBeat.m2504i(82072);
        this.mDrawFilter.clearGLSLSelf();
        AppMethodBeat.m2505o(82072);
    }

    public void setRenderMode(int i) {
        AppMethodBeat.m2504i(82073);
        this.mDrawFilter.setRenderMode(i);
        AppMethodBeat.m2505o(82073);
    }

    public void ApplyGLSLFilter() {
        AppMethodBeat.m2504i(82074);
        this.mDrawFilter.ApplyGLSLFilter();
        AppMethodBeat.m2505o(82074);
    }
}
