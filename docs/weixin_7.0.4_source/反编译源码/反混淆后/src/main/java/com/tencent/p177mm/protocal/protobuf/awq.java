...
/* renamed from: com.tencent.mm.protocal.protobuf.awq */
public final class awq extends btd {
    public String ProductID;

    /* renamed from: op */
    public final int mo4669op(int i, Object... objArr) {
        AppMethodBeat.m2504i(62573);
        C6092b c6092b;
        int ix;
        if (i == 0) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        awq.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.m2505o(62573);
                    return 0;
                case 2:
                    awq.ProductID = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(62573);
                    return 0;
                default:
                    AppMethodBeat.m2505o(62573);
