...
public class ShareSecurityCheck {
    ...
    public ShareSecurityCheck(Context context) {
        ...
        if (AFf == null) {
            ...
            try {
                String cq = SharePatchFileUtil.m9377cq(context2.getPackageManager().getPackageInfo(context2.getPackageName(), 64).signatures[0].toByteArray());
                AFf = cq;
                if (cq == null) {
                    throw new TinkerRuntimeException("get public key md5 is null");
                }
                SharePatchFileUtil.m9369ah(null);
            } catch (Exception e) {
    ...
    /* renamed from: aw */
    public final boolean mo12704aw(File file) {
        Throwable e;
        JarFile jarFile;
                ...
                while (entries.hasMoreElements()) {
                    ...
                    if (jarEntry != null) {
                        ...
                        if (!name.startsWith("META-INF/") && name.endsWith("meta.txt")) {
                            this.AFg.put(name, SharePatchFileUtil.m9367a(jarFile2, jarEntry));
                            Certificate[] certificates = jarEntry.getCertificates();
                            if (certificates == null || !m9406a(file, certificates)) {
                                try {
                                    jarFile2.close();
    ...
    /* renamed from: a */
    private static boolean m9406a(File file, Certificate[] certificateArr) {
        if (certificateArr.length > 0) {
            int length = certificateArr.length - 1;
            while (length >= 0) {
                try {
                    if (AFf.equals(SharePatchFileUtil.m9377cq(certificateArr[length].getEncoded()))) {
                        return true;
                    }
                    length--;
                } catch (Exception e) {
