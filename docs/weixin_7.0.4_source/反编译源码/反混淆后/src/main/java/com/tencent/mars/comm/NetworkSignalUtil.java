...
public class NetworkSignalUtil {
    ...
    /* renamed from: com.tencent.mars.comm.NetworkSignalUtil$1 */
    static class C10181 extends PhoneStateListener {
        C10181() {
        }
    ...
    public static void InitNetworkSignalUtil(Context context) {
        context = context;
        ((TelephonyManager) context.getSystemService("phone")).listen(new C10181(), 256);
    }
    ...
    public static long getWifiSignalStrength() {
        ...
        if (connectionInfo == null || connectionInfo.getBSSID() == null) {
            C4990ab.m7418v("MicroMsg.NetworkSignalUtil", "Can Not Get Wifi Signal");
            return 0;
        }
        int calculateSignalLevel = WifiManager.calculateSignalLevel(connectionInfo.getRssi(), 10);
        C4990ab.m7418v("MicroMsg.NetworkSignalUtil", "Wifi Signal:" + (calculateSignalLevel * 10));
