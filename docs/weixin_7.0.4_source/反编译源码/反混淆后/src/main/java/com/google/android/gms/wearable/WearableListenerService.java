...
public class WearableListenerService extends Service implements CapabilityListener, ChannelListener, DataListener, MessageListener {
    ...
    final class zzc extends Handler {
        ...
        zzc(Looper looper) {
            super(looper);
            AppMethodBeat.m2504i(70918);
            AppMethodBeat.m2505o(70918);
        }

        @SuppressLint({"UntrackedBindService"})
        private final synchronized void zzb() {
            AppMethodBeat.m2504i(70921);
            if (this.started) {
                AppMethodBeat.m2505o(70921);
            } else {
        ...
        public final void dispatchMessage(Message message) {
            AppMethodBeat.m2504i(70919);
            zzb();
            try {
                super.dispatchMessage(message);
                if (hasMessages(0)) {
                    AppMethodBeat.m2505o(70919);
                    return;
                }
                zzb("dispatch");
                AppMethodBeat.m2505o(70919);
        ...
        public final void quit() {
            AppMethodBeat.m2504i(70920);
            getLooper().quit();
            zzb("quit");
            AppMethodBeat.m2505o(70920);
        }
    }
    ...
    final class zzd extends zzen {
        ...
        public final void onConnectedNodes(List<zzfo> list) {
            AppMethodBeat.m2504i(70927);
            zza(new zzp(this, list), "onConnectedNodes", list);
            AppMethodBeat.m2505o(70927);
        }

        public final void zza(DataHolder dataHolder) {
            AppMethodBeat.m2504i(70923);
    ...
    public Looper getLooper() {
        ...
        AppMethodBeat.m2505o(70937);
        return looper;
    }

    public final IBinder onBind(Intent intent) {
        AppMethodBeat.m2504i(70936);
        if (BIND_LISTENER_INTENT_ACTION.equals(intent.getAction())) {
            IBinder iBinder = this.zzae;
            AppMethodBeat.m2505o(70936);
            return iBinder;
        }
        AppMethodBeat.m2505o(70936);
        return null;
