...
public class Sprite2d {
    ...
    public Sprite2d(Drawable2d drawable2d) {
        ...
        AppMethodBeat.m2505o(50029);
    }

    private void recomputeMatrix() {
        AppMethodBeat.m2504i(50030);
    ...
    public float[] getModelViewMatrix() {
        AppMethodBeat.m2504i(50031);
        if (!this.mMatrixReady) {
            recomputeMatrix();
        }
        float[] fArr = this.mModelViewMatrix;
        AppMethodBeat.m2505o(50031);
        return fArr;
    }
    ...
    public void draw(Texture2dProgram texture2dProgram, float[] fArr) {
        ...
        AppMethodBeat.m2505o(50033);
    }

    public String toString() {
        AppMethodBeat.m2504i(50034);
