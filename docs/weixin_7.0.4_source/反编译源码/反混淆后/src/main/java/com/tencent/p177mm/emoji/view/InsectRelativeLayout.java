...
/* renamed from: com.tencent.mm.emoji.view.InsectRelativeLayout */
public class InsectRelativeLayout extends RelativeLayout {
    ...
    /* renamed from: com.tencent.mm.emoji.view.InsectRelativeLayout$a */
    static final class C9290a implements Runnable {
        final /* synthetic */ int eAt;
        final /* synthetic */ InsectRelativeLayout eAu;

        C9290a(InsectRelativeLayout insectRelativeLayout, int i) {
            this.eAu = insectRelativeLayout;
            this.eAt = i;
        }

        public final void run() {
            AppMethodBeat.m2504i(63321);
            this.eAu.setPadding(this.eAu.getPaddingLeft(), this.eAu.getPaddingTop(), this.eAu.getPaddingRight(), this.eAt);
            this.eAu.requestLayout();
            AppMethodBeat.m2505o(63321);
        }
    }
    ...
    public InsectRelativeLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        AppMethodBeat.m2504i(63323);
        this.TAG = "MicroMsg.InsectLayout";
        this.eAp = new Rect();
        this.eAq = new int[2];
        AppMethodBeat.m2505o(63323);
    }

    public InsectRelativeLayout(Context context, AttributeSet attributeSet) {
        C25052j.m39376p(context, "context");
        this(context, attributeSet, 0);
        AppMethodBeat.m2504i(63324);
        AppMethodBeat.m2505o(63324);
    }
    ...
    /* renamed from: jn */
    public boolean mo20726jn(int i) {
        return false;
    }

    /* Access modifiers changed, original: protected */
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        AppMethodBeat.m2504i(63322);
        C4990ab.m7416i(this.TAG, "InsectRelativeLayout onLayout");
        getWindowVisibleDisplayFrame(this.eAp);
        getLocationOnScreen(this.eAq);
        int i5 = ((i4 - i2) + this.eAq[1]) - this.eAp.bottom;
        boolean jn = mo20726jn(i5);
        if (!(jn || this.eAr == null)) {
            C17126b c17126b = this.eAr;
            if (c17126b == null) {
                C25052j.dWJ();
            }
            jn = ((Boolean) c17126b.mo50am(Integer.valueOf(i5))).booleanValue();
        }
        if (!(jn || getPaddingBottom() == i5)) {
            post(new C9290a(this, i5));
        }
        super.onLayout(z, i, i2, i3, i4);
        AppMethodBeat.m2505o(63322);
    }
}
