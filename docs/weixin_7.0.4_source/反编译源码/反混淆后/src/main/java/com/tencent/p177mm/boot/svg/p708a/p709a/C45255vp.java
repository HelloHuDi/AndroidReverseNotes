...
/* renamed from: com.tencent.mm.boot.svg.a.a.vp */
public final class C45255vp extends C5163c {
    ...
    public final int mo10620a(int i, Object... objArr) {
        switch (i) {
            ...
            case 2:
                ...
                canvas.save();
                float[] a = C5163c.m7878a(g, 1.0f, 0.0f, 15.0f, 0.0f, 1.0f, 0.0f);
                h.reset();
                h.setValues(a);
                canvas.concat(h);
                ...
                k.setColor(-10461088);
                g = C5163c.m7878a(a, 1.0f, 0.0f, 21.0f, 0.0f, 1.0f, 58.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                ...
                g = C5163c.m7878a(g, -1.0f, 0.0f, 76.23529f, 0.0f, 1.0f, 0.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                l = C5163c.m7884l(looper);
