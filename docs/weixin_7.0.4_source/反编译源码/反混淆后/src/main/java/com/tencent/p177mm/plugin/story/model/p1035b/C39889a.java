...
public final class C39889a {
    ...
    public final void aaG(String str) {
        AppMethodBeat.m2504i(138750);
        C25052j.m39376p(str, "<set-?>");
        this.rVl = str;
        AppMethodBeat.m2505o(138750);
    }

    public C39889a(cdv cdv) {
        boolean z;
        boolean z2 = true;
        C25052j.m39376p(cdv, "commentDetail");
        this();
        AppMethodBeat.m2504i(109260);
        this.rUJ = cdv.vQE;
        this.fDG = cdv.pcX;
        this.rVd = cdv.wZG;
        String str = cdv.ndG;
        ...
        this.toUser = str;
        this.rVm = cdv.wZF;
        AppMethodBeat.m2505o(109260);
    }

    public C39889a(cdw cdw) {
        boolean z;
        C25052j.m39376p(cdw, "commentOp");
        this();
        AppMethodBeat.m2504i(109261);
        this.rUJ = cdw.rUJ;
        String str = cdw.cEV;
        if (str == null) {
            str = "";
        ...
        this.rVm = cdw.rVm;
        this.rVn = false;
        AppMethodBeat.m2505o(109261);
    }

    public final String toString() {
        AppMethodBeat.m2504i(109259);
