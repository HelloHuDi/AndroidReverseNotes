...
public class SQLiteAsyncQuery extends SQLiteProgram {
    ...
    public SQLiteAsyncQuery(SQLiteDatabase sQLiteDatabase, String str, Object[] objArr, CancellationSignal cancellationSignal) {
        ...
        AppMethodBeat.m2504i(12264);
        AppMethodBeat.m2505o(12264);
    }

    /* Access modifiers changed, original: 0000 */
    public void acquire() {
        AppMethodBeat.m2504i(12265);
        if (this.mPreparedStatement == null) {
            acquirePreparedStatement();
            this.mPreparedStatement.bindArguments(getBindArgs());
        }
        AppMethodBeat.m2505o(12265);
    }

    /* Access modifiers changed, original: 0000 */
    public void release() {
        AppMethodBeat.m2504i(12266);
        releasePreparedStatement();
        AppMethodBeat.m2505o(12266);
    }

    /* Access modifiers changed, original: 0000 */
    public int fillRows(ChunkedCursorWindow chunkedCursorWindow, int i, int i2) {
        AppMethodBeat.m2504i(12267);
        acquire();
        ...
        try {
            ...
            AppMethodBeat.m2505o(12267);
            return nativeFillRows;
        } catch (SQLiteException e) {
            Log.m9444e(TAG, "Got exception on fillRows: " + e.getMessage() + ", SQL: " + getSql());
            checkCorruption(e);
            AppMethodBeat.m2505o(12267);
            throw e;
        }
    ...
    /* Access modifiers changed, original: 0000 */
    public int getCount() {
        AppMethodBeat.m2504i(12268);
        acquire();
        try {
            int nativeCount = nativeCount(this.mPreparedStatement.getPtr());
            AppMethodBeat.m2505o(12268);
            return nativeCount;
        } catch (SQLiteException e) {
            Log.m9444e(TAG, "Got exception on getCount: " + e.getMessage() + ", SQL: " + getSql());
            checkCorruption(e);
            AppMethodBeat.m2505o(12268);
            throw e;
        }
    ...
    /* Access modifiers changed, original: 0000 */
    public void reset() {
        AppMethodBeat.m2504i(12269);
        if (this.mPreparedStatement != null) {
            this.mPreparedStatement.reset(false);
        }
        AppMethodBeat.m2505o(12269);
    }
}
