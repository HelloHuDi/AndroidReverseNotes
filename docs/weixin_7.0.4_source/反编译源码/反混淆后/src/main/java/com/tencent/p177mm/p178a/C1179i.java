...
/* renamed from: com.tencent.mm.a.i */
public final class C1179i {
    /* renamed from: bL */
    public static int m2593bL(int i, int i2) {
        int i3 = 0;
        ...
        return (int) ((((long) C1179i.m2594s(bArr, 4)) & 4294967295L) % ((long) i2));
    }

    /* renamed from: s */
    public static int m2594s(byte[] bArr, int i) {
        int i2;
        int i3 = i ^ 0;
        int i4 = i >> 2;
        for (i2 = 0; i2 < i4; i2++) {
