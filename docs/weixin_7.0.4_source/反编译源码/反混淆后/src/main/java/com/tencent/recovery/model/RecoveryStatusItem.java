...
public class RecoveryStatusItem extends RecoveryPersistentItem {
    public static final Creator<RecoveryStatusItem> CREATOR = new C58021();
    public int AqZ;
    public int Arb;
    public int Arc;
    ...
    /* renamed from: com.tencent.recovery.model.RecoveryStatusItem$1 */
    static class C58021 implements Creator<RecoveryStatusItem> {
        C58021() {
        }
