...
final class zzel extends SQLiteOpenHelper {
    ...
    public final SQLiteDatabase getWritableDatabase() {
        SQLiteException e;
        AppMethodBeat.m2504i(68694);
        if (this.zzafi.zzafc.zzj(3600000)) {
            SQLiteDatabase writableDatabase;
            try {
                writableDatabase = super.getWritableDatabase();
                AppMethodBeat.m2505o(68694);
    ...
    public final void onCreate(SQLiteDatabase sQLiteDatabase) {
        AppMethodBeat.m2504i(68696);
        zzei.zza(this.zzafi.zzge(), sQLiteDatabase);
        AppMethodBeat.m2505o(68696);
    }
