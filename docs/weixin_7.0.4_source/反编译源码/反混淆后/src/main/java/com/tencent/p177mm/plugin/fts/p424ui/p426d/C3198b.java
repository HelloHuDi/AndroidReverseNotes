...
/* renamed from: com.tencent.mm.plugin.fts.ui.d.b */
public final class C3198b extends C39153a {
    public C3198b(Context context, C39133b c39133b, int i) {
        super(context, c39133b, i);
    }

    /* renamed from: a */
    public final C28106a mo7330a(C7306ak c7306ak, HashSet<String> hashSet) {
        AppMethodBeat.m2504i(62056);
        ...
        AppMethodBeat.m2505o(62056);
        return search;
    }

    /* renamed from: a */
    public final C3154a mo7331a(int i, C34203a c34203a) {
        AppMethodBeat.m2504i(62058);
        ...
        if (i2 < c34203a.mFf.size() && i2 >= 0) {
            ...
            if (c45966l.mDx.equals("create_chatroom​")) {
                c3154a = new C28140h(i);
                c3154a.mDz = c34203a.mDz;
            } else {
                C3154a c6925q = new C6925q(i);
                c6925q.hpS = c45966l;
