...
/* renamed from: com.tencent.mm.boot.svg.a.a.cr */
public final class C45194cr extends C5163c {
    ...
    public final int mo10620a(int i, Object... objArr) {
        switch (i) {
            ...
            case 2:
                ...
                a.setColor(-1);
                canvas.save();
                g = C5163c.m7878a(g, 1.0f, 0.0f, 8.0f, 0.0f, 1.0f, 27.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
                float[] a2 = C5163c.m7878a(g, 1.0f, 0.0f, 24.0f, 0.0f, 1.0f, 0.0f);
                h.reset();
                h.setValues(a2);
                canvas.concat(h);
                canvas.save();
                ...
                canvas.restore();
                canvas.save();
                g = C5163c.m7878a(a2, -1.0f, 0.0f, 40.0f, 0.0f, -1.0f, 26.0f);
                h.reset();
                h.setValues(g);
                canvas.concat(h);
                canvas.save();
