...
/* renamed from: com.tencent.d.f.c */
public final class C8768c {
    public static byte[] dQC() {
        AppMethodBeat.m2504i(114594);
        try {
    ...
    /* renamed from: a */
    private static void m15595a(byte[] bArr, int[] iArr) {
        int i;
        int i2;
    ...
    /* renamed from: a */
    private static void m15596a(int[] iArr, int i, byte[] bArr) {
        int i2;
        int length = bArr.length >> 2;
        if (length > i) {
            length = i;
    ...
    /* renamed from: cm */
    private static byte[] m15597cm(byte[] bArr) {
        AppMethodBeat.m2504i(114595);
        ...
        AppMethodBeat.m2505o(114595);
        return bArr;
    }

    /* renamed from: m */
    public static byte[] m15598m(byte[] bArr, byte[] bArr2) {
        AppMethodBeat.m2504i(114596);
        byte[] cm = C8768c.m15597cm(bArr2);
        if (bArr == null || cm == null || bArr.length == 0) {
            AppMethodBeat.m2505o(114596);
            return bArr;
        }
        int i;
        int length = bArr.length % 4 == 0 ? (bArr.length >>> 2) + 1 : (bArr.length >>> 2) + 2;
        int[] iArr = new int[length];
        C8768c.m15595a(bArr, iArr);
        ...
        while (true) {
            ...
            if (length > 0) {
                ...
                C8768c.m15596a(iArr, iArr.length, bArr);
                AppMethodBeat.m2505o(114596);
                return bArr;
            }
        }
    ...
    /* renamed from: n */
    public static byte[] m15599n(byte[] bArr, byte[] bArr2) {
        AppMethodBeat.m2504i(114597);
        byte[] cm = C8768c.m15597cm(bArr2);
        if (bArr == null || cm == null || bArr.length == 0) {
            AppMethodBeat.m2505o(114597);
            return bArr;
            ...
            C8768c.m15596a(iArr, iArr.length - 1, bArr);
            AppMethodBeat.m2505o(114597);
            return bArr;
        }
    }
