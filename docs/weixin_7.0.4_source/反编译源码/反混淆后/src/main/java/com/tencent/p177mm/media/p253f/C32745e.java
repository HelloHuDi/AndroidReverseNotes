...
public class C32745e {
    ...
    public float eWU;
    public float eWV;
    public final C1779d eWW;

    @C0220l(dWo = {1, 1, 13}, dWp = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u000b\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\b\b\u0018\u00002\u00020\u0001B\u0017\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u000b\u0010\u000b\u001a\u0004\u0018\u00010\u0003HÆ\u0003J\t\u0010\f\u001a\u00020\u0005HÆ\u0003J\u001f\u0010\r\u001a\u00020\u00002\n\b\u0002\u0010\u0002\u001a\u0004\u0018\u00010\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u0005HÆ\u0001J\u0013\u0010\u000e\u001a\u00020\u00052\b\u0010\u000f\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u0010\u001a\u00020\u0011HÖ\u0001J\t\u0010\u0012\u001a\u00020\u0013HÖ\u0001R\u0013\u0010\u0002\u001a\u0004\u0018\u00010\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u0014"}, dWq = {"Lcom/tencent/mm/media/mix/MixFrameSyncMgr$NextFrameInfo;", "", "mixBitmap", "Landroid/graphics/Bitmap;", "skip", "", "(Landroid/graphics/Bitmap;Z)V", "getMixBitmap", "()Landroid/graphics/Bitmap;", "getSkip", "()Z", "component1", "component2", "copy", "equals", "other", "hashCode", "", "toString", "", "plugin-mediaeditor_release"})
    /* renamed from: com.tencent.mm.media.f.e$a */
    public static final class C32746a {
        public final boolean cAi;
        public final Bitmap eWX;

        /* JADX WARNING: Missing block: B:9:0x0020, code skipped:
            if ((r5.cAi == r6.cAi) != false) goto L_0x0022;
     */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public final boolean equals(Object obj) {
            AppMethodBeat.m2504i(12998);
            if (this != obj) {
                if (obj instanceof C32746a) {
                    C32746a c32746a = (C32746a) obj;
                    if (C25052j.m39373j(this.eWX, c32746a.eWX)) {
                    }
                }
                AppMethodBeat.m2505o(12998);
                return false;
            }
            AppMethodBeat.m2505o(12998);
            return true;
        ...
        public final int hashCode() {
            ...
            i += hashCode;
            AppMethodBeat.m2505o(12997);
            return i;
        }

        public final String toString() {
            AppMethodBeat.m2504i(12996);
            String str = "NextFrameInfo(mixBitmap=" + this.eWX + ", skip=" + this.cAi + ")";
            AppMethodBeat.m2505o(12996);
            return str;
        }

        public C32746a(Bitmap bitmap, boolean z) {
            this.eWX = bitmap;
            this.cAi = z;
        }
    }

    public C32745e(String str, C1779d c1779d) {
        C25052j.m39376p(str, "videoPath");
        C25052j.m39376p(c1779d, "emojiFrameRetriever");
        AppMethodBeat.m2504i(12999);
        this.eWW = c1779d;
        C43528a WR = C21846d.m33388WR(str);
        if (WR instanceof C43528a) {
            this.eWJ = WR.eTk;
            this.eWK = WR.eWK;
            this.eWS = 1000.0f / ((float) WR.eTk);
            this.eWI = (int) (((double) this.eWJ) * (((double) this.eWK) / 1000.0d));
        } else {
            this.eWI = 0;
            this.eWJ = 0;
            this.eWS = 0.0f;
