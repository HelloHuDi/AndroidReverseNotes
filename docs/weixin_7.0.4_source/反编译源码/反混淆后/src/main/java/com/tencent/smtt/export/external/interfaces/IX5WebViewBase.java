    ...
    public static class HitTestResult {
        ...
        public class ImageData {
            ...
            public Bitmap getBitmap() {
                AppMethodBeat.m2504i(63817);
                Bitmap bitmapData = HitTestResult.this.getBitmapData();
                AppMethodBeat.m2505o(63817);
                return bitmapData;
            }
        }
        ...
        public class ImageAnchorData {
            ...
            public Bitmap getBitmap() {
                AppMethodBeat.m2504i(63816);
                Bitmap bitmapData = HitTestResult.this.getBitmapData();
                AppMethodBeat.m2505o(63816);
                return bitmapData;
            }
        }
        ...
        public Point getHitTestPoint() {
            AppMethodBeat.m2504i(63818);
            Point point = new Point(this.mPoint);
            AppMethodBeat.m2505o(63818);
            return point;
        }
