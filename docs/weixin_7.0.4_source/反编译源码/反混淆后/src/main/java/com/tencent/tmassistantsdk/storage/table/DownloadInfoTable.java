...
public class DownloadInfoTable implements ITableBase {
    ...
    public SqliteHelper getHelper() {
        AppMethodBeat.m2504i(76194);
        SqliteHelper instance = AstSDKDBHelper_V2.getInstance();
        AppMethodBeat.m2505o(76194);
        return instance;
    }
    ...
    private static int update(DownloadInfo downloadInfo, SQLiteDatabase sQLiteDatabase) {
        AppMethodBeat.m2504i(76199);
        if (downloadInfo == null) {
            AppMethodBeat.m2505o(76199);
            return -1;
        }
        try {
            ContentValues contentValues = new ContentValues();
        ...
        if (!(sQLiteDatabase2 == null || sQLiteDatabase == null)) {
            ...
            try {
                ...
                if (cursor == null || !cursor.moveToFirst()) {
                    ...
                    TMLog.m60588i(TABLE_NAME, "start move data!");
                    do {
                        ContentValues contentValues = new ContentValues();
                ...
                C4990ab.printErrStackTrace(TAG, e, "", new Object[0]);
                TMLog.m60588i(TABLE_NAME, "move data exception!");
                if (cursor != null) {
                    cursor.close();
                }
            } catch (Throwable th) {
