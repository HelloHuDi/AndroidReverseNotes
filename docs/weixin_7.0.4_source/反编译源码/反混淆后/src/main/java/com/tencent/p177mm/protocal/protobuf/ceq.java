...
/* renamed from: com.tencent.mm.protocal.protobuf.ceq */
public final class ceq extends C1331a {
    public int qQn;
    public long qQp;

    /* renamed from: op */
    public final int mo4669op(int i, Object... objArr) {
        AppMethodBeat.m2504i(56533);
        int o;
        if (i == 0) {
            C6093a c6093a = (C6093a) objArr[0];
            c6093a.mo13472ai(1, this.qQp);
            c6093a.mo13480iz(2, this.qQn);
            AppMethodBeat.m2505o(56533);
            return 0;
        } else if (i == 1) {
            ...
            switch (((Integer) objArr[2]).intValue()) {
                case 1:
                    ceq.qQp = c6086a2.BTU.mo13459ve();
                    AppMethodBeat.m2505o(56533);
                    return 0;
                case 2:
                    ceq.qQn = c6086a2.BTU.mo13458vd();
                    AppMethodBeat.m2505o(56533);
                    return 0;
                default:
                    AppMethodBeat.m2505o(56533);
