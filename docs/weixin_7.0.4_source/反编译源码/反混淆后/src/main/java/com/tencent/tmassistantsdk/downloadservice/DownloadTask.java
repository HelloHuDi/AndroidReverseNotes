...
public class DownloadTask {
    ...
    /* renamed from: com.tencent.tmassistantsdk.downloadservice.DownloadTask$1 */
    class C163251 implements Runnable {
        C163251() {
        }

        public void run() {
            AppMethodBeat.m2504i(75743);
            DownloadTask.access$000(DownloadTask.this);
            AppMethodBeat.m2505o(75743);
        }
    }

    static /* synthetic */ void access$000(DownloadTask downloadTask) {
        AppMethodBeat.m2504i(75756);
        downloadTask.cancelInWorkThread();
        AppMethodBeat.m2505o(75756);
    }

    public DownloadTask(DownloadInfo downloadInfo) {
        AppMethodBeat.m2504i(75744);
        this.mDownloadInfo = downloadInfo;
        AppMethodBeat.m2505o(75744);
    }
    ...
    public void cancel() {
        AppMethodBeat.m2504i(75745);
        TMLog.m60588i(TAG, "DownloadTask::cancel url: " + this.mDownloadInfo.mURL);
        if (Thread.currentThread().getId() == Looper.getMainLooper().getThread().getId()) {
            C18514l.post(new C163251());
            AppMethodBeat.m2505o(75745);
            return;
        }
        cancelInWorkThread();
        AppMethodBeat.m2505o(75745);
    ...
    private void cancelInWorkThread() {
        AppMethodBeat.m2504i(75746);
        this.mStopTask = true;
        if (!(this.mHttpGet == null || this.mHttpGet.isAborted())) {
            this.mHttpGet.abort();
        }
        AppMethodBeat.m2505o(75746);
    }
    ...
    public void exec(String str) {
        ...
        while (z2) {
            ...
            try {
                ...
                if (!this.mIsRedirect || this.mRequestUrl == null || this.mRequestUrl.length() == 0) {
                    if (z) {
                        Ij = C38842c.m65894Ij(this.mDownloadInfo.mSecondaryUrl);
                    } else {
                        Ij = C38842c.m65894Ij(this.mDownloadInfo.mRequestURL);
                    }
                    this.mRequestUrl = Ij;
                } else {
                    Ij = this.mRequestUrl;
                }
                TMLog.m60588i(TAG, "is redirect request: " + this.mIsRedirect);
                TMLog.m60588i(TAG, "changeUrl = ".concat(String.valueOf(z)));
                TMLog.m60588i(TAG, "url = ".concat(String.valueOf(Ij)));
                ...
                TMLog.m60588i(TAG, "start httpGet " + Thread.currentThread().getName());
                ...
                if (this.mStopTask) {
                    ...
                    TMLog.m60588i(TAG, "ConnectTimeoutException " + Thread.currentThread().getName());
                ...
                if (this.mStopTask) {
                    ...
                    TMLog.m60588i(TAG, "SocketTimeoutException " + Thread.currentThread().getName());
                ...
                if (this.mStopTask) {
                    ...
                    TMLog.m60588i(TAG, "UnknownHostException " + Thread.currentThread().getName());
                ...
                if (!this.mStopTask) {
                    TMLog.m60588i(TAG, "InterruptedException " + Thread.currentThread().getName());
                    C4990ab.printErrStackTrace(TAG, e4, "", new Object[0]);
                ...
                if (!this.mStopTask) {
                    TMLog.m60588i(TAG, "SSLHandshakeException " + Thread.currentThread().getName());
                ...
                if (this.mStopTask) {
                    ...
                    TMLog.m60588i(TAG, "IOException " + Thread.currentThread().getName());
                    C4990ab.printErrStackTrace(TAG, e6, "", new Object[0]);
                    z3 = shouldRetryConnect();
                    if (!z3) {
                ...
                if (this.mStopTask) {
                    ...
                    TMLog.m60588i(TAG, "StopRequestException, errCode = " + stopRequestException2.mFinalErrCode + " " + Thread.currentThread().getName());
                    C4990ab.printErrStackTrace(TAG, stopRequestException2, "", new Object[0]);
        ...
        TMLog.m60588i(TAG, "mStopTask = " + this.mStopTask + " " + Thread.currentThread().getName());
        if (this.mStopTask) {
            this.mDownloadInfo.mDownloadFailedErrCode = 0;
        } else {
            TMLog.m60588i(TAG, "download finished, " + Thread.currentThread().getName() + ",finalstatus: " + this.mDownloadInfo.mStatus + " errCode: " + this.mDownloadInfo.mDownloadFailedErrCode);
            if (this.mDownloadInfo.hasReceivedAllDataBytes()) {
    ...
    private boolean shouldRetryConnect() {
        boolean z = false;
        AppMethodBeat.m2504i(75748);
        if (this.mStopTask) {
            TMLog.m60588i(TAG, "mStopTask = " + this.mStopTask);
            AppMethodBeat.m2505o(75748);
        } else {
            try {
                Thread.sleep(5000);
            ...
            if (!DownloadHelper.isNetworkConncted()) {
                TMLog.m60588i(TAG, "network unconnected");
                AppMethodBeat.m2505o(75748);
                ...
                TMLog.m60588i(TAG, "shouldRetryConnect(" + z + "), retryCnt = " + this.mDownloadInfo.mRetryCnt);
                AppMethodBeat.m2505o(75748);
            } else {
                TMLog.m60588i(TAG, "not equal netType, current: " + DownloadHelper.getNetStatus() + ", startNetType: " + this.startDownloadNetType);
                AppMethodBeat.m2505o(75748);
            }
        }
        return z;
        ...
        switch (statusCode) {
            ...
            case 307:
                if (this.mDownloadInfo.mRedirectCnt > 5) {
                    TMLog.m60588i(TAG, "mRedirectCnt = " + this.mDownloadInfo.mRedirectCnt + ",MAX_REDIRESTS = 5");
                    stopRequestException = new StopRequestException(709, "Redirect cnt many times.");
                    AppMethodBeat.m2505o(75750);
                    throw stopRequestException;
                }
                Header firstHeader = httpResponse.getFirstHeader(C8741b.LOCATION);
                if (firstHeader != null) {
                    String value2 = firstHeader.getValue();
                    TMLog.m60588i(TAG, "jumpURL = ".concat(String.valueOf(value2)));
                ...
                TMLog.m60587e(TAG, "location header is null. httpResponseCode = ".concat(String.valueOf(statusCode)));
    ...
    private boolean verifyTotalLen(HttpResponse httpResponse, HttpEntity httpEntity) {
        AppMethodBeat.m2504i(75751);
        long contentLength;
        if (httpResponse.getStatusLine().getStatusCode() == 200) {
            contentLength = httpEntity.getContentLength();
            TMLog.m60588i(TAG, "verifyTotalLen,totalLen = " + contentLength + "mRequestFileSize = " + this.mDownloadInfo.mRequestFileSize);
    ...
    /* JADX WARNING: Missing block: B:73:0x02ca, code skipped:
            ...
            com.tencent.tmassistantsdk.util.TMLog.m60590w(TAG, r0);
            r1 = new com.tencent.tmassistantsdk.downloadservice.StopRequestException(703, r0);
            com.tencent.matrix.trace.core.AppMethodBeat.m2505o(75752);
     */
    ...
    private void onReceivedResponseData(HttpResponse httpResponse, DownloadChunkLogInfo downloadChunkLogInfo) {
        ...
        if (verifyTotalLen(httpResponse, entity)) {
            ...
            if (this.mDownloadInfo.getTotalSize() == 0) {
                if (httpResponse.getStatusLine().getStatusCode() == 200) {
                    ...
                    TMLog.m60588i(TAG, "HTTPCode 200, totalBytes:" + this.mDownloadInfo.getTotalSize());
                } else if (httpResponse.getStatusLine().getStatusCode() == 206) {
                    this.mDownloadInfo.setTotalSize(ByteRange.getTotalSize(httpResponse.getFirstHeader("content-range").getValue()));
                    TMLog.m60588i(TAG, "HTTPCode 206, totalBytes:" + this.mDownloadInfo.getTotalSize());
                } else {
                    TMLog.m60590w(TAG, "statusCode=" + httpResponse.getStatusLine().getStatusCode() + " onReceivedResponseData error.");
                }
                TMLog.m60590w(TAG, "first start downloadinfoTotalSize = " + this.mDownloadInfo.getTotalSize());
                ...
                try {
                    ...
                    TMLog.m60590w(TAG, "totalSize = " + totalSize + "  downloadinfoTotalSize = " + this.mDownloadInfo.getTotalSize());
                    TMLog.m60588i(TAG, "mReceivedBytes = " + this.mDownloadInfo.mReceivedBytes);
                    TMLog.m60588i(TAG, "start = " + parseContentRange2.getStart() + ", end = " + parseContentRange2.getEnd());
                    if (parseContentRange2.getStart() != this.mDownloadInfo.mReceivedBytes) {
                        ...
                        TMLog.m60586d(TAG, "response ByteRange: ".concat(String.valueOf(firstHeader)));
                        if (this.mSaveFile != null) {
                            this.mSaveFile.close();
                            this.mSaveFile = null;
                        }
            ...
            try {
                ...
                TMLog.m60588i(TAG, "start write file, fileName: " + this.mDownloadInfo.mFileName);
                long j2 = 0;
                while (true) {
                    try {
        ...
        TMLog.m60588i(TAG, "verifyTotalLen false");
    ...
    private void renameApkFileName(HttpResponse httpResponse) {
        AppMethodBeat.m2504i(75754);
        if (httpResponse == null) {
            AppMethodBeat.m2505o(75754);
            return;
        }
        if (this.mDownloadInfo.mContentType.equals("application/vnd.android.package-archive")) {
            ...
            if (headers == null || headers.length <= 0) {
                ...
                String value = headers[0].getValue();
                TMLog.m60588i(TAG, "headerFileName = ".concat(String.valueOf(value)));
                if (TextUtils.isEmpty(value) || !value.contains("filename=\"")) {
                    ...
                    if (!TextUtils.isEmpty(value)) {
                        ...
                        TMLog.m60588i(TAG, "header file Name =".concat(String.valueOf(charSequence)));
                    }
                }
            }
    ...
    private void setExtraHeaderParam(HttpGet httpGet, Map<String, String> map) {
        AppMethodBeat.m2504i(75755);
        if (!(httpGet == null || map == null || map.size() <= 0)) {
            for (Entry entry : map.entrySet()) {
                httpGet.addHeader((String) entry.getKey(), (String) entry.getValue());
            }
        }
        AppMethodBeat.m2505o(75755);
    }
}
