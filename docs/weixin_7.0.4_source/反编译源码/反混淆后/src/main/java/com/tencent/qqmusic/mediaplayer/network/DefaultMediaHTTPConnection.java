...
public class DefaultMediaHTTPConnection implements IMediaHTTPConnection {
    ...
    public boolean connect(URL url, Map<String, String> map) {
        AppMethodBeat.m2504i(104788);
        disconnect();
        this.mAllowCrossDomainRedirect = true;
        this.mURL = url;
        this.mHeaders = map;
        AppMethodBeat.m2505o(104788);
        return true;
    }

    private boolean parseBoolean(String str) {
        AppMethodBeat.m2504i(104789);
        try {
            if (Long.parseLong(str) != 0) {
                AppMethodBeat.m2505o(104789);
                return true;
            }
            AppMethodBeat.m2505o(104789);
            return false;
    ...
    public void disconnect() {
        AppMethodBeat.m2504i(104791);
        teardownConnection();
        this.mHeaders = null;
        this.mURL = null;
        AppMethodBeat.m2505o(104791);
    }

    private void teardownConnection() {
        AppMethodBeat.m2504i(104792);
        ...
        AppMethodBeat.m2505o(104792);
    }

    private static final boolean isLocalHost(URL url) {
        AppMethodBeat.m2504i(104793);
        if (url == null) {
            AppMethodBeat.m2505o(104793);
            return false;
        }
        ...
        try {
            ...
            Logger.m71022e(TAG, "isLocalHost", e);
        }
        AppMethodBeat.m2505o(104793);
        return false;
    }
    ...
    /* JADX WARNING: Missing block: B:99:0x0241, code skipped:
            ...
            com.tencent.matrix.trace.core.AppMethodBeat.m2505o(104794);
     */
    ...
    private void seekTo(long j) {
        ...
        try {
            ...
            while (true) {
                ...
                Logger.m71025i(TAG, "setConnectTimeout " + this.mURL);
    ...
    public int readAt(long j, byte[] bArr, int i, int i2) {
        ...
        try {
            ...
            AppMethodBeat.m2505o(104795);
            return read;
        } catch (ProtocolException e) {
            Logger.m71027w(TAG, "readAt " + j + " / " + i2 + " => " + e);
            AppMethodBeat.m2505o(104795);
            return -1010;
        } catch (NoRouteToHostException e2) {
            Logger.m71027w(TAG, "readAt " + j + " / " + i2 + " => " + e2);
            AppMethodBeat.m2505o(104795);
            return -1010;
        } catch (UnknownServiceException e3) {
            Logger.m71027w(TAG, "readAt " + j + " / " + i2 + " => " + e3);
            AppMethodBeat.m2505o(104795);
            return -1010;
    ...
    public long getSize() {
        AppMethodBeat.m2504i(104796);
        if (this.mConnection == null) {
            try {
                seekTo(0);
            } catch (IOException e) {
                Logger.m71022e(TAG, "getSize", e);
                AppMethodBeat.m2505o(104796);
                return -1;
            }
        }
    ...
    public String getMIMEType() {
        String str;
        AppMethodBeat.m2504i(104797);
        if (this.mConnection == null) {
            try {
                seekTo(0);
            } catch (IOException e) {
                Logger.m71022e(TAG, "getMIMEType", e);
                str = "application/octet-stream";
                AppMethodBeat.m2505o(104797);
                return str;
            }
        }
    ...
    public String getUri() {
        AppMethodBeat.m2504i(104798);
        String url = this.mURL.toString();
        AppMethodBeat.m2505o(104798);
        return url;
    }
}
