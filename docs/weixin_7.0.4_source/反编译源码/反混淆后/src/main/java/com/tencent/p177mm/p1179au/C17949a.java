...
/* renamed from: com.tencent.mm.au.a */
public final class C17949a {
    /* renamed from: sK */
    public static int m28208sK(String str) {
        int i = 0;
        AppMethodBeat.m2504i(59950);
        if (str == null || str.length() <= 0) {
            C4990ab.m7412e("Big5Util", "getStrokesCount buffer is empty");
            AppMethodBeat.m2505o(59950);
        } else {
            try {
                int i2;
                byte[] bytes = str.getBytes("big5");
                if (bytes == null || bytes.length < 2) {
                    C4990ab.m7412e("Big5Util", "byteToShort");
                    i2 = 0;
                } else {
                    int i3 = 0;
                    for (i2 = 0; i2 < 2; i2++) {
                ...
                C4990ab.m7413e("Big5Util", "exception:%s", C5046bo.m7574l(e));
            }
        }
        return i;
    }
