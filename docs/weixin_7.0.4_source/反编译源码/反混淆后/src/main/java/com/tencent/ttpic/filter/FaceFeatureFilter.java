...
public class FaceFeatureFilter extends VideoFilterBase {
    ...
    static {
        AppMethodBeat.m2504i(82359);
        AppMethodBeat.m2505o(82359);
    }

    public FaceFeatureFilter() {
        super(VERTEX_SHADER, FRAGMENT_SHADER);
        AppMethodBeat.m2504i(82341);
    ...
    public void setFaceFeatureParam(FaceFeatureParam faceFeatureParam) {
        ...
        initFaceImage();
        AppMethodBeat.m2505o(82344);
    }

    public void setNormalAlphaValue(float f) {
        AppMethodBeat.m2504i(82345);
        this.alphaNormal = f;
        addParam(new C0933f("alphaNormal", this.alphaNormal * this.factorNormal));
        AppMethodBeat.m2505o(82345);
    }

    public void setMultiplyAlphaValue(float f) {
        AppMethodBeat.m2504i(82346);
        this.alphaMultiply = f;
        addParam(new C0933f("alphaMultiply", this.alphaMultiply));
        AppMethodBeat.m2505o(82346);
    }

    public void setSoftlightAlphaValue(float f) {
        AppMethodBeat.m2504i(82347);
        this.alphaSoftlight = f;
        addParam(new C0933f("alphaSoftlight", this.alphaSoftlight));
        AppMethodBeat.m2505o(82347);
    }

    public void updateParam(float[] fArr) {
        AppMethodBeat.m2504i(82348);
        setPositions(fArr);
        updateTextureParams();
        AppMethodBeat.m2505o(82348);
    }

    public void initAttribParams() {
        AppMethodBeat.m2504i(82349);
        super.initAttribParams();
        initFaceTexCoords();
        setDrawMode(DRAW_MODE.TRIANGLES);
        setCoordNum(690);
        AppMethodBeat.m2505o(82349);
    }

    private void initFaceTexCoords() {
        AppMethodBeat.m2504i(82350);
        ...
        AppMethodBeat.m2505o(82350);
    }

    public void updateVideoSize(int i, int i2, double d) {
        AppMethodBeat.m2504i(82351);
        super.updateVideoSize(i, i2, d);
        addParam(new C25629b("canvasSize", (float) i, (float) i2));
        AppMethodBeat.m2505o(82351);
    }

    public boolean renderTexture(int i, int i2, int i3) {
        AppMethodBeat.m2504i(82352);
    ...
    public void updateTextureParams() {
        AppMethodBeat.m2504i(82353);
        initFaceImage();
        AppMethodBeat.m2505o(82353);
    }

    private boolean initFaceImage() {
        AppMethodBeat.m2504i(82354);
    ...
    public void ApplyGLSLFilter() {
        AppMethodBeat.m2504i(82355);
        super.ApplyGLSLFilter();
        GLES20.glGenTextures(this.texture.length, this.texture, 0);
        AppMethodBeat.m2505o(82355);
    }

    public void clearGLSLSelf() {
        AppMethodBeat.m2504i(82356);
        GLES20.glDeleteTextures(this.texture.length, this.texture, 0);
        this.isSoftLiteImageReady = false;
        super.clearGLSLSelf();
        AppMethodBeat.m2505o(82356);
    }

    public boolean needRender() {
        AppMethodBeat.m2504i(82357);
        updateTextureParams();
        if (this.isSoftLiteImageReady && this.isMultiplyImageReady && this.isNormalImageReady) {
            AppMethodBeat.m2505o(82357);
            return true;
        }
        AppMethodBeat.m2505o(82357);
        return false;
    ...
    public void setNormalAlphaFactor(float f) {
        AppMethodBeat.m2504i(82358);
        this.factorNormal = f;
        setNormalAlphaValue(this.alphaNormal);
        AppMethodBeat.m2505o(82358);
    }
}
