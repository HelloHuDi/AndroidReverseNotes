...
/* renamed from: com.tencent.mm.protocal.protobuf.aie */
public final class aie extends btd {
    public String content;

    /* renamed from: op */
    public final int mo4669op(int i, Object... objArr) {
        AppMethodBeat.m2504i(28435);
        C6092b c6092b;
        int ix;
        if (i == 0) {
            ...
            if (this.content != null) {
                ix += C6091a.m9575f(2, this.content);
            }
            AppMethodBeat.m2505o(28435);
            return ix;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        aie.BaseResponse = baseResponse;
                    }
                    AppMethodBeat.m2505o(28435);
                    return 0;
                case 2:
                    aie.content = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(28435);
                    return 0;
                default:
                    AppMethodBeat.m2505o(28435);
