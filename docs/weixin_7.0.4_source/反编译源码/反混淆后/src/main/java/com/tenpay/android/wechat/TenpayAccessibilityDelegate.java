...
public class TenpayAccessibilityDelegate extends AccessibilityDelegate {
    public void sendAccessibilityEvent(View view, int i) {
        AppMethodBeat.m2504i(5494);
        LogUtil.m71577d("CFT", "sendAccessibilityEvent eventType=".concat(String.valueOf(i)));
        if (view != null && i == 128) {
            Object contentDescription;
            if (view instanceof EditText) {
                LogUtil.m71577d("CFT", "EditText");
                ...
                LogUtil.m71577d("CFT", "not EditText");
                contentDescription = view.getContentDescription();
                TenpayTTSUtil.speak((CharSequence) contentDescription);
            }
            LogUtil.m71577d("CFT", "content = ".concat(String.valueOf(contentDescription)));
            LogUtil.m71577d("CFT", "host.getContentDescription() = " + view.getContentDescription());
            if (!TextUtils.isEmpty(contentDescription)) {
