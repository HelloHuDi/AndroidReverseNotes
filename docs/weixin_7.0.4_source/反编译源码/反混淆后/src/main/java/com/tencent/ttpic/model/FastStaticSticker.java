...
public class FastStaticSticker extends FastSticker {
    ...
    public FastStaticSticker(StickerItem stickerItem, String str) {
        ...
        AppMethodBeat.m2504i(83491);
        initRelativeParams();
        this.renderParam.texScale = 1.0f;
        AppMethodBeat.m2505o(83491);
    }

    public void updateVideoSize(int i, int i2, double d) {
        AppMethodBeat.m2504i(83492);
        super.updateVideoSize(i, i2, d);
        initPositionAdjusted();
        AppMethodBeat.m2505o(83492);
    }

    /* Access modifiers changed, original: protected */
    public void updatePositions(List<PointF> list, float[] fArr) {
        AppMethodBeat.m2504i(83493);
        if (this.initialized) {
            AppMethodBeat.m2505o(83493);
            return;
        }
        initPositionAdjusted();
        AppMethodBeat.m2505o(83493);
    ...
    public void updatePositions(List<PointF> list) {
        AppMethodBeat.m2504i(83494);
        if (this.initialized) {
            AppMethodBeat.m2505o(83494);
            return;
        }
        initPositionAdjusted();
        AppMethodBeat.m2505o(83494);
    ...
    public void clearTextureParam() {
        AppMethodBeat.m2504i(83495);
        super.clearTextureParam();
        this.initialized = false;
        AppMethodBeat.m2505o(83495);
    }

    public void initPositionAdjusted() {
        AppMethodBeat.m2504i(83496);
