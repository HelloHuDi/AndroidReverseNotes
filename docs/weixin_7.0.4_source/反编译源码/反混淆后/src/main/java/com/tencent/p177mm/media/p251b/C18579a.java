...
/* renamed from: com.tencent.mm.media.b.a */
public class C18579a {
    static final String TAG = TAG;
    public static final C1771a eTg = new C1771a();
    ...
    /* renamed from: com.tencent.mm.media.b.a$a */
    public static final class C1771a {
        private C1771a() {
        }

        public /* synthetic */ C1771a(byte b) {
            this();
        }
    }

    static {
        AppMethodBeat.m2504i(12847);
        AppMethodBeat.m2505o(12847);
    }

    /* renamed from: a */
    public final void mo33813a(MediaCodecInfo mediaCodecInfo, MediaFormat mediaFormat) {
        AppMethodBeat.m2504i(12846);
                ...
                if (capabilitiesForType != null) {
                    ...
                    if (codecProfileLevelArr != null) {
                        ...
                        for (CodecProfileLevel codecProfileLevel2 : codecProfileLevelArr) {
                            ...
                            C4990ab.m7417i(TAG, "profile: %s, level: %s", Integer.valueOf(i), Integer.valueOf(i2));
                            switch (i) {
                                case 1:
                                case 2:
                                case 8:
                        ...
                        C4990ab.m7417i(TAG, "best profile: %s, level: %s", Integer.valueOf(codecProfileLevel.profile), Integer.valueOf(codecProfileLevel.level));
                        if (codecProfileLevel.profile > 0 && codecProfileLevel.level >= 256) {
                            ...
                            AppMethodBeat.m2505o(12846);
                            return;
                        }
                    }
                }
            } catch (Exception e) {
                C4990ab.m7413e(TAG, "trySetProfile error: %s", e.getMessage());
            }
        }
        AppMethodBeat.m2505o(12846);
    }
