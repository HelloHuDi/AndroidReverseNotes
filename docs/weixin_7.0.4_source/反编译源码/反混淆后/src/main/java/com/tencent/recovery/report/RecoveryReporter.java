...
public class RecoveryReporter {
    /* renamed from: iA */
    private static File m8729iA(Context context) {
    ...
    /* renamed from: a */
    public static boolean m8726a(Context context, String str, RecoveryPersistentItem recoveryPersistentItem) {
        Throwable e;
        File iA = m8729iA(context);
        RecoveryLog.m8712i("Recovery.RecoveryReporter", "addItem %s", recoveryPersistentItem.dQf());
        File file = new File(iA, str);
        if (file.length() > 2097152) {
            RecoveryLog.m8712i("Recovery.RecoveryReporter", "addItem file size large than 5MB", new Object[0]);
            file.delete();
        }
        if (!file.exists()) {
            try {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    /* renamed from: c */
    public static boolean m8728c(Context context, String str, List<? extends RecoveryPersistentItem> list) {
        Throwable e;
        RecoveryLog.m8712i("Recovery.RecoveryReporter", "addItemList %s %d", str, Integer.valueOf(list.size()));
        File file = new File(m8729iA(context), str);
        if (file.length() > 2097152) {
            RecoveryLog.m8712i("Recovery.RecoveryReporter", "addItem file size large than 5MB", new Object[0]);
            file.delete();
        }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    /* renamed from: a */
    public static <T extends RecoveryPersistentItem> List<T> m8725a(Context context, String str, Class<T> cls) {
        Throwable e;
        File iA = m8729iA(context);
        LinkedList linkedList = new LinkedList();
        File file = new File(iA, str);
        if (file.length() > 2097152) {
            RecoveryLog.m8712i("Recovery.RecoveryReporter", "getItemList file size large than 5MB", new Object[0]);
            file.delete();
            return linkedList;
        } else if (file.exists()) {
                ...
                try {
                    ...
                    for (String atL : new String(byteArrayOutputStream.toByteArray()).split(IOUtils.LINE_SEPARATOR_UNIX)) {
                        ...
                        if (recoveryPersistentItem.atL(atL)) {
                            ...
                            RecoveryLog.m8711e("Recovery.RecoveryReporter", "parse item error %s", r4[r3]);
                        }
                    }
                    try {
            ...
            RecoveryLog.m8712i("Recovery.RecoveryReporter", "getItemList file not exist %s", str);
            return linkedList;
        }
    }

    /* renamed from: bX */
    public static void m8727bX(Context context, String str) {
        new File(m8729iA(context), str).delete();
    }
}
