...
public class zzhp {
    ...
    static {
        AppMethodBeat.m2504i(71442);
        AppMethodBeat.m2505o(71442);
    }

    @VisibleForTesting
    private zzhp(Context context) {
        AppMethodBeat.m2504i(71435);
        this.zzft = context.getApplicationContext();
        AppMethodBeat.m2505o(71435);
    }

    public static zzhp zza(Context context) {
        AppMethodBeat.m2504i(71436);
    ...
    private static boolean zza(PackageInfo packageInfo, boolean z) {
        boolean z2 = false;
        AppMethodBeat.m2504i(71440);
        if (packageInfo.signatures.length != 1) {
            AppMethodBeat.m2505o(71440);
        } else {
    ...
    private static boolean zza(PackageInfo packageInfo, byte[]... bArr) {
        AppMethodBeat.m2504i(71441);
        if (packageInfo.signatures == null) {
            AppMethodBeat.m2505o(71441);
            return false;
    ...
    private static byte[] zzd(String str) {
        AppMethodBeat.m2504i(71437);
        try {
            byte[] bytes = str.getBytes("ISO-8859-1");
            AppMethodBeat.m2505o(71437);
            return bytes;
    ...
    public final boolean zze(String str) {
        AppMethodBeat.m2504i(71438);
        PackageInfo zzf = zzf(str);
        boolean zza;
        if (zzf == null) {
            AppMethodBeat.m2505o(71438);
            return false;
