...
public class DoodleFilter extends VideoFilterBase {
    ...
    public DoodleFilter() {
        ...
        AppMethodBeat.m2504i(82154);
        AppMethodBeat.m2505o(82154);
    }

    public void setTouchPoints(List<List<PointF>> list, List<List<PointF>> list2, int i, int i2, float f) {
        AppMethodBeat.m2504i(82155);
        if (list == null || list.size() == 0) {
            this.list.clear();
            AppMethodBeat.m2505o(82155);
            return;
        }
    ...
    public void initAttribParams() {
        AppMethodBeat.m2504i(82156);
        setPositions(null);
        AppMethodBeat.m2505o(82156);
    }

    public void renderProcess() {
        AppMethodBeat.m2504i(82157);
