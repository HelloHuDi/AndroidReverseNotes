...
public final class TVHttpProxyLoadLibrary {
    ...
    static {
        AppMethodBeat.m2504i(124392);
        AppMethodBeat.m2505o(124392);
    }
    ...
    public static String find(String str, Context context) {
        AppMethodBeat.m2504i(124393);
        if (context == null) {
            AppMethodBeat.m2505o(124393);
            return null;
        }
        String str2;
        try {
    ...
    /* JADX WARNING: Missing block: B:31:?, code skipped:
            com.tencent.matrix.trace.core.AppMethodBeat.m2505o(124394);
     */
    ...
    public static void load(String str, ClassLoader classLoader, Context context) {
        ...
        Throwable e;
        AppMethodBeat.m2504i(124394);
        if (str == null || str.length() == 0 || classLoader == null) {
            AppMethodBeat.m2505o(124394);
            return;
        }
        mContext = context;
    ...
    static /* synthetic */ void access$1(Context context) {
        AppMethodBeat.m2504i(124401);
        extractAllLibraries(context);
        AppMethodBeat.m2505o(124401);
    }

    private static void extractAllLibraries(Context context) {
        AppMethodBeat.m2504i(124399);
        if (context == null) {
            AppMethodBeat.m2505o(124399);
            return;
        }
