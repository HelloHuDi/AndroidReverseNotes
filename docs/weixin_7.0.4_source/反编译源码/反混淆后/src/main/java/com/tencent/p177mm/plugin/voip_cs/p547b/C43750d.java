...
/* renamed from: com.tencent.mm.plugin.voip_cs.b.d */
public final class C43750d {
    ...
    public C43750d() {
        ...
        this.tdD = 0;
        this.tdE = 0;
        this.cpuFlag0 = C45290m.m83509Lw();
        this.nxW = "";
        this.nxV = "";
        ...
        AppMethodBeat.m2505o(135297);
    }

    /* renamed from: GW */
    public final void mo69459GW(int i) {
        AppMethodBeat.m2504i(135298);
        this.sUq = Math.abs(i);
        AppMethodBeat.m2505o(135298);
    }

    public final void cMh() {
        AppMethodBeat.m2504i(135299);
        C4990ab.m7410d("MicroMsg.VoipCSReportHelper", "markEndTalk");
        if (this.tdD == 0 && this.tdC != 0) {
            this.tdD = (int) (System.currentTimeMillis() / 1000);
            this.nxM = (long) (this.tdD - this.tdC);
        }
        AppMethodBeat.m2505o(135299);
    }

    public final void cMi() {
        AppMethodBeat.m2504i(135300);
        C4990ab.m7410d("MicroMsg.VoipCSReportHelper", "markUserAccept");
        if (this.tdp == 0) {
            this.tdB = (int) (System.currentTimeMillis() / 1000);
            this.tdp = (long) (this.tdB - this.tdz);
        }
        AppMethodBeat.m2505o(135300);
    }

    public final coy cMj() {
        AppMethodBeat.m2504i(135301);
        coy coy = new coy();
        coy.jCt = 2;
        coy.xmI = this.nxV;
        C4990ab.m7417i("MicroMsg.VoipCSReportHelper", "getVoipCSEngineReportData, result: %s", coy.xmI);
        String[] split = this.nxV.split(",");
        if (split != null && split.length > 0) {
            try {
                this.videoFps = C5046bo.getInt(split[8], 0);
                this.tcR = C5046bo.getInt(split[10], 0);
            } catch (Exception e) {
                C4990ab.m7412e("MicroMsg.VoipCSReportHelper", "get videoFps and rate fail!!");
            }
        }
        AppMethodBeat.m2505o(135301);
        return coy;
    }

    public static int cMk() {
        int i;
        AppMethodBeat.m2504i(135302);
        try {
            ...
            C4990ab.m7412e("MicroMsg.VoipCSReportHelper", "isMobileNetworkAvailable fail!");
        }
        i = tcM;
        AppMethodBeat.m2505o(135302);
        return i;
    ...
    public static int getNetType(Context context) {
        AppMethodBeat.m2504i(135303);
        try {
            NetworkInfo activeNetworkInfo = ((ConnectivityManager) context.getSystemService("connectivity")).getActiveNetworkInfo();
            if (activeNetworkInfo == null) {
                AppMethodBeat.m2505o(135303);
                return 0;
            ...
            C4990ab.printErrStackTrace("MicroMsg.VoipCSReportHelper", e, "", new Object[0]);
            AppMethodBeat.m2505o(135303);
            return 0;
        }
    }
