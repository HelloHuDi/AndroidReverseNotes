...
/* renamed from: com.tencent.mm.protocal.protobuf.axy */
public final class axy extends C1331a {
    public float vRp;
    public float vRq;
    public String wCf;
    public int wfG;
    ...
    public final int mo4669op(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.wCf != null) {
                c6093a.mo13475e(7, this.wCf);
            }
            AppMethodBeat.m2505o(124320);
            return 0;
        } else if (i == 1) {
            ...
            switch (((Integer) objArr[2]).intValue()) {
                case 1:
                    axy.vRp = Float.intBitsToFloat(c6086a2.BTU.eia());
                    AppMethodBeat.m2505o(124320);
                    return 0;
                case 2:
                    axy.vRq = Float.intBitsToFloat(c6086a2.BTU.eia());
                    AppMethodBeat.m2505o(124320);
                    return 0;
                case 3:
                    axy.wfG = c6086a2.BTU.mo13458vd();
                    AppMethodBeat.m2505o(124320);
                    return 0;
                case 4:
                    axy.wfH = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(124320);
                    return 0;
                case 5:
                    axy.wfI = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(124320);
                    return 0;
                case 6:
                    axy.wfJ = c6086a2.BTU.mo13458vd();
                    AppMethodBeat.m2505o(124320);
                    return 0;
                case 7:
                    axy.wCf = c6086a2.BTU.readString();
                    AppMethodBeat.m2505o(124320);
                    return 0;
                default:
                    AppMethodBeat.m2505o(124320);
