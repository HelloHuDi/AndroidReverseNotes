...
final class zzaan {
    ...
    static final void zzb(StringBuilder stringBuilder, int i, String str, Object obj) {
        int i2 = 0;
        AppMethodBeat.m2504i(3342);
        if (obj instanceof List) {
            for (Object zzb : (List) obj) {
                zzb(stringBuilder, i, str, zzb);
            }
            AppMethodBeat.m2505o(3342);
