...
public class QbarNative {
    ...
    public static class QBarPoint {
        ...
        /* renamed from: x0 */
        public float f13773x0;
        /* renamed from: x1 */
        public float f13774x1;
        /* renamed from: x2 */
        public float f13775x2;
        /* renamed from: x3 */
        public float f13776x3;
        /* renamed from: y0 */
        public float f13777y0;
        /* renamed from: y1 */
        public float f13778y1;
        /* renamed from: y2 */
        public float f13779y2;
        /* renamed from: y3 */
        public float f13780y3;
    }
    ...
    public QbarNative() {
        AppMethodBeat.m2504i(56461);
        AppMethodBeat.m2505o(56461);
    }

    static {
        AppMethodBeat.m2504i(56476);
        System.loadLibrary("wechatQrMod");
        AppMethodBeat.m2505o(56476);
    }

    public static String getVersion() {
        AppMethodBeat.m2504i(56462);
        String GetVersion = GetVersion();
        AppMethodBeat.m2505o(56462);
        return GetVersion;
    }

    /* renamed from: a */
    public static int m49363a(byte[] bArr, int[] iArr, String str, int i, int i2, String str2) {
        AppMethodBeat.m2504i(56463);
        int Encode = Encode(bArr, iArr, str, i, i2, str2, -1);
        AppMethodBeat.m2505o(56463);
        return Encode;
    }

    /* renamed from: a */
    public final int mo49467a(int i, String str, String str2, QbarAiModelParam qbarAiModelParam) {
        AppMethodBeat.m2504i(56464);
        if (this.Aqx < 0) {
    ...
    /* renamed from: i */
    public final int mo49469i(int[] iArr, int i) {
        AppMethodBeat.m2504i(56465);
        int SetReaders = SetReaders(iArr, i, this.Aqx);
        AppMethodBeat.m2505o(56465);
        return SetReaders;
    }

    /* renamed from: z */
    public final int mo49473z(byte[] bArr, int i, int i2) {
        AppMethodBeat.m2504i(56466);
        ScanImage(bArr, i, i2, 0, this.Aqx);
        if (dPR().size() > 0) {
            AppMethodBeat.m2505o(56466);
            return 0;
        }
        AppMethodBeat.m2505o(56466);
        return -1;
    ...
    public final int release() {
        AppMethodBeat.m2504i(56467);
        int Release = Release(this.Aqx);
        this.Aqx = -1;
        AppMethodBeat.m2505o(56467);
        return Release;
    }

    public final List<QBarResult> dPR() {
        int i = 0;
        AppMethodBeat.m2504i(56468);
        ...
        AppMethodBeat.m2505o(56468);
        return arrayList;
    }

    /* renamed from: s */
    public final int mo49471s(List<QBarResult> list, List<QBarReportMsg> list2) {
        int i;
        AppMethodBeat.m2504i(56469);
        QBarResultJNI[] qBarResultJNIArr = new QBarResultJNI[3];
        ...
        i = list.size();
        AppMethodBeat.m2505o(56469);
        return i;
    }

    /* renamed from: t */
    public final int mo49472t(List<QBarCodeDetectInfo> list, List<QBarPoint> list2) {
        int i = 0;
        AppMethodBeat.m2504i(56470);
        if (this.Aqx < 0) {
            AppMethodBeat.m2505o(56470);
            return 0;
        }
        int i2;
    ...
    /* renamed from: a */
    public static int m49364a(byte[] bArr, int[] iArr, byte[] bArr2, int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        AppMethodBeat.m2504i(56471);
        if (bArr == null || bArr2 == null) {
            AppMethodBeat.m2505o(56471);
            return -1;
        }
    ...
    /* renamed from: a */
    public static int m49361a(byte[] bArr, byte[] bArr2, int i, int i2) {
        AppMethodBeat.m2504i(56472);
        if (bArr2 == null) {
            AppMethodBeat.m2505o(56472);
            return -1;
        }
    ...
    /* renamed from: b */
    public static int m49365b(byte[] bArr, byte[] bArr2, int i, int i2) {
        AppMethodBeat.m2504i(56473);
        if (bArr == null || bArr2 == null) {
            AppMethodBeat.m2505o(56473);
            return -1;
        }
    ...
    /* renamed from: a */
    public static int m49362a(byte[] bArr, int[] iArr, int i, int i2, int i3, int i4, int i5, int i6) {
        AppMethodBeat.m2504i(56474);
        if (bArr == null) {
            AppMethodBeat.m2505o(56474);
            return -1;
        }
    ...
    private static boolean isNullOrNil(String str) {
        AppMethodBeat.m2504i(56475);
        if (str == null || str.isEmpty()) {
            AppMethodBeat.m2505o(56475);
            return true;
        }
        AppMethodBeat.m2505o(56475);
        return false;
