...
public final class zzj extends zzn<zzj> {
    ...
    public zzj() {
        ...
        this.zzhc = null;
        this.zzhl = -1;
        AppMethodBeat.m2505o(70698);
    }

    public final boolean equals(Object obj) {
        AppMethodBeat.m2504i(70699);
        if (obj == this) {
            AppMethodBeat.m2505o(70699);
            return true;
    ...
    public final void zza(zzl zzl) {
        ...
        super.zza(zzl);
        AppMethodBeat.m2505o(70701);
    }

    /* Access modifiers changed, original: protected|final */
    public final int zzg() {
        int i;
        AppMethodBeat.m2504i(70702);
        int zzg = super.zzg();
        if (!Arrays.equals(this.zzgd, zzw.zzhy)) {
            byte[] bArr = this.zzgd;
