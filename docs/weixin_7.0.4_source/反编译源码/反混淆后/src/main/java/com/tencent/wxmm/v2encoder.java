...
public class v2encoder {
    ...
    static {
        AppMethodBeat.m2504i(35413);
        AppMethodBeat.m2505o(35413);
    }

    @SuppressLint({"NewApi"})
    private boolean SupportAvcCodec(String str, int i) {
        AppMethodBeat.m2504i(35397);
        boolean z = false;
        ...
        AppMethodBeat.m2505o(35397);
        return z;
    }

    private MediaCodecInfo selectCodec(String str) {
        AppMethodBeat.m2504i(35398);
    ...
    public v2encoder(int i, int i2, int i3, int i4, int i5, v2service v2service) {
        ...
        AppMethodBeat.m2505o(35402);
    }

    public int InitHWEncoder(boolean z) {
        int StartEncoder;
        AppMethodBeat.m2504i(35403);
    ...
    private void StopEncoder() {
        AppMethodBeat.m2504i(35405);
        try {
            if (this.mediaCodec != null) {
                this.mediaCodec.stop();
                this.mediaCodec.release();
            }
            AppMethodBeat.m2505o(35405);
        } catch (Exception e) {
    ...
    public void DoQosSvrCtrl() {
        ...
        AppMethodBeat.m2505o(35408);
    }

    @SuppressLint({"NewApi"})
    public boolean SetBitRate(int i) {
        AppMethodBeat.m2504i(35409);
        try {
            if (this.mediaCodec != null) {
                Bundle bundle = new Bundle();
                bundle.putInt("video-bitrate", i * 1000);
                this.mediaCodec.setParameters(bundle);
                AppMethodBeat.m2505o(35409);
                return true;
            }
        } catch (Exception e) {
    ...
    public void MakeIFrame() {
        AppMethodBeat.m2504i(35410);
        if (this.mediaCodec != null) {
            Bundle bundle = new Bundle();
            bundle.putInt("request-sync", 0);
            this.mediaCodec.setParameters(bundle);
        }
        AppMethodBeat.m2505o(35410);
    }

    public void putH2645Data(byte[] bArr, int i, int i2) {
        AppMethodBeat.m2504i(35411);
        ...
        AppMethodBeat.m2505o(35411);
    }

    private void NV21ToNV12(byte[] bArr, byte[] bArr2, int i, int i2, int i3) {
        int i4 = 0;
        AppMethodBeat.m2504i(35412);
        if (bArr == null || bArr2 == null) {
            AppMethodBeat.m2505o(35412);
            return;
        }
        int i5 = i * i2;
        if (i3 == 0) {
