...
public class WebViewBagBgView extends View {
    ...
    /* renamed from: com.tencent.mm.plugin.webview.ui.tools.bag.WebViewBagBgView$1 */
    class C145861 implements Runnable {
        C145861() {
        }

        public final void run() {
            AppMethodBeat.m2504i(8197);
            WebViewBagBgView.this.uzn = true;
            WebViewBagBgView.this.invalidate();
            AppMethodBeat.m2505o(8197);
        }
    }

    public WebViewBagBgView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        AppMethodBeat.m2504i(8198);
        this.mPaint.setAntiAlias(true);
        this.uzm = -1;
        AppMethodBeat.m2505o(8198);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawOval(this.f2961nI, this.mPaint);
        ...
        AppMethodBeat.m2505o(8199);
    }

    /* Access modifiers changed, original: protected */
    public void onMeasure(int i, int i2) {
        AppMethodBeat.m2504i(8200);
        super.onMeasure(i, i2);
        this.uzm = MeasureSpec.getSize(i);
        this.f2961nI = new RectF(0.0f, 0.0f, (float) this.uzm, (float) this.uzm);
        this.uzl = this.uzm / 2;
        mo26825lT(System.currentTimeMillis());
        AppMethodBeat.m2505o(8200);
    }

    /* Access modifiers changed, original: final */
    /* renamed from: lT */
    public final void mo26825lT(long j) {
        AppMethodBeat.m2504i(8201);
        if (this.uzm < 0) {
            C4990ab.m7417i("MicroMsg.WebViewBagBgView", "doUpdateAngryInfo not measured, mDiameter:%d", Integer.valueOf(this.uzm));
            AppMethodBeat.m2505o(8201);
            return;
        }
        float f;
