...
/* renamed from: com.tencent.mm.media.f.c */
public final class C1778c {
    ...
    public final boolean equals(Object obj) {
        AppMethodBeat.m2504i(12995);
        if (this != obj) {
            if (obj instanceof C1778c) {
                C1778c c1778c = (C1778c) obj;
                if (C25052j.m39373j(this.bitmap, c1778c.bitmap)) {
                }
            }
            AppMethodBeat.m2505o(12995);
            return false;
        }
        AppMethodBeat.m2505o(12995);
        return true;
    ...
    public final int hashCode() {
        AppMethodBeat.m2504i(12994);
        Bitmap bitmap = this.bitmap;
        int hashCode = (bitmap != null ? bitmap.hashCode() : 0) * 31;
        long j = this.eWH;
        hashCode += (int) (j ^ (j >>> 32));
        AppMethodBeat.m2505o(12994);
        return hashCode;
    }

    public final String toString() {
        AppMethodBeat.m2504i(12993);
        String str = "FrameInfo(bitmap=" + this.bitmap + ", frameDuration=" + this.eWH + ")";
        AppMethodBeat.m2505o(12993);
        return str;
    }

    public C1778c(Bitmap bitmap, long j) {
        C25052j.m39376p(bitmap, "bitmap");
        AppMethodBeat.m2504i(12992);
        this.bitmap = bitmap;
        this.eWH = j;
        AppMethodBeat.m2505o(12992);
    }
}
