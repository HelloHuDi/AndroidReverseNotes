...
public final class SignInOptions implements Optional {
    ...
    public static final class Builder {
        ...
        public final SignInOptions build() {
            ...
            AppMethodBeat.m2505o(61645);
            return signInOptions;
        }

        public final Builder requestIdToken(String str) {
            AppMethodBeat.m2504i(61647);
            this.zzadg = true;
            this.zzadh = zza(str);
            AppMethodBeat.m2505o(61647);
            return this;
        }

        public final Builder requestServerAuthCode(String str, boolean z) {
            AppMethodBeat.m2504i(61646);
            this.zzadi = z;
            this.zzadf = true;
            this.zzadh = zza(str);
            AppMethodBeat.m2505o(61646);
            return this;
        }

        public final Builder setAuthApiSignInModuleVersion(long j) {
            AppMethodBeat.m2504i(61648);
            this.zzadl = Long.valueOf(j);
            AppMethodBeat.m2505o(61648);
            return this;
        }
        ...
        public final Builder setRealClientLibraryVersion(long j) {
            AppMethodBeat.m2504i(61649);
            this.zzadm = Long.valueOf(j);
            AppMethodBeat.m2505o(61649);
            return this;
        }
    ...
    static {
        AppMethodBeat.m2504i(61651);
        AppMethodBeat.m2505o(61651);
    }
