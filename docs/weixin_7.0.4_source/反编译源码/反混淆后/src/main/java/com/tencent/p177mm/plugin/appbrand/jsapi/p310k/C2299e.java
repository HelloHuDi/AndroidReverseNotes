...
/* renamed from: com.tencent.mm.plugin.appbrand.jsapi.k.e */
public final class C2299e extends C10296a<C38492q> {
    public static final int CTRL_INDEX = -2;
    public static final String NAME = "hideTabBar";

    /* renamed from: a */
    public final /* synthetic */ void mo5994a(C2241c c2241c, JSONObject jSONObject, int i) {
        AppMethodBeat.m2504i(74754);
        C38492q c38492q = (C38492q) c2241c;
        C19640n currentPage = c38492q.getRuntime().asV().getCurrentPage();
        if (currentPage instanceof C27224g) {
            ((C27224g) currentPage).getTabBar().mo22645fi(jSONObject.optBoolean("animation", true));
            c38492q.mo6107M(i, mo73394j("ok", null));
            AppMethodBeat.m2505o(74754);
            return;
        }
