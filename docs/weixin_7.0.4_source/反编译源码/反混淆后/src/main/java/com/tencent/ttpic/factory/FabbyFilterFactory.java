...
public class FabbyFilterFactory {
    ...
    public enum FILTER_MODEL {
        WU("cameftOrigin", C31128d.MIC_PTU_WU, 0),
        ZIRAN("cameftNature", C31128d.MIC_PTU_ZIRAN, 0),
        ZIPAI_GRADIENT_LIPNEW("cameftCherry", C31128d.MIC_PTU_ZIPAI_GRADIENT_LIPNEW, 0),
        ZIPAI_FAIRYTALE("cameftFairytale", C31128d.MIC_PTU_ZIPAI_FAIRYTALE, 0),
        XINYE("cameftXinye", 285, 0),
        QIANGWEI("cameftQiangwei", 283, 0),
        TANGGUOMEIGUI("cameftTangguomeigui", 286, 0),
        SHUILIAN("cameftShuilian", C31128d.MIC_PTU_SHUILIAN, 0),
        FENHONGBAO("cameftFenhongbao", 295, 0),
        AMARO("cameftQingyi", 5, 0),
        FBBS_NUANYANG("cameftNuanyang", 292, 6),
        YOUJIALI("cameftYoujiali", C31128d.MIC_PTU_YOUJIALI, 0),
        MIC_PTU_YOUJIALI("cameftShengdai", C31128d.MIC_PTU_ZIPAI_LIGHTWHITE, 0),
        MIC_PTU_ZIPAI_LIGHTRED("cameftYinghong", C31128d.MIC_PTU_ZIPAI_LIGHTRED, 0),
        MIC_PTU_FBBS_LANGMAN("cameftRomantic", 293, 4),
        MIC_PTU_ZIPAI_OKINAWA("cameftFenbi", C31128d.MIC_PTU_ZIPAI_OKINAWA, 0),
        ...
        MIC_PTU_ZIPAI_TOKYO("cameftTokyo", C31128d.MIC_PTU_ZIPAI_TOKYO, 0),
        MIC_PTU_ZIPAI_SAPPORO("cameftSapporo", C31128d.MIC_PTU_ZIPAI_SAPPORO, 0),
        ...
        MIC_PTU_ZIPAI_BLACKWHITEZIPAI("cameftHeibai", C31128d.MIC_PTU_ZIPAI_BLACKWHITEZIPAI, 0),
        MIC_PTU_ZIPAI_GRADIENT_GLAREFONDDREAM("cameftMenghuan", C31128d.MIC_PTU_ZIPAI_GRADIENT_GLAREFONDDREAM, 0),
        MIC_PTU_ZIPAI_GRADIENT_FASHION("cameftShishang", C31128d.MIC_PTU_ZIPAI_GRADIENT_FASHION, 0),
    ...
    public static BaseFilter createFilter(String str) {
        ...
        AppMethodBeat.m2504i(81919);
        if (str == null) {
            AppMethodBeat.m2505o(81919);
        } else {
