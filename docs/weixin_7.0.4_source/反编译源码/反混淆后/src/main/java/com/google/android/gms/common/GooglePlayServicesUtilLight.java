...
public class GooglePlayServicesUtilLight {
    ...
    static {
        AppMethodBeat.m2504i(89418);
        AppMethodBeat.m2505o(89418);
    }
    ...
    public static void cancelAvailabilityErrorNotifications(Context context) {
        AppMethodBeat.m2504i(89407);
        if (zzbt.getAndSet(true)) {
            AppMethodBeat.m2505o(89407);
            return;
        }
        try {
    ...
    public static int getApkVersion(Context context) {
        int i = 0;
        AppMethodBeat.m2504i(89412);
        try {
            i = context.getPackageManager().getPackageInfo("com.google.android.gms", 0).versionCode;
            AppMethodBeat.m2505o(89412);
            return i;
    ...
    public static boolean honorsDebugCertificates(Context context) {
        AppMethodBeat.m2504i(89405);
        if (isTestKeysBuild(context) || !isUserBuildDevice()) {
            AppMethodBeat.m2505o(89405);
            return true;
        }
        AppMethodBeat.m2505o(89405);
        return false;
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        ...
        AppMethodBeat.m2504i(89396);
        try {
            context.getResources().getString(C25738R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
        }
    ...
    public static boolean isRestrictedUserProfile(Context context) {
        AppMethodBeat.m2504i(89417);
        if (PlatformVersion.isAtLeastJellyBeanMR2()) {
            Bundle applicationRestrictions = ((UserManager) context.getSystemService("user")).getApplicationRestrictions(context.getPackageName());
            if (applicationRestrictions != null && "true".equals(applicationRestrictions.getString("restricted_profile"))) {
                AppMethodBeat.m2505o(89417);
                return true;
            }
        }
        AppMethodBeat.m2505o(89417);
    ...
    static boolean isUninstalledAppPossiblyUpdating(Context context, String str) {
        AppMethodBeat.m2504i(89416);
        boolean equals = str.equals("com.google.android.gms");
        if (PlatformVersion.isAtLeastLollipop()) {
            try {
                for (SessionInfo appPackageName : context.getPackageManager().getPackageInstaller().getAllSessions()) {
                    if (str.equals(appPackageName.getAppPackageName())) {
                        AppMethodBeat.m2505o(89416);
                        return true;
                    }
                }
            } catch (Exception e) {
    ...
    public static boolean isUserBuildDevice() {
        AppMethodBeat.m2504i(89403);
        boolean isUserBuild = DeviceProperties.isUserBuild();
        AppMethodBeat.m2505o(89403);
        return isUserBuild;
    }
