...
public final class SQLiteConnectionPool implements Closeable {
    ...
    private SQLiteConnectionPool(SQLiteDatabase sQLiteDatabase, SQLiteDatabaseConfiguration sQLiteDatabaseConfiguration, int i) {
        ...
        AppMethodBeat.m2505o(12362);
    }

    /* Access modifiers changed, original: protected|final */
    public final void finalize() {
        AppMethodBeat.m2504i(12363);
        try {
            dispose(true);
        } finally {
            super.finalize();
            AppMethodBeat.m2505o(12363);
        }
    }
    ...
    private void open() {
        AppMethodBeat.m2504i(12366);
        this.mAvailablePrimaryConnection = openConnectionLocked(this.mConfiguration, true);
        this.mIsOpen = true;
        AppMethodBeat.m2505o(12366);
    }

    public final void close() {
        AppMethodBeat.m2504i(12367);
        dispose(false);
        AppMethodBeat.m2505o(12367);
    }

    private void dispose(boolean z) {
        AppMethodBeat.m2504i(12368);
        if (z) {
            AppMethodBeat.m2505o(12368);
            return;
        }
        synchronized (this.mLock) {
            try {
                ...
                if (size != 0) {
                    Log.m9448i(TAG, "The connection pool for " + this.mConfiguration.label + " has been closed but there are still " + size + " connections in use.  They will be closed as they are released back to the pool.");
                }
    ...
    public final void reconfigure(SQLiteDatabaseConfiguration sQLiteDatabaseConfiguration) {
        Object obj = 1;
        AppMethodBeat.m2504i(12369);
        if (sQLiteDatabaseConfiguration == null) {
            IllegalArgumentException illegalArgumentException = new IllegalArgumentException("configuration must not be null.");
            AppMethodBeat.m2505o(12369);
            throw illegalArgumentException;
        }
        synchronized (this.mLock) {
            try {
    ...
    private boolean recycleConnectionLocked(SQLiteConnection sQLiteConnection, AcquiredConnectionStatus acquiredConnectionStatus) {
        AppMethodBeat.m2504i(12372);
        if (acquiredConnectionStatus == AcquiredConnectionStatus.RECONFIGURE) {
            try {
                sQLiteConnection.reconfigure(this.mConfiguration);
            } catch (RuntimeException e) {
                Log.m9445e(TAG, "Failed to reconfigure released connection, closing it: ".concat(String.valueOf(sQLiteConnection)), e);
                acquiredConnectionStatus = AcquiredConnectionStatus.DISCARD;
            }
        }
        if (acquiredConnectionStatus == AcquiredConnectionStatus.DISCARD) {
            closeConnectionAndLogExceptionsLocked(sQLiteConnection);
            AppMethodBeat.m2505o(12372);
            return false;
        }
        AppMethodBeat.m2505o(12372);
        return true;
    ...
    private SQLiteConnection openConnectionLocked(SQLiteDatabaseConfiguration sQLiteDatabaseConfiguration, boolean z) {
        ...
        AppMethodBeat.m2505o(12375);
        return open;
    }

    /* Access modifiers changed, original: final */
    public final void onConnectionLeaked() {
        AppMethodBeat.m2504i(12376);
        Log.m9452w(TAG, "A SQLiteConnection object for database '" + this.mConfiguration.label + "' was leaked!  Please fix your application to end transactions in progress properly and to close the database when it is no longer needed.");
        this.mConnectionLeaked.set(true);
        AppMethodBeat.m2505o(12376);
    }

    private void closeAvailableConnectionsAndLogExceptionsLocked() {
        AppMethodBeat.m2504i(12377);
        closeAvailableNonPrimaryConnectionsAndLogExceptionsLocked();
        if (this.mAvailablePrimaryConnection != null) {
            closeConnectionAndLogExceptionsLocked(this.mAvailablePrimaryConnection);
            this.mAvailablePrimaryConnection = null;
        }
        AppMethodBeat.m2505o(12377);
    }

    private void closeAvailableNonPrimaryConnectionsAndLogExceptionsLocked() {
        AppMethodBeat.m2504i(12378);
        ...
        AppMethodBeat.m2505o(12378);
    }

    private void closeExcessConnectionsAndLogExceptionsLocked() {
        AppMethodBeat.m2504i(12379);
        int size = this.mAvailableNonPrimaryConnections.size();
        while (true) {
            int i = size - 1;
    ...
    private void closeConnectionAndLogExceptionsLocked(SQLiteConnection sQLiteConnection) {
        AppMethodBeat.m2504i(12380);
        try {
            sQLiteConnection.close();
            AppMethodBeat.m2505o(12380);
        } catch (RuntimeException e) {
            Log.m9444e(TAG, "Failed to close connection, its fate is now in the hands of the merciful GC: " + sQLiteConnection + e.getMessage());
            AppMethodBeat.m2505o(12380);
        }
    }

    private void discardAcquiredConnectionsLocked() {
        AppMethodBeat.m2504i(12381);
        markAcquiredConnectionsLocked(AcquiredConnectionStatus.DISCARD);
        AppMethodBeat.m2505o(12381);
    }

    private void reconfigureAllConnectionsLocked() {
        AppMethodBeat.m2504i(12382);
        if (this.mAvailablePrimaryConnection != null) {
            try {
                this.mAvailablePrimaryConnection.reconfigure(this.mConfiguration);
            } catch (RuntimeException e) {
                Log.m9445e(TAG, "Failed to reconfigure available primary connection, closing it: " + this.mAvailablePrimaryConnection, e);
                closeConnectionAndLogExceptionsLocked(this.mAvailablePrimaryConnection);
                this.mAvailablePrimaryConnection = null;
            }
        }
        ...
        while (i < size) {
            ...
            try {
                ...
                Log.m9445e(TAG, "Failed to reconfigure available non-primary connection, closing it: ".concat(String.valueOf(sQLiteConnection)), e2);
                closeConnectionAndLogExceptionsLocked(sQLiteConnection);
                i2 = i - 1;
    ...
    private void logConnectionPoolBusy(ConnectionPoolBusyInfo connectionPoolBusyInfo, long j, int i) {
        ...
        Log.m9452w(TAG, stringBuilder.toString());
        AppMethodBeat.m2505o(12386);
    }

    private ConnectionPoolBusyInfo gatherConnectionPoolBusyInfoLocked() {
        AppMethodBeat.m2504i(12387);
        ...
        AppMethodBeat.m2505o(12387);
        return connectionPoolBusyInfo;
    }

    private void wakeConnectionWaitersLocked() {
        AppMethodBeat.m2504i(12388);
    ...
    private void finishAcquireConnectionLocked(SQLiteConnection sQLiteConnection, int i) {
        ...
        try {
            ...
            AppMethodBeat.m2505o(12391);
        } catch (RuntimeException e) {
            Log.m9444e(TAG, "Failed to prepare acquired connection for session, closing it: " + sQLiteConnection + ", connectionFlags=" + i);
            closeConnectionAndLogExceptionsLocked(sQLiteConnection);
            AppMethodBeat.m2505o(12391);
            throw e;
        }
    ...
    private void setMaxConnectionPoolSizeLocked(int i) {
        ...
        Log.m9449i(TAG, "Max connection pool size is %d.", Integer.valueOf(this.mMaxConnectionPoolSize));
        AppMethodBeat.m2505o(12393);
    }

    private void throwIfClosedLocked() {
        AppMethodBeat.m2504i(12394);
        if (this.mIsOpen) {
            AppMethodBeat.m2505o(12394);
            return;
        }
    ...
    public final void traceExecute(String str, int i, long j) {
        AppMethodBeat.m2504i(12398);
        SQLiteDatabase sQLiteDatabase = (SQLiteDatabase) this.mDB.get();
        SQLiteTrace sQLiteTrace = this.mTraceCallback;
        if (sQLiteTrace == null || sQLiteDatabase == null) {
            AppMethodBeat.m2505o(12398);
            return;
        }
    ...
    public final void setCheckpointListener(SQLiteCheckpointListener sQLiteCheckpointListener) {
        ...
        AppMethodBeat.m2505o(12399);
    }

    /* Access modifiers changed, original: final */
    public final void notifyCheckpoint(String str, int i) {
        AppMethodBeat.m2504i(12400);
        SQLiteDatabase sQLiteDatabase = (SQLiteDatabase) this.mDB.get();
    ...
    public final void dump(Printer printer, boolean z) {
        ...
        synchronized (this.mLock) {
            try {
                ...
                AppMethodBeat.m2505o(12401);
            }
        }
    }

    public final String toString() {
        AppMethodBeat.m2504i(12402);
        String str = "SQLiteConnectionPool: " + this.mConfiguration.path;
        AppMethodBeat.m2505o(12402);
        return str;
    }
}
