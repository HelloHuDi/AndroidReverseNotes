...
public final class TenpaySegmentEditText extends LinearLayout {
    ...
    public TenpaySegmentEditText(Context context, AttributeSet attributeSet) {
        ...
        this.mContext = context;
        init();
        AppMethodBeat.m2505o(49525);
    }

    private void init() {
        AppMethodBeat.m2504i(49526);
    ...
    public final void setText(String str) {
        AppMethodBeat.m2504i(49527);
        setText(str, null);
        AppMethodBeat.m2505o(49527);
    }

    public final void setText(String str, String str2) {
        AppMethodBeat.m2504i(49528);
        ...
        for (int i = 0; i < split.length; i++) {
            ...
            editText.setOnFocusChangeListener(new OnFocusChangeListener() {
                public void onFocusChange(View view, boolean z) {
                    AppMethodBeat.m2504i(49520);
                    LogUtil.m71577d("MyTag", "edit onFocusChange hasFocus=".concat(String.valueOf(z)));
                    if (z) {
                        if (TenpaySegmentEditText.this.mOnClickListener != null) {
                            TenpaySegmentEditText.this.mOnClickListener.onClick(view);
                        }
                        if (TenpaySegmentEditText.this.mKeyboard != null) {
                            LogUtil.m71577d("MyTag", "keyboard is not null");
                            TenpaySegmentEditText.this.mKeyboard.setXMode(0);
                            TenpaySegmentEditText.this.mKeyboard.setInputEditText(editText);
                        }
                    }
                    AppMethodBeat.m2505o(49520);
                }
            });
    ...
    public final void setFocusable(boolean z) {
        int i = 0;
        AppMethodBeat.m2504i(49529);
        LogUtil.m71577d("MyTag", "setFocusable ".concat(String.valueOf(z)));
        while (true) {
            int i2 = i;
    ...
    public final void onDraw(Canvas canvas) {
        AppMethodBeat.m2504i(49530);
        super.onDraw(canvas);
        drawBackgroundLine(canvas);
        AppMethodBeat.m2505o(49530);
    }

    private void drawBackgroundLine(Canvas canvas) {
        AppMethodBeat.m2504i(49531);
        int width = getWidth();
    ...
    public final String getEncryptDataWithHash(boolean z) {
        AppMethodBeat.m2504i(49533);
        String inputText = getInputText();
        if (inputText == null || inputText.length() == 0) {
            AppMethodBeat.m2505o(49533);
            return null;
        }
        if (z) {
    ...
    public final String get3DesEncrptData() {
        AppMethodBeat.m2504i(49534);
        String inputText = getInputText();
        if (inputText == null || inputText.length() == 0) {
            AppMethodBeat.m2505o(49534);
            return null;
        }
        Encrypt encrypt = new Encrypt();
    ...
    public final boolean isMatchPattern(String str) {
        boolean z = false;
        AppMethodBeat.m2504i(49535);
        if (str != null) {
            try {
                z = Pattern.compile(str).matcher(getInputText()).matches();
                AppMethodBeat.m2505o(49535);
            } catch (Exception e) {
                AppMethodBeat.m2505o(49535);
            }
        } else {
    ...
    private boolean isMatchPattern(String str, String str2) {
        boolean z = false;
        AppMethodBeat.m2504i(49536);
        if (str2 != null) {
            try {
                z = Pattern.compile(str2).matcher(str).matches();
                AppMethodBeat.m2505o(49536);
            } catch (Exception e) {
                AppMethodBeat.m2505o(49536);
            }
        } else {
    ...
    public final int getInputLength() {
        AppMethodBeat.m2504i(49537);
        String inputText = getInputText();
        if (inputText == null) {
            AppMethodBeat.m2505o(49537);
            return 0;
        }
    ...
    public static void setNoSystemInputOnEditText(EditText editText) {
        AppMethodBeat.m2504i(49538);
        if (VERSION.SDK_INT < 11) {
            editText.setInputType(0);
            AppMethodBeat.m2505o(49538);
            return;
        }
