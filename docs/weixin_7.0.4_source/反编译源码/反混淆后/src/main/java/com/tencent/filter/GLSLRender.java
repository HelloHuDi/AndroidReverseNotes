...
public class GLSLRender {
    ...
    public static int bLO = C31128d.MIC_ALPHA_ADJUST_REAL;
    public static int bLP = 118;
    public static int bLQ = C31128d.MIC_AVROUND_BLUR;
    ...
    public static int bLY = C31128d.MIC_SketchMark;
    ...
    public static int bMe = C19394e.CTRL_INDEX;
    public static int bMf = C19392d.CTRL_INDEX;
    public static int bMg = C44697b.CTRL_INDEX;
    public static int bMh = C19395n.CTRL_INDEX;
