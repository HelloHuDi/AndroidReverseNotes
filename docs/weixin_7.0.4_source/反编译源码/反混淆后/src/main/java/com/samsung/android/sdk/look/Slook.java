...
public final class Slook implements SsdkInterface {
    ...
    public static class VERSION_CODES {
        /* renamed from: L1 */
        public static final int f1037L1 = 1;
    }

    public final int getVersionCode() {
        AppMethodBeat.m2504i(117188);
        int i;
        if (mVersionCode != -1) {
            i = mVersionCode;
            AppMethodBeat.m2505o(117188);
            return i;
        }
        try {
