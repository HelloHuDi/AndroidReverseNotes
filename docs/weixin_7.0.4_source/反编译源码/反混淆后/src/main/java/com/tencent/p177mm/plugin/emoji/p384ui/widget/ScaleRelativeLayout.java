...
public class ScaleRelativeLayout extends RelativeLayout {
    ...
    /* renamed from: com.tencent.mm.plugin.emoji.ui.widget.ScaleRelativeLayout$1 */
    class C204221 implements AnimatorUpdateListener {
        C204221() {
        }

        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            AppMethodBeat.m2504i(53859);
            ScaleRelativeLayout.this.lgA = ((Float) valueAnimator.getAnimatedValue()).floatValue();
            ScaleRelativeLayout.this.postInvalidate();
            AppMethodBeat.m2505o(53859);
        }
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        AppMethodBeat.m2504i(53860);
        if (motionEvent.getPointerCount() > 1) {
            AppMethodBeat.m2505o(53860);
            return true;
        }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            case 1:
                ...
                this.lgH.addUpdateListener(new C204221());
                this.lgH.start();
                break;
            case 2:
        ...
        postInvalidate();
        AppMethodBeat.m2505o(53861);
        return true;
    }

    /* Access modifiers changed, original: protected */
    public void dispatchDraw(Canvas canvas) {
        AppMethodBeat.m2504i(53862);
