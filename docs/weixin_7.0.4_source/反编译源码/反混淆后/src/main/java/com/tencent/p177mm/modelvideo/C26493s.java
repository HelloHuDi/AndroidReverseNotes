...
/* renamed from: com.tencent.mm.modelvideo.s */
public final class C26493s {
    public int bJt = -1;
    public int cFa = 0;
    public String cIS = "";
    public long cKK = 0;
    ...
    public C26493s() {
        AppMethodBeat.m2504i(50782);
        AppMethodBeat.m2505o(50782);
    }

    /* renamed from: ue */
    public static String m42234ue(String str) {
        String str2;
        AppMethodBeat.m2504i(50783);
        try {
            Map z = C5049br.m7595z(str, "msg");
            if (z != null) {
                str2 = (String) z.get(".msg.videomsg.$cdnvideourl");
                AppMethodBeat.m2505o(50783);
                return str2;
            }
        } catch (Exception e) {
        }
    ...
    /* renamed from: d */
    public final void mo44274d(Cursor cursor) {
        AppMethodBeat.m2504i(50784);
        ...
        m42232Z(cursor.getBlob(26));
        this.cMn = cursor.getString(27);
        this.egF = cursor.getInt(28);
        m42233aa(cursor.getBlob(29));
        this.cFa = cursor.getInt(30);
        this.videoFormat = cursor.getInt(31);
        AppMethodBeat.m2505o(50784);
    }

    /* renamed from: Hl */
    public final ContentValues mo44267Hl() {
        AppMethodBeat.m2504i(50785);
        ...
        AppMethodBeat.m2505o(50785);
        return contentValues;
    }

    private byte[] alu() {
        AppMethodBeat.m2504i(50786);
        byte[] bArr = new byte[0];
        try {
            bArr = this.fXm.toByteArray();
        } catch (Exception e) {
            C4990ab.printErrStackTrace("MicroMsg.VideoInfo", e, "", new Object[0]);
        }
        AppMethodBeat.m2505o(50786);
        return bArr;
    }

    /* renamed from: Z */
    private void m42232Z(byte[] bArr) {
        AppMethodBeat.m2504i(50787);
        this.fXm = new cfh();
        try {
            this.fXm.parseFrom(bArr);
            AppMethodBeat.m2505o(50787);
        } catch (Exception e) {
            C4990ab.printErrStackTrace("MicroMsg.VideoInfo", e, "", new Object[0]);
            AppMethodBeat.m2505o(50787);
        }
    ...
    /* renamed from: aa */
    private void m42233aa(byte[] bArr) {
        AppMethodBeat.m2504i(50788);
        this.fXn = new baa();
        try {
            this.fXn.parseFrom(bArr);
            AppMethodBeat.m2505o(50788);
        } catch (Exception e) {
            AppMethodBeat.m2505o(50788);
        }
    }
    ...
    private byte[] alA() {
        AppMethodBeat.m2504i(50789);
        byte[] bArr = new byte[0];
        try {
            bArr = this.fXn.toByteArray();
        } catch (Exception e) {
        }
        AppMethodBeat.m2505o(50789);
        return bArr;
    }
}
