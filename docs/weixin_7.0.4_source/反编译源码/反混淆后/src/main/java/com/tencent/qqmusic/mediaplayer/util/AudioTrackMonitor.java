...
public class AudioTrackMonitor {
            ...
            while (!AudioTrackMonitor.this.mStop) {
                ...
                try {
                    ...
                    if (audioTrack != null) {
                        ...
                        Logger.m71021e(AudioTrackMonitor.TAG, AudioTrackMonitor.this.mBuilder.toString());
                        AudioTrackMonitor.this.mBuilder.delete(0, AudioTrackMonitor.this.mBuilder.length());
                    }
                } catch (Throwable th2) {
                    Logger.m71024e(AudioTrackMonitor.TAG, th2);
                }
            }
            AppMethodBeat.m2505o(128390);
        }
    ...
    public AudioTrackMonitor(AudioTrack audioTrack) {
        AppMethodBeat.m2504i(128387);
        this.mAudioTrackRef = new WeakReference(audioTrack);
        AppMethodBeat.m2505o(128387);
    }
