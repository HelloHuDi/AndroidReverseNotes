...
public class ApiHelper {
    ...
    public static class VERSION_CODES {
        ...
        /* renamed from: O */
        public static final int f3490O = 26;
    ...
    private static boolean hasField(Class<?> cls, String str) {
        AppMethodBeat.m2504i(49578);
        try {
            cls.getDeclaredField(str);
            AppMethodBeat.m2505o(49578);
            return true;
    ...
    private static boolean hasMethod(String str, String str2, Class<?>... clsArr) {
        AppMethodBeat.m2504i(49579);
        try {
            Class.forName(str).getDeclaredMethod(str2, clsArr);
            AppMethodBeat.m2505o(49579);
            return true;
        } catch (Throwable th) {
            AppMethodBeat.m2505o(49579);
            return false;
    ...
    private static boolean hasMethod(Class<?> cls, String str, Class<?>... clsArr) {
        AppMethodBeat.m2504i(49580);
        try {
            cls.getDeclaredMethod(str, clsArr);
            AppMethodBeat.m2505o(49580);
            return true;
