...
/* renamed from: com.tencent.recovery.wx.util.MyDES */
public class MyDES {
    /* renamed from: a */
    private static void m8752a(MyByteArray myByteArray, MyByteArray myByteArray2, int i) {
    ...
    /* renamed from: b */
    private static void m8755b(MyByteArray myByteArray, MyByteArray myByteArray2, int i) {
        for (int i2 = 0; i2 < i; i2++) {
    ...
    /* renamed from: c */
    private static void m8756c(MyByteArray myByteArray, MyByteArray myByteArray2, int i) {
        int i2 = 0;
        MyDES.m8757d(myByteArray2, myByteArray, i);
    ...
    /* renamed from: a */
    private static void m8753a(MyByteArray myByteArray, MyByteArray myByteArray2, byte[] bArr, int i, MyByteArray myByteArray3) {
        for (int i2 = 0; i2 < i; i2++) {
            myByteArray3.cca[myByteArray3.ccb + i2] = myByteArray2.cca[(myByteArray2.ccb + bArr[i2]) - 1];
        }
        MyDES.m8757d(myByteArray, myByteArray3, i);
    }

    /* renamed from: a */
    private static void m8754a(MyByteArray myByteArray, MyByteArray myByteArray2, MyByteArray[] myByteArrayArr, MyByteArray myByteArray3, MyByteArray myByteArray4, MyByteArray myByteArray5, MyByteArray myByteArray6, MyByteArray myByteArray7, MyByteArray myByteArray8) {
        int i;
        ...
        MyDES.m8755b(myByteArray3, myByteArray2, 64);
        MyDES.m8753a(myByteArray3, myByteArray3, bArr, 64, myByteArray8);
        for (i = 0; i < 16; i++) {
            MyDES.m8757d(myByteArray5, myByteArray7, 32);
            ...
            while (i4 < 8) {
                ...
                MyDES.m8755b(myByteArray10, new MyByteArray(r6[i4][(byte) ((myByteArray4.cca[myByteArray4.ccb + 0] << 1) + myByteArray4.cca[myByteArray4.ccb + 5])][b]), 4);
                i4 = (byte) (i4 + 1);
                myByteArray4.ccb += 6;
                myByteArray7.ccb += 4;
            }
            myByteArray4.ccb = i2;
            myByteArray7.ccb = i3;
            MyDES.m8753a(myByteArray7, myByteArray7, bArr3, 32, myByteArray8);
            MyDES.m8752a(myByteArray7, myByteArray6, 32);
            MyDES.m8757d(myByteArray6, myByteArray5, 32);
        }
        MyDES.m8753a(myByteArray3, myByteArray3, bArr2, 64, myByteArray8);
        MyDES.m8751a(myByteArray, 8);
        for (i = 0; i < 64; i++) {
    ...
    /* renamed from: a */
    public static char m8750a(byte[] bArr, byte[] bArr2, long j, int i, byte[] bArr3) {
        int i2;
        ...
        if (bArr3 != null && bArr3.length > 0) {
            ...
            if (j2 != 0) {
                ...
                MyDES.m8751a(myByteArray4, 24);
                myByteArray2 = new MyByteArray(bArr3);
                if (i > 24) {
                    i = 24;
                }
                MyDES.m8757d(myByteArray4, myByteArray2, i);
                ...
                MyDES.m8755b(myByteArray5, myByteArray4, 64);
                MyDES.m8753a(myByteArray5, myByteArray5, bArr4, 56, myByteArray3);
                for (i3 = 0; i3 < 16; i3++) {
                    MyDES.m8756c(myByteArray6, myByteArray3, bArr6[i3]);
                    MyDES.m8756c(myByteArray7, myByteArray3, bArr6[i3]);
                    MyDES.m8753a(myByteArrayArr[i3], myByteArray5, bArr5, 48, myByteArray3);
                }
                i3 = myByteArray2.ccb;
                int i4 = myByteArray.ccb;
                MyDES.m8754a(myByteArray, myByteArray13, myByteArrayArr, myByteArray10, myByteArray11, myByteArray12, myByteArray8, myByteArray9, myByteArray3);
                MyDES.m8757d(myByteArray14, myByteArray, 8);
                myByteArray.ccb += 8;
                long j3 = 0;
                j2 >>= 3;
                while (j3 < j2) {
                    ...
                    MyDES.m8754a(myByteArray, myByteArray14, myByteArrayArr, myByteArray10, myByteArray11, myByteArray12, myByteArray8, myByteArray9, myByteArray3);
                    MyDES.m8757d(myByteArray14, myByteArray, 8);
                    j3++;
                    myByteArray.ccb += 8;
                    myByteArray2.ccb += 8;
    ...
    /* renamed from: d */
    private static void m8757d(MyByteArray myByteArray, MyByteArray myByteArray2, int i) {
        for (int i2 = 0; i2 < i; i2++) {
    ...
    /* renamed from: a */
    private static void m8751a(MyByteArray myByteArray, int i) {
        for (int i2 = 0; i2 < i; i2++) {
