...
public final class C36821c extends C35248e {
    private float faK;
    private float faL;
    private float hke;
    private float hkf;
    ...
    View snE;
    private int snF = C5229aj.fromDPToPix(C4996ah.getContext(), 30);
    private boolean snG;
    private int snH;

    public C36821c() {
        AppMethodBeat.m2504i(110709);
        AppMethodBeat.m2505o(110709);
    }

    /* renamed from: a */
    public final boolean mo9099a(MotionEvent motionEvent, boolean z, int i) {
        float f = 0.0f;
        AppMethodBeat.m2504i(110708);
