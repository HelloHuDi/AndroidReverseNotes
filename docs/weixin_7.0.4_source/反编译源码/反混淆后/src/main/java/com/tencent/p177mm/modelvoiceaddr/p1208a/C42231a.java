...
public final class C42231a {
    private int gbD = 0;
    private int gbE = 0;
    int gbF = 0;
    private short[] gbG;

    public C42231a(int i) {
        AppMethodBeat.m2504i(116754);
        if (i <= 1) {
            i = 512;
        }
        this.gbG = new short[i];
        AppMethodBeat.m2505o(116754);
    }

    /* Access modifiers changed, original: final */
    /* renamed from: d */
    public final int mo67757d(short[] sArr, int i) {
        int length;
        AppMethodBeat.m2504i(116755);
        if (i > sArr.length) {
            length = sArr.length;
        } else {
            length = i;
    ...
    /* Access modifiers changed, original: final */
    /* renamed from: e */
    public final int mo67758e(short[] sArr, int i) {
        AppMethodBeat.m2504i(116756);
        if (sArr.length < 0) {
            AppMethodBeat.m2505o(116756);
            return 0;
        }
        int length;
        if (i > sArr.length + 0) {
